...
.export sub_0x01D046_ожидание_записи_палитры_в_буфер
...
sub_0x01D046_ожидание_записи_палитры_в_буфер:
...
sub_D187_ожидание_записи_палитры:   ; bzk мусор для лого с кунио и ресета, удалить лишнее
