...
loc_0x01001F:
C - - J - - 0x01001F 04:800F: 4C 16 B3  JMP loc_B316_смещение_объектов_ветром__или_смерчем
...
loc_B316_смещение_объектов_ветром__или_смерчем:
...
C - - - - - 0x013866 04:B856: 30 0F     BMI bra_B867_бот
