...
C - - - - - 0x0100AA 04:809A: B9 74 00  LDA ram_анимация_игрока,Y
...
C - - - - - 0x0101D8 04:81C8: C9 0E     CMP #con_индекс_цифры
...
C - - - - - 0x0101E0 04:81D0: E9 0E     SBC #con_индекс_цифры
...
C - - - - - 0x012FC1 04:AFB1: B9 6C 04  LDA ram_категория_анимации_игрока,Y
...
C - - - - - 0x013529 04:B519: C0 0A     CPY #con_индекс_кипера
