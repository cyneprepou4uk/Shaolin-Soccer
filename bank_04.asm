...
.export loc_0x010010_отрисовка_спрайтов_анимаций_объектов
.export loc_0x010013_положение_мяча_относительно_игрока
.export loc_0x010016_фиксированное_положение_мяча_относительно_игрока
.export loc_0x01001C_флаг_видимости_и_приоритет_анимаций
.export loc_0x01001F
.export loc_0x010022
.export loc_0x010025
.export loc_0x010028
...
loc_0x010010_отрисовка_спрайтов_анимаций_объектов:
C D 0 J - - 0x010010 04:8000: 4C 31 80  JMP loc_8031_отрисовка_спрайтов_анимаций_объектов
...
loc_0x010016_фиксированное_положение_мяча_относительно_игрока:
C - - J - - 0x010016 04:8006: 4C 8D AF  JMP loc_AF8D_фиксированное_положение_мяча_относительно_игрока

loc_0x01001C_флаг_видимости_и_приоритет_анимаций:
C - - J - - 0x01001C 04:800C: 4C 04 B2  JMP loc_B204_флаг_видимости_и_приоритет_анимаций

loc_0x01001F:
C - - J - - 0x01001F 04:800F: 4C 16 B3  JMP loc_B316_смещение_объектов_ветром_или_смерчем
...
loc_8031_отрисовка_спрайтов_анимаций_объектов:
C D 0 - - - 0x010041 04:8031: A5 5C     LDA ram_flag_gameplay
C - - - - - 0x010043 04:8033: 10 01     BPL bra_8036_не_ручная_пауза
C - - - - - 0x010045 04:8035: 60        RTS
bra_8036_не_ручная_пауза:
C - - - - - 0x010046 04:8036: A9 40     LDA #$FF
C - - - - - 0x010048 04:8038: 8D E3 05  STA ram_счетчик_спрайтов
C - - - - - 0x01004B 04:803B: A2 FC     LDX #$FF
C - - - - - 0x01004D 04:803D: A5 F4     LDA ram_счетчик_объектов_на_экране
C - - - - - 0x01004F 04:803F: D0 03     BNE bra_8044_объекты_имеются
C - - - - - 0x010051 04:8041: 4C 8B 81  JMP loc_818B
bra_8044_объекты_имеются:
loc_8044_следующий_объект:
C D 0 - - - 0x010054 04:8044: C6 F4     DEC ram_счетчик_объектов_на_экране
C - - - - - 0x010056 04:8046: 10 03     BPL bra_804B_объекты_еще_есть
C - - - - - 0x010058 04:8048: 4C 8B 81  JMP loc_818B
bra_804B_объекты_еще_есть:
C - - - - - 0x01005B 04:804B: A4 F4     LDY ram_счетчик_объектов_на_экране
C - - - - - 0x01005D 04:804D: B9 A1 00  LDA ram_приоритет_анимации,Y
C - - - - - 0x010060 04:8050: 29 1F     AND #$1F
C - - - - - 0x010062 04:8052: A8        TAY
C - - - - - 0x010063 04:8053: B9 AF 03  LDA ram_03AF_разница_X_объекта_и_камеры,Y
...
C - - - - - 0x010076 04:8066: A4 F4     LDY ram_счетчик_объектов_на_экране
...
C - - - - - 0x0100AA 04:809A: B9 74 00  LDA ram_номер_анимации_игрока,Y
...
C - - - - - 0x0100C2 04:80B2: B9 61 00  LDA ram_тип_анимации_игрока,Y
C - - - - - 0x0100C5 04:80B5: C9 03     CMP #con_anim_type_цифра
C - - - - - 0x0100C7 04:80B7: D0 03     BNE bra_80BC_это_не_циферки
C - - - - - 0x0100C9 04:80B9: 4C 96 82  JMP loc_8296_отобразить_цифру
bra_80BC_это_не_циферки:
C - - - - - 0x0100CC 04:80BC: 0A        ASL
C - - - - - 0x0100CD 04:80BD: A8        TAY
C - - - - - 0x0100CE 04:80BE: B9 D8 83  LDA tbl_83D8_анимации,Y
C - - - - - 0x0100D1 04:80C1: 85 3A     STA ram_003A
C - - - - - 0x0100D3 04:80C3: B9 D9 83  LDA tbl_83D8_анимации + 1,Y
...
C - - - - - 0x0100EB 04:80DB: 85 2C     STA ram_002C    ; номер тайла тела и рожи
...
C - - - - - 0x0100F5 04:80E5: 85 2E     STA ram_002E    ; атрибут спрайтов
...
C - - - - - 0x0100FF 04:80EF: 85 30     STA ram_0030    ; смещение по X
...
C - - - - - 0x010109 04:80F9: 85 32     STA ram_0032    ; смещение по Y
...
C - - - - - 0x010114 04:8104: 85 2B     STA ram_002B    ; счетчик спрайтов анимации
loc_8106_loop_спрайты_анимации:
C D 0 - - - 0x010116 04:8106: B1 32     LDA (ram_0032),Y
C - - - - - 0x010118 04:8108: C5 1F     CMP ram_001F
C - - - - - 0x01011A 04:810A: B0 0D     BCS bra_8119_следующий_спрайт
C - - - - - 0x01011C 04:810C: 18        CLC
C - - - - - 0x01011D 04:810D: 65 1D     ADC ram_001D
C - - - - - 0x01011F 04:810F: C5 56     CMP ram_ограничитель_Y_спрайтов
C - - - - - 0x010121 04:8111: B0 06     BCS bra_8119_следующий_спрайт   ; если спрайт залазит на статусбар
C - - - - - 0x010123 04:8113: 9D 00 02  STA ram_spr_Y,X
C - - - - - 0x010126 04:8116: 4C 1C 81  JMP loc_811C
bra_8119_следующий_спрайт:
C - - - - - 0x010129 04:8119: 4C 80 81  JMP loc_8180_следующий_спрайт_этой_анимации
loc_811C:
C D 0 - - - 0x01012C 04:811C: B1 2C     LDA (ram_002C),Y
C - - - - - 0x01012E 04:811E: C9 06     CMP #$06
C - - - - - 0x010130 04:8120: 90 03     BCC bra_8125_это_тайл_рожи
C - - - - - 0x010132 04:8122: 4C 3A 81  JMP loc_813A_запись_тайла
bra_8125_это_тайл_рожи:
...
C - - - - - 0x010142 04:8132: B9 C6 82  LDA tbl_82C6_spr_T,Y
C - - - - - 0x010145 04:8135: A4 44     LDY ram_0044
loc_813A_запись_тайла:
...
C - - - - - 0x010172 04:8162: 10 1C     BPL bra_8180_следующий_спрайт_этой_анимации
...
C - - - - - 0x010180 04:8170: 30 0E     BMI bra_8180_следующий_спрайт_этой_анимации
bra_8172:
loc_8172:
C D 0 - - - 0x010182 04:8172: CE E3 05  DEC ram_счетчик_спрайтов
C - - - - - 0x010185 04:8175: CA        DEX
C - - - - - 0x010189 04:8179: E0 FC     CPX #$FF
C - - - - - 0x01018B 04:817B: D0 03     BNE bra_8180_следующий_спрайт_этой_анимации
C - - - - - 0x01018D 04:817D: 4C B4 81  JMP loc_81B4
bra_8180_следующий_спрайт_этой_анимации:
loc_8180_следующий_спрайт_этой_анимации:
C D 0 - - - 0x010190 04:8180: C8        INY
C - - - - - 0x010191 04:8181: C4 2B     CPY ram_002B
C - - - - - 0x010193 04:8183: F0 03     BEQ bra_8188_спрайты_анимации_закончились
C - - - - - 0x010195 04:8185: 4C 06 81  JMP loc_8106_loop_спрайты_анимации
bra_8188_спрайты_анимации_закончились:
C - - - - - 0x010198 04:8188: 4C 44 80  JMP loc_8044_следующий_объект



loc_818B:
C D 0 - - - 0x01019B 04:818B: AD 66 04  LDA ram_погодный_эффект
...
bra_81B4:
loc_81B4:
C D 0 - - - 0x0101C4 04:81B4: A5 F4     LDA ram_счетчик_объектов_на_экране
C - - - - - 0x0101C6 04:81B6: F0 06     BEQ bra_81BE_RTS
C - - - - - 0x0101C8 04:81B8: 10 05     BPL bra_81BF
C - - - - - 0x0101CA 04:81BA: A9 00     LDA #$00
C - - - - - 0x0101CC 04:81BC: 85 F4     STA ram_счетчик_объектов_на_экране
bra_81BE_RTS:
C - - - - - 0x0101CE 04:81BE: 60        RTS
bra_81BF:
C - - - - - 0x0101CF 04:81BF: A6 F4     LDX ram_счетчик_объектов_на_экране
...
C - - - - - 0x0101D8 04:81C8: C9 0E     CMP #con_id_цифры
C - - - - - 0x0101DA 04:81CA: 90 40     BCC bra_820C_проверить_следующий
C - - - - - 0x0101DC 04:81CC: 29 1F     AND #$1F
C - - - - - 0x0101DE 04:81CE: A8        TAY
C - - - - - 0x0101DF 04:81CF: 38        SEC
C - - - - - 0x0101E0 04:81D0: E9 0E     SBC #con_id_цифры
C - - - - - 0x0101E2 04:81D2: 85 1F     STA ram_001F
C - - - - - 0x0101E4 04:81D4: B9 AF 03  LDA ram_03AF_разница_X_объекта_и_камеры,Y
C - - - - - 0x0101E7 04:81D7: 85 1D     STA ram_001D
C - - - - - 0x0101E9 04:81D9: B9 C2 03  LDA ram_03C2,Y
C - - - - - 0x0101EC 04:81DC: C9 C0     CMP #$C0
C - - - - - 0x0101EE 04:81DE: 90 2C     BCC bra_820C_проверить_следующий
...
C - - - - - 0x01020D 04:81FD: B9 D3 83  LDA tbl_83D3_тайлы_циферок,Y
C - - - - - 0x010210 04:8200: A4 44     LDY ram_0044
C - - - - - 0x010212 04:8202: 99 01 02  STA ram_spr_T,Y
C - - - - - 0x010215 04:8205: A5 1C     DEC ram_001C
bra_820C_проверить_следующий:
C - - - - - 0x01021C 04:820C: CA        DEX
C - - - - - 0x01021D 04:820D: 10 B6     BPL bra_81C5_loop
C - - - - - 0x01021F 04:820F: A9 FF     LDA #$FF
C - - - - - 0x010221 04:8211: 85 F4     STA ram_счетчик_объектов_на_экране
...
C - - - - - 0x010235 04:8225: 4C 44 80  JMP loc_8044_следующий_объект
bra_8228:
C - - - - - 0x010238 04:8228: 9D 00 02  STA ram_spr_Y,X
C - - - - - 0x01023B 04:822B: A9 A1     LDA #con_номер_тайла + $A1
...
C - - - - - 0x010259 04:8249: 4C 44 80  JMP loc_8044_следующий_объект
bra_824C:
C - - - - - 0x01025C 04:824C: 9D 00 02  STA ram_spr_Y,X
C - - - - - 0x01025F 04:824F: A9 B7     LDA #con_номер_тайла + $B7
...
- - - - - - 0x010288 04:8278: 4C 44 80  JMP loc_8044_следующий_объект
bra_827B:
C - - - - - 0x01028B 04:827B: 9D 00 02  STA ram_spr_Y,X
C - - - - - 0x01028E 04:827E: A9 B7     LDA #con_номер_тайла + $B7
...
C - - - - - 0x0102BA 04:82AA: B9 CE 83  LDA tbl_83CE_тайлы_циферок,Y
...
tbl_82C6_spr_T:
- D 0 - - - 0x0102D6 04:82C6: 00        .byte con_номер_тайла + $00   ; 00
- D 0 - - - 0x0102D7 04:82C7: 01        .byte con_номер_тайла + $01   ; 01
- D 0 - - - 0x0102D8 04:82C8: 02        .byte con_номер_тайла + $02   ; 02
- D 0 - - - 0x0102D9 04:82C9: 03        .byte con_номер_тайла + $03   ; 03
- D 0 - - - 0x0102DA 04:82CA: 04        .byte con_номер_тайла + $04   ; 04
- D 0 - - - 0x0102DB 04:82CB: 05        .byte con_номер_тайла + $05   ; 05
- D 0 - - - 0x0102DC 04:82CC: 9B        .byte con_номер_тайла + $9B   ; 06
- D 0 - - - 0x0102DD 04:82CD: 9C        .byte con_номер_тайла + $9C   ; 07
- D 0 - - - 0x0102DE 04:82CE: BB        .byte con_номер_тайла + $BB   ; 08
- D 0 - - - 0x0102DF 04:82CF: BC        .byte con_номер_тайла + $BC   ; 09
- D 0 - - - 0x0102E0 04:82D0: 04        .byte con_номер_тайла + $04   ; 0A
- D 0 - - - 0x0102E1 04:82D1: FE        .byte con_номер_тайла + $FE   ; 0B
- D 0 - - - 0x0102E2 04:82D2: AB        .byte con_номер_тайла + $AB   ; 0C
- D 0 - - - 0x0102E3 04:82D3: AC        .byte con_номер_тайла + $AC   ; 0D
- D 0 - - - 0x0102E4 04:82D4: BA        .byte con_номер_тайла + $BA   ; 0E
- D 0 - - - 0x0102E5 04:82D5: 03        .byte con_номер_тайла + $03   ; 0F
- D 0 - - - 0x0102E6 04:82D6: 04        .byte con_номер_тайла + $04   ; 10
- D 0 - - - 0x0102E7 04:82D7: 05        .byte con_номер_тайла + $05   ; 11
- D 0 - - - 0x0102E8 04:82D8: AD        .byte con_номер_тайла + $AD   ; 12
- D 0 - - - 0x0102E9 04:82D9: AE        .byte con_номер_тайла + $AE   ; 13
- D 0 - - - 0x0102EA 04:82DA: BF        .byte con_номер_тайла + $BF   ; 14
- D 0 - - - 0x0102EB 04:82DB: 03        .byte con_номер_тайла + $03   ; 15
- D 0 - - - 0x0102EC 04:82DC: 04        .byte con_номер_тайла + $04   ; 16
- D 0 - - - 0x0102ED 04:82DD: 05        .byte con_номер_тайла + $05   ; 17
- D 0 - - - 0x0102EE 04:82DE: CD        .byte con_номер_тайла + $CD   ; 18
- D 0 - - - 0x0102EF 04:82DF: CE        .byte con_номер_тайла + $CE   ; 19
- D 0 - - - 0x0102F0 04:82E0: ED        .byte con_номер_тайла + $ED   ; 1A
- D 0 - - - 0x0102F1 04:82E1: EE        .byte con_номер_тайла + $EE   ; 1B
- D 0 - - - 0x0102F2 04:82E2: BD        .byte con_номер_тайла + $BD   ; 1C
- D 0 - - - 0x0102F3 04:82E3: BE        .byte con_номер_тайла + $BE   ; 1D
- D 0 - - - 0x0102F4 04:82E4: 8D        .byte con_номер_тайла + $8D   ; 1E
- D 0 - - - 0x0102F5 04:82E5: 8E        .byte con_номер_тайла + $8E   ; 1F
- D 0 - - - 0x0102F6 04:82E6: 9F        .byte con_номер_тайла + $9F   ; 20
- D 0 - - - 0x0102F7 04:82E7: 03        .byte con_номер_тайла + $03   ; 21
- D 0 - - - 0x0102F8 04:82E8: 04        .byte con_номер_тайла + $04   ; 22
- D 0 - - - 0x0102F9 04:82E9: 05        .byte con_номер_тайла + $05   ; 23
- D 0 - - - 0x0102FA 04:82EA: DD        .byte con_номер_тайла + $DD   ; 24
- D 0 - - - 0x0102FB 04:82EB: DE        .byte con_номер_тайла + $DE   ; 25
- D 0 - - - 0x0102FC 04:82EC: DF        .byte con_номер_тайла + $DF   ; 26
- D 0 - - - 0x0102FD 04:82ED: 03        .byte con_номер_тайла + $03   ; 27
- D 0 - - - 0x0102FE 04:82EE: 04        .byte con_номер_тайла + $04   ; 28
- D 0 - - - 0x0102FF 04:82EF: 05        .byte con_номер_тайла + $05   ; 29
- D 0 - - - 0x010300 04:82F0: EB        .byte con_номер_тайла + $EB   ; 2A
- D 0 - - - 0x010301 04:82F1: EC        .byte con_номер_тайла + $EC   ; 2B
- D 0 - - - 0x010302 04:82F2: FF        .byte con_номер_тайла + $FF   ; 2C
- D 0 - - - 0x010303 04:82F3: 03        .byte con_номер_тайла + $03   ; 2D
- D 0 - - - 0x010304 04:82F4: 04        .byte con_номер_тайла + $04   ; 2E
- D 0 - - - 0x010305 04:82F5: 05        .byte con_номер_тайла + $05   ; 2F
- D 0 - - - 0x010306 04:82F6: CB        .byte con_номер_тайла + $CB   ; 30
- D 0 - - - 0x010307 04:82F7: CC        .byte con_номер_тайла + $CC   ; 31
- D 0 - - - 0x010308 04:82F8: EF        .byte con_номер_тайла + $EF   ; 32
- D 0 - - - 0x010309 04:82F9: 03        .byte con_номер_тайла + $03   ; 33
- D 0 - - - 0x01030A 04:82FA: 04        .byte con_номер_тайла + $04   ; 34
- D 0 - - - 0x01030B 04:82FB: 05        .byte con_номер_тайла + $05   ; 35
- D 0 - - - 0x01030C 04:82FC: DB        .byte con_номер_тайла + $DB   ; 36
- D 0 - - - 0x01030D 04:82FD: DC        .byte con_номер_тайла + $DC   ; 37
- D 0 - - - 0x01030E 04:82FE: CF        .byte con_номер_тайла + $CF   ; 38
- D 0 - - - 0x01030F 04:82FF: 03        .byte con_номер_тайла + $03   ; 39
- D 0 - - - 0x010310 04:8300: 04        .byte con_номер_тайла + $04   ; 3A
- D 0 - - - 0x010311 04:8301: 05        .byte con_номер_тайла + $05   ; 3B
- D 0 - - - 0x010312 04:8302: 9D        .byte con_номер_тайла + $9D   ; 3C
- D 0 - - - 0x010313 04:8303: 9E        .byte con_номер_тайла + $9E   ; 3D
- D 0 - - - 0x010314 04:8304: AF        .byte con_номер_тайла + $AF   ; 3E
- D 0 - - - 0x010315 04:8305: 03        .byte con_номер_тайла + $03   ; 3F
- - - - - - 0x010316 04:8306: 04        .byte con_номер_тайла + $04   ; 40
- - - - - - 0x010317 04:8307: 05        .byte con_номер_тайла + $05   ; 41
- D 0 - - - 0x010318 04:8308: 8B        .byte con_номер_тайла + $8B   ; 42
- D 0 - - - 0x010319 04:8309: 8C        .byte con_номер_тайла + $8C   ; 43
- D 0 - - - 0x01031A 04:830A: 8F        .byte con_номер_тайла + $8F   ; 44
- D 0 - - - 0x01031B 04:830B: 03        .byte con_номер_тайла + $03   ; 45
- D 0 - - - 0x01031C 04:830C: 04        .byte con_номер_тайла + $04   ; 46
- D 0 - - - 0x01031D 04:830D: 05        .byte con_номер_тайла + $05   ; 47
- D 0 - - - 0x01031E 04:830E: 8B        .byte con_номер_тайла + $8B   ; 48
- D 0 - - - 0x01031F 04:830F: 8C        .byte con_номер_тайла + $8C   ; 49
- D 0 - - - 0x010320 04:8310: 8F        .byte con_номер_тайла + $8F   ; 4A
- D 0 - - - 0x010321 04:8311: BC        .byte con_номер_тайла + $BC   ; 4B
- D 0 - - - 0x010322 04:8312: BD        .byte con_номер_тайла + $BD   ; 4C
- D 0 - - - 0x010323 04:8313: BE        .byte con_номер_тайла + $BE   ; 4D
- D 0 - - - 0x010324 04:8314: 8D        .byte con_номер_тайла + $8D   ; 4E
- D 0 - - - 0x010325 04:8315: 8E        .byte con_номер_тайла + $8E   ; 4F
- D 0 - - - 0x010326 04:8316: 9F        .byte con_номер_тайла + $9F   ; 50
- D 0 - - - 0x010327 04:8317: BC        .byte con_номер_тайла + $BC   ; 51
- D 0 - - - 0x010328 04:8318: BD        .byte con_номер_тайла + $BD   ; 52
- D 0 - - - 0x010329 04:8319: BE        .byte con_номер_тайла + $BE   ; 53
- D 0 - - - 0x01032A 04:831A: 9B        .byte con_номер_тайла + $9B   ; 54
- D 0 - - - 0x01032B 04:831B: 9C        .byte con_номер_тайла + $9C   ; 55
- D 0 - - - 0x01032C 04:831C: BB        .byte con_номер_тайла + $BB   ; 56
- D 0 - - - 0x01032D 04:831D: BC        .byte con_номер_тайла + $BC   ; 57
- D 0 - - - 0x01032E 04:831E: BD        .byte con_номер_тайла + $BD   ; 58
- D 0 - - - 0x01032F 04:831F: BE        .byte con_номер_тайла + $BE   ; 59
- D 0 - - - 0x010330 04:8320: 9D        .byte con_номер_тайла + $9D   ; 5A
- D 0 - - - 0x010331 04:8321: 9E        .byte con_номер_тайла + $9E   ; 5B
- D 0 - - - 0x010332 04:8322: AF        .byte con_номер_тайла + $AF   ; 5C
- D 0 - - - 0x010333 04:8323: BC        .byte con_номер_тайла + $BC   ; 5D
- D 0 - - - 0x010334 04:8324: BD        .byte con_номер_тайла + $BD   ; 5E
- D 0 - - - 0x010335 04:8325: BE        .byte con_номер_тайла + $BE   ; 5F
- D 0 - - - 0x010336 04:8326: AB        .byte con_номер_тайла + $AB   ; 60
- D 0 - - - 0x010337 04:8327: AC        .byte con_номер_тайла + $AC   ; 61
- D 0 - - - 0x010338 04:8328: BA        .byte con_номер_тайла + $BA   ; 62
- D 0 - - - 0x010339 04:8329: BC        .byte con_номер_тайла + $BC   ; 63
- D 0 - - - 0x01033A 04:832A: BD        .byte con_номер_тайла + $BD   ; 64
- D 0 - - - 0x01033B 04:832B: BE        .byte con_номер_тайла + $BE   ; 65
- D 0 - - - 0x01033C 04:832C: AD        .byte con_номер_тайла + $AD   ; 66
- D 0 - - - 0x01033D 04:832D: AE        .byte con_номер_тайла + $AE   ; 67
- D 0 - - - 0x01033E 04:832E: BF        .byte con_номер_тайла + $BF   ; 68
- D 0 - - - 0x01033F 04:832F: BC        .byte con_номер_тайла + $BC   ; 69
- D 0 - - - 0x010340 04:8330: BD        .byte con_номер_тайла + $BD   ; 6A
- D 0 - - - 0x010341 04:8331: BE        .byte con_номер_тайла + $BE   ; 6B
- D 0 - - - 0x010342 04:8332: 4B        .byte con_номер_тайла + $4B   ; 6C
- D 0 - - - 0x010343 04:8333: 4C        .byte con_номер_тайла + $4C   ; 6D
- D 0 - - - 0x010344 04:8334: 4F        .byte con_номер_тайла + $4F   ; 6E
- D 0 - - - 0x010345 04:8335: 7C        .byte con_номер_тайла + $7C   ; 6F
- D 0 - - - 0x010346 04:8336: 7D        .byte con_номер_тайла + $7D   ; 70
- D 0 - - - 0x010347 04:8337: 7E        .byte con_номер_тайла + $7E   ; 71
- D 0 - - - 0x010348 04:8338: 4D        .byte con_номер_тайла + $4D   ; 72
- D 0 - - - 0x010349 04:8339: 4E        .byte con_номер_тайла + $4E   ; 73
- D 0 - - - 0x01034A 04:833A: 5F        .byte con_номер_тайла + $5F   ; 74
- D 0 - - - 0x01034B 04:833B: 7C        .byte con_номер_тайла + $7C   ; 75
- D 0 - - - 0x01034C 04:833C: 7D        .byte con_номер_тайла + $7D   ; 76
- D 0 - - - 0x01034D 04:833D: 7E        .byte con_номер_тайла + $7E   ; 77
- D 0 - - - 0x01034E 04:833E: 5B        .byte con_номер_тайла + $5B   ; 78
- D 0 - - - 0x01034F 04:833F: 5C        .byte con_номер_тайла + $5C   ; 79
- D 0 - - - 0x010350 04:8340: 7B        .byte con_номер_тайла + $7B   ; 7A
- D 0 - - - 0x010351 04:8341: 7C        .byte con_номер_тайла + $7C   ; 7B
- D 0 - - - 0x010352 04:8342: 7D        .byte con_номер_тайла + $7D   ; 7C
- D 0 - - - 0x010353 04:8343: 7E        .byte con_номер_тайла + $7E   ; 7D
- D 0 - - - 0x010354 04:8344: 5D        .byte con_номер_тайла + $5D   ; 7E
- D 0 - - - 0x010355 04:8345: 5E        .byte con_номер_тайла + $5E   ; 7F
- D 0 - - - 0x010356 04:8346: 6F        .byte con_номер_тайла + $6F   ; 80
- D 0 - - - 0x010357 04:8347: 7C        .byte con_номер_тайла + $7C   ; 81
- D 0 - - - 0x010358 04:8348: 7D        .byte con_номер_тайла + $7D   ; 82
- D 0 - - - 0x010359 04:8349: 7E        .byte con_номер_тайла + $7E   ; 83
- D 0 - - - 0x01035A 04:834A: 6B        .byte con_номер_тайла + $6B   ; 84
- D 0 - - - 0x01035B 04:834B: 6C        .byte con_номер_тайла + $6C   ; 85
- D 0 - - - 0x01035C 04:834C: 7A        .byte con_номер_тайла + $7A   ; 86
- D 0 - - - 0x01035D 04:834D: 7C        .byte con_номер_тайла + $7C   ; 87
- D 0 - - - 0x01035E 04:834E: 7D        .byte con_номер_тайла + $7D   ; 88
- D 0 - - - 0x01035F 04:834F: 7E        .byte con_номер_тайла + $7E   ; 89
- D 0 - - - 0x010360 04:8350: 6D        .byte con_номер_тайла + $6D   ; 8A
- D 0 - - - 0x010361 04:8351: 6E        .byte con_номер_тайла + $6E   ; 8B
- D 0 - - - 0x010362 04:8352: 7F        .byte con_номер_тайла + $7F   ; 8C
- D 0 - - - 0x010363 04:8353: 7C        .byte con_номер_тайла + $7C   ; 8D
- D 0 - - - 0x010364 04:8354: 7D        .byte con_номер_тайла + $7D   ; 8E
- D 0 - - - 0x010365 04:8355: 7E        .byte con_номер_тайла + $7E   ; 8F
- - - - - - 0x010366 04:8356: 84        .byte con_номер_тайла + $84   ; 90
- - - - - - 0x010367 04:8357: 85        .byte con_номер_тайла + $85   ; 91
- D 0 - - - 0x010368 04:8358: 86        .byte con_номер_тайла + $86   ; 92
- D 0 - - - 0x010369 04:8359: 87        .byte con_номер_тайла + $87   ; 93
- - - - - - 0x01036A 04:835A: 04        .byte con_номер_тайла + $04   ; 94
- - - - - - 0x01036B 04:835B: 05        .byte con_номер_тайла + $05   ; 95
- - - - - - 0x01036C 04:835C: 88        .byte con_номер_тайла + $88   ; 96
- - - - - - 0x01036D 04:835D: 89        .byte con_номер_тайла + $89   ; 97
- - - - - - 0x01036E 04:835E: 8A        .byte con_номер_тайла + $8A   ; 98
- - - - - - 0x01036F 04:835F: 8B        .byte con_номер_тайла + $8B   ; 99
- - - - - - 0x010370 04:8360: 04        .byte con_номер_тайла + $04   ; 9A
- - - - - - 0x010371 04:8361: 05        .byte con_номер_тайла + $05   ; 9B
- - - - - - 0x010372 04:8362: 8C        .byte con_номер_тайла + $8C   ; 9C
- - - - - - 0x010373 04:8363: 8D        .byte con_номер_тайла + $8D   ; 9D
- - - - - - 0x010374 04:8364: 8E        .byte con_номер_тайла + $8E   ; 9E
- - - - - - 0x010375 04:8365: 8F        .byte con_номер_тайла + $8F   ; 9F
- - - - - - 0x010376 04:8366: 04        .byte con_номер_тайла + $04   ; A0
- - - - - - 0x010377 04:8367: 05        .byte con_номер_тайла + $05   ; A1
- D 0 - - - 0x010378 04:8368: B0        .byte con_номер_тайла + $B0   ; A2
- D 0 - - - 0x010379 04:8369: B1        .byte con_номер_тайла + $B1   ; A3
- - - - - - 0x01037A 04:836A: B2        .byte con_номер_тайла + $B2   ; A4
- - - - - - 0x01037B 04:836B: B3        .byte con_номер_тайла + $B3   ; A5
- - - - - - 0x01037C 04:836C: 04        .byte con_номер_тайла + $04   ; A6
- - - - - - 0x01037D 04:836D: 05        .byte con_номер_тайла + $05   ; A7
- D 0 - - - 0x01037E 04:836E: 98        .byte con_номер_тайла + $98   ; A8
- D 0 - - - 0x01037F 04:836F: 99        .byte con_номер_тайла + $99   ; A9
- D 0 - - - 0x010380 04:8370: 9A        .byte con_номер_тайла + $9A   ; AA
- D 0 - - - 0x010381 04:8371: 9B        .byte con_номер_тайла + $9B   ; AB
- - - - - - 0x010382 04:8372: 04        .byte con_номер_тайла + $04   ; AC
- - - - - - 0x010383 04:8373: 05        .byte con_номер_тайла + $05   ; AD
- D 0 - - - 0x010384 04:8374: 9C        .byte con_номер_тайла + $9C   ; AE
- D 0 - - - 0x010385 04:8375: 9D        .byte con_номер_тайла + $9D   ; AF
- D 0 - - - 0x010386 04:8376: 9E        .byte con_номер_тайла + $9E   ; B0
- D 0 - - - 0x010387 04:8377: 9F        .byte con_номер_тайла + $9F   ; B1
- - - - - - 0x010388 04:8378: 04        .byte con_номер_тайла + $04   ; B2
- - - - - - 0x010389 04:8379: 05        .byte con_номер_тайла + $05   ; B3
- - - - - - 0x01038A 04:837A: A4        .byte con_номер_тайла + $A4   ; B4
- - - - - - 0x01038B 04:837B: A5        .byte con_номер_тайла + $A5   ; B5
- D 0 - - - 0x01038C 04:837C: A6        .byte con_номер_тайла + $A6   ; B6
- D 0 - - - 0x01038D 04:837D: A7        .byte con_номер_тайла + $A7   ; B7
- - - - - - 0x01038E 04:837E: 04        .byte con_номер_тайла + $04   ; B8
- - - - - - 0x01038F 04:837F: 05        .byte con_номер_тайла + $05   ; B9
- D 0 - - - 0x010390 04:8380: A8        .byte con_номер_тайла + $A8   ; BA
- D 0 - - - 0x010391 04:8381: A9        .byte con_номер_тайла + $A9   ; BB
- - - - - - 0x010392 04:8382: AA        .byte con_номер_тайла + $AA   ; BC
- - - - - - 0x010393 04:8383: AB        .byte con_номер_тайла + $AB   ; BD
- - - - - - 0x010394 04:8384: 04        .byte con_номер_тайла + $04   ; BE
- - - - - - 0x010395 04:8385: 05        .byte con_номер_тайла + $05   ; BF
- D 0 - - - 0x010396 04:8386: AC        .byte con_номер_тайла + $AC   ; C0
- D 0 - - - 0x010397 04:8387: AD        .byte con_номер_тайла + $AD   ; C1
- D 0 - - - 0x010398 04:8388: AE        .byte con_номер_тайла + $AE   ; C2
- D 0 - - - 0x010399 04:8389: AF        .byte con_номер_тайла + $AF   ; C3
- - - - - - 0x01039A 04:838A: 04        .byte con_номер_тайла + $04   ; C4
- - - - - - 0x01039B 04:838B: 05        .byte con_номер_тайла + $05   ; C5
- D 0 - - - 0x01039C 04:838C: B4        .byte con_номер_тайла + $B4   ; C6
- D 0 - - - 0x01039D 04:838D: B5        .byte con_номер_тайла + $B5   ; C7
- D 0 - - - 0x01039E 04:838E: B6        .byte con_номер_тайла + $B6   ; C8
- D 0 - - - 0x01039F 04:838F: B7        .byte con_номер_тайла + $B7   ; C9
- - - - - - 0x0103A0 04:8390: 04        .byte con_номер_тайла + $04   ; CA
- - - - - - 0x0103A1 04:8391: 05        .byte con_номер_тайла + $05   ; CB
- D 0 - - - 0x0103A2 04:8392: B8        .byte con_номер_тайла + $B8   ; CC
- D 0 - - - 0x0103A3 04:8393: B9        .byte con_номер_тайла + $B9   ; CD
- D 0 - - - 0x0103A4 04:8394: BA        .byte con_номер_тайла + $BA   ; CE
- D 0 - - - 0x0103A5 04:8395: BB        .byte con_номер_тайла + $BB   ; CF
- - - - - - 0x0103A6 04:8396: 04        .byte con_номер_тайла + $04   ; D0
- - - - - - 0x0103A7 04:8397: 05        .byte con_номер_тайла + $05   ; D1
- - - - - - 0x0103A8 04:8398: BC        .byte con_номер_тайла + $BC   ; D2
- - - - - - 0x0103A9 04:8399: BD        .byte con_номер_тайла + $BD   ; D3
- D 0 - - - 0x0103AA 04:839A: BE        .byte con_номер_тайла + $BE   ; D4
- D 0 - - - 0x0103AB 04:839B: BF        .byte con_номер_тайла + $BF   ; D5
- - - - - - 0x0103AC 04:839C: 04        .byte con_номер_тайла + $04   ; D6
- - - - - - 0x0103AD 04:839D: 05        .byte con_номер_тайла + $05   ; D7
- - - - - - 0x0103AE 04:839E: CA        .byte con_номер_тайла + $CA   ; D8
- - - - - - 0x0103AF 04:839F: CB        .byte con_номер_тайла + $CB   ; D9
- - - - - - 0x0103B0 04:83A0: CC        .byte con_номер_тайла + $CC   ; DA
- - - - - - 0x0103B1 04:83A1: CD        .byte con_номер_тайла + $CD   ; DB
- - - - - - 0x0103B2 04:83A2: CE        .byte con_номер_тайла + $CE   ; DC
- - - - - - 0x0103B3 04:83A3: CF        .byte con_номер_тайла + $CF   ; DD
- D 0 - - - 0x0103B4 04:83A4: DA        .byte con_номер_тайла + $DA   ; DE
- D 0 - - - 0x0103B5 04:83A5: DB        .byte con_номер_тайла + $DB   ; DF
- - - - - - 0x0103B6 04:83A6: DC        .byte con_номер_тайла + $DC   ; E0
- - - - - - 0x0103B7 04:83A7: DD        .byte con_номер_тайла + $DD   ; E1
- - - - - - 0x0103B8 04:83A8: DE        .byte con_номер_тайла + $DE   ; E2
- - - - - - 0x0103B9 04:83A9: DF        .byte con_номер_тайла + $DF   ; E3
- - - - - - 0x0103BA 04:83AA: EA        .byte con_номер_тайла + $EA   ; E4
- - - - - - 0x0103BB 04:83AB: EB        .byte con_номер_тайла + $EB   ; E5
- - - - - - 0x0103BC 04:83AC: EC        .byte con_номер_тайла + $EC   ; E6
- - - - - - 0x0103BD 04:83AD: ED        .byte con_номер_тайла + $ED   ; E7
- - - - - - 0x0103BE 04:83AE: EE        .byte con_номер_тайла + $EE   ; E8
- - - - - - 0x0103BF 04:83AF: EF        .byte con_номер_тайла + $EF   ; E9
- D 0 - - - 0x0103C0 04:83B0: FA        .byte con_номер_тайла + $FA   ; EA
- D 0 - - - 0x0103C1 04:83B1: FB        .byte con_номер_тайла + $FB   ; EB
- - - - - - 0x0103C2 04:83B2: FC        .byte con_номер_тайла + $FC   ; EC
- - - - - - 0x0103C3 04:83B3: FD        .byte con_номер_тайла + $FD   ; ED
- - - - - - 0x0103C4 04:83B4: FE        .byte con_номер_тайла + $FE   ; EE
- - - - - - 0x0103C5 04:83B5: FF        .byte con_номер_тайла + $FF   ; EF
- - - - - - 0x0103C6 04:83B6: CC        .byte con_номер_тайла + $CC   ; F0
- - - - - - 0x0103C7 04:83B7: CD        .byte con_номер_тайла + $CD   ; F1
- - - - - - 0x0103C8 04:83B8: FC        .byte con_номер_тайла + $FC   ; F2
- - - - - - 0x0103C9 04:83B9: FD        .byte con_номер_тайла + $FD   ; F3
- - - - - - 0x0103CA 04:83BA: FE        .byte con_номер_тайла + $FE   ; F4
- - - - - - 0x0103CB 04:83BB: FF        .byte con_номер_тайла + $FF   ; F5



tbl_83BC:
- D 0 - - - 0x0103CC 04:83BC: 01        .byte $01   ; 00
- D 0 - - - 0x0103CD 04:83BD: 02        .byte $02   ; 01
- D 0 - - - 0x0103CE 04:83BE: 01        .byte $01   ; 02
- D 0 - - - 0x0103CF 04:83BF: 02        .byte $02   ; 03
- D 0 - - - 0x0103D0 04:83C0: 01        .byte $01   ; 04
- D 0 - - - 0x0103D1 04:83C1: 02        .byte $02   ; 05
- D 0 - - - 0x0103D2 04:83C2: 01        .byte $01   ; 06
- D 0 - - - 0x0103D3 04:83C3: 02        .byte $02   ; 07
- D 0 - - - 0x0103D4 04:83C4: 01        .byte $01   ; 08
- D 0 - - - 0x0103D5 04:83C5: 02        .byte $02   ; 09
- D 0 - - - 0x0103D6 04:83C6: 01        .byte $01   ; 0A
- D 0 - - - 0x0103D7 04:83C7: 02        .byte $02   ; 0B
- D 0 - - - 0x0103D8 04:83C8: 00        .byte $00   ; 0C
- - - - - - 0x0103D9 04:83C9: 00        .byte $00   ; 0D
- D 0 - - - 0x0103DA 04:83CA: 00        .byte $00   ; 0E
- D 0 - - - 0x0103DB 04:83CB: 00        .byte $00   ; 0F
- D 0 - - - 0x0103DC 04:83CC: 00        .byte $00   ; 10
- D 0 - - - 0x0103DD 04:83CD: 00        .byte $00   ; 11



tbl_83CE_тайлы_циферок:
- D 0 - - - 0x0103DE 04:83CE: C0        .byte con_номер_тайла + $C0   ; 1
- D 0 - - - 0x0103DF 04:83CF: C1        .byte con_номер_тайла + $C1   ; 2
- D 0 - - - 0x0103E0 04:83D0: D0        .byte con_номер_тайла + $D0   ; 3
- D 0 - - - 0x0103E1 04:83D1: D1        .byte con_номер_тайла + $D1   ; 4
- D 0 - - - 0x0103E2 04:83D2: C2        .byte con_номер_тайла + $C2   ; мяч



tbl_83D3_тайлы_циферок:
- D 0 - - - 0x0103E3 04:83D3: C2        .byte con_номер_тайла + $C2   ; мяч
- D 0 - - - 0x0103E4 04:83D4: C0        .byte con_номер_тайла + $C0   ; 1
- D 0 - - - 0x0103E5 04:83D5: C1        .byte con_номер_тайла + $C1   ; 2
- D 0 - - - 0x0103E6 04:83D6: D0        .byte con_номер_тайла + $D0   ; 3
- D 0 - - - 0x0103E7 04:83D7: D1        .byte con_номер_тайла + $D1   ; 4



tbl_83D8_анимации:
- D 0 - - - 0x0103E8 04:83D8: EC 83     .word off_83EC_00_полевой
- D 0 - - - 0x0103EA 04:83DA: E0 84     .word off_84E0_01_мяч
- - - - - - 0x0103EC 04:83DC: 6C 85     .word off_856C_02
- - - - - - 0x0103EE 04:83DE: 70 85     .word off_8570_03_циферки
- D 0 - - - 0x0103F0 04:83E0: 92 84     .word off_8492_04_после_гола_и_кубок
- D 0 - - - 0x0103F2 04:83E2: 7A 85     .word off_857A_05_стрелочка_рожи
- D 0 - - - 0x0103F4 04:83E4: B6 85     .word off_85B6_06_флаги_логотипы_транспорт
- D 0 - - - 0x0103F6 04:83E6: E4 85     .word off_85E4_07_победная_анимация
- D 0 - - - 0x0103F8 04:83E8: CF AC     .word off_ACCF_08_кунио_на_логотипе
- D 0 - - - 0x0103FA 04:83EA: 6E 86     .word off_866E_09_мисако
...
off_8492_04_после_гола_и_кубок:
...
off_85B6_06_флаги_логотипы_транспорт:
...
C - - - - - 0x012FD6 04:AFC6: B9 E8 03  LDA ram_spd_X_lo_игрока,Y
C - - - - - 0x012FD9 04:AFC9: 9D E8 03  STA ram_spd_X_lo_игрока,X
C - - - - - 0x012FDC 04:AFCC: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
C - - - - - 0x012FDF 04:AFCF: 9D F6 03  STA ram_spd_X_hi_игрока,X
C - - - - - 0x012FE2 04:AFD2: B9 04 04  LDA ram_spd_Y_lo_игрока,Y
C - - - - - 0x012FE5 04:AFD5: 9D 04 04  STA ram_spd_Y_lo_игрока,X
C - - - - - 0x012FE8 04:AFD8: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
C - - - - - 0x012FEB 04:AFDB: 9D 12 04  STA ram_spd_Y_hi_игрока,X
C - - - - - 0x012FEE 04:AFDE: B9 20 04  LDA ram_spd_Z_lo_игрока,Y
C - - - - - 0x012FF1 04:AFE1: 9D 20 04  STA ram_spd_Z_lo_игрока,X
C - - - - - 0x012FF4 04:AFE4: B9 2E 04  LDA ram_spd_Z_hi_игрока,Y
C - - - - - 0x012FF7 04:AFE7: 9D 2E 04  STA ram_spd_Z_hi_игрока,X
C - - - - - 0x012FFA 04:AFEA: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x012FFD 04:AFED: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x013000 04:AFF0: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x013003 04:AFF3: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x013006 04:AFF6: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x013009 04:AFF9: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x01300C 04:AFFC: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x01300F 04:AFFF: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x013012 04:B002: B9 86 03  LDA ram_pos_Z_lo_игрока,Y
C - - - - - 0x013015 04:B005: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x013018 04:B008: B9 99 03  LDA ram_pos_Z_hi_игрока,Y
C - - - - - 0x01301B 04:B00B: 9D 99 03  STA ram_pos_Z_hi_игрока,X
C - - - - - 0x01301E 04:B00E: B9 A3 04  LDA ram_напр_движ_игрока,Y
C - - - - - 0x013021 04:B011: 9D A3 04  STA ram_напр_движ_игрока,X
C - - - - - 0x013024 04:B014: 10 02     BPL bra_B018_повернут_направо
C - - - - - 0x013026 04:B016: C6 1C     DEC ram_001C
bra_B018_повернут_направо:
...
C - - - - - 0x013039 04:B029: B9 94 00  LDA ram_кадр_анимации_игрока,Y
C - - - - - 0x01303C 04:B02C: 0A        ASL
C - - - - - 0x01303D 04:B02D: 79 94 00  ADC ram_кадр_анимации_игрока,Y
...
C - - - - - 0x01304F 04:B03F: 7D 14 03  ADC ram_pos_X_lo_игрока,X
C - - - - - 0x013052 04:B042: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x013055 04:B045: A5 2F     LDA ram_002F
C - - - - - 0x013057 04:B047: 45 1C     EOR ram_001C
C - - - - - 0x013059 04:B049: 7D 27 03  ADC ram_pos_X_hi_игрока,X
C - - - - - 0x01305C 04:B04C: 9D 27 03  STA ram_pos_X_hi_игрока,X
...
bra_B057:
C - - - - - 0x013067 04:B057: 7D 4D 03  ADC ram_pos_Y_lo_игрока,X
C - - - - - 0x01306A 04:B05A: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x01306D 04:B05D: A5 31     LDA ram_0031
C - - - - - 0x01306F 04:B05F: 7D 60 03  ADC ram_pos_Y_hi_игрока,X
C - - - - - 0x013072 04:B062: 9D 60 03  STA ram_pos_Y_hi_игрока,X
...
bra_B06D:
C - - - - - 0x01307D 04:B06D: 7D 86 03  ADC ram_pos_Z_lo_игрока,X
C - - - - - 0x013080 04:B070: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x013083 04:B073: A5 33     LDA ram_0033
C - - - - - 0x013085 04:B075: 7D 99 03  ADC ram_pos_Z_hi_игрока,X
C - - - - - 0x013088 04:B078: 9D 99 03  STA ram_pos_Z_hi_игрока,X
C - - - - - 0x01308B 04:B07B: 60        RTS



tbl_B07C_индекс:
- - - - - - 0x01308C 04:B07C: 00        .byte $00   ; 00 80
- D 1 - - - 0x01308D 04:B07D: 00        .byte $00   ; 01 81
- D 1 - - - 0x01308E 04:B07E: 02        .byte $02   ; 02 82
- - - - - - 0x01308F 04:B07F: 00        .byte $00   ; 03 83
- - - - - - 0x013090 04:B080: 00        .byte $00   ; 04 84
- - - - - - 0x013091 04:B081: 00        .byte $00   ; 05 85
- D 1 - - - 0x013092 04:B082: 00        .byte $00   ; 06 86
- - - - - - 0x013093 04:B083: 00        .byte $00   ; 07 87
- - - - - - 0x013094 04:B084: 00        .byte $00   ; 08 88
- D 1 - - - 0x013095 04:B085: 00        .byte $00   ; 09 89
- D 1 - - - 0x013096 04:B086: 00        .byte $00   ; 0A 8A
- - - - - - 0x013097 04:B087: 00        .byte $00   ; 0B 8B
- D 1 - - - 0x013098 04:B088: 82        .byte $82   ; 0C 8C
- - - - - - 0x013099 04:B089: 00        .byte $00   ; 0D 8D
- D 1 - - - 0x01309A 04:B08A: 00        .byte $00   ; 0E 8E
- D 1 - - - 0x01309B 04:B08B: 00        .byte $00   ; 0F 8F
- D 1 - - - 0x01309C 04:B08C: 81        .byte $81   ; 10 90
- D 1 - - - 0x01309D 04:B08D: 00        .byte $00   ; 11 91
- - - - - - 0x01309E 04:B08E: 00        .byte $00   ; 12 92
- - - - - - 0x01309F 04:B08F: 00        .byte $00   ; 13 93
- - - - - - 0x0130A0 04:B090: 00        .byte $00   ; 14 94
- - - - - - 0x0130A1 04:B091: 00        .byte $00   ; 15 95
- D 1 - - - 0x0130A2 04:B092: 83        .byte $83   ; 16 96
- - - - - - 0x0130A3 04:B093: 00        .byte $00   ; 17 97
- - - - - - 0x0130A4 04:B094: 00        .byte $00   ; 18 98
- - - - - - 0x0130A5 04:B095: 00        .byte $00   ; 19 99
- D 1 - - - 0x0130A6 04:B096: 00        .byte $00   ; 1A 9A
- - - - - - 0x0130A7 04:B097: 00        .byte $00   ; 1B 9B
- - - - - - 0x0130A8 04:B098: 00        .byte $00   ; 1C 9C
- D 1 - - - 0x0130A9 04:B099: 00        .byte $00   ; 1D 9D
- - - - - - 0x0130AA 04:B09A: 00        .byte $00   ; 1E 9E
- - - - - - 0x0130AB 04:B09B: 00        .byte $00   ; 1F 9F
- D 1 - - - 0x0130AC 04:B09C: 00        .byte $00   ; 20 A0
- D 1 - - - 0x0130AD 04:B09D: 00        .byte $00   ; 21 A1
- - - - - - 0x0130AE 04:B09E: 00        .byte $00   ; 22 A2
- D 1 - - - 0x0130AF 04:B09F: 00        .byte $00   ; 23 A3
- D 1 - - - 0x0130B0 04:B0A0: 00        .byte $00   ; 24 A4
- - - - - - 0x0130B1 04:B0A1: 00        .byte $00   ; 25 A5
- - - - - - 0x0130B2 04:B0A2: 00        .byte $00   ; 26 A6
- - - - - - 0x0130B3 04:B0A3: 00        .byte $00   ; 27 A7
- - - - - - 0x0130B4 04:B0A4: 80        .byte $80   ; 28 A8
- D 1 - - - 0x0130B5 04:B0A5: 80        .byte $80   ; 29 A9
- - - - - - 0x0130B6 04:B0A6: 00        .byte $00   ; 2A AA
- - - - - - 0x0130B7 04:B0A7: 00        .byte $00   ; 2B AB
- - - - - - 0x0130B8 04:B0A8: 00        .byte $00   ; 2C AC
- D 1 - - - 0x0130B9 04:B0A9: 00        .byte $00   ; 2D AD
- D 1 - - - 0x0130BA 04:B0AA: 00        .byte $00   ; 2E AE
- D 1 - - - 0x0130BB 04:B0AB: 10        .byte $10   ; 2F AF
- D 1 - - - 0x0130BC 04:B0AC: 00        .byte $00   ; 30 B0
- - - - - - 0x0130BD 04:B0AD: 00        .byte $00   ; 31 B1
- - - - - - 0x0130BE 04:B0AE: 09        .byte $09   ; 32 B2
- - - - - - 0x0130BF 04:B0AF: 00        .byte $00   ; 33 B3
- - - - - - 0x0130C0 04:B0B0: 00        .byte $00   ; 34 B4
- - - - - - 0x0130C1 04:B0B1: 00        .byte $00   ; 35 B5
- - - - - - 0x0130C2 04:B0B2: 00        .byte $00   ; 36 B6
- D 1 - - - 0x0130C3 04:B0B3: 0A        .byte $0A   ; 37 B7
- D 1 - - - 0x0130C4 04:B0B4: 0B        .byte $0B   ; 38 B8
- D 1 - - - 0x0130C5 04:B0B5: 00        .byte $00   ; 39 B9
- - - - - - 0x0130C6 04:B0B6: 00        .byte $00   ; 3A BA
- - - - - - 0x0130C7 04:B0B7: 00        .byte $00   ; 3B BB
- D 1 - - - 0x0130C8 04:B0B8: 00        .byte $00   ; 3C BC
- D 1 - - - 0x0130C9 04:B0B9: 00        .byte $00   ; 3D BD
- - - - - - 0x0130CA 04:B0BA: 80        .byte $80   ; 3E BE
- D 1 - - - 0x0130CB 04:B0BB: 80        .byte $80   ; 3F BF
- D 1 - - - 0x0130CC 04:B0BC: 0C        .byte $0C   ; 40 C0
- - - - - - 0x0130CD 04:B0BD: 00        .byte $00   ; 41 C1
- - - - - - 0x0130CE 04:B0BE: 00        .byte $00   ; 42 C2
- - - - - - 0x0130CF 04:B0BF: 00        .byte $00   ; 43 C3
- - - - - - 0x0130D0 04:B0C0: 00        .byte $00   ; 44 C4
- D 1 - - - 0x0130D1 04:B0C1: 00        .byte $00   ; 45 C5
- D 1 - - - 0x0130D2 04:B0C2: 09        .byte $09   ; 46 C6
- - - - - - 0x0130D3 04:B0C3: 00        .byte $00   ; 47 C7
- - - - - - 0x0130D4 04:B0C4: 00        .byte $00   ; 48 C8
- - - - - - 0x0130D5 04:B0C5: 00        .byte $00   ; 49 C9
- - - - - - 0x0130D6 04:B0C6: 00        .byte $00   ; 4A CA
- - - - - - 0x0130D7 04:B0C7: 00        .byte $00   ; 4B CB
- - - - - - 0x0130D8 04:B0C8: 00        .byte $00   ; 4C CC
- - - - - - 0x0130D9 04:B0C9: 00        .byte $00   ; 4D CD
- - - - - - 0x0130DA 04:B0CA: 00        .byte $00   ; 4E CE
- - - - - - 0x0130DB 04:B0CB: 00        .byte $00   ; 4F CF
- - - - - - 0x0130DC 04:B0CC: 00        .byte $00   ; 50 D0
- - - - - - 0x0130DD 04:B0CD: 00        .byte $00   ; 51 D1
- - - - - - 0x0130DE 04:B0CE: 00        .byte $00   ; 52 D2
- - - - - - 0x0130DF 04:B0CF: 00        .byte $00   ; 53 D3
- - - - - - 0x0130E0 04:B0D0: 00        .byte $00   ; 54 D4
- - - - - - 0x0130E1 04:B0D1: 00        .byte $00   ; 55 D5
- - - - - - 0x0130E2 04:B0D2: 00        .byte $00   ; 56 D6
- D 1 - - - 0x0130E3 04:B0D3: 0F        .byte $0F   ; 57 D7
- - - - - - 0x0130E4 04:B0D4: 00        .byte $00   ; 58 D8
- - - - - - 0x0130E5 04:B0D5: 00        .byte $00   ; 59 D9
- - - - - - 0x0130E6 04:B0D6: 00        .byte $00   ; 5A DA
- - - - - - 0x0130E7 04:B0D7: 00        .byte $00   ; 5B DB
...
loc_B204_флаг_видимости_и_приоритет_анимаций:
C D 1 - - - 0x013214 04:B204: 20 6E B2  JSR sub_B26E_вычисление_флага_видимости
C - - - - - 0x013217 04:B207: 4C 0D B2  JMP loc_B20D_поменять_приоритет_анимаций



loc_B20D_поменять_приоритет_анимаций:
...
C - - - - - 0x013226 04:B216: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x013229 04:B219: ED EE 00  SBC ram_pos_Y_lo_скролл
C - - - - - 0x01322C 04:B21C: 9D C1 00  STA ram_разница_Y_объекта_и_скролла,X
C - - - - - 0x01322F 04:B21F: E8        INX
C - - - - - 0x013230 04:B220: E4 F4     CPX ram_счетчик_объектов_на_экране
C - - - - - 0x013232 04:B222: 90 EB     BCC bra_B20F_loop
C - - - - - 0x013234 04:B224: AD F4 00  LDA ram_счетчик_объектов_на_экране
C - - - - - 0x013237 04:B227: 85 2B     STA ram_002B
C - - - - - 0x013239 04:B229: F0 42     BEQ bra_B26D_RTS    ; bzk опт, сначала проверить есть ли объекты, а потом все остальное
...
bra_B235_loop:
C - - - - - 0x013245 04:B235: BD C1 00  LDA ram_разница_Y_объекта_и_скролла,X
C - - - - - 0x013248 04:B238: DD C2 00  CMP ram_разница_Y_объекта_и_скролла + 1,X
...
C - - - - - 0x01325D 04:B24D: BD C2 00  LDA ram_разница_Y_объекта_и_скролла + 1,X
C - - - - - 0x013260 04:B250: 85 1F     STA ram_001F
C - - - - - 0x013262 04:B252: BD C1 00  LDA ram_разница_Y_объекта_и_скролла,X
C - - - - - 0x013265 04:B255: 9D C2 00  STA ram_разница_Y_объекта_и_скролла + 1,X
C - - - - - 0x013268 04:B258: A5 1F     LDA ram_001F
C - - - - - 0x01326A 04:B25A: 9D C1 00  STA ram_разница_Y_объекта_и_скролла,X
C - - - - - 0x01326D 04:B25D: E6 1C     INC ram_001C
bra_B25F:
C - - - - - 0x01326F 04:B25F: E8        INX
C - - - - - 0x013270 04:B260: E4 2B     CPX ram_002B
C - - - - - 0x013272 04:B262: 90 D1     BCC bra_B235_loop
C - - - - - 0x013274 04:B264: A5 1C     LDA ram_001C
C - - - - - 0x013276 04:B266: F0 05     BEQ bra_B26D_RTS
C - - - - - 0x013278 04:B268: C6 2B     DEC ram_002B
C - - - - - 0x01327A 04:B26A: 4C 2D B2  JMP loc_B22D_loop
bra_B26D_RTS:
C - - - - - 0x01327D 04:B26D: 60        RTS



sub_B26E_вычисление_флага_видимости:
...
C - - - - - 0x013291 04:B281: A5 F4     LDA ram_счетчик_объектов_на_экране
C - - - - - 0x013293 04:B283: D0 03     BNE bra_B288_на_экране_чтото_есть
C - - - - - 0x013295 04:B285: 4C 15 B3  RTS
bra_B288_на_экране_чтото_есть:
...
C - - - - - 0x0132A0 04:B290: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x0132A3 04:B293: 38        SEC
C - - - - - 0x0132A4 04:B294: E5 F0     SBC ram_pos_X_lo_камера
C - - - - - 0x0132A6 04:B296: 99 AF 03  STA ram_03AF_разница_X_объекта_и_камеры,Y
C - - - - - 0x0132A9 04:B299: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x0132AC 04:B29C: E5 F1     SBC ram_pos_X_hi_камера
C - - - - - 0x0132AE 04:B29E: D0 5B     BNE bra_B2FB
C - - - - - 0x0132B0 04:B2A0: B9 AF 03  LDA ram_03AF_разница_X_объекта_и_камеры,Y
C - - - - - 0x0132B3 04:B2A3: C9 08     CMP #$08
C - - - - - 0x0132B5 04:B2A5: 90 54     BCC bra_B2FB
C - - - - - 0x0132B7 04:B2A7: 18        CLC
C - - - - - 0x0132B8 04:B2A8: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x0132BB 04:B2AB: 65 F5     ADC ram_00F5
C - - - - - 0x0132BD 04:B2AD: 85 2C     STA ram_002C
C - - - - - 0x0132BF 04:B2AF: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
...
C - - - - - 0x0132D9 04:B2C9: F9 86 03  SBC ram_pos_Z_lo_игрока,Y
C - - - - - 0x0132DC 04:B2CC: 99 C2 03  STA ram_03C2,Y
C - - - - - 0x0132DF 04:B2CF: A5 2D     LDA ram_002D
C - - - - - 0x0132E1 04:B2D1: F9 99 03  SBC ram_pos_Z_hi_игрока,Y
...
C - - - - - 0x01330E 04:B2FE: CE F4 00  DEC ram_счетчик_объектов_на_экране
bra_B301_loop:
...
C - - - - - 0x013318 04:B308: CC F4 00  CPY ram_счетчик_объектов_на_экране
C - - - - - 0x01331B 04:B30B: 90 F4     BCC bra_B301_loop
bra_B30D:
C - - - - - 0x01331D 04:B30D: E8        INX
C - - - - - 0x01331E 04:B30E: E4 F4     CPX ram_счетчик_объектов_на_экране
C - - - - - 0x013320 04:B310: B0 03     BCS bra_B315_RTS
C - - - - - 0x013322 04:B312: 4C 8A B2  JMP loc_B28A_loop
bra_B315_RTS:
C D 1 - - - 0x013325 04:B315: 60        RTS



loc_B316_смещение_объектов_ветром_или_смерчем:
C D 1 - - - 0x013326 04:B316: A0 00     LDY #$00
C - - - - - 0x013328 04:B318: 8C FC 05  STY ram_степень_силы_ветра
...
C - - - - - 0x013335 04:B325: EE FC 05  INC ram_степень_силы_ветра
...
C - - - - - 0x0133A8 04:B398: AD 66 04  LDA ram_погодный_эффект
C - - - - - 0x0133AB 04:B39B: C9 03     CMP #con_погода_смерч
...
C - - - - - 0x0133E3 04:B3D3: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x0133E6 04:B3D6: CD 34 03  CMP ram_pos_X_hi_погоды
C - - - - - 0x0133E9 04:B3D9: F0 05     BEQ bra_B3E0
- - - - - - 0x0133EB 04:B3DB: 90 1E     BCC bra_B3FB
- - - - - - 0x0133ED 04:B3DD: 4C EA B3  JMP loc_B3EA
bra_B3E0:
C - - - - - 0x0133F0 04:B3E0: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x0133F3 04:B3E3: CD 21 03  CMP ram_pos_X_lo_погоды
...
C - - - - - 0x01340C 04:B3FC: BD E8 03  LDA ram_spd_X_lo_игрока,X
C - - - - - 0x01340F 04:B3FF: 65 2C     ADC ram_002C
C - - - - - 0x013411 04:B401: 9D E8 03  STA ram_spd_X_lo_игрока,X
C - - - - - 0x013414 04:B404: BD F6 03  LDA ram_spd_X_hi_игрока,X
C - - - - - 0x013417 04:B407: 65 2D     ADC ram_002D
C - - - - - 0x013419 04:B409: 9D F6 03  STA ram_spd_X_hi_игрока,X
bra_B40C:
C - - - - - 0x01341C 04:B40C: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x01341F 04:B40F: CD 6D 03  CMP ram_pos_Y_hi_погоды
C - - - - - 0x013422 04:B412: F0 05     BEQ bra_B419
C - - - - - 0x013424 04:B414: 90 1E     BCC bra_B434
- - - - - - 0x013426 04:B416: 4C 23 B4  JMP loc_B423
bra_B419:
- - - - - - 0x013429 04:B419: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
- - - - - - 0x01342C 04:B41C: CD 5A 03  CMP ram_pos_Y_lo_погоды
...
C - - - - - 0x013445 04:B435: BD 04 04  LDA ram_spd_Y_lo_игрока,X
C - - - - - 0x013448 04:B438: 65 2E     ADC ram_002E
C - - - - - 0x01344A 04:B43A: 9D 04 04  STA ram_spd_Y_lo_игрока,X
C - - - - - 0x01344D 04:B43D: BD 12 04  LDA ram_spd_Y_hi_игрока,X
C - - - - - 0x013450 04:B440: 65 2F     ADC ram_002F
C - - - - - 0x013452 04:B442: 9D 12 04  STA ram_spd_Y_hi_игрока,X
loc_B445:
bra_B445:
...
C - - - - - 0x0134C8 04:B4B8: 20 50 B8  JSR sub_B850_разводка    ; 01
C - - - - - 0x0134CB 04:B4BB: 4C C8 B4  RTS
bra_B4BE_не_kick_off:
C - - - - - 0x0134CE 04:B4BE: A2 00     LDX #$00
bra_B4C0_loop:
C - - - - - 0x0134D0 04:B4C0: 20 C9 B4  JSR sub_B4C9_игра_в_поле
...
sub_B4C9_игра_в_поле:
C - - - - - 0x0134D9 04:B4C9: 86 43     STX ram_0043
C - - - - - 0x0134DB 04:B4CB: BD 68 05  LDA ram_номер_управляемого,X
C - - - - - 0x0134DE 04:B4CE: 30 0B     BMI bra_B4DB_бот
C - - - - - 0x0134E0 04:B4D0: AA        TAX
C - - - - - 0x0134E1 04:B4D1: BD 50 06  LDA ram_позиция_управление,X
C - - - - - 0x0134E4 04:B4D4: 30 05     BMI bra_B4DB_бот
C - - - - - 0x0134E6 04:B4D6: BD 79 04  LDA ram_next_действие_игрока,X
C - - - - - 0x0134E9 04:B4D9: 30 03     BMI bra_B4DE_нет_действия
bra_B4DB_бот:
C - - - - - 0x0134EB 04:B4DB: 4C 24 B7  JMP loc_B724_выход
bra_B4DE_нет_действия:
C - - - - - 0x0134EE 04:B4DE: A6 43     LDX ram_0043
C - - - - - 0x0134F0 04:B4E0: 20 7A C0  JSR sub_0x01FAFE    ; кнопки
...
C - - - - - 0x013520 04:B510: D0 44     BNE bra_B556    ; участие в этажерке
C - - - - - 0x013522 04:B512: E0 0A     CPX #con_id_кипера    ; CPX оба кипера
C - - - - - 0x013524 04:B514: B0 2B     BCS bra_B541_это_кипер
C - - - - - 0x013526 04:B516: AC D6 04  LDY ram_игрок_с_мячом
C - - - - - 0x013529 04:B519: C0 0A     CPY #con_id_кипера
C - - - - - 0x01352B 04:B51B: 90 0C     BCC bra_B529    ; если это не кипер
C - - - - - 0x01352D 04:B51D: AD 92 04  LDA ram_состояние_мяча
C - - - - - 0x013530 04:B520: 29 40     AND #$40
C - - - - - 0x013532 04:B522: F0 05     BEQ bra_B529
C - - - - - 0x013534 04:B524: B9 7C 06  LDA ram_флаг_кипера_в_штрафной - con_id_кипера,Y
C - - - - - 0x013537 04:B527: 10 0D     BPL bra_B536    ; если кипер в штрафной
bra_B529:
...
- - - - - - 0x01354F 04:B53F: 90 15     BCC bra_B556    ; если это не кипер
bra_B541_это_кипер:
C - - - - - 0x013551 04:B541: BD 7C 06  LDA ram_флаг_кипера_в_штрафной - con_id_кипера,X
C - - - - - 0x013554 04:B544: 30 10     BMI bra_B556    ; если кипер не в штрафной
...
- - - - - - 0x0135DA 04:B5CA: A9 45     LDA #con_action_45
- - - - - - 0x0135DC 04:B5CC: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B5CF:
...
C - - - - - 0x0135F8 04:B5E8: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B5EB:
...
C - - - - - 0x013608 04:B5F8: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B5FB:
...
C - - - - - 0x013618 04:B608: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B60B:
C - - - - - 0x01361B 04:B60B: A0 03     LDY #$03
C - - - - - 0x01361D 04:B60D: B1 2C     LDA (ram_002C),Y
C - - - - - 0x01361F 04:B60F: 30 03     BMI bra_B614
C - - - - - 0x013621 04:B611: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B614:
loc_B614:
C D 1 - - - 0x013624 04:B614: 0A        ASL
C - - - - - 0x013625 04:B615: 10 30     BPL bra_B647
C - - - - - 0x013627 04:B617: AD 65 04  LDA ram_действие_мяча
C - - - - - 0x01362A 04:B61A: 29 7F     AND #$7F
C - - - - - 0x01362C 04:B61C: C9 0A     CMP #con_act_ball_подкинут_после_чеканки
...
C - - - - - 0x01363B 04:B62B: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B62E:
...
C - - - - - 0x01364B 04:B63B: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B63E:
C - - - - - 0x01364E 04:B63E: A0 06     LDY #$06
C - - - - - 0x013650 04:B640: B1 2C     LDA (ram_002C),Y
C - - - - - 0x013652 04:B642: 30 03     BMI bra_B647
C - - - - - 0x013654 04:B644: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B647:
...
C - - - - - 0x013669 04:B659: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B65C:
...
C - - - - - 0x013679 04:B669: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B66C:
...
C - - - - - 0x013689 04:B679: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B67C:
...
C - - - - - 0x01369A 04:B68A: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B68D:
C - - - - - 0x01369D 04:B68D: A0 0A     LDY #$0A
C - - - - - 0x01369F 04:B68F: B1 2C     LDA (ram_002C),Y
C - - - - - 0x0136A1 04:B691: 30 03     BMI bra_B696
C - - - - - 0x0136A3 04:B693: 4C 21 B7  JMP loc_B70F_запись_действия
bra_B696:
...
C - - - - - 0x013728 04:B718: B9 27 B7  LDA tbl_B727_угол_смещения_игрока,Y
...
tbl_B727_угол_смещения_игрока:
- D 1 - - - 0x013737 04:B727: FF        .byte $FF   ; на месте
- D 1 - - - 0x013738 04:B728: 40        .byte $40   ; вправо
- D 1 - - - 0x013739 04:B729: C0        .byte $C0   ; влево
- - - - - - 0x01373A 04:B72A: 00        .byte $00   ; вверх
- D 1 - - - 0x01373B 04:B72B: 80        .byte $80   ; вниз
- D 1 - - - 0x01373C 04:B72C: 60        .byte $60   ; вправо+вниз
- D 1 - - - 0x01373D 04:B72D: A0        .byte $A0   ; влево+вниз
- - - - - - 0x01373E 04:B72E: 00        .byte $00   ; вверх
- D 1 - - - 0x01373F 04:B72F: 00        .byte $00   ; вверх
- D 1 - - - 0x013740 04:B730: 20        .byte $20   ; вправо+вверх
- D 1 - - - 0x013741 04:B731: E0        .byte $E0   ; влево+вверх
- - - - - - 0x013742 04:B732: 00        .byte $00   ; вверх
- - - - - - 0x013743 04:B733: 00        .byte $00   ; вверх
- - - - - - 0x013744 04:B734: 00        .byte $00   ; вверх
- - - - - - 0x013745 04:B735: 00        .byte $00   ; вверх
- - - - - - 0x013746 04:B736: 00        .byte $00   ; вверх
...
off_B745_00:
- D 1 - I - 0x013755 04:B745: 7D B7     .word off_B77D_00_00
- D 1 - I - 0x013757 04:B747: 89 B7     .word off_B789_00_01
- - - - - - 0x013759 04:B749: 95 B7     .word off_B795_00_02
- - - - - - 0x01375B 04:B74B: 01 B8     .word off_B801_00_03

off_B74D_01:
- D 1 - I - 0x01375D 04:B74D: D1 B7     .word off_B7D1_01_00
- D 1 - I - 0x01375F 04:B74F: DD B7     .word off_B7DD_01_01
- - - - - - 0x013761 04:B751: C5 B7     .word off_B7C5_01_02
- - - - - - 0x013763 04:B753: 01 B8     .word off_B801_01_03

off_B755_02:
- D 1 - I - 0x013765 04:B755: AD B7     .word off_B7AD_02_00
- D 1 - I - 0x013767 04:B757: B9 B7     .word off_B7B9_02_01
- - - - - - 0x013769 04:B759: A1 B7     .word off_B7A1_02_02
- D 1 - I - 0x01376B 04:B75B: 01 B8     .word off_B801_02_03

off_B75D_03:
- D 1 - I - 0x01376D 04:B75D: E9 B7     .word off_B7E9_03_00
- D 1 - I - 0x01376F 04:B75F: F5 B7     .word off_B7F5_03_01
- - - - - - 0x013771 04:B761: E9 B7     .word off_B7E9_03_02
- - - - - - 0x013773 04:B763: 01 B8     .word off_B801_03_03

off_B765_05:
- D 1 - I - 0x013775 04:B765: 0D B8     .word off_B80D_05_00
- D 1 - I - 0x013777 04:B767: 19 B8     .word off_B819_05_01
- - - - - - 0x013779 04:B769: 25 B8     .word off_B825_05_02
- - - - - - 0x01377B 04:B76B: 01 B8     .word off_B801_05_03

off_B76D_04:
- D 1 - I - 0x01377D 04:B76D: 31 B8     .word off_B831_04_00
- D 1 - I - 0x01377F 04:B76F: B9 B7     .word off_B7B9_04_01
- - - - - - 0x013781 04:B771: 31 B8     .word off_B831_04_02
- - - - - - 0x013783 04:B773: 01 B8     .word off_B801_04_03

off_B775_06:
- - - - - - 0x013785 04:B775: 3D B8     .word off_B83D_06_00
- - - - - - 0x013787 04:B777: 44 B8     .word off_B844_06_01
- - - - - - 0x013789 04:B779: 3D B8     .word off_B83D_06_02
...
- D 1 - I - 0x013795 04:B785: 07        .byte con_action_07   ; 08
- D 1 - I - 0x013796 04:B786: 31        .byte con_action_31   ; 09
- D 1 - I - 0x013797 04:B787: 31        .byte con_action_31   ; 0A
- D 1 - I - 0x013798 04:B788: 31        .byte con_action_31   ; 0B

off_B789_00_01:
- - - - - - 0x013799 04:B789: FF        .byte $FF   ; 00
- - - - - - 0x01379A 04:B78A: FF        .byte $FF   ; 01
- - - - - - 0x01379B 04:B78B: FF        .byte $FF   ; 02
- - - - - - 0x01379C 04:B78C: FF        .byte $FF   ; 03
- D 1 - I - 0x01379D 04:B78D: 35        .byte con_action_35   ; 04
- - - - - - 0x01379E 04:B78E: 35        .byte con_action_35   ; 05
- D 1 - I - 0x01379F 04:B78F: 35        .byte con_action_35   ; 06
- D 1 - I - 0x0137A0 04:B790: 33        .byte con_action_33   ; 07
- D 1 - I - 0x0137A1 04:B791: 34        .byte con_action_34   ; 08
- D 1 - I - 0x0137A2 04:B792: 32        .byte con_action_32   ; 09
- D 1 - I - 0x0137A3 04:B793: 34        .byte con_action_34   ; 0A
- - - - - - 0x0137A4 04:B794: 34        .byte con_action_34   ; 0B

off_B795_00_02:
- - - - - - 0x0137A5 04:B795: 44        .byte con_action_44   ; 00
- - - - - - 0x0137A6 04:B796: 44        .byte con_action_44   ; 01
- - - - - - 0x0137A7 04:B797: 44        .byte con_action_44   ; 02
- - - - - - 0x0137A8 04:B798: 44        .byte con_action_44   ; 03
- - - - - - 0x0137A9 04:B799: 08        .byte con_action_08   ; 04
- - - - - - 0x0137AA 04:B79A: 08        .byte con_action_08   ; 05
- - - - - - 0x0137AB 04:B79B: 08        .byte con_action_08   ; 06
- - - - - - 0x0137AC 04:B79C: 07        .byte con_action_07   ; 07
- - - - - - 0x0137AD 04:B79D: 07        .byte con_action_07   ; 08
- - - - - - 0x0137AE 04:B79E: 07        .byte con_action_07   ; 09
- - - - - - 0x0137AF 04:B79F: 07        .byte con_action_07   ; 0A
- - - - - - 0x0137B0 04:B7A0: 07        .byte con_action_07   ; 0B

off_B7A1_02_02:
- - - - - - 0x0137B1 04:B7A1: 44        .byte con_action_44   ; 00
- - - - - - 0x0137B2 04:B7A2: 44        .byte con_action_44   ; 01
- - - - - - 0x0137B3 04:B7A3: 44        .byte con_action_44   ; 02
- - - - - - 0x0137B4 04:B7A4: 44        .byte con_action_44   ; 03
- - - - - - 0x0137B5 04:B7A5: 0A        .byte con_action_0A   ; 04
- - - - - - 0x0137B6 04:B7A6: 0A        .byte con_action_0A   ; 05
- - - - - - 0x0137B7 04:B7A7: 0A        .byte con_action_0A   ; 06
- - - - - - 0x0137B8 04:B7A8: 09        .byte con_action_09   ; 07
- - - - - - 0x0137B9 04:B7A9: 09        .byte con_action_09   ; 08
- - - - - - 0x0137BA 04:B7AA: 09        .byte con_action_09   ; 09
- - - - - - 0x0137BB 04:B7AB: 09        .byte con_action_09   ; 0A
...
- - - - - - 0x0137C5 04:B7B5: 09        .byte con_action_09   ; 08
- D 1 - I - 0x0137C6 04:B7B6: 09        .byte con_action_09   ; 09
- D 1 - I - 0x0137C7 04:B7B7: 09        .byte con_action_09   ; 0A
- D 1 - I - 0x0137C8 04:B7B8: 09        .byte con_action_09   ; 0B

off_B7B9_02_01:
off_B7B9_04_01:
- - - - - - 0x0137C9 04:B7B9: FF        .byte $FF   ; 00
- - - - - - 0x0137CA 04:B7BA: FF        .byte $FF   ; 01
- - - - - - 0x0137CB 04:B7BB: FF        .byte $FF   ; 02
- - - - - - 0x0137CC 04:B7BC: FF        .byte $FF   ; 03
- - - - - - 0x0137CD 04:B7BD: 39        .byte con_action_39   ; 04
- - - - - - 0x0137CE 04:B7BE: 39        .byte con_action_39   ; 05
- D 1 - I - 0x0137CF 04:B7BF: 39        .byte con_action_39   ; 06
- D 1 - I - 0x0137D0 04:B7C0: 37        .byte con_action_37   ; 07
- D 1 - I - 0x0137D1 04:B7C1: 38        .byte con_action_38   ; 08
- D 1 - I - 0x0137D2 04:B7C2: 46        .byte con_action_46   ; 09
- D 1 - I - 0x0137D3 04:B7C3: 38        .byte con_action_38   ; 0A
- - - - - - 0x0137D4 04:B7C4: 38        .byte con_action_38   ; 0B

off_B7C5_01_02:
- - - - - - 0x0137D5 04:B7C5: 44        .byte con_action_44   ; 00
...
off_B7DD_01_01:
- - - - - - 0x0137ED 04:B7DD: FF        .byte $FF   ; 00
...
- D 1 - I - 0x013818 04:B808: FF        .byte $FF   ; 07
- D 1 - I - 0x013819 04:B809: FF        .byte $FF   ; 08
- D 1 - I - 0x01381A 04:B80A: FF        .byte $FF   ; 09
- D 1 - I - 0x01381B 04:B80B: FF        .byte $FF   ; 0A
...
- D 1 - I - 0x013828 04:B818: 41        .byte con_action_41   ; 0B

off_B819_05_01:
- - - - - - 0x013829 04:B819: FF        .byte $FF   ; 00
- - - - - - 0x01382A 04:B81A: FF        .byte $FF   ; 01
- - - - - - 0x01382B 04:B81B: FF        .byte $FF   ; 02
- - - - - - 0x01382C 04:B81C: FF        .byte $FF   ; 03
- - - - - - 0x01382D 04:B81D: 54        .byte con_action_54   ; 04
- - - - - - 0x01382E 04:B81E: 54        .byte con_action_54   ; 05
- D 1 - I - 0x01382F 04:B81F: 54        .byte con_action_54   ; 06
- D 1 - I - 0x013830 04:B820: 54        .byte con_action_54   ; 07
- - - - - - 0x013831 04:B821: 54        .byte con_action_54   ; 08
- - - - - - 0x013832 04:B822: 54        .byte con_action_54   ; 09
- - - - - - 0x013833 04:B823: 54        .byte con_action_54   ; 0A
...
- - - - - - 0x013840 04:B830: 41        .byte con_action_41   ; 0B
...
- D 1 - I - 0x013848 04:B838: 09        .byte con_action_09   ; 07
- - - - - - 0x013849 04:B839: 09        .byte con_action_09   ; 08
- - - - - - 0x01384A 04:B83A: 09        .byte con_action_09   ; 09
- - - - - - 0x01384B 04:B83B: 09        .byte con_action_09   ; 0A
- - - - - - 0x01384C 04:B83C: 09        .byte con_action_09   ; 0B

off_B83D_06_00:
off_B83D_06_02:    ; bzk unused? должно быть по 12 байтов
- - - - - - 0x01384D 04:B83D: 30        .byte $30   ; 00
- - - - - - 0x01384E 04:B83E: 30        .byte $30   ; 01
- - - - - - 0x01384F 04:B83F: 30        .byte $30   ; 02
- - - - - - 0x013850 04:B840: 30        .byte $30   ; 03
- - - - - - 0x013851 04:B841: 17        .byte $17   ; 04
- - - - - - 0x013852 04:B842: 17        .byte $17   ; 05
...
sub_B850_разводка:
C - - - - - 0x013868 04:B858: A2 00     LDX ram_игрок_с_мячом
C - - - - - 0x013860 04:B850: AD 50 06  LDA ram_позиция_управление,X
C - - - - - 0x01386A 04:B85A: BD 68 05  BPL bra_B87E_управляемый_игрок
bra_B867_бот:
C - - - - - 0x013877 04:B867: AD 00 03  LDA ram_счетчик_кадров
...
C - - - - - 0x01388B 04:B87B: 4C A2 B8  JMP loc_B8A2_пас
bra_B87E_управляемый_игрок:
C - - - - - 0x01388E 04:B87E: B5 08     LDA ram_btn_press,X
C - - - - - 0x013890 04:B880: 30 20     BMI bra_B8A2_пас    ; if A
C - - - - - 0x013892 04:B882: 0A        ASL
C - - - - - 0x013893 04:B883: 30 19     BMI bra_B89E_удар   ; if B
C - - - - - 0x013895 04:B885: A5 08     LDA ram_btn_press
C - - - - - 0x013897 04:B887: 29 30     AND #con_btns_SS
C - - - - - 0x013899 04:B889: D0 17     BNE bra_B8A2_пас
...
C - - - - - 0x0138A5 04:B895: B9 A8 B8  LDA tbl_B8A8_угол_смещение_паса_на_разводке,Y
C - - - - - 0x0138A8 04:B898: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x0138AB 04:B89B: 4C A7 B8  RTS
bra_B89E_удар:
C - - - - - 0x0138AE 04:B89E: A9 09     LDA #con_action_09    ; удар по мячу с земли
C - - - - - 0x0138B0 04:B8A0: D0 02     BNE bra_B8A4_запись_действия
bra_B8A2_пас:
loc_B8A2_пас:
C D 1 - - - 0x0138B2 04:B8A2: A9 0A     LDA #con_action_0A    ; пас
bra_B8A4_запись_действия:
C - - - - - 0x0138B4 04:B8A4: 9D 79 04  STA ram_next_действие_игрока,X
bra_B8A7_RTS:
C D 1 - - - 0x0138B7 04:B8A7: 60        RTS



tbl_B8A8_угол_смещение_паса_на_разводке:
- D 1 - - - 0x0138B8 04:B8A8: 00        .byte $00   ; вверх
- D 1 - - - 0x0138B9 04:B8A9: 80        .byte $80   ; вниз
- - - - - - 0x0138BA 04:B8AA: 00        .byte $00   ; вверх
...
C - - - - - 0x0138C6 04:B8B6: BD 79 04  LDA ram_next_действие_игрока,X
C - - - - - 0x0138C9 04:B8B9: 30 03     BMI bra_B8BE    ; bzk опт, разве next действие может быть записано +80?
bra_B8BB_это_бот:
C - - - - - 0x0138CB 04:B8BB: 4C E2 B9  JMP loc_B9E2_выход
bra_B8BE:
...
C - - - - - 0x013944 04:B934: A9 09     LDA #con_action_09
C - - - - - 0x013946 04:B936: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B939:
- - - - - - 0x013949 04:B939: A9 0A     LDA #con_action_0A
...
bra_B94A_не_бежит:
C - - - - - 0x01395A 04:B94A: A9 08     LDA #con_action_08
C - - - - - 0x01395C 04:B94C: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B94F:
loc_B94F:
...
C - - - - - 0x01396F 04:B95F: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B962:
C - - - - - 0x013972 04:B962: A0 06     LDY #$06
C - - - - - 0x013974 04:B964: B1 2C     LDA (ram_002C),Y
C - - - - - 0x013976 04:B966: 30 03     BMI bra_B96B
C - - - - - 0x013978 04:B968: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B96B:
...
C - - - - - 0x01398B 04:B97B: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B97E:
...
C - - - - - 0x01399B 04:B98B: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B98E:
...
C - - - - - 0x0139AC 04:B99C: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B99F:
C - - - - - 0x0139AF 04:B99F: A0 0A     LDY #$0A
C - - - - - 0x0139B1 04:B9A1: B1 2C     LDA (ram_002C),Y
C - - - - - 0x0139B3 04:B9A3: 30 03     BMI bra_B9A8
C - - - - - 0x0139B5 04:B9A5: 4C DF B9  JMP loc_B9DF_запись_действия
bra_B9A8:
...
C - - - - - 0x0139D1 04:B9C1: D0 0A     BNE bra_B9CD_запись_действия
bra_B9C3:
...
bra_B9CD_запись_действия:
C - - - - - 0x0139DD 04:B9CD: 9D 79 04  STA ram_next_действие_игрока,X
bra_B9D0_в_воздухе:
C - - - - - 0x0139E0 04:B9D0: AD 1D 00  LDA ram_001D
C - - - - - 0x0139E3 04:B9D3: 29 0F     AND #$0F
C - - - - - 0x0139E5 04:B9D5: A8        TAY
C - - - - - 0x0139E6 04:B9D6: B9 E5 B9  LDA tbl_B727_угол_смещения_игрока,Y
C - - - - - 0x0139E9 04:B9D9: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x0139EC 04:B9DC: 4C E2 B9  JMP loc_B9E2_выход
loc_B9DF_запись_действия:
C D 1 - - - 0x0139EF 04:B9DF: 9D 79 04  STA ram_next_действие_игрока,X
loc_B9E2_выход:
C D 1 - - - 0x0139F2 04:B9E2: A6 43     LDX ram_0043
C - - - - - 0x0139F4 04:B9E4: 60        RTS

tbl_B9F5:
; bzk оптимизировать таблицу, первые 5 байтов не используются, 
...
- - - - - - 0x013A25 04:BA15: 08        .byte con_action_08   ; 
- - - - - - 0x013A26 04:BA16: 08        .byte con_action_08   ; 
- - - - - - 0x013A27 04:BA17: 08        .byte con_action_08   ; 
- - - - - - 0x013A28 04:BA18: 08        .byte con_action_08   ; 
- - - - - - 0x013A29 04:BA19: 08        .byte con_action_08   ; 
- - - - - - 0x013A2A 04:BA1A: 08        .byte con_action_08   ; 
...
C - - - - - 0x013A45 04:BA35: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x013A48 04:BA38: 85 2C     STA ram_002C
C - - - - - 0x013A4A 04:BA3A: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x013A4D 04:BA3D: 85 2D     STA ram_002D
C - - - - - 0x013A4F 04:BA3F: BD A3 04  LDA ram_напр_движ_игрока,X
C - - - - - 0x013A52 04:BA42: 10 0D     BPL bra_BA51_повернут_направо
...
C - - - - - 0x013ABF 04:BAAF: D0 09     BNE bra_BABA_это_не_япония
...
C - - - - - 0x013AD1 04:BAC1: 20 02 BB  JSR sub_BB02_добавить_силу_мяча
...
- - - - - - 0x013B01 04:BAF1: 20 02 BB  JSR sub_BB02_добавить_силу_мяча
bra_BAF4:
...
C - - - - - 0x013B33 04:BB23: 10 02     BPL bra_BB27_повернут_направо
C - - - - - 0x013B35 04:BB25: A0 04     LDY #$04
bra_BB27_повернут_направо:
...
C - - - - - 0x013B54 04:BB44: FD 4D 03  SBC ram_pos_Y_lo_игрока,X
C - - - - - 0x013B57 04:BB47: B9 BB BB  LDA tbl_BBBB,Y
C - - - - - 0x013B5A 04:BB4A: FD 60 03  SBC ram_pos_Y_hi_игрока,X
...
C - - - - - 0x013C24 04:BC14: 9D 20 04  STA ram_spd_Z_lo_игрока,X
C - - - - - 0x013C1C 04:BC0C: B9 4B BD  LDA tbl_BD4B_Z_скорость + 1,Y
C - - - - - 0x013C1F 04:BC0F: 9D 2E 04  STA ram_spd_Z_hi_игрока,X
...
C - - - - - 0x013C47 04:BC37: 20 27 80  JSR sub_0x01C25C_сдвинуть_объект
C - - - - - 0x013C4A 04:BC3A: 20 27 80  JSR sub_0x01C25C_сдвинуть_объект
bra_BC3D:
C - - - - - 0x013C4D 04:BC3D: BD 99 03  LDA ram_pos_Z_hi_игрока,X
C - - - - - 0x013C50 04:BC40: 10 0B     BPL bra_BC4D
- - - - - - 0x013C52 04:BC42: A9 00     LDA #$00
- - - - - - 0x013C54 04:BC44: 9D 86 03  STA ram_pos_Z_lo_игрока,X
- - - - - - 0x013C57 04:BC47: 9D 99 03  STA ram_pos_Z_hi_игрока,X
- - - - - - 0x013C5A 04:BC4A: 4C 5E BC  RTS
bra_BC4D:
C - - - - - 0x013C5D 04:BC4D: AD 10 05  LDA ram_подтип_супера
C - - - - - 0x013C60 04:BC50: D0 0C     BNE bra_BC5E_RTS
C - - - - - 0x013C62 04:BC52: BD 86 03  LDA ram_pos_Z_lo_игрока,X
C - - - - - 0x013C65 04:BC55: C9 08     CMP #$08
C - - - - - 0x013C67 04:BC57: B0 05     BCS bra_BC5E_RTS
C - - - - - 0x013C69 04:BC59: A9 08     LDA #$08
C - - - - - 0x013C6B 04:BC5B: 9D 86 03  STA ram_pos_Z_lo_игрока,X
bra_BC5E_RTS:
...
C - - - - - 0x013C84 04:BC74: 9D 4A 04  STA ram_gravity_hi_игрока,X
C - - - - - 0x013C87 04:BC77: A9 80     LDA #$80
C - - - - - 0x013C89 04:BC79: 9D 3C 04  STA ram_gravity_lo_игрока,X
...
C - - - - - 0x013C9E 04:BC8E: 10 11     BPL bra_BCA1_повернут_направо
...
C - - - - - 0x013CB9 04:BCA9: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x013CBC 04:BCAC: E5 2C     SBC ram_002C
C - - - - - 0x013CBE 04:BCAE: 85 2C     STA ram_002C
C - - - - - 0x013CC0 04:BCB0: BD 27 03  LDA ram_pos_X_hi_игрока,X
...
C - - - - - 0x013D07 04:BCF7: BC 86 03  LDY ram_pos_Z_lo_игрока,X
...
C - - - - - 0x013D18 04:BD08: 9D 87 00  STA ram_таймер_анимации_игрока,X
C - - - - - 0x013D1B 04:BD0B: 9D 94 00  STA ram_кадр_анимации_игрока,X
bra_BD0E_RTS:
