...
C - - - - - 0x013248 04:B238: DD C2 00  CMP ram_разница_координат_и_камеры + 1,X
...
C - - - - - 0x01325D 04:B24D: BD C2 00  LDA ram_разница_координат_и_камеры + 1,X
C - - - - - 0x013260 04:B250: 85 1F     STA ram_001F
C - - - - - 0x013262 04:B252: BD C1 00  LDA ram_разница_координат_и_камеры,X
C - - - - - 0x013265 04:B255: 9D C2 00  STA ram_разница_координат_и_камеры + 1,X
...
; фикс гвинейской крутилки, стороны полета мяча
                                        LDA ram_индикатор_гвинейской_крутилки
                                        BEQ bra_BA47
                                        LDA #$00
                                        STA ram_индикатор_гвинейской_крутилки
                                        LDA ram_опция_режим_и_сложность
                                        AND #$20
                                        BEQ bra_BA39_игра_в_поле
                                        LDY #$00    ; ПК
bra_BA39_игра_в_поле:                                        
                                        TYA
                                        AND #$01                                        
                                        TAY
                                        LDA tbl_BA44_направление_движения_мяча,Y
                                        LDY ram_игрок_с_мячом
                                        JMP loc_BA4A
...
tbl_BA44_направление_движения_мяча:   
                                        .byte $00   ; направо
                                        .byte $80   ; налево 
...
; фикс удара в свою сторону, чтобы мяч не прицеливался в свои ворота
                                        LDA ram_игрок_с_мячом
                                        AND #$01
                                        TAY
                                        LDA ram_опция_режим_и_сложность
                                        AND #$20
                                        BEQ bra_BCFB_игра_в_поле
                                        LDY #$01    ; ПК
bra_BCFB_игра_в_поле:                                       
                                        LDA tbl_BBF8_сторона_полета_мяча,Y
                                        CMP ram_напр_движ_мяча
                                        BNE bra_BC03
                                        LDA tbl_BBFA_скорость_полета_мяча_по_X,Y
                                        STA ram_spd_X_hi_мяча
                                        JMP loc_BC07
bra_BC03:
...
tbl_BBF8_сторона_полета_мяча:
                                       .byte $80   ; налево
                                       .byte $00   ; направо
                                       
tbl_BBFA_скорость_полета_мяча_по_X:
                                       .byte $F8   ; налево
                                       .byte $08   ; направо                                      
