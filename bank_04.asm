...
- - - - - - 0x0135DC 04:B5CC: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B5CF:
...
C - - - - - 0x0135F8 04:B5E8: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B5EB:
...
C - - - - - 0x013608 04:B5F8: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B5FB:
...
C - - - - - 0x013618 04:B608: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B60B:
C - - - - - 0x01361B 04:B60B: A0 03     LDY #$03
C - - - - - 0x01361D 04:B60D: B1 2C     LDA (ram_002C),Y
C - - - - - 0x01361F 04:B60F: 30 03     BMI bra_B614
C - - - - - 0x013621 04:B611: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B614:
loc_B614:
...
C - - - - - 0x01363B 04:B62B: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B62E:
...
C - - - - - 0x01364B 04:B63B: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B63E:
C - - - - - 0x01364E 04:B63E: A0 06     LDY #$06
C - - - - - 0x013650 04:B640: B1 2C     LDA (ram_002C),Y
C - - - - - 0x013652 04:B642: 30 03     BMI bra_B647
C - - - - - 0x013654 04:B644: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B647:
...
C - - - - - 0x013669 04:B659: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B65C:
...
C - - - - - 0x013679 04:B669: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B66C:
...
C - - - - - 0x013689 04:B679: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B67C:
...
C - - - - - 0x01369A 04:B68A: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B68D:
C - - - - - 0x01369D 04:B68D: A0 0A     LDY #$0A
C - - - - - 0x01369F 04:B68F: B1 2C     LDA (ram_002C),Y
C - - - - - 0x0136A1 04:B691: 30 03     BMI bra_B696
C - - - - - 0x0136A3 04:B693: 4C 21 B7  JMP loc_B721_запись_следующего_действия
bra_B696:
...
C - - - - - 0x01372E 04:B71E: 4C 24 B7  JMP loc_B724_выход
loc_B721_запись_следующего_действия:
C D 1 - - - 0x013731 04:B721: 9D 79 04  STA ram_next_действие_игрока,X
loc_B724_выход:
...
C - - - - - 0x013870 04:B860: F0 1C     BEQ bra_B87E_совпадение
...
bra_B89E:
C - - - - - 0x0138AE 04:B89E: A9 09     LDA #con_action_09
C - - - - - 0x0138B0 04:B8A0: D0 02     BNE bra_B8A4_запись_действия
bra_B8A2:
loc_B8A2:
C D 1 - - - 0x0138B2 04:B8A2: A9 0A     LDA #con_action_0A
