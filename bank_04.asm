...
C - - - - - 0x012FA7 04:AF97: B9 59 04  LDA ram_подтип_действия,Y
...
C - - - - - 0x0134E6 04:B4D6: BD 79 04  LDA ram_тип_действия,X
...
C - - - - - 0x0135CA 04:B5BA: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x013627 04:B617: AD 65 04  LDA ram_подтип_удара
...
C - - - - - 0x01365A 04:B64A: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x0136AB 04:B69B: BD 59 04  LDA ram_подтип_действия,X
...
loc_B70F:
C D 1 - - - 0x01371F 04:B70F: 9D 79 04  STA ram_тип_действия,X
bra_B712:
...
loc_B721:
C D 1 - - - 0x013731 04:B721: 9D 79 04  STA ram_тип_действия,X
loc_B724:
...
bra_B8A4:
C - - - - - 0x0138B4 04:B8A4: 9D 79 04  STA ram_тип_действия,X
bra_B8A7_RTS:
...
C - - - - - 0x0138C6 04:B8B6: BD 79 04  LDA ram_тип_действия,X
...
bra_B9CD:
C - - - - - 0x0139DD 04:B9CD: 9D 79 04  STA ram_тип_действия,X
bra_B9D0_в_воздухе:
...
loc_B9DF:
C D 1 - - - 0x0139EF 04:B9DF: 9D 79 04  STA ram_тип_действия,X
loc_B9E2:
...
C - - - - - 0x013A85 04:BA75: B9 59 04  LDA ram_подтип_действия,Y
...
C - - - - - 0x013AF2 04:BAE2: B9 59 04  LDA ram_подтип_действия,Y
