...
.export loc_0x004010
.export loc_0x004013_подготовка_болельщиков
.export loc_0x004016_молния_и_смерч
...
loc_0x004013_подготовка_болельщиков:
C - - J - - 0x004013 01:8003: 4C A1 B8  JMP loc_B8A1_подготовка_болельщиков

loc_0x004016_молния_и_смерч:
C - - J - - 0x004016 01:8006: 4C C0 B9  JMP loc_B9C0_молния_и_смерч
...
; заполнитель, предположительно таблица ниже должна
; начинаться в банках 01 и 02 с одинакового адреса
    .byte $FF, $FF, $FF


; начинается с 8022, как и в банке 02
off_8024_00:
...
C - - - - - 0x007491 01:B481: BD 20 06  LDA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x007494 01:B484: 8D 07 20  STA $2007
C - - - - - 0x007497 01:B487: BD 21 06  LDA ram_pos_X_lo_точка_удара_бота + 1,X
...
C - - - - - 0x0074B5 01:B4A5: BD 22 06  LDA ram_pos_X_lo_точка_удара_бота + 2,X
C - - - - - 0x0074B8 01:B4A8: 8D 07 20  STA $2007
C - - - - - 0x0074BB 01:B4AB: BD 23 06  LDA ram_pos_X_lo_точка_удара_бота + 3,X
...
.scope
tmp_2006_hi = ram_002C
tmp_2006_lo = ram_002D

C - - - - - 0x00756C 01:B55C: A2 00     LDX #$00
bra_B55E_loop:
C D 1 - - - 0x00756E 01:B55E: A9 24     LDA #$24
C - - - - - 0x007570 01:B560: 85 2C     STA tmp_2006_hi
C - - - - - 0x007572 01:B562: BD EB B5  LDA tbl_B5EB,X
C - - - - - 0x007575 01:B565: 85 2D     STA tmp_2006_lo
...
C - - - - - 0x00758A 01:B57A: 85 2C     STA tmp_2006_hi
C - - - - - 0x00758C 01:B57C: BD ED B5  LDA tbl_B5ED,X
C - - - - - 0x00758F 01:B57F: 85 2D     STA tmp_2006_lo
...
- - - - - - 0x00759E 01:B58E: 85 2C     STA tmp_2006_hi
- - - - - - 0x0075A0 01:B590: BD EF B5  LDA tbl_B5EF,X
- - - - - - 0x0075A3 01:B593: 85 2D     STA tmp_2006_lo
...
- - - - - - 0x0075B3 01:B5A3: 85 2C     STA tmp_2006_hi
- - - - - - 0x0075B5 01:B5A5: BD F1 B5  LDA tbl_B5F1,X
- - - - - - 0x0075B8 01:B5A8: 85 2D     STA tmp_2006_lo
...
bra_B5BC:
C - - - - - 0x0075CC 01:B5BC: AD 02 20  BIT $2002
...
C - - - - - 0x00763A 01:B62A: 90 F6     BCC bra_B622_loop
...
C - - - - - 0x00765D 01:B64D: 90 EF     BCC bra_B63E_loop
...
loc_B8A1_подготовка_болельщиков:
...
C - - - - - 0x0078CE 01:B8BE: AD 30 06  LDA ram_тип_болельщиков
C - - - - - 0x0078D1 01:B8C1: 29 03     AND #$03
C - - - - - 0x0078D3 01:B8C3: 18        CLC
C - - - - - 0x0078D4 01:B8C4: 69 10     ADC #$10    ; экран со зрителями, 10-12
C - - - - - 0x0078D6 01:B8C6: 20 68 C0  JSR sub_0x01E838_отрисовать_статичный_экран
C - - - - - 0x0078D9 01:B8C9: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x0078E8 01:B8D8: AD 30 06  LDA ram_тип_болельщиков
C - - - - - 0x0078EB 01:B8DB: 10 3A     BPL bra_B917_болельщики_без_анимации
C - - - - - 0x0078ED 01:B8DD: 29 03     AND #$03
C - - - - - 0x0078EF 01:B8DF: F0 07     BEQ bra_B8E8_закрытые_рты
C - - - - - 0x0078F1 01:B8E1: C9 01     CMP #$01
C - - - - - 0x0078F3 01:B8E3: F0 0B     BEQ bra_B8F0_открытые_рты
- - - - - - 0x0078F5 01:B8E5: 4C 05 B9  JMP loc_B905_недовольные
bra_B8E8_закрытые_рты:
C - - - - - 0x0078F8 01:B8E8: A9 01     LDA #$01
C - - - - - 0x0078FA 01:B8EA: 8D EC 05  STA ram_следы_2006_lo
C - - - - - 0x0078FD 01:B8ED: 4C 17 B9  JMP loc_B917
bra_B8F0_открытые_рты:
...
C - - - - - 0x00790A 01:B8FA: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00790D 01:B8FD: E8        INX
C - - - - - 0x00790E 01:B8FE: E0 10     CPX #$10
C - - - - - 0x007910 01:B900: 90 F5     BCC bra_B8F7_loop
C - - - - - 0x007912 01:B902: 4C 17 B9  JMP loc_B917
loc_B905_недовольные:
...
- - - - - - 0x00791F 01:B90F: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
- - - - - - 0x007922 01:B912: E8        INX
- - - - - - 0x007923 01:B913: E0 10     CPX #$10
- - - - - - 0x007925 01:B915: 90 F5     BCC bra_B90C_loop
bra_B917_болельщики_без_анимации:
loc_B917:
...
- D 1 - - - 0x007A08 01:B9F8: 05 BA     .word ofs_BA05_01_новая_молния
- D 1 - - - 0x007A0A 01:B9FA: 2D BA     .word _общий_RTS    ; 02
- D 1 - - - 0x007A0C 01:B9FC: 2E BA     .word ofs_BA2E_03_новый_смерч
...
ofs_BA2E_03_новый_смерч:
C - - J - - 0x007A3E 01:BA2E: A9 41     LDA #con_sfx_ветер
C - - - - - 0x007A40 01:BA30: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
...
loc_BA75:
C D 1 - - - 0x007A85 01:BA75: 8D 03 04  STA ram_spd_X_hi_погоды
...
bra_BA84:
C D 1 - - - 0x007A94 01:BA84: 8D 1F 04  STA ram_spd_Y_hi_погоды
...
- - - - - - 0x007B70 01:BB60: 8D 5A 03  STA ram_pos_Y_lo_погоды
- - - - - - 0x007B73 01:BB63: A9 00     LDA #$00
- - - - - - 0x007B75 01:BB65: 8D 6D 03  STA ram_pos_Y_hi_погоды
...
C - - - - - 0x007B7D 01:BB6D: 8D 6D 03  STA ram_pos_Y_hi_погоды
C - - - - - 0x007B80 01:BB70: A9 65     LDA #$65
C - - - - - 0x007B82 01:BB72: 8D 5A 03  STA ram_pos_Y_lo_погоды
loc_BB75:
C - - - - - 0x007B85 01:BB75: AD 11 04  LDA ram_spd_Y_lo_погоды
C - - - - - 0x007B88 01:BB78: 49 FF     EOR #$FF
C - - - - - 0x007B8A 01:BB7A: 18        CLC
C - - - - - 0x007B8B 01:BB7B: 69 01     ADC #$01
C - - - - - 0x007B8D 01:BB7D: 8D 11 04  STA ram_spd_Y_lo_погоды
C - - - - - 0x007B90 01:BB80: AD 1F 04  LDA ram_spd_Y_hi_погоды
C - - - - - 0x007B93 01:BB83: 49 FF     EOR #$FF
C - - - - - 0x007B95 01:BB85: 69 00     ADC #$00
C - - - - - 0x007B97 01:BB87: 8D 1F 04  STA ram_spd_Y_hi_погоды
bra_BB8A:
loc_BB8A:
...
C - - - - - 0x007BA4 01:BB94: AD 34 03  LDA ram_pos_X_hi_погоды
...
C - - - - - 0x007C51 01:BC41: D0 1B     BNE bra_BC5E    ; если это не япония
...
C - - - - - 0x007C92 01:BC82: 9D F1 04  STA ram_скилл,X
...
tbl_BCFC:
- - - - - - 0x007D0C 01:BCFC: 00        .byte $00   ; 00 00хп
- - - - - - 0x007D0D 01:BCFD: 14        .byte $14   ; 01 20хп
- - - - - - 0x007D0E 01:BCFE: 0F        .byte $0F   ; 02 15хп
- - - - - - 0x007D0F 01:BCFF: 0A        .byte $0A   ; 03 10хп
...
off_BD38_0C:
; 00
- D 1 - I - 0x007D48 01:BD38: 32        .byte $32   ; сила
- D 1 - I - 0x007D49 01:BD39: 01        .byte $01   ; тип скорости
- D 1 - I - 0x007D4A 01:BD3A: C1        .byte $01 + $C0   ; защита + поведение
- D 1 - I - 0x007D4B 01:BD3B: 40        .byte con_skill_коленочник   ; скилл
; 01
- D 1 - I - 0x007D4C 01:BD3C: 32        .byte $32   ; 
- D 1 - I - 0x007D4D 01:BD3D: 00        .byte $00   ; 
- D 1 - I - 0x007D4E 01:BD3E: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007D4F 01:BD3F: 04        .byte con_skill_высокопрыгающий   ; 
; 02
- D 1 - I - 0x007D50 01:BD40: 37        .byte $37   ; 
- D 1 - I - 0x007D51 01:BD41: 01        .byte $01   ; 
- D 1 - I - 0x007D52 01:BD42: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007D53 01:BD43: 20        .byte con_skill_ветряная_крутилка   ; 
; 03
- D 1 - I - 0x007D54 01:BD44: 3C        .byte $3C   ; 
- D 1 - I - 0x007D55 01:BD45: 03        .byte $03   ; 
- D 1 - I - 0x007D56 01:BD46: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D57 01:BD47: 40        .byte con_skill_коленочник   ; 
; 04
- D 1 - I - 0x007D58 01:BD48: 2D        .byte $2D   ; 
- D 1 - I - 0x007D59 01:BD49: 01        .byte $01   ; 
- D 1 - I - 0x007D5A 01:BD4A: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007D5B 01:BD4B: 08        .byte con_skill_мексиканское_сверло   ; 
; 05
- D 1 - I - 0x007D5C 01:BD4C: 3C        .byte $3C   ; 
- D 1 - I - 0x007D5D 01:BD4D: 02        .byte $02   ; 
- D 1 - I - 0x007D5E 01:BD4E: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D5F 01:BD4F: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 06
- D 1 - I - 0x007D60 01:BD50: 2D        .byte $2D   ; 
- D 1 - I - 0x007D61 01:BD51: 03        .byte $03   ; 
- D 1 - I - 0x007D62 01:BD52: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007D63 01:BD53: 02        .byte con_skill_гвинейская_крутилка   ; 
; 07
- D 1 - I - 0x007D64 01:BD54: 32        .byte $32   ; 
- D 1 - I - 0x007D65 01:BD55: 01        .byte $01   ; 
- D 1 - I - 0x007D66 01:BD56: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007D67 01:BD57: 80        .byte con_skill_зачистка   ; 
; 08
- D 1 - I - 0x007D68 01:BD58: 32        .byte $32   ; 
- D 1 - I - 0x007D69 01:BD59: 03        .byte $03   ; 
- D 1 - I - 0x007D6A 01:BD5A: 43        .byte $03 + $40   ; 
- D 1 - I - 0x007D6B 01:BD5B: 40        .byte con_skill_коленочник   ; 
; 09
- D 1 - I - 0x007D6C 01:BD5C: 2D        .byte $2D   ; 
- D 1 - I - 0x007D6D 01:BD5D: 03        .byte $03   ; 
- D 1 - I - 0x007D6E 01:BD5E: 43        .byte $03 + $40   ; 
- D 1 - I - 0x007D6F 01:BD5F: 40        .byte con_skill_коленочник   ; 
; 0A
- D 1 - I - 0x007D70 01:BD60: 41        .byte $41   ; 
- D 1 - I - 0x007D71 01:BD61: 01        .byte $01   ; 
- D 1 - I - 0x007D72 01:BD62: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007D73 01:BD63: 80        .byte con_skill_зачистка   ; 
; 0B
- D 1 - I - 0x007D74 01:BD64: 41        .byte $41   ; 
- D 1 - I - 0x007D75 01:BD65: 03        .byte $03   ; 
- D 1 - I - 0x007D76 01:BD66: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007D77 01:BD67: 12        .byte con_skill_гвинейская_крутилка + con_skill_вратарская_крутилка   ; 
...
- D 1 - I - 0x007D7A 01:BD6A: 00        .byte $00 + $00   ; 
- D 1 - I - 0x007D7B 01:BD6B: 00        .byte con_skill_нету   ; 
; 01
- D 1 - I - 0x007D7C 01:BD6C: 23        .byte $23   ; 
- D 1 - I - 0x007D7D 01:BD6D: 02        .byte $02   ; 
- D 1 - I - 0x007D7E 01:BD6E: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007D7F 01:BD6F: 00        .byte con_skill_нету   ; 
; 02
- D 1 - I - 0x007D80 01:BD70: 28        .byte $28   ; 
- D 1 - I - 0x007D81 01:BD71: 02        .byte $02   ; 
- D 1 - I - 0x007D82 01:BD72: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D83 01:BD73: 00        .byte con_skill_нету   ; 
; 03
- D 1 - I - 0x007D84 01:BD74: 14        .byte $14   ; 
- D 1 - I - 0x007D85 01:BD75: 02        .byte $02   ; 
- D 1 - I - 0x007D86 01:BD76: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D87 01:BD77: 00        .byte con_skill_нету   ; 
; 04
- D 1 - I - 0x007D88 01:BD78: 32        .byte $32   ; 
- D 1 - I - 0x007D89 01:BD79: 02        .byte $02   ; 
- D 1 - I - 0x007D8A 01:BD7A: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D8B 01:BD7B: 00        .byte con_skill_нету   ; 
; 05
- D 1 - I - 0x007D8C 01:BD7C: 28        .byte $28   ; 
- D 1 - I - 0x007D8D 01:BD7D: 02        .byte $02   ; 
- D 1 - I - 0x007D8E 01:BD7E: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007D8F 01:BD7F: 00        .byte con_skill_нету   ; 
...
- - - - - - 0x007D92 01:BD82: C1        .byte $01 + $C0   ; 
- - - - - - 0x007D93 01:BD83: 00        .byte con_skill_нету   ; 
; 01
- - - - - - 0x007D94 01:BD84: 23        .byte $23   ; 
- - - - - - 0x007D95 01:BD85: 01        .byte $01   ; 
- - - - - - 0x007D96 01:BD86: 41        .byte $01 + $40   ; 
- - - - - - 0x007D97 01:BD87: 00        .byte con_skill_нету   ; 
; 02
- - - - - - 0x007D98 01:BD88: 23        .byte $23   ; 
- - - - - - 0x007D99 01:BD89: 02        .byte $02   ; 
- - - - - - 0x007D9A 01:BD8A: 41        .byte $01 + $40   ; 
- - - - - - 0x007D9B 01:BD8B: 00        .byte con_skill_нету   ; 
; 03
- - - - - - 0x007D9C 01:BD8C: 46        .byte $46   ; 
- - - - - - 0x007D9D 01:BD8D: 01        .byte $01   ; 
- - - - - - 0x007D9E 01:BD8E: 41        .byte $01 + $40   ; 
- - - - - - 0x007D9F 01:BD8F: 00        .byte con_skill_нету   ; 
; 04
- - - - - - 0x007DA0 01:BD90: 46        .byte $46   ; 
- - - - - - 0x007DA1 01:BD91: 03        .byte $03   ; 
- - - - - - 0x007DA2 01:BD92: C1        .byte $01 + $C0   ; 
- - - - - - 0x007DA3 01:BD93: 00        .byte con_skill_нету   ; 
; 05
- - - - - - 0x007DA4 01:BD94: 32        .byte $32   ; 
- - - - - - 0x007DA5 01:BD95: 03        .byte $03   ; 
- - - - - - 0x007DA6 01:BD96: 41        .byte $01 + $40   ; 
- - - - - - 0x007DA7 01:BD97: 00        .byte con_skill_нету   ; 
...
- D 1 - I - 0x007DAA 01:BD9A: C3        .byte $03 + $C0   ; 
- D 1 - I - 0x007DAB 01:BD9B: 40        .byte con_skill_коленочник   ; 
; 01
- D 1 - I - 0x007DAC 01:BD9C: 14        .byte $14   ; 
- D 1 - I - 0x007DAD 01:BD9D: 01        .byte $01   ; 
- D 1 - I - 0x007DAE 01:BD9E: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007DAF 01:BD9F: 40        .byte con_skill_коленочник   ; 
; 02
- D 1 - I - 0x007DB0 01:BDA0: 14        .byte $14   ; 
- D 1 - I - 0x007DB1 01:BDA1: 00        .byte $00   ; 
- D 1 - I - 0x007DB2 01:BDA2: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007DB3 01:BDA3: 40        .byte con_skill_коленочник   ; 
; 03
- D 1 - I - 0x007DB4 01:BDA4: 14        .byte $14   ; 
- D 1 - I - 0x007DB5 01:BDA5: 02        .byte $02   ; 
- D 1 - I - 0x007DB6 01:BDA6: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007DB7 01:BDA7: 40        .byte con_skill_коленочник   ; 
; 04
- D 1 - I - 0x007DB8 01:BDA8: 28        .byte $28   ; 
- D 1 - I - 0x007DB9 01:BDA9: 02        .byte $02   ; 
- D 1 - I - 0x007DBA 01:BDAA: 43        .byte $03 + $40   ; 
- D 1 - I - 0x007DBB 01:BDAB: 40        .byte con_skill_коленочник   ; 
; 05
- D 1 - I - 0x007DBC 01:BDAC: 23        .byte $23   ; 
- D 1 - I - 0x007DBD 01:BDAD: 02        .byte $02   ; 
- D 1 - I - 0x007DBE 01:BDAE: 83        .byte $03 + $80   ; 
- D 1 - I - 0x007DBF 01:BDAF: 40        .byte con_skill_коленочник   ; 
...
- D 1 - I - 0x007DC2 01:BDB2: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007DC3 01:BDB3: 02        .byte con_skill_гвинейская_крутилка   ; 
; 01
- D 1 - I - 0x007DC4 01:BDB4: 14        .byte $14   ; 
- D 1 - I - 0x007DC5 01:BDB5: 03        .byte $03   ; 
- D 1 - I - 0x007DC6 01:BDB6: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007DC7 01:BDB7: 02        .byte con_skill_гвинейская_крутилка   ; 
; 02
- D 1 - I - 0x007DC8 01:BDB8: 14        .byte $14   ; 
- D 1 - I - 0x007DC9 01:BDB9: 03        .byte $03   ; 
- D 1 - I - 0x007DCA 01:BDBA: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007DCB 01:BDBB: 02        .byte con_skill_гвинейская_крутилка   ; 
; 03
- D 1 - I - 0x007DCC 01:BDBC: 14        .byte $14   ; 
- D 1 - I - 0x007DCD 01:BDBD: 01        .byte $01   ; 
- D 1 - I - 0x007DCE 01:BDBE: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007DCF 01:BDBF: 02        .byte con_skill_гвинейская_крутилка   ; 
; 04
- D 1 - I - 0x007DD0 01:BDC0: 23        .byte $23   ; 
- D 1 - I - 0x007DD1 01:BDC1: 03        .byte $03   ; 
- D 1 - I - 0x007DD2 01:BDC2: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007DD3 01:BDC3: 02        .byte con_skill_гвинейская_крутилка   ; 
; 05
- D 1 - I - 0x007DD4 01:BDC4: 23        .byte $23   ; 
- D 1 - I - 0x007DD5 01:BDC5: 03        .byte $03   ; 
- D 1 - I - 0x007DD6 01:BDC6: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007DD7 01:BDC7: 02        .byte con_skill_гвинейская_крутилка   ; 
...
- - - - - - 0x007DDA 01:BDCA: C2        .byte $02 + $C0   ; 
- - - - - - 0x007DDB 01:BDCB: 00        .byte con_skill_нету   ; 
; 01
- - - - - - 0x007DDC 01:BDCC: 28        .byte $28   ; 
- - - - - - 0x007DDD 01:BDCD: 03        .byte $03   ; 
- - - - - - 0x007DDE 01:BDCE: 42        .byte $02 + $40   ; 
- - - - - - 0x007DDF 01:BDCF: 00        .byte con_skill_нету   ; 
; 02
- - - - - - 0x007DE0 01:BDD0: 32        .byte $32   ; 
- - - - - - 0x007DE1 01:BDD1: 03        .byte $03   ; 
- - - - - - 0x007DE2 01:BDD2: 42        .byte $02 + $40   ; 
- - - - - - 0x007DE3 01:BDD3: 00        .byte con_skill_нету   ; 
; 03
- - - - - - 0x007DE4 01:BDD4: 28        .byte $28   ; 
- - - - - - 0x007DE5 01:BDD5: 03        .byte $03   ; 
- - - - - - 0x007DE6 01:BDD6: 42        .byte $02 + $40   ; 
- - - - - - 0x007DE7 01:BDD7: 00        .byte con_skill_нету   ; 
; 04
- - - - - - 0x007DE8 01:BDD8: 28        .byte $28   ; 
- - - - - - 0x007DE9 01:BDD9: 03        .byte $03   ; 
- - - - - - 0x007DEA 01:BDDA: C2        .byte $02 + $C0   ; 
- - - - - - 0x007DEB 01:BDDB: 00        .byte con_skill_нету   ; 
; 05
- - - - - - 0x007DEC 01:BDDC: 32        .byte $32   ; 
- - - - - - 0x007DED 01:BDDD: 03        .byte $03   ; 
- - - - - - 0x007DEE 01:BDDE: 42        .byte $02 + $40   ; 
- - - - - - 0x007DEF 01:BDDF: 00        .byte con_skill_нету   ; 
...
- D 1 - I - 0x007DF2 01:BDE2: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007DF3 01:BDE3: 04        .byte con_skill_высокопрыгающий   ; 
; 01
- D 1 - I - 0x007DF4 01:BDE4: 50        .byte $50   ; 
- D 1 - I - 0x007DF5 01:BDE5: 03        .byte $03   ; 
- D 1 - I - 0x007DF6 01:BDE6: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007DF7 01:BDE7: 04        .byte con_skill_высокопрыгающий   ; 
; 02
- D 1 - I - 0x007DF8 01:BDE8: 32        .byte $32   ; 
- D 1 - I - 0x007DF9 01:BDE9: 01        .byte $01   ; 
- D 1 - I - 0x007DFA 01:BDEA: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007DFB 01:BDEB: 04        .byte con_skill_высокопрыгающий   ; 
; 03
- D 1 - I - 0x007DFC 01:BDEC: 46        .byte $46   ; 
- D 1 - I - 0x007DFD 01:BDED: 03        .byte $03   ; 
- D 1 - I - 0x007DFE 01:BDEE: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007DFF 01:BDEF: 04        .byte con_skill_высокопрыгающий   ; 
; 04
- D 1 - I - 0x007E00 01:BDF0: 32        .byte $32   ; 
- D 1 - I - 0x007E01 01:BDF1: 03        .byte $03   ; 
- D 1 - I - 0x007E02 01:BDF2: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E03 01:BDF3: 04        .byte con_skill_высокопрыгающий   ; 
; 05
- D 1 - I - 0x007E04 01:BDF4: 46        .byte $46   ; 
- D 1 - I - 0x007E05 01:BDF5: 03        .byte $03   ; 
- D 1 - I - 0x007E06 01:BDF6: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E07 01:BDF7: 04        .byte con_skill_высокопрыгающий   ; 
...
- D 1 - I - 0x007E0A 01:BDFA: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007E0B 01:BDFB: 80        .byte con_skill_зачистка   ; 
; 01
- D 1 - I - 0x007E0C 01:BDFC: 46        .byte $46   ; 
- D 1 - I - 0x007E0D 01:BDFD: 00        .byte $00   ; 
- D 1 - I - 0x007E0E 01:BDFE: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E0F 01:BDFF: 80        .byte con_skill_зачистка   ; 
; 02
- D 1 - I - 0x007E10 01:BE00: 50        .byte $50   ; 
- D 1 - I - 0x007E11 01:BE01: 00        .byte $00   ; 
- D 1 - I - 0x007E12 01:BE02: 81        .byte $01 + $80   ; 
- D 1 - I - 0x007E13 01:BE03: 80        .byte con_skill_зачистка   ; 
; 03
- D 1 - I - 0x007E14 01:BE04: 50        .byte $50   ; 
- D 1 - I - 0x007E15 01:BE05: 03        .byte $03   ; 
- D 1 - I - 0x007E16 01:BE06: 41        .byte $01 + $40   ; 
- D 1 - I - 0x007E17 01:BE07: 80        .byte con_skill_зачистка   ; 
; 04
- D 1 - I - 0x007E18 01:BE08: 50        .byte $50   ; 
- D 1 - I - 0x007E19 01:BE09: 00        .byte $00   ; 
- D 1 - I - 0x007E1A 01:BE0A: C0        .byte $00 + $C0   ; 
- D 1 - I - 0x007E1B 01:BE0B: 80        .byte con_skill_зачистка   ; 
; 05
- D 1 - I - 0x007E1C 01:BE0C: 46        .byte $46   ; 
- D 1 - I - 0x007E1D 01:BE0D: 00        .byte $00   ; 
- D 1 - I - 0x007E1E 01:BE0E: 80        .byte $00 + $80   ; 
- D 1 - I - 0x007E1F 01:BE0F: 80        .byte con_skill_зачистка   ; 
...
- - - - - - 0x007E22 01:BE12: 43        .byte $03 + $40   ; 
- - - - - - 0x007E23 01:BE13: 80        .byte con_skill_зачистка   ; 
; 01
- - - - - - 0x007E24 01:BE14: 32        .byte $32   ; 
- - - - - - 0x007E25 01:BE15: 01        .byte $01   ; 
- - - - - - 0x007E26 01:BE16: C3        .byte $03 + $C0   ; 
- - - - - - 0x007E27 01:BE17: 80        .byte con_skill_зачистка   ; 
; 02
- - - - - - 0x007E28 01:BE18: 32        .byte $32   ; 
- - - - - - 0x007E29 01:BE19: 00        .byte $00   ; 
- - - - - - 0x007E2A 01:BE1A: C3        .byte $03 + $C0   ; 
- - - - - - 0x007E2B 01:BE1B: 80        .byte con_skill_зачистка   ; 
; 03
- - - - - - 0x007E2C 01:BE1C: 46        .byte $46   ; 
- - - - - - 0x007E2D 01:BE1D: 01        .byte $01   ; 
- - - - - - 0x007E2E 01:BE1E: 43        .byte $03 + $40   ; 
- - - - - - 0x007E2F 01:BE1F: 80        .byte con_skill_зачистка   ; 
; 04
- - - - - - 0x007E30 01:BE20: 46        .byte $46   ; 
- - - - - - 0x007E31 01:BE21: 02        .byte $02   ; 
- - - - - - 0x007E32 01:BE22: 43        .byte $03 + $40   ; 
- - - - - - 0x007E33 01:BE23: 80        .byte con_skill_зачистка   ; 
; 05
- - - - - - 0x007E34 01:BE24: 46        .byte $46   ; 
- - - - - - 0x007E35 01:BE25: 02        .byte $02   ; 
- - - - - - 0x007E36 01:BE26: 43        .byte $03 + $40   ; 
- - - - - - 0x007E37 01:BE27: 80        .byte con_skill_зачистка   ; 
...
- D 1 - I - 0x007E3A 01:BE2A: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E3B 01:BE2B: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
; 01
- D 1 - I - 0x007E3C 01:BE2C: 50        .byte $50   ; 
- D 1 - I - 0x007E3D 01:BE2D: 00        .byte $00   ; 
- D 1 - I - 0x007E3E 01:BE2E: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E3F 01:BE2F: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
; 02
- D 1 - I - 0x007E40 01:BE30: 46        .byte $46   ; 
- D 1 - I - 0x007E41 01:BE31: 00        .byte $00   ; 
- D 1 - I - 0x007E42 01:BE32: C0        .byte $00 + $C0   ; 
- D 1 - I - 0x007E43 01:BE33: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
; 03
- D 1 - I - 0x007E44 01:BE34: 46        .byte $46   ; 
- D 1 - I - 0x007E45 01:BE35: 03        .byte $03   ; 
- D 1 - I - 0x007E46 01:BE36: C0        .byte $00 + $C0   ; 
- D 1 - I - 0x007E47 01:BE37: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
; 04
- D 1 - I - 0x007E48 01:BE38: 50        .byte $50   ; 
- D 1 - I - 0x007E49 01:BE39: 03        .byte $03   ; 
- D 1 - I - 0x007E4A 01:BE3A: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E4B 01:BE3B: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
; 05
- D 1 - I - 0x007E4C 01:BE3C: 50        .byte $50   ; 
- D 1 - I - 0x007E4D 01:BE3D: 03        .byte $03   ; 
- D 1 - I - 0x007E4E 01:BE3E: 40        .byte $00 + $40   ; 
- D 1 - I - 0x007E4F 01:BE3F: 14        .byte con_skill_высокопрыгающий + con_skill_вратарская_крутилка   ; 
...
- D 1 - I - 0x007E52 01:BE42: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E53 01:BE43: 04        .byte con_skill_высокопрыгающий   ; 
; 01
- D 1 - I - 0x007E54 01:BE44: 46        .byte $46   ; 
- D 1 - I - 0x007E55 01:BE45: 00        .byte $00   ; 
- D 1 - I - 0x007E56 01:BE46: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E57 01:BE47: 04        .byte con_skill_высокопрыгающий   ; 
; 02
- D 1 - I - 0x007E58 01:BE48: 46        .byte $46   ; 
- D 1 - I - 0x007E59 01:BE49: 03        .byte $03   ; 
- D 1 - I - 0x007E5A 01:BE4A: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007E5B 01:BE4B: 04        .byte con_skill_высокопрыгающий   ; 
; 03
- D 1 - I - 0x007E5C 01:BE4C: 46        .byte $46   ; 
- D 1 - I - 0x007E5D 01:BE4D: 00        .byte $00   ; 
- D 1 - I - 0x007E5E 01:BE4E: 41        .byte $01 + $40   ; 
- D 1 - I - 0x007E5F 01:BE4F: 04        .byte con_skill_высокопрыгающий   ; 
; 04
- D 1 - I - 0x007E60 01:BE50: 50        .byte $50   ; 
- D 1 - I - 0x007E61 01:BE51: 03        .byte $03   ; 
- D 1 - I - 0x007E62 01:BE52: C1        .byte $01 + $C0   ; 
- D 1 - I - 0x007E63 01:BE53: 04        .byte con_skill_высокопрыгающий   ; 
; 05
- D 1 - I - 0x007E64 01:BE54: 46        .byte $46   ; 
- D 1 - I - 0x007E65 01:BE55: 03        .byte $03   ; 
- D 1 - I - 0x007E66 01:BE56: C0        .byte $00 + $C0   ; 
- D 1 - I - 0x007E67 01:BE57: 04        .byte con_skill_высокопрыгающий   ; 
...
- D 1 - I - 0x007E6A 01:BE5A: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007E6B 01:BE5B: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 01
- D 1 - I - 0x007E6C 01:BE5C: 32        .byte $32   ; 
- D 1 - I - 0x007E6D 01:BE5D: 00        .byte $00   ; 
- D 1 - I - 0x007E6E 01:BE5E: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E6F 01:BE5F: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 02
- D 1 - I - 0x007E70 01:BE60: 46        .byte $46   ; 
- D 1 - I - 0x007E71 01:BE61: 01        .byte $01   ; 
- D 1 - I - 0x007E72 01:BE62: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E73 01:BE63: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 03
- D 1 - I - 0x007E74 01:BE64: 28        .byte $28   ; 
- D 1 - I - 0x007E75 01:BE65: 03        .byte $03   ; 
- D 1 - I - 0x007E76 01:BE66: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007E77 01:BE67: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 04
- D 1 - I - 0x007E78 01:BE68: 32        .byte $32   ; 
- D 1 - I - 0x007E79 01:BE69: 01        .byte $01   ; 
- D 1 - I - 0x007E7A 01:BE6A: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007E7B 01:BE6B: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
; 05
- D 1 - I - 0x007E7C 01:BE6C: 46        .byte $46   ; 
- D 1 - I - 0x007E7D 01:BE6D: 03        .byte $03   ; 
- D 1 - I - 0x007E7E 01:BE6E: C0        .byte $00 + $C0   ; 
- D 1 - I - 0x007E7F 01:BE6F: 90        .byte con_skill_вратарская_крутилка + con_skill_зачистка   ; 
...
- D 1 - I - 0x007E82 01:BE72: 82        .byte $02 + $80   ; 
- D 1 - I - 0x007E83 01:BE73: 08        .byte con_skill_мексиканское_сверло   ; 
; 01
- D 1 - I - 0x007E84 01:BE74: 28        .byte $28   ; 
- D 1 - I - 0x007E85 01:BE75: 01        .byte $01   ; 
- D 1 - I - 0x007E86 01:BE76: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E87 01:BE77: 08        .byte con_skill_мексиканское_сверло   ; 
; 02
- D 1 - I - 0x007E88 01:BE78: 28        .byte $28   ; 
- D 1 - I - 0x007E89 01:BE79: 01        .byte $01   ; 
- D 1 - I - 0x007E8A 01:BE7A: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007E8B 01:BE7B: 08        .byte con_skill_мексиканское_сверло   ; 
; 03
- D 1 - I - 0x007E8C 01:BE7C: 32        .byte $32   ; 
- D 1 - I - 0x007E8D 01:BE7D: 03        .byte $03   ; 
- D 1 - I - 0x007E8E 01:BE7E: 42        .byte $02 + $40   ; 
- D 1 - I - 0x007E8F 01:BE7F: 08        .byte con_skill_мексиканское_сверло   ; 
; 04
- D 1 - I - 0x007E90 01:BE80: 23        .byte $23   ; 
- D 1 - I - 0x007E91 01:BE81: 01        .byte $01   ; 
- D 1 - I - 0x007E92 01:BE82: 02        .byte $02 + $00   ; 
- D 1 - I - 0x007E93 01:BE83: 08        .byte con_skill_мексиканское_сверло   ; 
; 05
- D 1 - I - 0x007E94 01:BE84: 28        .byte $28   ; 
- D 1 - I - 0x007E95 01:BE85: 01        .byte $01   ; 
- D 1 - I - 0x007E96 01:BE86: C2        .byte $02 + $C0   ; 
- D 1 - I - 0x007E97 01:BE87: 08        .byte con_skill_мексиканское_сверло   ; 



loc_BE88:
C D 1 - - - 0x007E98 01:BE88: AD 5A 06  LDA ram_позиция_управление + 10
C - - - - - 0x007E9B 01:BE8B: 09 80     ORA #con_флаг_бота
...
bra_BEAC:
C - - - - - 0x007EBC 01:BEAC: AD 6C 03  LDA ram_pos_Y_hi_мяча
C - - - - - 0x007EBF 01:BEAF: D0 07     BNE bra_BEB8
C - - - - - 0x007EC1 01:BEB1: AD 59 03  LDA ram_pos_Y_lo_мяча
...
C - - - - - 0x007F68 01:BF58: 8D 92 04  STA ram_состояние_мяча
