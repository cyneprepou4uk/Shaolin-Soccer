...
C - - - - - 0x00C3E1 03:83D1: A5 22     LDA ram_0022    ; 0A-0B киперы
...
bra_83E1_полевые:
loc_83E1_полевые:
C D 0 - - - 0x00C3F1 03:83E1: A5 21     LDA ram_0021    ; 00-09 полевые
...
C - - - - - 0x00C3FD 03:83ED: D0 0D     BNE bra_83FC_правый_кипер
C - - - - - 0x00C3FF 03:83EF: A9 A0     LDA #$A0    ; левый кипер
...
bra_83FC_правый_кипер:
C - - - - - 0x00C40C 03:83FC: A9 60     LDA #$60    ; правый кипер
...
C - - - - - 0x00C41F 03:840F: D0 2B     BNE bra_843C_правый_кипер
C - - - - - 0x00C421 03:8411: AD 20 03  LDA ram_pos_X_lo_мяча   ; левый кипер
