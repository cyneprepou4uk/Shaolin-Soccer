...
C - - - - - 0x00D453 03:9443: 4C 4D 94  JMP loc_944D_запись_действия
bra_9446:
C - - - - - 0x00D456 03:9446: A9 33     LDA #con_action_33
C - - - - - 0x00D458 03:9448: 4C 4D 94  JMP loc_944D_запись_действия
bra_944B:
C - - - - - 0x00D45B 03:944B: A9 34     LDA #con_action_34
loc_944D_запись_действия:   ; bzk опт
...
- - - - - - 0x00D76C 03:975C: 4C 66 97  JMP loc_9766_запись_действия
bra_975F:
C - - - - - 0x00D76F 03:975F: A9 46     LDA #con_action_46
C - - - - - 0x00D771 03:9761: 4C 66 97  JMP loc_9766_запись_действия
bra_9764:
- - - - - - 0x00D774 03:9764: A9 37     LDA #con_action_37
loc_9766_запись_действия:   ; bzk опт
