...
loc_0x00C019_выбрать_погоду:
C - - J - - 0x00C019 03:8009: 4C F9 BA  JMP loc_BAF9_выбрать_погоду
...
bra_801D_loop:
C - - - - - 0x00C02D 03:801D: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C030 03:8020: 09 F0     ORA #$F0
C - - - - - 0x00C032 03:8022: 9D 68 06  STA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C035 03:8025: A9 00     LDA #con_ai_00
C - - - - - 0x00C037 03:8027: 9D 5C 06  STA ram_интеллект_бота,X
C - - - - - 0x00C03A 03:802A: CA        DEX
C - - - - - 0x00C03B 03:802B: 10 F0     BPL bra_801D_loop
C - - - - - 0x00C03D 03:802D: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00C054 03:8044: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00C057 03:8047: 48        PHA
C - - - - - 0x00C058 03:8048: AD 6C 03  LDA ram_pos_Y_hi_мяча
...
C - - - - - 0x00C076 03:8066: AD 92 04  LDA ram_состояние_мяча
C - - - - - 0x00C079 03:8069: 10 10     BPL bra_807B
C - - - - - 0x00C07B 03:806B: 68        PLA
C - - - - - 0x00C07C 03:806C: 8D 6C 03  STA ram_pos_Y_hi_мяча
C - - - - - 0x00C07F 03:806F: 68        PLA
C - - - - - 0x00C080 03:8070: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00C083 03:8073: 68        PLA
C - - - - - 0x00C084 03:8074: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00C087 03:8077: 68        PLA
C - - - - - 0x00C088 03:8078: 8D 20 03  STA ram_pos_X_lo_мяча
bra_807B:
C - - - - - 0x00C08B 03:807B: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00C0C7 03:80B7: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00C0D7 03:80C7: 8D 77 06  STA ram_дистанция_ближайшего + 1
...
C - - - - - 0x00C0FB 03:80EB: 8D 77 06  STA ram_дистанция_ближайшего + 1
C - - - - - 0x00C0FE 03:80EE: B5 2C     LDA ram_002C,X
loc_80F0:
C D 0 - - - 0x00C100 03:80F0: 8D 75 06  STA ram_номер_ближайшего + 1
...
C - - - - - 0x00C116 03:8106: B9 68 06  LDA ram_счетчик_поведения_ботов,Y
...
C - - - - - 0x00C128 03:8118: 99 68 06  STA ram_счетчик_поведения_ботов,Y
...
C - - - - - 0x00C145 03:8135: 8D 72 06  STA ram_счетчик_поведения_ботов + 10
bra_8138:
C - - - - - 0x00C148 03:8138: AD 73 06  LDA ram_счетчик_поведения_ботов + 11
...
bra_816A_не_нарушение:
loc_816A:
C D 0 - - - 0x00C17A 03:816A: A2 00     LDX #$00
bra_816C_loop:
C - - - - - 0x00C17C 03:816C: DE 68 06  DEC ram_счетчик_поведения_ботов,X
C - - - - - 0x00C17F 03:816F: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C182 03:8172: 29 0F     AND #$0F
C - - - - - 0x00C184 03:8174: F0 03     BEQ bra_8179
C - - - - - 0x00C186 03:8176: 4C 89 81  JMP loc_8189
bra_8179:
C - - - - - 0x00C189 03:8179: 20 39 83  JSR sub_8339_обработка_интеллекта
C - - - - - 0x00C18C 03:817C: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C18F 03:817F: 4A        LSR
C - - - - - 0x00C190 03:8180: 4A        LSR
C - - - - - 0x00C191 03:8181: 4A        LSR
C - - - - - 0x00C192 03:8182: 4A        LSR
C - - - - - 0x00C193 03:8183: 1D 68 06  ORA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C196 03:8186: 9D 68 06  STA ram_счетчик_поведения_ботов,X
loc_8189:
...
C - - - - - 0x00C1A6 03:8196: 8D 20 03  STA ram_pos_X_lo_мяча
C - - - - - 0x00C1A9 03:8199: A5 33     LDA ram_0033
C - - - - - 0x00C1AB 03:819B: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00C1AE 03:819E: A5 34     LDA ram_0034
C - - - - - 0x00C1B0 03:81A0: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00C1B3 03:81A3: A5 35     LDA ram_0035
C - - - - - 0x00C1B5 03:81A5: 8D 6C 03  STA ram_pos_Y_hi_мяча
...
C - - - - - 0x00C1E7 03:81D7: A9 2B     LDA #con_ai_2B
...
bra_8214:
C - - - - - 0x00C224 03:8214: AD 92 04  LDA ram_состояние_мяча
...
bra_8259:
C - - - - - 0x00C269 03:8259: A9 06     LDA #con_ai_06
loc_825B:
...
C - - - - - 0x00C28A 03:827A: 4C 8C 82  JMP loc_828C_FW
bra_827D_GK:
...
C - - - - - 0x00C294 03:8284: 4C 8E 82  JMP loc_828E_запись_интеллекта
bra_8287_DF:
...
C - - - - - 0x00C2A3 03:8293: C0 0B     CPY #$0B    ; bzk баг? киперу справа не записывается
C - - - - - 0x00C2A5 03:8295: 90 D4     BCC bra_826B_loop
...
C - - - - - 0x00C2BF 03:82AF: 90 F7     BCC bra_82A8_loop
...
C - - - - - 0x00C2CD 03:82BD: A9 0A     LDA #con_ai_0A
C - - - - - 0x00C2CF 03:82BF: 4C C4 82  JMP loc_82C4
bra_82C2_это_не_кипер:
C - - - - - 0x00C2D2 03:82C2: A9 29     LDA #con_ai_29
loc_82C4:
...
bra_82E5:
C - - - - - 0x00C2F5 03:82E5: AD 19 05  LDA ram_pos_Y_lo_подающий
...
C - - - - - 0x00C309 03:82F9: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C30C 03:82FC: 29 F0     AND #$F0
C - - - - - 0x00C30E 03:82FE: 09 01     ORA #$01
C - - - - - 0x00C310 03:8300: 9D 68 06  STA ram_счетчик_поведения_ботов,X
...
C - - - - - 0x00C31E 03:830E: BD 68 06  LDA ram_счетчик_поведения_ботов,X
...
C - - - - - 0x00C333 03:8323: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C336 03:8326: 29 F0     AND #$F0
C - - - - - 0x00C338 03:8328: 09 01     ORA #$01
C - - - - - 0x00C33A 03:832A: 9D 68 06  STA ram_счетчик_поведения_ботов,X
C - - - - - 0x00C33D 03:832D: 60        RTS



tbl_832E:
- D 0 - - - 0x00C33E 03:832E: 15        .byte con_ai_15   ; 
- D 0 - - - 0x00C33F 03:832F: 16        .byte con_ai_16   ; 
- D 0 - - - 0x00C340 03:8330: 17        .byte con_ai_17   ; 



tbl_8331:
- D 0 - - - 0x00C341 03:8331: 18        .byte con_ai_18   ; 
- D 0 - - - 0x00C342 03:8332: 19        .byte con_ai_19   ; 
- D 0 - - - 0x00C343 03:8333: 1A        .byte con_ai_1A   ; 



tbl_8334:
- D 0 - - - 0x00C344 03:8334: 1B        .byte con_ai_1B   ; 
- D 0 - - - 0x00C345 03:8335: 1C        .byte con_ai_1C   ; 
- D 0 - - - 0x00C346 03:8336: 1D        .byte con_ai_1D   ; 
- D 0 - - - 0x00C347 03:8337: 1E        .byte con_ai_1E   ; 
- D 0 - - - 0x00C348 03:8338: 1F        .byte con_ai_1F   ; 



sub_8339_обработка_интеллекта:
C - - - - - 0x00C349 03:8339: BD 79 04  LDA ram_next_действие_игрока,X
C - - - - - 0x00C34C 03:833C: 10 08     BPL bra_8346_RTS    ; если действие еще не обработано
C - - - - - 0x00C34E 03:833E: BD 50 06  LDA ram_позиция_управление,X
C - - - - - 0x00C351 03:8341: 10 03     BMI bra_8347_это_бот
bra_8346_RTS:
...
- - - - - - 0x00C36F 03:835F: 60 87     .word ofs_85F7_03
- D 0 - - - 0x00C371 03:8361: 34 87     .word ofs_8734_04
- D 0 - - - 0x00C373 03:8363: CA 83     .word ofs_83CA_05   ; кипер принимает решение что-то делать,(ловить, отбивать) когда идет удар по его воротам
...
- D 0 - - - 0x00C383 03:8373: 58 88     .word ofs_8858_0D   ; кипер стоит на готове в воротах и смещается относительно мяча 
...
- D 0 - - - 0x00C3B1 03:83A1: EC 92     .word ofs_92EC_24   ; кипер бежит забирать мяч, если он не далеко от его зоны и им никто не владеет
...
- D 0 - - - 0x00C3B9 03:83A9: 33 95     .word ofs_9533_28   ; кипер бежит забирать/отбивать или атаковать, если соперник подошел очень близко с мячем
...
C - - - - - 0x00C3CA 03:83BA: A9 0F     LDA #con_action_споткнуться
...
C - - - - - 0x00C3D6 03:83C6: 9D B0 04  STA ram_смена_угла_движения,X
...
bra_83E1_это_не_кипер:
loc_83E1:
C D 0 - - - 0x00C3F1 03:83E1: A5 21     LDA ram_0021
C - - - - - 0x00C3F3 03:83E3: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00C3F6 03:83E6: A5 22     LDA ram_0022
C - - - - - 0x00C3F8 03:83E8: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00C425 03:8415: FD 14 03  SBC ram_pos_X_lo_игрока,X
C - - - - - 0x00C428 03:8418: 85 1D     STA ram_001D
C - - - - - 0x00C42A 03:841A: AD 33 03  LDA ram_pos_X_hi_мяча
C - - - - - 0x00C42D 03:841D: FD 27 03  SBC ram_pos_X_hi_игрока,X
C - - - - - 0x00C430 03:8420: 85 1E     STA ram_001E
C - - - - - 0x00C432 03:8422: AD 02 04  LDA ram_spd_X_hi_мяча
C - - - - - 0x00C435 03:8425: 49 FF     EOR #$FF
C - - - - - 0x00C437 03:8427: 85 2D     STA ram_002D
C - - - - - 0x00C439 03:8429: AD F4 03  LDA ram_spd_X_lo_мяча
...
bra_843C_это_правый_кипер:
C - - - - - 0x00C44C 03:843C: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x00C44F 03:843F: 38        SEC
C - - - - - 0x00C450 03:8440: ED 20 03  SBC ram_pos_X_lo_мяча
C - - - - - 0x00C453 03:8443: 85 1D     STA ram_001D
C - - - - - 0x00C455 03:8445: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x00C458 03:8448: ED 33 03  SBC ram_pos_X_hi_мяча
C - - - - - 0x00C45B 03:844B: 85 1E     STA ram_001E
C - - - - - 0x00C45D 03:844D: AD 02 04  LDA ram_spd_X_hi_мяча
C - - - - - 0x00C460 03:8450: 85 2D     STA ram_002D
C - - - - - 0x00C462 03:8452: AD F4 03  LDA ram_spd_X_lo_мяча
C - - - - - 0x00C465 03:8455: 85 2C     STA ram_002C
loc_8457:
C D 0 - - - 0x00C467 03:8457: A9 00     LDA #$00
C - - - - - 0x00C469 03:8459: 85 1C     STA ram_001C
C - - - - - 0x00C46B 03:845B: 20 26 C0  JSR sub_0x01F4D1_деление_24бит_на_16бит
C - - - - - 0x00C46E 03:845E: A5 1C     LDA ram_001C
C - - - - - 0x00C470 03:8460: 85 1F     STA ram_001F
C - - - - - 0x00C472 03:8462: AD 1E 04  LDA ram_spd_Y_hi_мяча
C - - - - - 0x00C475 03:8465: 30 11     BMI bra_8478_мяч_летит_вверх
C - - - - - 0x00C477 03:8467: AD 1E 04  LDA ram_spd_Y_hi_мяча
C - - - - - 0x00C47A 03:846A: 85 1D     STA ram_001D
C - - - - - 0x00C47C 03:846C: AD 10 04  LDA ram_spd_Y_lo_мяча
...
bra_8478_мяч_летит_вверх:
C - - - - - 0x00C488 03:8478: AD 1E 04  LDA ram_spd_Y_hi_мяча
C - - - - - 0x00C48B 03:847B: 49 FF     EOR #$FF
C - - - - - 0x00C48D 03:847D: 85 1D     STA ram_001D
C - - - - - 0x00C48F 03:847F: AD 10 04  LDA ram_spd_Y_lo_мяча
...
C - - - - - 0x00C4A2 03:8492: AD 1E 04  LDA ram_spd_Y_hi_мяча
C - - - - - 0x00C4A5 03:8495: 30 12     BMI bra_84A9_мяч_летит_вверх
C - - - - - 0x00C4A7 03:8497: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00C4AA 03:849A: 18        CLC
C - - - - - 0x00C4AB 03:849B: 65 21     ADC ram_0021
C - - - - - 0x00C4AD 03:849D: 85 21     STA ram_0021
C - - - - - 0x00C4AF 03:849F: AD 6C 03  LDA ram_pos_Y_hi_мяча
C - - - - - 0x00C4B2 03:84A2: 65 22     ADC ram_0022
C - - - - - 0x00C4B4 03:84A4: 85 22     STA ram_0022
C - - - - - 0x00C4B6 03:84A6: 4C B8 84  RTS
bra_84A9_мяч_летит_вверх:
C - - - - - 0x00C4B9 03:84A9: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00C4BC 03:84AC: 38        SEC
C - - - - - 0x00C4BD 03:84AD: E5 21     SBC ram_0021
C - - - - - 0x00C4BF 03:84AF: 85 21     STA ram_0021
C - - - - - 0x00C4C1 03:84B1: AD 6C 03  LDA ram_pos_Y_hi_мяча
...
C - - - - - 0x00C4CC 03:84BC: C9 21     CMP #con_ai_21
C - - - - - 0x00C4CE 03:84BE: D0 06     BNE bra_84C6
- - - - - - 0x00C4D0 03:84C0: BC C7 84  LDY tbl_84CD - 6,X
...
- - - - - - 0x00C4F4 03:84E4: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00C501 03:84F1: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00C51C 03:850C: B9 86 04  LDA ram_состояние_игрока,Y
C - - - - - 0x00C51F 03:850F: 10 0E     BPL bra_851F_не_в_воздухе
bra_8511:
...
- - - - - - 0x00C54C 03:853C: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00C56D 03:855D: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00C5D4 03:85C4: A9 19     LDA #con_action_19
C - - - - - 0x00C5D6 03:85C6: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00C625 03:8615: AD F4 03  LDA ram_spd_X_lo_мяча
C - - - - - 0x00C628 03:8618: 0D 10 04  ORA ram_spd_Y_lo_мяча
...
C - - - - - 0x00C656 03:8646: B9 E7 86  LDA tbl_86E6 + 1,Y
...
C - - - - - 0x00C660 03:8650: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
...
C - - - - - 0x00C66A 03:865A: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
...
C - - - - - 0x00C674 03:8664: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
...
C - - - - - 0x00C67E 03:866E: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00C689 03:8679: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00C698 03:8688: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x00C69B 03:868B: C9 02     CMP #$02
C - - - - - 0x00C69D 03:868D: 90 1B     BCC bra_86AA
C - - - - - 0x00C69F 03:868F: 4C 99 86  JMP loc_8699
bra_8692:
C - - - - - 0x00C6A2 03:8692: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x00C6A5 03:8695: C9 02     CMP #$02
C - - - - - 0x00C6A7 03:8697: B0 11     BCS bra_86AA
loc_8699:
C D 0 - - - 0x00C6A9 03:8699: BD 20 06  LDA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C6AC 03:869C: 18        CLC
C - - - - - 0x00C6AD 03:869D: 69 C0     ADC #$C0
C - - - - - 0x00C6AF 03:869F: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C6B2 03:86A2: BD 2C 06  LDA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00C6B5 03:86A5: 69 00     ADC #$00
C - - - - - 0x00C6B7 03:86A7: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
bra_86AA:
C - - - - - 0x00C6BA 03:86AA: 8A        TXA
C - - - - - 0x00C6BB 03:86AB: 29 01     AND #$01
C - - - - - 0x00C6BD 03:86AD: F0 15     BEQ bra_86C4
C - - - - - 0x00C6BF 03:86AF: BD 20 06  LDA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C6C2 03:86B2: 49 FF     EOR #$FF
C - - - - - 0x00C6C4 03:86B4: 18        CLC
C - - - - - 0x00C6C5 03:86B5: 69 01     ADC #$01
C - - - - - 0x00C6C7 03:86B7: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C6CA 03:86BA: BD 2C 06  LDA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00C6CD 03:86BD: 49 FF     EOR #$FF
C - - - - - 0x00C6CF 03:86BF: 69 04     ADC #$04
C - - - - - 0x00C6D1 03:86C1: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
bra_86C4:
ofs_86C4_01:
...
C - - - - - 0x00C6E1 03:86D1: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
ofs_8734_04:
C - - J - - 0x00C744 03:8734: A9 09     LDA #con_action_09
C - - - - - 0x00C746 03:8736: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00C749 03:8739: A9 FF     LDA #$FF
C - - - - - 0x00C74B 03:873B: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00C74E 03:873E: 60        RTS



ofs_873F_02:
C - - J - - 0x00C74F 03:873F: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00C752 03:8742: 10 05     BPL bra_8749_не_в_воздухе
C - - - - - 0x00C754 03:8744: A9 39     LDA #con_action_39
C - - - - - 0x00C756 03:8746: 4C 4B 87  BNE bra_874B_запись_действия
bra_8749_не_в_воздухе:
C - - - - - 0x00C759 03:8749: A9 0A     LDA #con_action_0A
bra_874B_запись_действия:
C D 0 - - - 0x00C75B 03:874B: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00C785 03:8775: B9 F9 B1  LDA tbl_B1F8 + 1,Y
...
C - - - - - 0x00C7C8 03:87B8: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00C7CB 03:87BB: A5 1D     LDA ram_001D
C - - - - - 0x00C7CD 03:87BD: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C7D0 03:87C0: A5 1E     LDA ram_001E
C - - - - - 0x00C7D2 03:87C2: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00C7D5 03:87C5: A5 1F     LDA ram_001F
C - - - - - 0x00C7D7 03:87C7: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
...
C - - - - - 0x00C7F1 03:87E1: B9 42 98  LDA tbl_9841 + 1,Y
...
C - - - - - 0x00C84C 03:883C: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00C84F 03:883F: A9 30     LDA #$30
C - - - - - 0x00C851 03:8841: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00C854 03:8844: 4C 51 88  JMP loc_8851
bra_8847:
C - - - - - 0x00C857 03:8847: A9 01     LDA #$01
C - - - - - 0x00C859 03:8849: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00C85C 03:884C: A9 60     LDA #$60
C - - - - - 0x00C85E 03:884E: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
loc_8851:
...
loc_8858:
ofs_8858_0D:
C D 0 J - - 0x00C868 03:8858: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x00C86B 03:885B: 48        PHA
C - - - - - 0x00C86C 03:885C: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x00C86F 03:885F: 48        PHA
C - - - - - 0x00C870 03:8860: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00C873 03:8863: 48        PHA
C - - - - - 0x00C874 03:8864: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00C877 03:8867: 48        PHA
C - - - - - 0x00C878 03:8868: BD CB 89  LDA tbl_89CB,X
C - - - - - 0x00C87B 03:886B: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x00C87E 03:886E: BD CD 89  LDA tbl_89CD,X
C - - - - - 0x00C881 03:8871: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x00C884 03:8874: BD CF 89  LDA tbl_89CF,X
C - - - - - 0x00C887 03:8877: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x00C88A 03:887A: BD D1 89  LDA tbl_89D1,X
C - - - - - 0x00C88D 03:887D: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x00C890 03:8880: A0 0C     LDY #$0C
C - - - - - 0x00C892 03:8882: 20 32 C0  JSR sub_0x01F68D
C - - - - - 0x00C895 03:8885: 85 1C     STA ram_001C
C - - - - - 0x00C897 03:8887: 68        PLA
C - - - - - 0x00C898 03:8888: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x00C89B 03:888B: 68        PLA
C - - - - - 0x00C89C 03:888C: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x00C89F 03:888F: 68        PLA
C - - - - - 0x00C8A0 03:8890: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x00C8A3 03:8893: 68        PLA
C - - - - - 0x00C8A4 03:8894: 9D 14 03  STA ram_pos_X_lo_игрока,X
...
C - - - - - 0x00C8CA 03:88BA: B9 02 89  LDA tbl_8901 + 1,Y
...
C - - - - - 0x00C8E4 03:88D4: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00C8E7 03:88D7: C8        INY
C - - - - - 0x00C8E8 03:88D8: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00C8EA 03:88DA: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00C8ED 03:88DD: C8        INY
C - - - - - 0x00C8EE 03:88DE: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00C8F0 03:88E0: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00C8F3 03:88E3: C8        INY
C - - - - - 0x00C8F4 03:88E4: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00C8F6 03:88E6: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00C8F9 03:88E9: 20 37 AE  JSR sub_AE37
C - - - - - 0x00C8FC 03:88EC: 20 5F 98  JSR sub_985F
C - - - - - 0x00C8FF 03:88EF: BD 99 03  LDA ram_pos_Z_hi_игрока,X
...
bra_89EB:
C - - - - - 0x00C9FB 03:89EB: AD A5 03  LDA ram_pos_Z_hi_мяча
C - - - - - 0x00C9FE 03:89EE: 30 14     BMI bra_8A04
C - - - - - 0x00CA00 03:89F0: AD 92 03  LDA ram_pos_Z_lo_мяча
C - - - - - 0x00CA03 03:89F3: 38        SEC
C - - - - - 0x00CA04 03:89F4: FD 86 03  SBC ram_pos_Z_lo_игрока,X
C - - - - - 0x00CA07 03:89F7: C9 20     CMP #$20
C - - - - - 0x00CA09 03:89F9: 90 09     BCC bra_8A04
C - - - - - 0x00CA0B 03:89FB: AD 3A 04  LDA ram_spd_Z_hi_мяча
...
loc_8A32:
C D 0 - - - 0x00CA42 03:8A32: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00CA78 03:8A68: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00CA84 03:8A74: 4C 79 8A  BNE bra_8A79_запись_действия
bra_8A77:
C - - - - - 0x00CA87 03:8A77: A9 54     LDA #con_action_54
bra_8A79_запись_действия:
C D 0 - - - 0x00CA89 03:8A79: 9D 79 04  STA ram_next_действие_игрока,X
...
loc_8A88:
C D 0 - - - 0x00CA98 03:8A88: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00CAAF 03:8A9F: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00CAB2 03:8AA2: 38        SEC
C - - - - - 0x00CAB3 03:8AA3: E5 21     SBC ram_0021
C - - - - - 0x00CAB5 03:8AA5: 85 1C     STA ram_001C
C - - - - - 0x00CAB7 03:8AA7: BD 60 03  LDA ram_pos_Y_hi_игрока,X
...
- - - - - - 0x00CAE6 03:8AD6: A9 0A     LDA #con_action_0A
- - - - - - 0x00CAE8 03:8AD8: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00CB0B 03:8AFB: BD E4 04  LDA ram_сила_игрока,X
...
C - - - - - 0x00CB19 03:8B09: B9 6F B7  LDA tbl_B76E + 1,Y
...
C - - - - - 0x00CB25 03:8B15: BD E4 04  LDA ram_сила_игрока,X
...
C - - - - - 0x00CB61 03:8B51: AD 27 B9  LDA tbl_B926 + 1
C - - - - - 0x00CB64 03:8B54: 85 2F     STA ram_002F
C - - - - - 0x00CB66 03:8B56: BD E4 04  LDA ram_сила_игрока,X
...
bra_8B67:
C - - - - - 0x00CB77 03:8B67: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00CB7A 03:8B6A: C8        INY
C - - - - - 0x00CB7B 03:8B6B: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00CB7D 03:8B6D: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00CB80 03:8B70: C8        INY
C - - - - - 0x00CB81 03:8B71: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00CB83 03:8B73: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00CB86 03:8B76: C8        INY
C - - - - - 0x00CB87 03:8B77: B1 2E     LDA (ram_002E),Y
C - - - - - 0x00CB89 03:8B79: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00CB8C 03:8B7C: 8A        TXA
C - - - - - 0x00CB8D 03:8B7D: 29 01     AND #$01
C - - - - - 0x00CB8F 03:8B7F: F0 15     BEQ bra_8B96
C - - - - - 0x00CB91 03:8B81: BD 20 06  LDA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00CB94 03:8B84: 49 FF     EOR #$FF
C - - - - - 0x00CB96 03:8B86: 18        CLC
C - - - - - 0x00CB97 03:8B87: 69 01     ADC #$01
C - - - - - 0x00CB99 03:8B89: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00CB9C 03:8B8C: BD 2C 06  LDA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00CB9F 03:8B8F: 49 FF     EOR #$FF
C - - - - - 0x00CBA1 03:8B91: 69 04     ADC #$04
C - - - - - 0x00CBA3 03:8B93: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
bra_8B96:
...
C - - - - - 0x00CBBF 03:8BAF: BD B0 04  LDA ram_смена_угла_движения,X
...
C - - - - - 0x00CD40 03:8D30: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
C - - - - - 0x00CD43 03:8D33: 29 07     AND #$07
C - - - - - 0x00CD45 03:8D35: 85 1D     STA ram_001D
C - - - - - 0x00CD47 03:8D37: BD 68 06  LDA ram_счетчик_поведения_ботов,X
C - - - - - 0x00CD4A 03:8D3A: 29 F0     AND #$F0
C - - - - - 0x00CD4C 03:8D3C: 05 1D     ORA ram_001D
C - - - - - 0x00CD4E 03:8D3E: 09 01     ORA #$01
C - - - - - 0x00CD50 03:8D40: 9D 68 06  STA ram_счетчик_поведения_ботов,X
...
C - - - - - 0x00CD6B 03:8D5B: 9D B0 04  STA ram_смена_угла_движения,X
loc_8D5E:
...
C - - - - - 0x00CD7B 03:8D6B: A9 0F     LDA #con_action_споткнуться
C - - - - - 0x00CD7D 03:8D6D: 4C 85 8D  JMP loc_8D85_запись_действия
bra_8D70:
C - - - - - 0x00CD80 03:8D70: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00CD83 03:8D73: 29 20     AND #con_state_20
...
bra_8D89:
C - - - - - 0x00CD99 03:8D89: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00CD9C 03:8D8C: 29 20     AND #con_state_20
...
C - - - - - 0x00CDFD 03:8DED: B9 F6 8D  LDA tbl_8DF5 + 1,Y
...
tbl_8DF5:
- D 0 - - - 0x00CE05 03:8DF5: 15 8E     .word off_8E15_00_япония
- D 0 - - - 0x00CE07 03:8DF7: 35 8E     .word off_8E35_01_корея
- - - - - - 0x00CE09 03:8DF9: 55 8E     .word off_8E55_02_монголия
- D 0 - - - 0x00CE0B 03:8DFB: 35 8E     .word off_8E35_03_таиланд
- - - - - - 0x00CE0D 03:8DFD: 15 8E     .word off_8E15_04
- D 0 - - - 0x00CE0F 03:8DFF: 35 8E     .word off_8E35_05_гвинея
- - - - - - 0x00CE11 03:8E01: 75 8E     .word off_8E75_06_сенегал
- - - - - - 0x00CE13 03:8E03: 35 8E     .word off_8E35_07_камерун
- - - - - - 0x00CE15 03:8E05: 15 8E     .word off_8E15_08
- - - - - - 0x00CE17 03:8E07: 35 8E     .word off_8E35_09_германия
- - - - - - 0x00CE19 03:8E09: 35 8E     .word off_8E35_0A_англия
- - - - - - 0x00CE1B 03:8E0B: 95 8E     .word off_8E95_0B_италия
- - - - - - 0x00CE1D 03:8E0D: 15 8E     .word off_8E15_0C
- - - - - - 0x00CE1F 03:8E0F: 35 8E     .word off_8E35_0D_бразилия
- - - - - - 0x00CE21 03:8E11: 35 8E     .word off_8E35_0E_аргентина
- D 0 - - - 0x00CE23 03:8E13: 35 8E     .word off_8E35_0F_мексика
...
off_8E35_05_гвинея:
off_8E35_07_камерун:
off_8E35_09_германия:
off_8E35_0A_англия:
off_8E35_0D_бразилия:
off_8E35_0E_аргентина:
off_8E35_0F_мексика:
...
ofs_8ED9_0F:
ofs_8ED9_05:
C - - J - - 0x00CEE9 03:8ED9: A9 10     LDA #con_action_подкинуть_мяч_через_себя
C - - - - - 0x00CEEB 03:8EDB: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00CEF1 03:8EE1: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00CEF4 03:8EE4: 38        SEC
C - - - - - 0x00CEF5 03:8EE5: FD 4D 03  SBC ram_pos_Y_lo_игрока,X
C - - - - - 0x00CEF8 03:8EE8: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00CEFB 03:8EEB: FD 60 03  SBC ram_pos_Y_hi_игрока,X
C - - - - - 0x00CEFE 03:8EEE: 10 0B     BPL bra_8EFB
C - - - - - 0x00CF00 03:8EF0: A9 00     LDA #$00
C - - - - - 0x00CF02 03:8EF2: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00CF05 03:8EF5: A9 24     LDA #con_action_24
C - - - - - 0x00CF07 03:8EF7: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00CF0A 03:8EFA: 60        RTS
bra_8EFB:
C - - - - - 0x00CF0B 03:8EFB: A9 80     LDA #$80
C - - - - - 0x00CF0D 03:8EFD: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00CF10 03:8F00: A9 24     LDA #con_action_24
C - - - - - 0x00CF12 03:8F02: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00CF15 03:8F05: 60        RTS



ofs_8F06_00:
C - - J - - 0x00CF16 03:8F06: A9 0F     LDA #con_action_споткнуться
C - - - - - 0x00CF18 03:8F08: 9D 79 04  STA ram_next_действие_игрока,X
...
ofs_8F12_04:
ofs_8F12_0C:
C D 0 - - - 0x00CF22 03:8F12: BD 86 04  LDA ram_состояние_игрока,X
...
- - - - - - 0x00CF44 03:8F34: 9D B0 04  STA ram_смена_угла_движения,X
...
bra_8F49:
- - - - - - 0x00CF59 03:8F49: BD 99 03  LDA ram_pos_Z_hi_игрока,X
- - - - - - 0x00CF5C 03:8F4C: 30 0A     BMI bra_8F58
- - - - - - 0x00CF5E 03:8F4E: BD 86 03  LDA ram_pos_Z_lo_игрока,X
...
bra_8F58:
- - - - - - 0x00CF68 03:8F58: BD 86 04  LDA ram_состояние_игрока,X
- - - - - - 0x00CF6B 03:8F5B: 29 10     AND #con_state_стоит_на_мяче
- - - - - - 0x00CF6D 03:8F5D: F0 05     BEQ bra_8F64
- - - - - - 0x00CF6F 03:8F5F: A9 10     LDA #con_action_подкинуть_мяч_через_себя
- - - - - - 0x00CF71 03:8F61: 4C 66 8F  BNE bra_8F66_запись_действия
bra_8F64:
- - - - - - 0x00CF74 03:8F64: A9 30     LDA #con_action_прыжок_обычный
bra_8F66_запись_действия:
- - - - - - 0x00CF76 03:8F66: 9D 79 04  STA ram_next_действие_игрока,X
- - - - - - 0x00CF79 03:8F69: 60        RTS
bra_8F6A:
- - - - - - 0x00CF7A 03:8F6A: A9 39     LDA #con_action_39
- - - - - - 0x00CF7C 03:8F6C: 9D 79 04  STA ram_next_действие_игрока,X
...
ofs_8FBB_12:
ofs_8FBB_13:
C D 0 - - - 0x00CFCB 03:8FBB: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00CFCE 03:8FBE: D0 0A     BNE bra_8FCA
C - - - - - 0x00CFD0 03:8FC0: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00CFD3 03:8FC3: C9 40     CMP #$40
C - - - - - 0x00CFD5 03:8FC5: 90 0D     BCC bra_8FD4
C - - - - - 0x00CFD7 03:8FC7: 4C E4 8F  JMP loc_8FE4
bra_8FCA:
C - - - - - 0x00CFDA 03:8FCA: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
...
bra_8FF9:
loc_8FF9:
C D 0 - - - 0x00D009 03:8FF9: B9 2C 00  LDA ram_002C,Y
...
loc_9028:
C D 0 - - - 0x00D038 03:9028: B9 2C 00  LDA ram_002C,Y
...
loc_9038:
C D 0 - - - 0x00D048 03:9038: A9 0A     LDA #con_action_0A
C - - - - - 0x00D04A 03:903A: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00D06B 03:905B: 20 35 C0  JSR sub_0x01F6A1
...
bra_90A4:
C - - - - - 0x00D0B4 03:90A4: A9 09     LDA #con_action_09
C - - - - - 0x00D0B6 03:90A6: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D0B9 03:90A9: A9 FF     LDA #$FF
C - - - - - 0x00D0BB 03:90AB: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00D0D1 03:90C1: AD 92 04  LDA ram_состояние_мяча
...
ofs_90CC_19:
ofs_90CC_1E:
C - - J - - 0x00D0DC 03:90CC: AD 17 05  LDA ram_pos_X_lo_подающий
C - - - - - 0x00D0DF 03:90CF: 85 32     STA ram_0032
C - - - - - 0x00D0E1 03:90D1: AD 18 05  LDA ram_pos_X_hi_подающий
C - - - - - 0x00D0E4 03:90D4: 85 33     STA ram_0033
C - - - - - 0x00D0E6 03:90D6: AD 19 05  LDA ram_pos_Y_lo_подающий
C - - - - - 0x00D0E9 03:90D9: 85 34     STA ram_0034
C - - - - - 0x00D0EB 03:90DB: AD 1A 05  LDA ram_pos_Y_hi_подающий
C - - - - - 0x00D0EE 03:90DE: 85 35     STA ram_0035
C - - - - - 0x00D0F0 03:90E0: 20 4B AE  JSR sub_AE4B
C - - - - - 0x00D0F3 03:90E3: 20 5F 98  JSR sub_985F
C - - - - - 0x00D0F6 03:90E6: BD B0 04  LDA ram_смена_угла_движения,X
...
ofs_90F1_17:
C - - J - - 0x00D101 03:90F1: A9 16     LDA #con_action_16
C - - - - - 0x00D103 03:90F3: 9D 79 04  STA ram_next_действие_игрока,X
...
ofs_90F7_1A:
ofs_90F7_1F:
C - - J - - 0x00D107 03:90F7: A9 1A     LDA #con_action_1A
C - - - - - 0x00D109 03:90F9: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00D119 03:9109: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D11C 03:910C: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x00D11F 03:910F: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D122 03:9112: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00D125 03:9115: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D128 03:9118: AD 6C 03  LDA ram_pos_Y_hi_мяча
C - - - - - 0x00D12B 03:911B: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00D142 03:9132: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D145 03:9135: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00D148 03:9138: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00D14B 03:913B: AD 17 05  LDA ram_pos_X_lo_подающий
C - - - - - 0x00D14E 03:913E: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D151 03:9141: AD 18 05  LDA ram_pos_X_hi_подающий
C - - - - - 0x00D154 03:9144: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D157 03:9147: 20 37 AE  JSR sub_AE37
C - - - - - 0x00D15A 03:914A: 20 5F 98  JSR sub_985F
C - - - - - 0x00D15D 03:914D: BD B0 04  LDA ram_смена_угла_движения,X
...
C - - - - - 0x00D16B 03:915B: C9 22     CMP #con_ai_22
C - - - - - 0x00D16D 03:915D: D0 06     BNE bra_9165
C - - - - - 0x00D16F 03:915F: BD C7 84  LDA tbl_84CD - 6,X
...
C - - - - - 0x00D194 03:9184: 20 35 C0  JSR sub_0x01F6A1
...
C - - - - - 0x00D1C2 03:91B2: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D1C5 03:91B5: A5 2F     LDA ram_002F
C - - - - - 0x00D1C7 03:91B7: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D1CA 03:91BA: A5 30     LDA ram_0030
C - - - - - 0x00D1CC 03:91BC: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D1CF 03:91BF: A5 31     LDA ram_0031
C - - - - - 0x00D1D1 03:91C1: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00D238 03:9228: 20 35 C0  JSR sub_0x01F6A1
...
C - - - - - 0x00D26B 03:925B: B9 64 92  LDA tbl_9263 + 1,Y
...
bra_927E:
C - - - - - 0x00D28E 03:927E: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00D291 03:9281: 10 0C     BPL bra_928F_не_в_воздухе
C - - - - - 0x00D293 03:9283: BD 86 03  LDA ram_pos_Z_lo_игрока,X
C - - - - - 0x00D296 03:9286: C9 12     CMP #$12
C - - - - - 0x00D298 03:9288: 90 22     BCC bra_92AC_RTS
C - - - - - 0x00D29A 03:928A: A9 37     LDA #con_action_37
C - - - - - 0x00D29C 03:928C: 4C 9A 92  JMP loc_929A_запись_действия
bra_928F_не_в_воздухе:
...
C - - - - - 0x00D2A8 03:9298: A9 09     LDA #con_action_09
loc_929A_запись_действия:
C D 0 - - - 0x00D2AA 03:929A: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D2AD 03:929D: A9 FF     LDA #$FF
C - - - - - 0x00D2AF 03:929F: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00D2B2 03:92A2: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00D2DF 03:92CF: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
bra_92DA_не_в_воздухе:
C - - - - - 0x00D2EA 03:92DA: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00D2ED 03:92DD: 29 10     AND #con_state_стоит_на_мяче
C - - - - - 0x00D2EF 03:92DF: F0 05     BEQ bra_92E6
C - - - - - 0x00D2F1 03:92E1: A9 10     LDA #con_action_подкинуть_мяч_через_себя
C - - - - - 0x00D2F3 03:92E3: 4C E8 92  BNE bra_92E8_запись_действия
bra_92E6:
C - - - - - 0x00D2F6 03:92E6: A9 30     LDA #con_action_прыжок_обычный
bra_92E8_запись_действия:
...
bra_92FD:
C - - - - - 0x00D30D 03:92FD: 20 41 C0  JSR sub_0x01FA7D
...
bra_9337:
C - - - - - 0x00D347 03:9337: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00D388 03:9378: B9 99 03  LDA ram_pos_Z_hi_игрока,Y
C - - - - - 0x00D38B 03:937B: 30 0A     BMI bra_9387
C - - - - - 0x00D38D 03:937D: B9 86 03  LDA ram_pos_Z_lo_игрока,Y
C - - - - - 0x00D390 03:9380: C9 18     CMP #$18
C - - - - - 0x00D392 03:9382: 90 03     BCC bra_9387
C - - - - - 0x00D394 03:9384: 4C F4 93  JMP loc_93F4
bra_9387:
C - - - - - 0x00D397 03:9387: 20 41 C0  JSR sub_0x01FA7D
...
loc_93D7:
C D 0 - - - 0x00D3E7 03:93D7: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00D3EA 03:93DA: A9 31     LDA #con_action_31
C - - - - - 0x00D3EC 03:93DC: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00D3F8 03:93E8: D0 05     BNE bra_93EF_RTS    ; если это подкат
...
C - - - - - 0x00D42E 03:941E: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00D451 03:9441: A9 32     LDA #con_action_32
C - - - - - 0x00D453 03:9443: 4C 4D 94  BNE bra_944D_запись_действия
bra_9446:
C - - - - - 0x00D456 03:9446: A9 33     LDA #con_action_33
C - - - - - 0x00D458 03:9448: 4C 4D 94  BNE bra_944D_запись_действия
bra_944B:
C - - - - - 0x00D45B 03:944B: A9 34     LDA #con_action_34
bra_944D_запись_действия:
C D 0 - - - 0x00D45D 03:944D: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D460 03:9450: A9 FF     LDA #$FF
C - - - - - 0x00D462 03:9452: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00D4BC 03:94AC: B9 2B 95  LDA tbl_952B_координаты_положения_кипера_в_раме,Y
C - - - - - 0x00D4BF 03:94AF: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D4C2 03:94B2: B9 2C 95  LDA tbl_952C,Y
C - - - - - 0x00D4C5 03:94B5: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D4C8 03:94B8: B9 2D 95  LDA tbl_952D,Y
C - - - - - 0x00D4CB 03:94BB: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D4CE 03:94BE: B9 2E 95  LDA tbl_952E,Y
C - - - - - 0x00D4D1 03:94C1: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00D4E0 03:94D0: BD B0 04  LDA ram_смена_угла_движения,X
...
C - - - - - 0x00D4FC 03:94EC: C9 2D     CMP #con_action_2D
C - - - - - 0x00D4FE 03:94EE: F0 22     BEQ bra_9512
C - - - - - 0x00D500 03:94F0: C9 2E     CMP #con_action_2E
C - - - - - 0x00D502 03:94F2: F0 1E     BEQ bra_9512
C - - - - - 0x00D504 03:94F4: C9 3C     CMP #con_action_3C
C - - - - - 0x00D506 03:94F6: F0 1A     BEQ bra_9512
C - - - - - 0x00D508 03:94F8: C9 3D     CMP #con_action_3D
C - - - - - 0x00D50A 03:94FA: F0 16     BEQ bra_9512
C - - - - - 0x00D50C 03:94FC: C9 59     CMP #con_action_59
C - - - - - 0x00D50E 03:94FE: F0 12     BEQ bra_9512
C - - - - - 0x00D510 03:9500: C9 5A     CMP #con_action_5A
C - - - - - 0x00D512 03:9502: F0 0E     BEQ bra_9512
C - - - - - 0x00D514 03:9504: A9 0A     LDA #con_action_0A
C - - - - - 0x00D516 03:9506: 9D 79 04  STA ram_next_действие_игрока,X
...
bra_9525_бежит:
C - - - - - 0x00D535 03:9525: A9 0F     LDA #con_action_споткнуться
C - - - - - 0x00D537 03:9527: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D53A 03:952A: 60        RTS



tbl_952B_координаты_положения_кипера_в_раме:
- D 0 - - - 0x00D53B 03:952B: C2        .byte $C2   ; Младшая координата x (у левых ворот для кипера x0A)
tbl_952C:
- D 0 - - - 0x00D53C 03:952C: 00        .byte $00   ; Старшая координата X (у левых ворот для кипера x0A)
tbl_952D:
- D 0 - - - 0x00D53D 03:952D: C0        .byte $C0   ; Младшая координата y (у левых ворот для кипера x0A)
tbl_952E:
- D 0 - - - 0x00D53E 03:952E: 00        .byte $00   ; Старшая координата Y (левых ворот для кипера x0A)
- D 0 - - - 0x00D53F 03:952F: 47        .byte $47   ; Младшая координата x (правых ворот для кипера x0B)
- D 0 - - - 0x00D540 03:9530: 03        .byte $03   ; Старшая координата X (правых ворот для кипера x0B)
- D 0 - - - 0x00D541 03:9531: C0        .byte $C0   ; Младшая координата y (правых ворот для кипера x0B)
- D 0 - - - 0x00D542 03:9532: 00        .byte $00   ; Старшая координата Y (правых ворот для кипера x0B)
...
C - - - - - 0x00D54F 03:953F: B9 86 04  LDA ram_состояние_игрока,Y
C - - - - - 0x00D552 03:9542: 30 03     BMI bra_9547_в_воздухе
C - - - - - 0x00D554 03:9544: 4C FE 95  JMP loc_95FE
bra_9547_в_воздухе:
C - - - - - 0x00D557 03:9547: 20 41 C0  JSR sub_0x01FA7D
...
- - - - - - 0x00D587 03:9577: BD B0 04  LDA ram_смена_угла_движения,X
- - - - - - 0x00D58A 03:957A: 29 80     AND #$80
- - - - - - 0x00D58C 03:957C: 18        CLC
- - - - - - 0x00D58D 03:957D: 69 40     ADC #$40
- - - - - - 0x00D58F 03:957F: 9D B0 04  STA ram_смена_угла_движения,X
- - - - - - 0x00D592 03:9582: A9 41     LDA #con_action_41
- - - - - - 0x00D594 03:9584: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00D5B2 03:95A2: BD B0 04  LDA ram_смена_угла_движения,X
C - - - - - 0x00D5B5 03:95A5: 29 80     AND #$80
C - - - - - 0x00D5B7 03:95A7: 18        CLC
C - - - - - 0x00D5B8 03:95A8: 69 40     ADC #$40
C - - - - - 0x00D5BA 03:95AA: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00D5BD 03:95AD: A9 54     LDA #con_action_54
C - - - - - 0x00D5BF 03:95AF: 9D 79 04  STA ram_next_действие_игрока,X
...
C - - - - - 0x00D5DD 03:95CD: BD B0 04  LDA ram_смена_угла_движения,X
C - - - - - 0x00D5E0 03:95D0: 18        CLC
C - - - - - 0x00D5E1 03:95D1: 69 40     ADC #$40
C - - - - - 0x00D5E3 03:95D3: 29 80     AND #$80
C - - - - - 0x00D5E5 03:95D5: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x00D5E8 03:95D8: A9 3E     LDA #con_action_3E
C - - - - - 0x00D5EA 03:95DA: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D5ED 03:95DD: 60        RTS
bra_95DE:
C - - - - - 0x00D5EE 03:95DE: AC D6 04  LDY ram_игрок_с_мячом
C - - - - - 0x00D5F1 03:95E1: A5 34     LDA ram_0034
C - - - - - 0x00D5F3 03:95E3: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D5F6 03:95E6: A5 35     LDA ram_0035
C - - - - - 0x00D5F8 03:95E8: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00D5FB 03:95EB: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x00D5FE 03:95EE: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D601 03:95F1: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x00D604 03:95F4: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
...
- - - - - - 0x00D62B 03:961B: BD B0 04  LDA ram_смена_угла_движения,X
- - - - - - 0x00D62E 03:961E: 18        CLC
- - - - - - 0x00D62F 03:961F: 69 40     ADC #$40
- - - - - - 0x00D631 03:9621: 29 80     AND #$80
- - - - - - 0x00D633 03:9623: 9D B0 04  STA ram_смена_угла_движения,X
- - - - - - 0x00D636 03:9626: A9 28     LDA #con_action_28
- - - - - - 0x00D638 03:9628: 9D 79 04  STA ram_next_действие_игрока,X
...
ofs_962F_29:
C - - J - - 0x00D63F 03:962F: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00D642 03:9632: D0 0A     BNE bra_963E
C - - - - - 0x00D644 03:9634: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
...
C - - - - - 0x00D650 03:9640: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00D653 03:9643: A9 FF     LDA #$FF
C - - - - - 0x00D655 03:9645: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D658 03:9648: 4C 64 96  JMP loc_9664
bra_964B:
C - - - - - 0x00D65B 03:964B: A9 00     LDA #$00
C - - - - - 0x00D65D 03:964D: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00D660 03:9650: A9 92     LDA #$92
C - - - - - 0x00D662 03:9652: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D665 03:9655: 4C 64 96  JMP loc_9664
loc_9658:
C D 0 - - - 0x00D668 03:9658: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00D66B 03:965B: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D66E 03:965E: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00D671 03:9661: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
loc_9664:
...
C - - - - - 0x00D682 03:9672: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D685 03:9675: A9 00     LDA #$00
C - - - - - 0x00D687 03:9677: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D68A 03:967A: 4C 96 96  JMP loc_9696
bra_967D:
C - - - - - 0x00D68D 03:967D: A9 02     LDA #$02
C - - - - - 0x00D68F 03:967F: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D692 03:9682: A9 FF     LDA #$FF
C - - - - - 0x00D694 03:9684: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D697 03:9687: 4C 96 96  JMP loc_9696
loc_968A:
C D 0 - - - 0x00D69A 03:968A: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x00D69D 03:968D: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D6A0 03:9690: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x00D6A3 03:9693: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
loc_9696:
...
C - - - - - 0x00D6B5 03:96A5: B9 14 03  LDA ram_pos_X_lo_игрока,Y
...
C - - - - - 0x00D6BF 03:96AF: B9 27 03  LDA ram_pos_X_hi_игрока,Y
...
bra_96BB:
C - - - - - 0x00D6CB 03:96BB: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x00D6CE 03:96BE: 85 1C     STA ram_001C
C - - - - - 0x00D6D0 03:96C0: B9 27 03  LDA ram_pos_X_hi_игрока,Y
...
bra_96D3:
C - - - - - 0x00D6E3 03:96D3: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00D6E6 03:96D6: D0 0D     BNE bra_96E5
C - - - - - 0x00D6E8 03:96D8: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
...
bra_96E5:
C - - - - - 0x00D6F5 03:96E5: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00D6F8 03:96E8: C9 20     CMP #$20
C - - - - - 0x00D6FA 03:96EA: B0 F6     BCS bra_96E2
loc_96EC:
C D 0 - - - 0x00D6FC 03:96EC: 20 41 C0  JSR sub_0x01FA7D
...
ofs_972D_2B:
C - - J - - 0x00D73D 03:972D: AD 92 04  LDA ram_состояние_мяча
C - - - - - 0x00D740 03:9730: 29 40     AND #$40
C - - - - - 0x00D742 03:9732: D0 12     BNE bra_9746
C - - - - - 0x00D744 03:9734: AD A5 03  LDA ram_pos_Z_hi_мяча
C - - - - - 0x00D747 03:9737: 30 0A     BMI bra_9743
C - - - - - 0x00D749 03:9739: AD 92 03  LDA ram_pos_Z_lo_мяча
...
bra_9746:
C - - - - - 0x00D756 03:9746: BD 86 04  LDA ram_состояние_игрока,X
C - - - - - 0x00D759 03:9749: 10 24     BPL bra_9779_не_в_воздухе
C - - - - - 0x00D75B 03:974B: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
- - - - - - 0x00D76A 03:975A: A9 38     LDA #con_action_38
- - - - - - 0x00D76C 03:975C: 4C 66 97  BNE bra_9766_запись_действия
bra_975F:
C - - - - - 0x00D76F 03:975F: A9 46     LDA #con_action_46
C - - - - - 0x00D771 03:9761: 4C 66 97  BNE bra_9766_запись_действия
bra_9764:
- - - - - - 0x00D774 03:9764: A9 37     LDA #con_action_37
bra_9766_запись_действия:
C D 0 - - - 0x00D776 03:9766: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D779 03:9769: A9 FF     LDA #$FF
C - - - - - 0x00D77B 03:976B: 9D B0 04  STA ram_смена_угла_движения,X
bra_976E_RTS:
C - - - - - 0x00D77E 03:976E: 60        RTS

bra_9779_не_в_воздухе:
C - - - - - 0x00D789 03:9779: AD 8F 06  LDA ram_rng_байт_pos_удара_бота_пк
...
C - - - - - 0x00D797 03:9787: 9D 20 06  STA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00D79A 03:978A: A9 03     LDA #$03
C - - - - - 0x00D79C 03:978C: 69 00     ADC #$00
C - - - - - 0x00D79E 03:978E: 9D 2C 06  STA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00D7A1 03:9791: AD 8F 06  LDA ram_rng_байт_pos_удара_бота_пк
...
C - - - - - 0x00D7B0 03:97A0: 9D 38 06  STA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00D7B3 03:97A3: A9 00     LDA #$00
C - - - - - 0x00D7B5 03:97A5: 69 00     ADC #$00
C - - - - - 0x00D7B7 03:97A7: 9D 44 06  STA ram_pos_Y_hi_точка_удара_бота,X
...
C - - - - - 0x00D7C8 03:97B8: BD B0 04  LDA ram_смена_угла_движения,X
C - - - - - 0x00D7CB 03:97BB: C9 FF     CMP #$FF
C - - - - - 0x00D7CD 03:97BD: D0 03     BNE bra_97C2_есть_направление_движения
C - - - - - 0x00D7CF 03:97BF: 4C DF 97  JMP loc_97DF_нет_направления_движения
...
C - - - - - 0x00D7D6 03:97C6: A9 21     LDA #con_action_бег
...
C - - - - - 0x00D7E5 03:97D5: C9 21     CMP #con_action_бег
C - - - - - 0x00D7E7 03:97D7: D0 F2     BEQ bra_97CB_если_бег
- - - - - - 0x00D7DB 03:97CB: A9 0F     LDA #con_action_споткнуться
- - - - - - 0x00D7DD 03:97CD: 4C DB 97  BNE bra_97DB_запись_действия
bra_97CB_если_бег:
C - - - - - 0x00D7E9 03:97D9: A9 20     LDA #con_action_ходьба_пешком
bra_97DB_запись_действия:
C D 0 - - - 0x00D7EB 03:97DB: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x00D7EE 03:97DE: 60        RTS
loc_97DF_нет_направления_движения:
C - - - - - 0x00D7FB 03:97EB: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
C - - - - - 0x00D7FE 03:97EE: 29 03     AND #$03
C - - - - - 0x00D800 03:97F0: F0 0B     BEQ bra_97FD_обычный_прыжок
C - - - - - 0x00D802 03:97F2: C9 01     CMP #$01
C - - - - - 0x00D804 03:97F4: F0 0C     BEQ bra_9802_подкидывает_мяч_через_себя
...
C - - - - - 0x00D80D 03:97FD: A9 30     LDA #con_action_прыжок_обычный
C - - - - - 0x00D80F 03:97FF: 4C 0E 98  BNE bra_980E_запись_действия
bra_9802_подкидывает_мяч_через_себя:
C - - - - - 0x00D812 03:9802: A9 10     LDA #con_action_подкинуть_мяч_через_себя
C - - - - - 0x00D814 03:9804: 4C 0E 98  BNE bra_980E_запись_действия
bra_9807_подкидывает_мяч_вверх_коленом:
- - - - - - 0x00D817 03:9807: A9 0E     LDA #con_action_подкинуть_мяч_коленом
- - - - - - 0x00D819 03:9809: 4C 0E 98  BNE bra_980E_запись_действия
loc_980C_удар_по_мячу_с_земли_если_владеешь:
C D 0 - - - 0x00D81C 03:980C: A9 09     LDA #con_action_09  ; lda #удар по мячу если владеешь
bra_980E_запись_действия:
C D 0 - - - 0x00D81E 03:980E: 9D 79 04  STA ram_next_действие_игрока,X
...
; bzk баг возможно, типа продолжение таблицы
sub_985F:
C D 0 - I - 0x00D86F 03:985F: BD 68 06  LDA ram_счетчик_поведения_ботов,X
...
C - - - - - 0x00D904 03:98F4: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
...
C - - - - - 0x00D96F 03:995F: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
C - - - - - 0x00D9AB 03:999B: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
...
C - - - - - 0x00D9BD 03:99AD: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
...
sub_99B5:
C - - - - - 0x00D9C5 03:99B5: B9 99 03  LDA ram_pos_Z_hi_игрока,Y
C - - - - - 0x00D9C8 03:99B8: 30 0A     BMI bra_99C4
C - - - - - 0x00D9CA 03:99BA: B9 86 03  LDA ram_pos_Z_lo_игрока,Y
C - - - - - 0x00D9CD 03:99BD: C9 18     CMP #$18
C - - - - - 0x00D9CF 03:99BF: 90 03     BCC bra_99C4
C - - - - - 0x00D9D1 03:99C1: 4C E2 99  JMP loc_99E2
bra_99C4:
C - - - - - 0x00D9D4 03:99C4: B9 2E 04  LDA ram_spd_Z_hi_игрока,Y
C - - - - - 0x00D9D7 03:99C7: 19 20 04  ORA ram_spd_Z_lo_игрока,Y
C - - - - - 0x00D9DA 03:99CA: F0 03     BEQ bra_99CF
C - - - - - 0x00D9DC 03:99CC: 4C E2 99  JMP loc_99E2
bra_99CF:
C - - - - - 0x00D9DF 03:99CF: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00DA5E 03:9A4E: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x00DA61 03:9A51: D0 0A     BNE bra_9A5D
C - - - - - 0x00DA63 03:9A53: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00DA66 03:9A56: C9 40     CMP #$40
C - - - - - 0x00DA68 03:9A58: 90 0D     BCC bra_9A67
C - - - - - 0x00DA6A 03:9A5A: 4C 7A 9A  JMP loc_9A7A
bra_9A5D:
C - - - - - 0x00DA6D 03:9A5D: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
...
loc_9A7A:
C D 0 - - - 0x00DA8A 03:9A7A: BD 27 03  LDA ram_pos_X_hi_игрока,X
...
bra_9A86:
C - - - - - 0x00DA96 03:9A86: BD 14 03  LDA ram_pos_X_lo_игрока,X
C - - - - - 0x00DA99 03:9A89: C9 C0     CMP #$C0
C - - - - - 0x00DA9B 03:9A8B: 90 0D     BCC bra_9A9A
C - - - - - 0x00DA9D 03:9A8D: 4C AD 9A  RTS
bra_9A90:
C - - - - - 0x00DAA0 03:9A90: BD 14 03  LDA ram_pos_X_lo_игрока,X
...
loc_9ABC:
C D 0 - - - 0x00DACC 03:9ABC: B9 2D 00  LDA ram_002D,Y
C - - - - - 0x00DACF 03:9ABF: 38        SEC
C - - - - - 0x00DAD0 03:9AC0: FD B0 04  SBC ram_смена_угла_движения,X
...
- - - - - - 0x00DB96 03:9B86: BD E4 04  LDA ram_сила_игрока,X
...
- - - - - - 0x00DBA6 03:9B96: BD E4 04  LDA ram_сила_игрока,X
...
C - - - - - 0x00DBF1 03:9BE1: 90 F8     BCC bra_9BDB_loop
...
bra_9BF6:
C - - - - - 0x00DC06 03:9BF6: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00DC83 03:9C73: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00DCA5 03:9C95: AD 92 04  LDA ram_состояние_мяча
...
bra_9CC8_был_отдан_новый_приказ:
C - - - - - 0x00DCD8 03:9CC8: A5 1C     LDA ram_001C
C - - - - - 0x00DCDA 03:9CCA: 0A        ASL
C - - - - - 0x00DCDB 03:9CCB: A8        TAY
C - - - - - 0x00DCDC 03:9CCC: B9 D9 9C  LDA tbl_9CD9_приказы,Y
C - - - - - 0x00DCDF 03:9CCF: 85 2C     STA ram_002C
C - - - - - 0x00DCE1 03:9CD1: B9 DA 9C  LDA tbl_9CD9_приказы + 1,Y
C - - - - - 0x00DCE4 03:9CD4: 85 2D     STA ram_002D
C - - - - - 0x00DCE6 03:9CD6: 6C 2C 00  JMP (ram_002C)

tbl_9CD9_приказы:
- D 0 - - - 0x00DCE9 03:9CD9: E1 9C     .word ofs_9CE1_00_пас
- D 0 - - - 0x00DCEB 03:9CDB: 2C 9D     .word ofs_9D2C_01_удар
- D 0 - - - 0x00DCED 03:9CDD: 60 9D     .word ofs_9D60_02_подкат
- D 0 - - - 0x00DCEF 03:9CDF: 73 9D     .word ofs_9D73_03_локоть



ofs_9CE1_00_пас:
C - - J - - 0x00DCF1 03:9CE1: 20 94 9E  JSR sub_9E94_выбор_текста_приказа
C - - - - - 0x00DCF4 03:9CE4: 20 4A 9E  JSR sub_9E4A
C - - - - - 0x00DCF7 03:9CE7: 29 01     AND #$01
C - - - - - 0x00DCF9 03:9CE9: F0 09     BEQ bra_9CF4_бот_согласен
C - - - - - 0x00DCFB 03:9CEB: A9 34     LDA #con_sfx_no
C - - - - - 0x00DCFD 03:9CED: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
C - - - - - 0x00DD00 03:9CF0: 20 02 9F  JSR sub_9F02_выбор_отрицательного_ответа_на_приказ
C - - - - - 0x00DD03 03:9CF3: 60        RTS
bra_9CF4_бот_согласен:
C - - - - - 0x00DD04 03:9CF4: A9 33     LDA #con_sfx_yes
C - - - - - 0x00DD06 03:9CF6: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
C - - - - - 0x00DD09 03:9CF9: A5 1C     LDA ram_001C    ; перезаписать приказ
C - - - - - 0x00DD0B 03:9CFB: 9D 78 06  STA ram_приказ_боту,X
C - - - - - 0x00DD0E 03:9CFE: 20 09 9F  JSR sub_9F09_выбор_положительного_ответа_на_приказ
...
C - - - - - 0x00DD25 03:9D15: D9 27 03  CMP ram_pos_X_hi_игрока,Y
...
C - - - - - 0x00DD49 03:9D39: 20 94 9E  JSR sub_9E94_выбор_текста_приказа
C - - - - - 0x00DD4C 03:9D3C: 20 4A 9E  JSR sub_9E4A
C - - - - - 0x00DD4F 03:9D3F: 29 02     AND #$02
C - - - - - 0x00DD51 03:9D41: F0 09     BEQ bra_9D4C_бот_согласен
C - - - - - 0x00DD53 03:9D43: A9 34     LDA #con_sfx_no
C - - - - - 0x00DD55 03:9D45: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
C - - - - - 0x00DD58 03:9D48: 20 02 9F  JSR sub_9F02_выбор_отрицательного_ответа_на_приказ
C - - - - - 0x00DD5B 03:9D4B: 60        RTS
bra_9D4C_бот_согласен:
C - - - - - 0x00DD5C 03:9D4C: A9 33     LDA #con_sfx_yes
C - - - - - 0x00DD5E 03:9D4E: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
C - - - - - 0x00DD61 03:9D51: A5 1C     LDA ram_001C    ; перезаписать приказ
C - - - - - 0x00DD63 03:9D53: 9D 78 06  STA ram_приказ_боту,X
C - - - - - 0x00DD66 03:9D56: 20 09 9F  JSR sub_9F09_выбор_положительного_ответа_на_приказ
...
ofs_9D60_02_подкат:
C - - J - - 0x00DD70 03:9D60: 20 94 9E  JSR sub_9E94_выбор_текста_приказа
C - - - - - 0x00DD73 03:9D63: 20 4A 9E  JSR sub_9E4A
C - - - - - 0x00DD76 03:9D66: 29 04     AND #$04
C - - - - - 0x00DD78 03:9D68: F0 E2     BEQ bra_9D4C_бот_согласен
C - - - - - 0x00DD7A 03:9D6A: A9 34     LDA #con_sfx_no
C - - - - - 0x00DD7C 03:9D6C: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
C - - - - - 0x00DD7F 03:9D6F: 20 02 9F  JSR sub_9F02_выбор_отрицательного_ответа_на_приказ
C - - - - - 0x00DD82 03:9D72: 60        RTS



ofs_9D73_03_локоть:
C - - J - - 0x00DD83 03:9D73: 20 94 9E  JSR sub_9E94_выбор_текста_приказа
C - - - - - 0x00DD86 03:9D76: 20 4A 9E  JSR sub_9E4A
C - - - - - 0x00DD89 03:9D79: 29 08     AND #$08
C - - - - - 0x00DD8B 03:9D7B: F0 CF     BEQ bra_9D4C_бот_согласен
- - - - - - 0x00DD8D 03:9D7D: A9 34     LDA #con_sfx_no
- - - - - - 0x00DD8F 03:9D7F: 20 02 C0  JSR sub_0x01C2F4_воспроизвести_звук
- - - - - - 0x00DD92 03:9D82: 20 02 9F  JSR sub_9F02_выбор_отрицательного_ответа_на_приказ
- - - - - - 0x00DD95 03:9D85: 60        RTS



sub_9D86:
C - - - - - 0x00DD96 03:9D86: AD 20 03  LDA ram_pos_X_lo_мяча
C - - - - - 0x00DD99 03:9D89: 48        PHA
C - - - - - 0x00DD9A 03:9D8A: AD 33 03  LDA ram_pos_X_hi_мяча
C - - - - - 0x00DD9D 03:9D8D: 48        PHA
C - - - - - 0x00DD9E 03:9D8E: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00DDA1 03:9D91: 48        PHA
C - - - - - 0x00DDA2 03:9D92: AD 6C 03  LDA ram_pos_Y_hi_мяча
...
C - - - - - 0x00DDBC 03:9DAC: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00DDBF 03:9DAF: A5 34     LDA ram_0034
C - - - - - 0x00DDC1 03:9DB1: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00DDC4 03:9DB4: A5 35     LDA ram_0035
C - - - - - 0x00DDC6 03:9DB6: 8D 6C 03  STA ram_pos_Y_hi_мяча
bra_9DB9:
...
C - - - - - 0x00DDD1 03:9DC1: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00DE03 03:9DF3: 8D 6C 03  STA ram_pos_Y_hi_мяча
C - - - - - 0x00DE06 03:9DF6: 68        PLA
C - - - - - 0x00DE07 03:9DF7: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00DE0A 03:9DFA: 68        PLA
C - - - - - 0x00DE0B 03:9DFB: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00DE0E 03:9DFE: 68        PLA
C - - - - - 0x00DE0F 03:9DFF: 8D 20 03  STA ram_pos_X_lo_мяча
...
C - - - - - 0x00DE1C 03:9E0C: 20 41 C0  JSR sub_0x01FA7D
...
sub_9E3D:
C - - - - - 0x00DE4D 03:9E3D: BD 04 00  LDA ram_btn_hold,X
...
C - - - - - 0x00DE7E 03:9E6E: BD E4 04  LDA ram_сила_игрока,X
...
sub_9E94_выбор_текста_приказа:
C - - - - - 0x00DEA4 03:9E94: A5 1C     LDA ram_001C
C - - - - - 0x00DEA6 03:9E96: D0 1B     BNE bra_9EB3    ; если приказ это не пас
...
C - - - - - 0x00DF0E 03:9EFE: 9D 80 06  STA ram_номер_текста_приказа,X
C - - - - - 0x00DF11 03:9F01: 60        RTS



sub_9F02_выбор_отрицательного_ответа_на_приказ:
C - - - - - 0x00DF12 03:9F02: A9 10     LDA #$10
C - - - - - 0x00DF14 03:9F04: 85 1E     STA ram_001E
C - - - - - 0x00DF16 03:9F06: 4C 0D 9F  JMP loc_9F0D

sub_9F09_выбор_положительного_ответа_на_приказ:
...
C - - - - - 0x00DF3D 03:9F2D: 9D 82 06  STA ram_номер_текста_ответа,X
...
tbl_9F53:
- - - - - - 0x00DF63 03:9F53: 06        .byte $06   ; 00 80
- - - - - - 0x00DF64 03:9F54: 22        .byte $22   ; 01 81
- - - - - - 0x00DF65 03:9F55: 08        .byte $08   ; 02 82
- - - - - - 0x00DF66 03:9F56: 03        .byte $03   ; 03 83
- - - - - - 0x00DF67 03:9F57: 15        .byte $15   ; 04 84
- - - - - - 0x00DF68 03:9F58: 1C        .byte $1C   ; 05 85
- - - - - - 0x00DF69 03:9F59: 01        .byte $01   ; 06 86
- - - - - - 0x00DF6A 03:9F5A: 06        .byte $06   ; 07 87
- - - - - - 0x00DF6B 03:9F5B: 23        .byte $23   ; 08 88
- - - - - - 0x00DF6C 03:9F5C: 33        .byte $33   ; 09 89
- - - - - - 0x00DF6D 03:9F5D: 34        .byte $34   ; 0A 8A
- - - - - - 0x00DF6E 03:9F5E: 06        .byte $06   ; 0B 8B
- - - - - - 0x00DF6F 03:9F5F: 0E        .byte $0E   ; 0C 8C
- - - - - - 0x00DF70 03:9F60: 27        .byte $27   ; 0D 8D
- - - - - - 0x00DF71 03:9F61: 33        .byte $33   ; 0E 8E
- - - - - - 0x00DF72 03:9F62: 17        .byte $17   ; 0F 8F
- D 0 - - - 0x00DF73 03:9F63: 07        .byte $07   ; 10 90
- D 0 - - - 0x00DF74 03:9F64: 08        .byte $08   ; 11 91
- D 0 - - - 0x00DF75 03:9F65: 16        .byte $16   ; 12 92
- - - - - - 0x00DF76 03:9F66: 07        .byte $07   ; 13 93
- D 0 - - - 0x00DF77 03:9F67: 00        .byte $00   ; 14 94
- D 0 - - - 0x00DF78 03:9F68: 01        .byte $01   ; 15 95
- D 0 - - - 0x00DF79 03:9F69: 03        .byte $03   ; 16 96
- D 0 - - - 0x00DF7A 03:9F6A: 02        .byte $02   ; 17 97
- D 0 - - - 0x00DF7B 03:9F6B: 12        .byte $12   ; 18 98
- D 0 - - - 0x00DF7C 03:9F6C: 13        .byte $13   ; 19 99
- D 0 - - - 0x00DF7D 03:9F6D: 17        .byte $17   ; 1A 9A
- - - - - - 0x00DF7E 03:9F6E: 12        .byte $12   ; 1B 9B
- D 0 - - - 0x00DF7F 03:9F6F: 0D        .byte $0D   ; 1C 9C
- D 0 - - - 0x00DF80 03:9F70: 11        .byte $11   ; 1D 9D
- D 0 - - - 0x00DF81 03:9F71: 0E        .byte $0E   ; 1E 9E
- D 0 - - - 0x00DF82 03:9F72: 0D        .byte $0D   ; 1F 9F
- - - - - - 0x00DF83 03:9F73: 08        .byte $08   ; 20 A0
- - - - - - 0x00DF84 03:9F74: 0C        .byte $0C   ; 21 A1
- - - - - - 0x00DF85 03:9F75: 2C        .byte $2C   ; 22 A2
- - - - - - 0x00DF86 03:9F76: 07        .byte $07   ; 23 A3
- D 0 - - - 0x00DF87 03:9F77: 15        .byte $15   ; 24 A4
- D 0 - - - 0x00DF88 03:9F78: 02        .byte $02   ; 25 A5
- D 0 - - - 0x00DF89 03:9F79: 01        .byte $01   ; 26 A6
- D 0 - - - 0x00DF8A 03:9F7A: 07        .byte $07   ; 27 A7
- D 0 - - - 0x00DF8B 03:9F7B: 16        .byte $16   ; 28 A8
- D 0 - - - 0x00DF8C 03:9F7C: 17        .byte $17   ; 29 A9
- D 0 - - - 0x00DF8D 03:9F7D: 15        .byte $15   ; 2A AA
- D 0 - - - 0x00DF8E 03:9F7E: 12        .byte $12   ; 2B AB
- D 0 - - - 0x00DF8F 03:9F7F: 0D        .byte $0D   ; 2C AC
- D 0 - - - 0x00DF90 03:9F80: 10        .byte $10   ; 2D AD
- D 0 - - - 0x00DF91 03:9F81: 0F        .byte $0F   ; 2E AE
- D 0 - - - 0x00DF92 03:9F82: 15        .byte $15   ; 2F AF
- D 0 - - - 0x00DF93 03:9F83: 07        .byte $07   ; 30 B0
- D 0 - - - 0x00DF94 03:9F84: 08        .byte $08   ; 31 B1
- - - - - - 0x00DF95 03:9F85: 16        .byte $16   ; 32 B2
- D 0 - - - 0x00DF96 03:9F86: 0B        .byte $0B   ; 33 B3
- D 0 - - - 0x00DF97 03:9F87: 00        .byte $00   ; 34 B4
- D 0 - - - 0x00DF98 03:9F88: 01        .byte $01   ; 35 B5
- D 0 - - - 0x00DF99 03:9F89: 03        .byte $03   ; 36 B6
- D 0 - - - 0x00DF9A 03:9F8A: 02        .byte $02   ; 37 B7
- D 0 - - - 0x00DF9B 03:9F8B: 12        .byte $12   ; 38 B8
- D 0 - - - 0x00DF9C 03:9F8C: 09        .byte $09   ; 39 B9
- D 0 - - - 0x00DF9D 03:9F8D: 11        .byte $11   ; 3A BA
- D 0 - - - 0x00DF9E 03:9F8E: 13        .byte $13   ; 3B BB
- D 0 - - - 0x00DF9F 03:9F8F: 0D        .byte $0D   ; 3C BC
- D 0 - - - 0x00DFA0 03:9F90: 10        .byte $10   ; 3D BD
- D 0 - - - 0x00DFA1 03:9F91: 0F        .byte $0F   ; 3E BE
- D 0 - - - 0x00DFA2 03:9F92: 0E        .byte $0E   ; 3F BF

- - - - - - 0x00DFA3 03:9F93: 23        .byte $23   ; 40 C0
- - - - - - 0x00DFA4 03:9F94: 21        .byte $21   ; 41 C1
- - - - - - 0x00DFA5 03:9F95: 15        .byte $15   ; 42 C2
- - - - - - 0x00DFA6 03:9F96: 06        .byte $06   ; 43 C3
- - - - - - 0x00DFA7 03:9F97: 15        .byte $15   ; 44 C4
- - - - - - 0x00DFA8 03:9F98: 17        .byte $17   ; 45 C5
- - - - - - 0x00DFA9 03:9F99: 11        .byte $11   ; 46 C6
- - - - - - 0x00DFAA 03:9F9A: 03        .byte $03   ; 47 C7
- - - - - - 0x00DFAB 03:9F9B: 23        .byte $23   ; 48 C8
- - - - - - 0x00DFAC 03:9F9C: 33        .byte $33   ; 49 C9
- - - - - - 0x00DFAD 03:9F9D: 0E        .byte $0E   ; 4A CA
- - - - - - 0x00DFAE 03:9F9E: 06        .byte $06   ; 4B CB
- - - - - - 0x00DFAF 03:9F9F: 0F        .byte $0F   ; 4C CC
- - - - - - 0x00DFB0 03:9FA0: 2A        .byte $2A   ; 4D CD
- - - - - - 0x00DFB1 03:9FA1: 31        .byte $31   ; 4E CE
- - - - - - 0x00DFB2 03:9FA2: 16        .byte $16   ; 4F CF
- - - - - - 0x00DFB3 03:9FA3: 07        .byte $07   ; 50 D0
- - - - - - 0x00DFB4 03:9FA4: 08        .byte $08   ; 51 D1
- D 0 - - - 0x00DFB5 03:9FA5: 16        .byte $16   ; 52 D2
- D 0 - - - 0x00DFB6 03:9FA6: 07        .byte $07   ; 53 D3
- D 0 - - - 0x00DFB7 03:9FA7: 04        .byte $04   ; 54 D4
- D 0 - - - 0x00DFB8 03:9FA8: 05        .byte $05   ; 55 D5
- D 0 - - - 0x00DFB9 03:9FA9: 07        .byte $07   ; 56 D6
- D 0 - - - 0x00DFBA 03:9FAA: 04        .byte $04   ; 57 D7
- D 0 - - - 0x00DFBB 03:9FAB: 12        .byte $12   ; 58 D8
- D 0 - - - 0x00DFBC 03:9FAC: 14        .byte $14   ; 59 D9
- D 0 - - - 0x00DFBD 03:9FAD: 17        .byte $17   ; 5A DA
- D 0 - - - 0x00DFBE 03:9FAE: 12        .byte $12   ; 5B DB
- D 0 - - - 0x00DFBF 03:9FAF: 11        .byte $11   ; 5C DC
- - - - - - 0x00DFC0 03:9FB0: 10        .byte $10   ; 5D DD
- D 0 - - - 0x00DFC1 03:9FB1: 0E        .byte $0E   ; 5E DE
- D 0 - - - 0x00DFC2 03:9FB2: 11        .byte $11   ; 5F DF
- - - - - - 0x00DFC3 03:9FB3: 08        .byte $08   ; 60 E0
- - - - - - 0x00DFC4 03:9FB4: 0C        .byte $0C   ; 61 E1
- - - - - - 0x00DFC5 03:9FB5: 2C        .byte $2C   ; 62 E2
- - - - - - 0x00DFC6 03:9FB6: 07        .byte $07   ; 63 E3
- D 0 - - - 0x00DFC7 03:9FB7: 07        .byte $07   ; 64 E4
- D 0 - - - 0x00DFC8 03:9FB8: 05        .byte $05   ; 65 E5
- D 0 - - - 0x00DFC9 03:9FB9: 06        .byte $06   ; 66 E6
- D 0 - - - 0x00DFCA 03:9FBA: 15        .byte $15   ; 67 E7
- D 0 - - - 0x00DFCB 03:9FBB: 12        .byte $12   ; 68 E8
- D 0 - - - 0x00DFCC 03:9FBC: 16        .byte $16   ; 69 E9
- D 0 - - - 0x00DFCD 03:9FBD: 17        .byte $17   ; 6A EA
- D 0 - - - 0x00DFCE 03:9FBE: 12        .byte $12   ; 6B EB
- D 0 - - - 0x00DFCF 03:9FBF: 11        .byte $11   ; 6C EC
- D 0 - - - 0x00DFD0 03:9FC0: 0F        .byte $0F   ; 6D ED
- D 0 - - - 0x00DFD1 03:9FC1: 2D        .byte $2D   ; 6E EE
- D 0 - - - 0x00DFD2 03:9FC2: 15        .byte $15   ; 6F EF
- D 0 - - - 0x00DFD3 03:9FC3: 07        .byte $07   ; 70 F0
- D 0 - - - 0x00DFD4 03:9FC4: 08        .byte $08   ; 71 F1
- D 0 - - - 0x00DFD5 03:9FC5: 16        .byte $16   ; 72 F2
- - - - - - 0x00DFD6 03:9FC6: 0B        .byte $0B   ; 73 F3
- D 0 - - - 0x00DFD7 03:9FC7: 04        .byte $04   ; 74 F4
- D 0 - - - 0x00DFD8 03:9FC8: 05        .byte $05   ; 75 F5
- D 0 - - - 0x00DFD9 03:9FC9: 17        .byte $17   ; 76 F6
- D 0 - - - 0x00DFDA 03:9FCA: 03        .byte $03   ; 77 F7
- D 0 - - - 0x00DFDB 03:9FCB: 02        .byte $02   ; 78 F8
- D 0 - - - 0x00DFDC 03:9FCC: 13        .byte $13   ; 79 F9
- D 0 - - - 0x00DFDD 03:9FCD: 08        .byte $08   ; 7A FA
- D 0 - - - 0x00DFDE 03:9FCE: 11        .byte $11   ; 7B FB
- D 0 - - - 0x00DFDF 03:9FCF: 10        .byte $10   ; 7C FC
- D 0 - - - 0x00DFE0 03:9FD0: 14        .byte $14   ; 7D FD
- D 0 - - - 0x00DFE1 03:9FD1: 0F        .byte $0F   ; 7E FE
- D 0 - - - 0x00DFE2 03:9FD2: 0E        .byte $0E   ; 7F FF
...
sub_A022:
C - - - - - 0x00E032 03:A022: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00E053 03:A043: D0 01     BNE bra_A046_есть_приказ
C - - - - - 0x00E055 03:A045: 60        RTS
bra_A046_есть_приказ:
C - - - - - 0x00E056 03:A046: 0A        ASL
C - - - - - 0x00E057 03:A047: A8        TAY
C - - - - - 0x00E058 03:A048: B9 55 A0  LDA tbl_A055_приказы,Y
C - - - - - 0x00E05B 03:A04B: 85 2C     STA ram_002C
C - - - - - 0x00E05D 03:A04D: B9 56 A0  LDA tbl_A055_приказы + 1,Y
C - - - - - 0x00E060 03:A050: 85 2D     STA ram_002D
C - - - - - 0x00E062 03:A052: 6C 2C 00  JMP (ram_002C)

tbl_A055_приказы:
- D 1 - - - 0x00E065 03:A055: 5D A0     .word ofs_A05D_00_пас
- D 1 - - - 0x00E067 03:A057: 7E A0     .word ofs_A07E_01_удар
- D 1 - - - 0x00E069 03:A059: AF A0     .word ofs_A0AF_02_подкат
- D 1 - - - 0x00E06B 03:A05B: C3 A0     .word ofs_A0C3_03_локоть
...
loc_A09E:
C D 1 - - - 0x00E0AE 03:A09E: B9 68 06  LDA ram_счетчик_поведения_ботов,Y
C - - - - - 0x00E0B1 03:A0A1: 29 F0     AND #$F0
C - - - - - 0x00E0B3 03:A0A3: 09 01     ORA #$01
C - - - - - 0x00E0B5 03:A0A5: 99 68 06  STA ram_счетчик_поведения_ботов,Y
...
sub_A0D7:
C - - - - - 0x00E0E7 03:A0D7: AD 92 04  LDA ram_состояние_мяча
...
sub_A0EC:
C - - - - - 0x00E0FC 03:A0EC: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00E120 03:A110: 29 01     AND #con_state_участие_в_этажерке
...
C - - - - - 0x00E132 03:A122: B9 14 03  LDA ram_pos_X_lo_игрока,Y
...
C - - - - - 0x00E13C 03:A12C: B9 27 03  LDA ram_pos_X_hi_игрока,Y
...
bra_A139:
C - - - - - 0x00E149 03:A139: B9 14 03  LDA ram_pos_X_lo_игрока,Y
...
C - - - - - 0x00E18B 03:A17B: A9 0A     LDA #con_ai_0A
bra_8261_loop:
C - - - - - 0x00C271 03:8261: 99 5C 06  STA ram_интеллект_бота,Y
C - - - - - 0x00C274 03:8264: C8        INY
C - - - - - 0x00C275 03:8265: C8        INY
C - - - - - 0x00C276 03:8266: C0 0B     CPY #$0B    ; bzk баг? киперу справа не записывается
C - - - - - 0x00C278 03:8268: 90 F7     BCC bra_8261_loop
...
C - - - - - 0x00E1C7 03:A1B7: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00E1CA 03:A1BA: 38        SEC
C - - - - - 0x00E1CB 03:A1BB: E9 30     SBC #$30
C - - - - - 0x00E1CD 03:A1BD: 85 2C     STA ram_002C
C - - - - - 0x00E1CF 03:A1BF: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
...
C - - - - - 0x00E217 03:A207: 20 6B 82  JSR sub_826B_интеллект_в_зависимости_от_позиции
loc_A20A:
C D 1 - - - 0x00E21A 03:A20A: AC D6 04  LDY ram_игрок_с_мячом
C - - - - - 0x00E21D 03:A20D: A9 0F     LDA #con_ai_0F
...
C - - - - - 0x00E227 03:A217: C9 06     CMP #$06    ; сенегал
C - - - - - 0x00E229 03:A219: F0 13     BEQ bra_A22E
C - - - - - 0x00E22B 03:A21B: C9 0E     CMP #$0E    ; аргентина
C - - - - - 0x00E22D 03:A21D: F0 0F     BEQ bra_A22E
C - - - - - 0x00E22F 03:A21F: C9 09     CMP #$09    ; германия
C - - - - - 0x00E231 03:A221: F0 0B     BEQ bra_A22E
C - - - - - 0x00E233 03:A223: C9 0A     CMP #$0A    ; англия
C - - - - - 0x00E235 03:A225: F0 07     BEQ bra_A22E
C - - - - - 0x00E237 03:A227: C9 0B     CMP #$0B    ; италия
...
C - - - - - 0x00E25E 03:A24E: A9 23     LDA #con_ai_23
...
C - - - - - 0x00E269 03:A259: D9 27 03  CMP ram_pos_X_hi_игрока,Y
...
C - - - - - 0x00E28A 03:A27A: 20 35 C0  JSR sub_0x01F6A1
...
C - - - - - 0x00E2A0 03:A290: A9 04     LDA #con_ai_04
...
C - - - - - 0x00E2E1 03:A2D1: A9 27     LDA #con_ai_27
...
C - - - - - 0x00E2EC 03:A2DC: A9 0F     LDA #con_ai_0F
...
C - - - - - 0x00E32C 03:A31C: 20 35 C0  JSR sub_0x01F6A1
...
C - - - - - 0x00E3CB 03:A3BB: 20 6B 82  JSR sub_826B_интеллект_в_зависимости_от_позиции
...
C - - - - - 0x00E443 03:A433: 29 30     AND #con_pos_GK
C - - - - - 0x00E445 03:A435: D0 05     BNE bra_A43C    ; если это кипер
C - - - - - 0x00E447 03:A437: A9 0A     LDA #con_ai_0A
...
C - - - - - 0x00E45B 03:A44B: A9 2A     LDA #con_ai_2A
C - - - - - 0x00E45D 03:A44D: 9D 64 06  STA ram_интеллект_бота + 8,X
bra_A450:
...
C - - - - - 0x00E46F 03:A45F: 20 41 C0  JSR sub_0x01FA7D
...
C - - - - - 0x00E482 03:A472: A9 28     LDA #con_ai_28
C - - - - - 0x00E484 03:A474: 4C 79 A4  JMP loc_A479_запись_интеллекта
bra_A477:
C - - - - - 0x00E487 03:A477: A9 0D     LDA #con_ai_0D
loc_A479_запись_интеллекта:
C D 1 - - - 0x00E489 03:A479: 9D 66 06  STA ram_интеллект_бота + 10,X
C - - - - - 0x00E48C 03:A47C: BD 2C 05  LDA ram_номер_команды,X
C - - - - - 0x00E48F 03:A47F: 29 0F     AND #$0F
C - - - - - 0x00E491 03:A481: C9 06     CMP #$06    ; сенегал
C - - - - - 0x00E493 03:A483: F0 13     BEQ bra_A498
C - - - - - 0x00E495 03:A485: C9 0E     CMP #$0E    ; аргентина
C - - - - - 0x00E497 03:A487: F0 0F     BEQ bra_A498
C - - - - - 0x00E499 03:A489: C9 09     CMP #$09    ; германия
C - - - - - 0x00E49B 03:A48B: F0 0B     BEQ bra_A498
C - - - - - 0x00E49D 03:A48D: C9 0A     CMP #$0A    ; англия
C - - - - - 0x00E49F 03:A48F: F0 07     BEQ bra_A498
C - - - - - 0x00E4A1 03:A491: C9 0B     CMP #$0B    ; италия
...
C - - - - - 0x00E4CD 03:A4BD: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
C - - - - - 0x00E4D0 03:A4C0: C9 C0     CMP #$C0
C - - - - - 0x00E4D2 03:A4C2: 90 05     BCC bra_A4C9
C - - - - - 0x00E4D4 03:A4C4: A9 08     LDA #con_ai_08
C - - - - - 0x00E4D6 03:A4C6: 4C CB A4  JMP loc_A4CB_запись_интеллекта
bra_A4C9:
C - - - - - 0x00E4D9 03:A4C9: A9 09     LDA #con_ai_09
loc_A4CB_запись_интеллекта:
...
bra_A4F0:
C - - - - - 0x00E500 03:A4F0: A9 09     LDA #con_ai_09
C - - - - - 0x00E502 03:A4F2: 4C 1A A5  JMP loc_A51A_запись_интеллекта
bra_A4F5:
C - - - - - 0x00E505 03:A4F5: AC D6 04  LDY ram_игрок_с_мячом
C - - - - - 0x00E508 03:A4F8: B9 27 03  LDA ram_pos_X_hi_игрока,Y
...
- - - - - - 0x00E528 03:A518: A9 07     LDA #con_ai_07
loc_A51A_запись_интеллекта:
...
sub_A520:
C - - - - - 0x00E530 03:A520: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
C - - - - - 0x00E533 03:A523: 19 E8 03  ORA ram_spd_X_lo_игрока,Y
C - - - - - 0x00E536 03:A526: 19 12 04  ORA ram_spd_Y_hi_игрока,Y
C - - - - - 0x00E539 03:A529: 19 04 04  ORA ram_spd_Y_lo_игрока,Y
...
bra_A533:
C - - - - - 0x00E543 03:A533: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
C - - - - - 0x00E546 03:A536: 19 E8 03  ORA ram_spd_X_lo_игрока,Y
C - - - - - 0x00E549 03:A539: F0 3D     BEQ bra_A578
C - - - - - 0x00E54B 03:A53B: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
C - - - - - 0x00E54E 03:A53E: 10 1C     BPL bra_A55C
C - - - - - 0x00E550 03:A540: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
C - - - - - 0x00E553 03:A543: 19 04 04  ORA ram_spd_Y_lo_игрока,Y
C - - - - - 0x00E556 03:A546: F0 0F     BEQ bra_A557
C - - - - - 0x00E558 03:A548: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
bra_A55C:
C - - - - - 0x00E56C 03:A55C: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
C - - - - - 0x00E56F 03:A55F: 19 04 04  ORA ram_spd_Y_lo_игрока,Y
C - - - - - 0x00E572 03:A562: F0 0F     BEQ bra_A573
C - - - - - 0x00E574 03:A564: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
bra_A578:
C - - - - - 0x00E588 03:A578: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
C - - - - - 0x00E59B 03:A58B: A9 0A     LDA #con_ai_0A
bra_A58D_loop:
...
C - - - - - 0x00E5AD 03:A59D: A9 0A     LDA #con_ai_0A
bra_A59F_loop:
...
C - - - - - 0x00E5CA 03:A5BA: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00E5CD 03:A5BD: 48        PHA
C - - - - - 0x00E5CE 03:A5BE: AD 6C 03  LDA ram_pos_Y_hi_мяча
...
C - - - - - 0x00E5F1 03:A5E1: 8D 6C 03  STA ram_pos_Y_hi_мяча
C - - - - - 0x00E5F4 03:A5E4: 68        PLA
C - - - - - 0x00E5F5 03:A5E5: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00E5F8 03:A5E8: 68        PLA
C - - - - - 0x00E5F9 03:A5E9: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00E5FC 03:A5EC: 68        PLA
C - - - - - 0x00E5FD 03:A5ED: 8D 20 03  STA ram_pos_X_lo_мяча
...
C - - - - - 0x00E617 03:A607: A9 25     LDA #con_ai_25
...
C - - - - - 0x00E664 03:A654: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00E667 03:A657: D0 10     BNE bra_A669
C - - - - - 0x00E669 03:A659: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
...
C - - - - - 0x00E690 03:A680: AD 92 04  LDA ram_состояние_мяча
...
C - - - - - 0x00E6AC 03:A69C: AD 59 03  LDA ram_pos_Y_lo_мяча
...
C - - - - - 0x00E6C2 03:A6B2: AD 6C 03  LDA ram_pos_Y_hi_мяча
C - - - - - 0x00E6C5 03:A6B5: F0 0A     BEQ bra_A6C1
C - - - - - 0x00E6C7 03:A6B7: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00E6CA 03:A6BA: C9 20     CMP #$20
C - - - - - 0x00E6CC 03:A6BC: B0 0F     BCS bra_A6CD
C - - - - - 0x00E6CE 03:A6BE: 4C C8 A6  JMP loc_A6C8
bra_A6C1:
C - - - - - 0x00E6D1 03:A6C1: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00E6D4 03:A6C4: C9 70     CMP #$70
C - - - - - 0x00E6D6 03:A6C6: 90 05     BCC bra_A6CD
loc_A6C8:
C D 1 - - - 0x00E6D8 03:A6C8: A9 24     LDA #con_ai_24
C - - - - - 0x00E6DA 03:A6CA: 9D 66 06  STA ram_интеллект_бота + 10,X
bra_A6CD:
C - - - - - 0x00E6DD 03:A6CD: 68        PLA
C - - - - - 0x00E6DE 03:A6CE: 8D 6C 03  STA ram_pos_Y_hi_мяча
C - - - - - 0x00E6E1 03:A6D1: 68        PLA
C - - - - - 0x00E6E2 03:A6D2: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x00E6E5 03:A6D5: 68        PLA
C - - - - - 0x00E6E6 03:A6D6: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x00E6E9 03:A6D9: 68        PLA
C - - - - - 0x00E6EA 03:A6DA: 8D 20 03  STA ram_pos_X_lo_мяча
bra_A6DD:
C - - - - - 0x00E6ED 03:A6DD: 4C 93 A7  JMP loc_A793
bra_A6E0:
C - - - - - 0x00E6F0 03:A6E0: AD 02 04  LDA ram_spd_X_hi_мяча
C - - - - - 0x00E6F3 03:A6E3: 30 20     BMI bra_A705
C - - - - - 0x00E6F5 03:A6E5: E0 01     CPX #$01
C - - - - - 0x00E6F7 03:A6E7: D0 F4     BNE bra_A6DD
C - - - - - 0x00E6F9 03:A6E9: AD 1F 03  LDA ram_pos_X_lo_игрока + 11
C - - - - - 0x00E6FC 03:A6EC: 38        SEC
C - - - - - 0x00E6FD 03:A6ED: ED 20 03  SBC ram_pos_X_lo_мяча
C - - - - - 0x00E700 03:A6F0: 85 1C     STA ram_001C
C - - - - - 0x00E702 03:A6F2: AD 32 03  LDA ram_pos_X_hi_игрока + 11
C - - - - - 0x00E705 03:A6F5: ED 33 03  SBC ram_pos_X_hi_мяча
...
C - - - - - 0x00E719 03:A709: AD 20 03  LDA ram_pos_X_lo_мяча
C - - - - - 0x00E71C 03:A70C: 38        SEC
C - - - - - 0x00E71D 03:A70D: ED 1E 03  SBC ram_pos_X_lo_игрока + 10
C - - - - - 0x00E720 03:A710: 85 1C     STA ram_001C
C - - - - - 0x00E722 03:A712: AD 33 03  LDA ram_pos_X_hi_мяча
C - - - - - 0x00E725 03:A715: ED 31 03  SBC ram_pos_X_hi_игрока + 10
...
bra_A725:
C - - - - - 0x00E735 03:A725: AD A5 03  LDA ram_pos_Z_hi_мяча
C - - - - - 0x00E738 03:A728: 30 1C     BMI bra_A746
C - - - - - 0x00E73A 03:A72A: AD 92 03  LDA ram_pos_Z_lo_мяча
...
bra_A736:
C - - - - - 0x00E746 03:A736: AD 92 03  LDA ram_pos_Z_lo_мяча
loc_A739:
...
loc_A756:
C D 1 - - - 0x00E766 03:A756: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00E77D 03:A76D: A9 0E     LDA #con_ai_0E
...
- - - - - - 0x00E794 03:A784: A9 00     LDA #con_ai_00
- - - - - - 0x00E796 03:A786: 4C 90 A7  BEQ bra_A790_запись_интеллекта
bra_A789:
C - - - - - 0x00E799 03:A789: A9 05     LDA #con_ai_05
C - - - - - 0x00E79B 03:A78B: 4C 90 A7  BNE bra_A790_запись_интеллекта
bra_A78E_кипер_не_в_штрафной:
loc_A78E:
C D 1 - - - 0x00E79E 03:A78E: A9 26     LDA #con_ai_26
loc_A790_запись_интеллекта:
bra_A790_запись_интеллекта:
C D 1 - - - 0x00E7A0 03:A790: 9D 66 06  STA ram_интеллект_бота + 10,X
bra_A793:
loc_A793:
C D 1 - - - 0x00E7A3 03:A793: BD 66 06  LDA ram_интеллект_бота + 10,X
C - - - - - 0x00E7A6 03:A796: D0 05     BNE bra_A79D_RTS
- - - - - - 0x00E7A8 03:A798: A9 0A     LDA #con_ai_0A
- - - - - - 0x00E7AA 03:A79A: 9D 66 06  STA ram_интеллект_бота + 10,X
bra_A79D_RTS:
...
C - - - - - 0x00E7CD 03:A7BD: B9 7C AB  LDA tbl_AB7C_выбор_буфера,Y
C - - - - - 0x00E7D0 03:A7C0: 85 2C     STA ram_002C
C - - - - - 0x00E7D2 03:A7C2: B9 7D AB  LDA tbl_AB7C_выбор_буфера + 1,Y
...
C - - - - - 0x00E839 03:A829: 4C B8 A7  JMP loc_A7B8_loop
bra_A82C_RTS:
...
bra_A83B:
C - - - - - 0x00E84B 03:A83B: 99 9C 06  STA ram_буфер_атрибутов + 6,Y
...
bra_A84D:
C - - - - - 0x00E85D 03:A84D: 99 9C 06  STA ram_буфер_атрибутов + 6,Y
...
C - - - - - 0x00E86C 03:A85C: B9 7C AB  LDA tbl_AB7C_выбор_буфера,Y
C - - - - - 0x00E86F 03:A85F: 85 2C     STA ram_002C
C - - - - - 0x00E871 03:A861: B9 7D AB  LDA tbl_AB7C_выбор_буфера + 1,Y
...
C - - - - - 0x00E8DE 03:A8CE: 90 F6     BCC bra_A8C6_loop
...
C - - - - - 0x00E909 03:A8F9: 9D 84 06  STA ram_таймер_текста_приказа,X
C - - - - - 0x00E90C 03:A8FC: A9 FF     LDA #$FF
C - - - - - 0x00E90E 03:A8FE: 4C 1D A9  JMP loc_A91D
bra_A901:
C - - - - - 0x00E911 03:A901: A9 20     LDA #$20
C - - - - - 0x00E913 03:A903: 9D 84 06  STA ram_таймер_текста_приказа,X
...
bra_A92A:
C - - - - - 0x00E93A 03:A92A: 9D 80 06  STA ram_номер_текста_приказа,X
C - - - - - 0x00E93D 03:A92D: 0A        ASL
C - - - - - 0x00E93E 03:A92E: A8        TAY
C - - - - - 0x00E93F 03:A92F: B9 88 AB  LDA tbl_AB88_текст_приказов_и_ответов,Y
C - - - - - 0x00E942 03:A932: 85 2E     STA ram_002E
C - - - - - 0x00E944 03:A934: B9 89 AB  LDA tbl_AB88_текст_приказов_и_ответов + 1,Y
...
; при перезаписи X можно восстановить его из 0043
...
bra_A955:
C - - - - - 0x00E965 03:A955: 9D 82 06  STA ram_номер_текста_ответа,X
C - - - - - 0x00E968 03:A958: 0A        ASL
C - - - - - 0x00E969 03:A959: A8        TAY
C - - - - - 0x00E96A 03:A95A: B9 88 AB  LDA tbl_AB88_текст_приказов_и_ответов,Y
...
C - - - - - 0x00E9CB 03:A9BB: BD 3C 05  LDA ram_номер_игрока + 10,X
...
C - - - - - 0x00EB06 03:AAF6: B9 4E AD  LDA tbl_AD4F - 1,Y
...
loc_AB2D:
C D 1 - - - 0x00EB3D 03:AB2D: 99 1C 00  STA ram_001C,Y
loc_AB30:
...
tbl_AB7C_выбор_буфера:
- D 1 - - - 0x00EB8C 03:AB7C: 96 06     .word ram_буфер_атрибутов
- D 1 - - - 0x00EB8E 03:AB7E: B9 06     .word ram_буфер_графики
...
tbl_AB88_текст_приказов_и_ответов:
...
C - - - - - 0x00EE2E 03:AE1E: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x00EE31 03:AE21: 85 32     STA ram_0032
C - - - - - 0x00EE33 03:AE23: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x00EE36 03:AE26: 85 33     STA ram_0033
C - - - - - 0x00EE38 03:AE28: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00EE3B 03:AE2B: 85 34     STA ram_0034
C - - - - - 0x00EE3D 03:AE2D: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
...
sub_AE37:
C - - - - - 0x00EE47 03:AE37: BD 20 06  LDA ram_pos_X_lo_точка_удара_бота,X
C - - - - - 0x00EE4A 03:AE3A: 85 32     STA ram_0032
C - - - - - 0x00EE4C 03:AE3C: BD 2C 06  LDA ram_pos_X_hi_точка_удара_бота,X
C - - - - - 0x00EE4F 03:AE3F: 85 33     STA ram_0033
C - - - - - 0x00EE51 03:AE41: BD 38 06  LDA ram_pos_Y_lo_точка_удара_бота,X
C - - - - - 0x00EE54 03:AE44: 85 34     STA ram_0034
C - - - - - 0x00EE56 03:AE46: BD 44 06  LDA ram_pos_Y_hi_точка_удара_бота,X
C - - - - - 0x00EE59 03:AE49: 85 35     STA ram_0035
sub_AE4B:
loc_AE4B:
C D 1 - - - 0x00EE5B 03:AE4B: A5 32     LDA ram_0032
C - - - - - 0x00EE5D 03:AE4D: 38        SEC
C - - - - - 0x00EE5E 03:AE4E: FD 14 03  SBC ram_pos_X_lo_игрока,X
C - - - - - 0x00EE61 03:AE51: 85 1E     STA ram_001E
C - - - - - 0x00EE63 03:AE53: A5 33     LDA ram_0033
C - - - - - 0x00EE65 03:AE55: FD 27 03  SBC ram_pos_X_hi_игрока,X
...
C - - - - - 0x00EE9C 03:AE8C: FD 4D 03  SBC ram_pos_Y_lo_игрока,X
C - - - - - 0x00EE9F 03:AE8F: 85 1E     STA ram_001E
C - - - - - 0x00EEA1 03:AE91: A5 35     LDA ram_0035
C - - - - - 0x00EEA3 03:AE93: FD 60 03  SBC ram_pos_Y_hi_игрока,X
...
bra_AEC7:
C - - - - - 0x00EED7 03:AEC7: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x00EEDA 03:AECA: 38        SEC
C - - - - - 0x00EEDB 03:AECB: FD 14 03  SBC ram_pos_X_lo_игрока,X
C - - - - - 0x00EEDE 03:AECE: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x00EEE1 03:AED1: FD 27 03  SBC ram_pos_X_hi_игрока,X
C - - - - - 0x00EEE4 03:AED4: 85 1C     STA ram_001C
C - - - - - 0x00EEE6 03:AED6: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00EEE9 03:AED9: 38        SEC
C - - - - - 0x00EEEA 03:AEDA: FD 4D 03  SBC ram_pos_Y_lo_игрока,X
C - - - - - 0x00EEED 03:AEDD: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00EEF0 03:AEE0: FD 60 03  SBC ram_pos_Y_hi_игрока,X
C - - - - - 0x00EEF3 03:AEE3: 85 1D     STA ram_001D
C - - - - - 0x00EEF5 03:AEE5: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
...
C - - - - - 0x00EF03 03:AEF3: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
C - - - - - 0x00EF13 03:AF03: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
C - - - - - 0x00EF16 03:AF06: 19 E8 03  ORA ram_spd_X_lo_игрока,Y
C - - - - - 0x00EF19 03:AF09: F0 0D     BEQ bra_AF18
C - - - - - 0x00EF1B 03:AF0B: B9 F6 03  LDA ram_spd_X_hi_игрока,Y
...
C - - - - - 0x00EF2A 03:AF1A: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
C - - - - - 0x00EF2D 03:AF1D: 19 04 04  ORA ram_spd_Y_lo_игрока,Y
C - - - - - 0x00EF30 03:AF20: F0 0D     BEQ bra_AF2F
C - - - - - 0x00EF32 03:AF22: B9 12 04  LDA ram_spd_Y_hi_игрока,Y
...
C - - - - - 0x00EF4E 03:AF3E: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x00EF51 03:AF41: 38        SEC
C - - - - - 0x00EF52 03:AF42: FD 14 03  SBC ram_pos_X_lo_игрока,X
C - - - - - 0x00EF55 03:AF45: 85 1C     STA ram_001C
C - - - - - 0x00EF57 03:AF47: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x00EF5A 03:AF4A: FD 27 03  SBC ram_pos_X_hi_игрока,X
...
C - - - - - 0x00EF7A 03:AF6A: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00EF7D 03:AF6D: 38        SEC
C - - - - - 0x00EF7E 03:AF6E: FD 4D 03  SBC ram_pos_Y_lo_игрока,X
C - - - - - 0x00EF81 03:AF71: 85 1E     STA ram_001E
C - - - - - 0x00EF83 03:AF73: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00EF86 03:AF76: FD 60 03  SBC ram_pos_Y_hi_игрока,X
...
C - - - - - 0x00F04F 03:B03F: 90 F9     BCC bra_B03A_loop
C - - - - - 0x00F051 03:B041: A6 43     LDX ram_0043
bra_B043:
C - - - - - 0x00F053 03:B043: B9 D9 00  LDA ram_флаг_видимости_игрока,Y
C - - - - - 0x00F056 03:B046: D0 03     BNE bra_B04B_visible
...
C - - - - - 0x00F08F 03:B07F: B9 2C 00  LDA ram_002C,Y
C - - - - - 0x00F092 03:B082: 99 2F 00  STA ram_002F,Y
C - - - - - 0x00F095 03:B085: B9 2D 00  LDA ram_002D,Y
C - - - - - 0x00F098 03:B088: 99 30 00  STA ram_0030,Y
C - - - - - 0x00F09B 03:B08B: B9 2E 00  LDA ram_002E,Y
C - - - - - 0x00F09E 03:B08E: 99 31 00  STA ram_0031,Y
bra_B091:
C - - - - - 0x00F0A1 03:B091: A5 24     LDA ram_0024
C - - - - - 0x00F0A3 03:B093: 99 2E 00  STA ram_002E,Y
C - - - - - 0x00F0A6 03:B096: A5 1F     LDA ram_001F
C - - - - - 0x00F0A8 03:B098: 99 2D 00  STA ram_002D,Y
C - - - - - 0x00F0AB 03:B09B: A5 44     LDA ram_0044
C - - - - - 0x00F0AD 03:B09D: 99 2C 00  STA ram_002C,Y
...
C - - - - - 0x00F0EA 03:B0DA: F9 4D 03  SBC ram_pos_Y_lo_игрока,Y
C - - - - - 0x00F0ED 03:B0DD: A9 00     LDA #$00
C - - - - - 0x00F0EF 03:B0DF: F9 60 03  SBC ram_pos_Y_hi_игрока,Y
C - - - - - 0x00F0F2 03:B0E2: 10 46     BPL bra_B12A
C - - - - - 0x00F0F4 03:B0E4: A9 20     LDA #$20
C - - - - - 0x00F0F6 03:B0E6: 38        SEC
C - - - - - 0x00F0F7 03:B0E7: F9 4D 03  SBC ram_pos_Y_lo_игрока,Y
C - - - - - 0x00F0FA 03:B0EA: A9 01     LDA #$01
C - - - - - 0x00F0FC 03:B0EC: F9 60 03  SBC ram_pos_Y_hi_игрока,Y
C - - - - - 0x00F0FF 03:B0EF: 30 39     BMI bra_B12A
C - - - - - 0x00F101 03:B0F1: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
...
C - - - - - 0x00F116 03:B106: F9 14 03  SBC ram_pos_X_lo_игрока,Y
C - - - - - 0x00F119 03:B109: A9 03     LDA #$03
C - - - - - 0x00F11B 03:B10B: F9 27 03  SBC ram_pos_X_hi_игрока,Y
...
C - - - - - 0x00F12D 03:B11D: F9 14 03  SBC ram_pos_X_lo_игрока,Y
C - - - - - 0x00F130 03:B120: A9 00     LDA #$00
C - - - - - 0x00F132 03:B122: F9 27 03  SBC ram_pos_X_hi_игрока,Y
...
C - - - - - 0x00F150 03:B140: B9 5E B1  LDA tbl_B15D + 1,Y
...
C - - - - - 0x00F168 03:B158: 90 EF     BCC bra_B149_loop
...
C - - - - - 0x00F1E3 03:B1D3: 9D B0 04  STA ram_смена_угла_движения,X
...
C - - - - - 0x00F9B0 03:B9A0: BD 59 04  LDA ram_действие_игрока,X
...
C - - - - - 0x00F9D8 03:B9C8: 99 80 06  STA ram_номер_текста_приказа,Y
C - - - - - 0x00F9DB 03:B9CB: A9 20     LDA #$20
C - - - - - 0x00F9DD 03:B9CD: 99 84 06  STA ram_таймер_текста_приказа,Y
...
C - - - - - 0x00F9F5 03:B9E5: 99 82 06  STA ram_номер_текста_ответа,Y
C - - - - - 0x00F9F8 03:B9E8: A9 20     LDA #$20
C - - - - - 0x00F9FA 03:B9EA: 99 84 06  STA ram_таймер_текста_приказа,Y
bra_B9ED_RTS:
...
sub_B9EE:
C - - - - - 0x00F9FE 03:B9EE: BD 59 04  LDA ram_действие_игрока,X
...
C - - - - - 0x00FB16 03:BB06: F0 03     BNE bra_BB0C_сейчас_не_молния
bra_BB0B_RTS:
C - - - - - 0x00FB1B 03:BB0B: 60        RTS
bra_BB0C_сейчас_не_молния:
...
C - - - - - 0x00FBB4 03:BBA4: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00FBD4 03:BBC4: 8D FE 05  STA ram_угол_ветра
C - - - - - 0x00FBD7 03:BBC7: 4C D2 BB  JMP loc_BBD2
bra_BBCA:
- - - - - - 0x00FBDA 03:BBCA: 4C 19 BC  JMP loc_BC19
bra_BBCD:
C - - - - - 0x00FBDD 03:BBCD: A9 C0     LDA #$C0
C - - - - - 0x00FBDF 03:BBCF: 8D FE 05  STA ram_угол_ветра
loc_BBD2:
C D 1 - - - 0x00FBE2 03:BBD2: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
C - - - - - 0x00FBE5 03:BBD5: 30 15     BMI bra_BBEC
C - - - - - 0x00FBE7 03:BBD7: AC FE 05  LDY ram_угол_ветра
C - - - - - 0x00FBEA 03:BBDA: 84 1C     STY ram_001C
C - - - - - 0x00FBEC 03:BBDC: 29 60     AND #$60
C - - - - - 0x00FBEE 03:BBDE: 4D FE 05  EOR ram_угол_ветра
...
- - - - - - 0x00FC2E 03:BC1E: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
- - - - - - 0x00FC31 03:BC21: C9 C0     CMP #$C0
- - - - - - 0x00FC33 03:BC23: B0 1B     BCS bra_BC40
bra_BC25:
- - - - - - 0x00FC35 03:BC25: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
bra_BC33:
- - - - - - 0x00FC43 03:BC33: 20 05 C0  JSR sub_0x01EE45_вращение_рандома
...
C - - - - - 0x00FCA0 03:BC90: AD FE 05  LDA ram_угол_ветра
...
bra_BCFF:
C - - - - - 0x00FD0F 03:BCFF: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x00FD12 03:BD02: 38        SEC
C - - - - - 0x00FD13 03:BD03: E9 80     SBC #$80
C - - - - - 0x00FD15 03:BD05: 85 1C     STA ram_001C
C - - - - - 0x00FD17 03:BD07: B9 27 03  LDA ram_pos_X_hi_игрока,Y
...
loc_BD56:
C D 1 - - - 0x00FD66 03:BD56: AD EC 00  LDA ram_pos_X_lo_скролл
C - - - - - 0x00FD69 03:BD59: 38        SEC
C - - - - - 0x00FD6A 03:BD5A: E5 1C     SBC ram_001C
C - - - - - 0x00FD6C 03:BD5C: 85 1C     STA ram_001C
C - - - - - 0x00FD6E 03:BD5E: AD ED 00  LDA ram_pos_X_hi_скролл
...
loc_BDB1:
C D 1 - - - 0x00FDC1 03:BDB1: AD EC 00  LDA ram_pos_X_lo_скролл
C - - - - - 0x00FDC4 03:BDB4: 38        SEC
C - - - - - 0x00FDC5 03:BDB5: E5 1C     SBC ram_001C
C - - - - - 0x00FDC7 03:BDB7: 8D F0 00  STA ram_pos_X_lo_камера
C - - - - - 0x00FDCA 03:BDBA: AD ED 00  LDA ram_pos_X_hi_скролл
C - - - - - 0x00FDCD 03:BDBD: E5 1D     SBC ram_001D
C - - - - - 0x00FDCF 03:BDBF: 8D F1 00  STA ram_pos_X_hi_камера
loc_BDC2:
C D 1 - - - 0x00FDD2 03:BDC2: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x00FDD5 03:BDC5: 38        SEC
C - - - - - 0x00FDD6 03:BDC6: E9 80     SBC #$80
C - - - - - 0x00FDD8 03:BDC8: 85 1C     STA ram_001C
C - - - - - 0x00FDDA 03:BDCA: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x00FDDD 03:BDCD: E9 00     SBC #$00
C - - - - - 0x00FDDF 03:BDCF: 85 1D     STA ram_001D
C - - - - - 0x00FDE1 03:BDD1: AD EE 00  LDA ram_pos_Y_lo_скролл
C - - - - - 0x00FDE4 03:BDD4: 38        SEC
C - - - - - 0x00FDE5 03:BDD5: E5 1C     SBC ram_001C
C - - - - - 0x00FDE7 03:BDD7: 85 1C     STA ram_001C
C - - - - - 0x00FDE9 03:BDD9: AD EF 00  LDA ram_pos_Y_hi_скролл
...
loc_BE2C:
C D 1 - - - 0x00FE3C 03:BE2C: AD EE 00  LDA ram_pos_Y_lo_скролл
C - - - - - 0x00FE3F 03:BE2F: 38        SEC
C - - - - - 0x00FE40 03:BE30: E5 1C     SBC ram_001C
C - - - - - 0x00FE42 03:BE32: 8D F2 00  STA ram_pos_Y_lo_камера
C - - - - - 0x00FE45 03:BE35: AD EF 00  LDA ram_pos_Y_hi_скролл
...
bra_BE47:
C - - - - - 0x00FE57 03:BE47: AD F1 00  LDA ram_pos_X_hi_камера
C - - - - - 0x00FE5A 03:BE4A: C9 00     CMP #$00
C - - - - - 0x00FE5C 03:BE4C: D0 14     BNE bra_BE62
C - - - - - 0x00FE5E 03:BE4E: AD F0 00  LDA ram_pos_X_lo_камера
C - - - - - 0x00FE61 03:BE51: C9 30     CMP #$30
C - - - - - 0x00FE63 03:BE53: B0 1E     BCS bra_BE73
C - - - - - 0x00FE65 03:BE55: A9 30     LDA #$30
C - - - - - 0x00FE67 03:BE57: 8D F0 00  STA ram_pos_X_lo_камера
C - - - - - 0x00FE6A 03:BE5A: A9 00     LDA #$00
C - - - - - 0x00FE6C 03:BE5C: 8D F1 00  STA ram_pos_X_hi_камера
C - - - - - 0x00FE6F 03:BE5F: 4C 73 BE  JMP loc_BE73
bra_BE62:
C - - - - - 0x00FE72 03:BE62: AD F0 00  LDA ram_pos_X_lo_камера
C - - - - - 0x00FE75 03:BE65: C9 D0     CMP #$D0
C - - - - - 0x00FE77 03:BE67: 90 0A     BCC bra_BE73
C - - - - - 0x00FE79 03:BE69: A9 01     LDA #$01
C - - - - - 0x00FE7B 03:BE6B: 8D F1 00  STA ram_pos_X_hi_камера
C - - - - - 0x00FE7E 03:BE6E: A9 D0     LDA #$D0
C - - - - - 0x00FE80 03:BE70: 8D F0 00  STA ram_pos_X_lo_камера
bra_BE73:
loc_BE73:
C D 1 - - - 0x00FE83 03:BE73: A9 00     LDA #$00
C - - - - - 0x00FE85 03:BE75: 8D F2 00  STA ram_pos_Y_lo_камера
C - - - - - 0x00FE88 03:BE78: 8D F3 00  STA ram_pos_Y_hi_камера
C - - - - - 0x00FE8B 03:BE7B: 4C D3 BE  RTS
bra_BE7E_это_не_экраны_со_счетом:
C - - - - - 0x00FE8E 03:BE7E: AD F1 00  LDA ram_pos_X_hi_камера
C - - - - - 0x00FE91 03:BE81: C9 01     CMP #$01
C - - - - - 0x00FE93 03:BE83: B0 11     BCS bra_BE96
C - - - - - 0x00FE95 03:BE85: AD F0 00  LDA ram_pos_X_lo_камера
C - - - - - 0x00FE98 03:BE88: C9 40     CMP #$40
C - - - - - 0x00FE9A 03:BE8A: B0 0A     BCS bra_BE96
C - - - - - 0x00FE9C 03:BE8C: A9 40     LDA #$40
C - - - - - 0x00FE9E 03:BE8E: 8D F0 00  STA ram_pos_X_lo_камера
C - - - - - 0x00FEA1 03:BE91: A9 00     LDA #$00
C - - - - - 0x00FEA3 03:BE93: 8D F1 00  STA ram_pos_X_hi_камера
bra_BE96:
C - - - - - 0x00FEA6 03:BE96: AD F1 00  LDA ram_pos_X_hi_камера
C - - - - - 0x00FEA9 03:BE99: C9 02     CMP #$02
C - - - - - 0x00FEAB 03:BE9B: 90 11     BCC bra_BEAE
C - - - - - 0x00FEAD 03:BE9D: AD F0 00  LDA ram_pos_X_lo_камера
C - - - - - 0x00FEB0 03:BEA0: C9 C0     CMP #$C0
C - - - - - 0x00FEB2 03:BEA2: 90 0A     BCC bra_BEAE
C - - - - - 0x00FEB4 03:BEA4: A9 02     LDA #$02
C - - - - - 0x00FEB6 03:BEA6: 8D F1 00  STA ram_pos_X_hi_камера
C - - - - - 0x00FEB9 03:BEA9: A9 C0     LDA #$C0
C - - - - - 0x00FEBB 03:BEAB: 8D F0 00  STA ram_pos_X_lo_камера
bra_BEAE:
C - - - - - 0x00FEBE 03:BEAE: AD F3 00  LDA ram_pos_Y_hi_камера
C - - - - - 0x00FEC1 03:BEB1: 10 08     BPL bra_BEBB
C - - - - - 0x00FEC3 03:BEB3: A9 00     LDA #$00
C - - - - - 0x00FEC5 03:BEB5: 8D F2 00  STA ram_pos_Y_lo_камера
C - - - - - 0x00FEC8 03:BEB8: 8D F3 00  STA ram_pos_Y_hi_камера
bra_BEBB:
C - - - - - 0x00FECB 03:BEBB: AD F3 00  LDA ram_pos_Y_hi_камера
C - - - - - 0x00FECE 03:BEBE: C9 01     CMP #$01
C - - - - - 0x00FED0 03:BEC0: B0 07     BCS bra_BEC9
C - - - - - 0x00FED2 03:BEC2: AD F2 00  LDA ram_pos_Y_lo_камера
C - - - - - 0x00FED5 03:BEC5: C9 AF     CMP #$AF
C - - - - - 0x00FED7 03:BEC7: 90 0A     BCC bra_BED3_RTS
bra_BEC9:
C - - - - - 0x00FED9 03:BEC9: A9 AF     LDA #$AF
C - - - - - 0x00FEDB 03:BECB: 8D F2 00  STA ram_pos_Y_lo_камера
C - - - - - 0x00FEDE 03:BECE: A9 00     LDA #$00
C - - - - - 0x00FEE0 03:BED0: 8D F3 00  STA ram_pos_Y_hi_камера
bra_BED3_RTS:
...
C - - - - - 0x00FEF7 03:BEE7: D0 04     BNE bra_BEED_второй_тайм
bra_BEE9:
C - - - - - 0x00FEF9 03:BEE9: 29 02     AND #$02
C - - - - - 0x00FEFB 03:BEEB: F0 05     BEQ bra_BEF2
bra_BEED_второй_тайм:
...
C - - - - - 0x00FF18 03:BF08: B0 F8     BCS bra_BF02_loop
bra_BF0A:
C - - - - - 0x00FF1A 03:BF0A: B9 1B BF  LDA tbl_BF1B,Y
C - - - - - 0x00FF1D 03:BF0D: 30 03     BMI bra_BF12_RTS
loc_BF0F:
C D 1 - - - 0x00FF1F 03:BF0F: 8D BB 05  STA ram_банк_спрайтов + 3
bra_BF12_RTS:
...
C - - - - - 0x00FF54 03:BF44: 99 1C 00  STA ram_001C,Y
...
bra_BF4F:
C - - - - - 0x00FF5F 03:BF4F: B9 1C 00  LDA ram_001C,Y
...
bra_BF59:
C - - - - - 0x00FF69 03:BF59: AD 59 03  LDA ram_pos_Y_lo_мяча
C - - - - - 0x00FF6C 03:BF5C: 38        SEC
C - - - - - 0x00FF6D 03:BF5D: ED 92 03  SBC ram_pos_Z_lo_мяча
C - - - - - 0x00FF70 03:BF60: 85 1F     STA ram_001F
C - - - - - 0x00FF72 03:BF62: AD 6C 03  LDA ram_pos_Y_hi_мяча
C - - - - - 0x00FF75 03:BF65: ED A5 03  SBC ram_pos_Z_hi_мяча
...
C - - - - - 0x00FF84 03:BF74: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x00FF87 03:BF77: 38        SEC
C - - - - - 0x00FF88 03:BF78: E5 1F     SBC ram_001F
C - - - - - 0x00FF8A 03:BF7A: 85 1C     STA ram_001C
C - - - - - 0x00FF8C 03:BF7C: BD 60 03  LDA ram_pos_Y_hi_игрока,X
...
C - - - - - 0x00FF9A 03:BF8A: 99 2C 00  STA ram_002C,Y
...
C - - - - - 0x00FFB5 03:BFA5: BD A1 00  LDA ram_приоритет_анимации,X
bra_BFA8:
C - - - - - 0x00FFB8 03:BFA8: D9 2C 00  CMP ram_002C,Y
C - - - - - 0x00FFBB 03:BFAB: D0 12     BNE bra_BFBF
C - - - - - 0x00FFBD 03:BFAD: 84 44     STY ram_0044
C - - - - - 0x00FFBF 03:BFAF: A4 1D     LDY ram_001D
C - - - - - 0x00FFC1 03:BFB1: 99 32 00  STA ram_0032,Y
C - - - - - 0x00FFC4 03:BFB4: 8A        TXA
C - - - - - 0x00FFC5 03:BFB5: 99 38 00  STA ram_0038,Y
C - - - - - 0x00FFC8 03:BFB8: E6 1D     INC ram_001D
C - - - - - 0x00FFCA 03:BFBA: A4 44     LDY ram_0044
C - - - - - 0x00FFCC 03:BFBC: BD A1 00  LDA ram_приоритет_анимации,X
bra_BFBF:
