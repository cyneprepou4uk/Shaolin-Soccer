...
C - - - - - 0x00E77F 03:A76F: 4C 90 A7  JMP loc_A790_запись_интеллекта
bra_A772:
loc_A772:
...
- - - - - - 0x00E796 03:A786: 4C 90 A7  JMP loc_A790_запись_интеллекта
bra_A789:
C - - - - - 0x00E799 03:A789: A9 05     LDA #$05
C - - - - - 0x00E79B 03:A78B: 4C 90 A7  JMP loc_A790_запись_интеллекта
bra_A78E:
loc_A78E:
C D 1 - - - 0x00E79E 03:A78E: A9 26     LDA #$26
loc_A790_запись_интеллекта:   ; bzk опт
