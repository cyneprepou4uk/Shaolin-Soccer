...
C - - - - - 0x00D7D6 03:97C6: A9 21     LDA #con_action_21
C - - - - - 0x00D7D8 03:97C8: 4C DB 97  JMP loc_97DB_запись_действия
bra_97CB:
- - - - - - 0x00D7DB 03:97CB: A9 0F     LDA #con_action_0F
- - - - - - 0x00D7DD 03:97CD: 4C DB 97  JMP loc_97DB_запись_действия
bra_97D0:
...
bra_97FD:
C - - - - - 0x00D80D 03:97FD: A9 30     LDA #con_action_30
C - - - - - 0x00D80F 03:97FF: 4C 0E 98  JMP loc_980E_запись_действия
bra_9802:
C - - - - - 0x00D812 03:9802: A9 10     LDA #con_action_10
C - - - - - 0x00D814 03:9804: 4C 0E 98  JMP loc_980E_запись_действия
bra_9807:
- - - - - - 0x00D817 03:9807: A9 0E     LDA #con_action_0E
- - - - - - 0x00D819 03:9809: 4C 0E 98  JMP loc_980E_запись_действия
loc_980C:
C D 0 - - - 0x00D81C 03:980C: A9 09     LDA #con_action_09
