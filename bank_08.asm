...
;                                        JSR sub_подготовка_палитры_vt03
                                        LDA #$00
                                        STA ram_pos_X_lo_camera
                                        STA ram_pos_X_hi_camera
                                        STA ram_pos_Y_lo_camera
                                        STA ram_pos_Y_hi_camera
                                        STA $4016
                                        LDA #$40
                                        STA $4017
                                        LDA #$0F
