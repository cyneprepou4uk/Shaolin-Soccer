...
ofs_8E8F_04_пас:
C - - J - - 0x018E9F 06:8E8F: BD 59 04  LDA ram_действие_мяча - $0C,X
...
C - - - - - 0x018ED8 06:8EC8: BD 2E 04  LDA ram_spd_Z_hi_мяча - $0C,X
C - - - - - 0x018EDB 06:8ECB: 10 05     BPL bra_8ED2
C - - - - - 0x018EDD 06:8ECD: A9 06     LDA #con_action_06
C - - - - - 0x018EDF 06:8ECF: 9D 59 04  STA ram_действие_мяча - $0C,X
bra_8ED2:
...
C - - - - - 0x018EED 06:8EDD: 9D 20 04  STA ram_spd_Z_lo_мяча - $0C,X
C - - - - - 0x018EF0 06:8EE0: 9D 2E 04  STA ram_spd_Z_hi_мяча - $0C,X
C - - - - - 0x018EF3 06:8EE3: A9 07     LDA #con_action_07
C - - - - - 0x018EF5 06:8EE5: 9D 59 04  STA ram_действие_мяча - $0C,X
...
C - - - - - 0x01A004 06:9FF4: 4C 08 A0  JMP loc_A008_запись_действия_мяча
bra_9FF7:
- - - - - - 0x01A007 06:9FF7: A9 01     LDA #$01
- - - - - - 0x01A009 06:9FF9: 4C 08 A0  JMP loc_A008_запись_действия_мяча
bra_9FFC:
...
loc_A008_запись_действия_мяча:   ; bzk опт
