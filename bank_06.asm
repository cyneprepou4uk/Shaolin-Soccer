...
.export loc_0x01802B
loc_0x01802B:
C - - J - - 0x01802B 06:801B: 4C E8 99  JMP loc_99E8_скорость_движения
.export loc_0x01802E
loc_0x01802E:
...
C - - - - - 0x0181F2 06:81E2: 20 EB 99  JSR sub_99EB_скорость_движения
bra_81E5:
...
C - - - - - 0x0183E5 06:83D5: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x0183FD 06:83ED: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018457 06:8447: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x0184D0 06:84C0: 20 EB 99  JSR sub_99EB_скорость_движения
bra_84C3:
...
C - - - - - 0x018529 06:8519: 20 EB 99  JSR sub_99EB_скорость_движения
bra_851C:
...
C - - - - - 0x018573 06:8563: 20 EB 99  JSR sub_99EB_скорость_движения
bra_8566:
...
C - - - - - 0x01859B 06:858B: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x0185CA 06:85BA: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018608 06:85F8: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x01865B 06:864B: 20 EB 99  JSR sub_99EB_скорость_движения
bra_864E:
...
C - - - - - 0x018689 06:8679: 20 EB 99  JSR sub_99EB_скорость_движения
; bzk
loc_867C:
...
C - - - - - 0x0186EF 06:86DF: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018826 06:8816: 20 EB 99  JSR sub_99EB_скорость_движения
...
- - - - - - 0x01888B 06:887B: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018910 06:8900: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018A82 06:8A72: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018ABE 06:8AAE: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018B13 06:8B03: 20 EB 99  JSR sub_99EB_скорость_движения
...
C - - - - - 0x018B5E 06:8B4E: 20 EB 99  JSR sub_99EB_скорость_движения
...
bra_99B9:
C - - - - - 0x0199C9 06:99B9: 4C F3 99  JMP loc_99F3_скорость_движения
...
loc_99E8_скорость_движения:
C D 0 - - - 0x0199F8 06:99E8: AD 93 04  LDA ram_0493
sub_99EB_скорость_движения:
...
tbl_9A57_X_скорость:
tbl_9A57_Y_скорость:
- D 0 - - - 0x019A67 06:9A57: 00 00     .word $0000, $F800      ; $0000, $F800
- D 0 - - - 0x019A6B 06:9A5B: A8 05     .word $05A8, $FA58      ; $05A8, $FA58
- D 0 - - - 0x019A6F 06:9A5F: 00 08     .word $0800, $0000      ; $0800, $0000
- D 0 - - - 0x019A73 06:9A63: A8 05     .word $05A8, $05A8      ; $05A8, $05A8
- D 0 - - - 0x019A77 06:9A67: 00 00     .word $0000, $0800      ; $0000, $0800
- D 0 - - - 0x019A7B 06:9A6B: 58 FA     .word $FA58, $05A8      ; $FA58, $05A8
- D 0 - - - 0x019A7F 06:9A6F: 00 F8     .word $F800, $0000      ; $F800, $0000
- D 0 - - - 0x019A83 06:9A73: 58 FA     .word $FA58, $FA58      ; $FA58, $FA58
