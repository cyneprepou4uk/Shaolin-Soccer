...
C - - - - - 0x0183B8 06:83A8: 9D 6C 04  STA ram_подтип_анимации_игрока,X
...
C - - - - - 0x0184C5 06:84B5: BC 6C 04  LDY ram_подтип_анимации_игрока,X
...
bra_86C8:
C - - - - - 0x0186D8 06:86C8: BD 6C 04  LDA ram_подтип_анимации_игрока,X
...
C - - - - - 0x018AB3 06:8AA3: BC 6C 04  LDY ram_подтип_анимации_игрока,X
...
C - - - - - 0x018BA3 06:8B93: 9D 6C 04  STA ram_подтип_анимации_игрока,X
...
C - - - - - 0x019944 06:9934: 9D 6C 04  STA ram_подтип_анимации_игрока,X
...
sub_9CF8:
C - - - - - 0x019D08 06:9CF8: BD 6C 04  LDA ram_подтип_анимации_игрока,X
...
C - - - - - 0x019E97 06:9E87: 99 6C 04  STA ram_подтип_анимации_игрока,Y
...
C - - - - - 0x01A2C2 06:A2B2: FE 6C 04  INC ram_подтип_анимации_игрока,X
...
C - - - - - 0x01A2D7 06:A2C7: FE 6C 04  INC ram_подтип_анимации_игрока,X
...
C - - - - - 0x01A2E3 06:A2D3: 9D 6C 04  STA ram_подтип_анимации_игрока,X
bra_A2D6_RTS:
...
C - - - - - 0x01B0A3 06:B093: 99 6C 04  STA ram_подтип_анимации_игрока,Y
bra_B096_RTS:
...
C - - - - - 0x01B364 06:B354: BC 6C 04  LDY ram_подтип_анимации_игрока,X
