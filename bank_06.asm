...
.export loc_0x018028
loc_0x018028:
C - - J - - 0x018028 06:8018: 4C 67 98  JMP loc_9867_вычислить_скорость_удара
.export loc_0x01802B
loc_0x01802B:
...
loc_9867_вычислить_скорость_удара:
sub_9867_вычислить_скорость_удара:
...
C - - - - - 0x01A41B 06:A40B: 20 67 98  JSR sub_9867_вычислить_скорость_удара
