...
C - - - - - 0x018268 06:8258: 9D 74 00  STA ram_номер_анимации,X
bra_825B:
loc_825B:
...
bra_85A6:
C - - - - - 0x0185B6 06:85A6: BD 87 00  LDA ram_таймер_кадра_анимации,X
...
bra_8B0B:
C - - - - - 0x018B1B 06:8B0B: BD 87 00  LDA ram_таймер_кадра_анимации,X
...
C - - - - - 0x018BA0 06:8B90: 9D 87 00  STA ram_таймер_кадра_анимации,X
...
- D 0 - - - 0x018CCF 06:8CBF: 5F 90     .word ofs_905F_08
...
C - - - - - 0x018D76 06:8D66: 9D 74 00  STA ram_номер_анимации,X
...
C - - - - - 0x018E6D 06:8E5D: 9D 74 00  STA ram_номер_анимации,X
C - - - - - 0x018E70 06:8E60: AD 0D 05  LDA ram_таймер_мокрого_мяча
C - - - - - 0x018E73 06:8E63: F0 14     BEQ bra_8E79
C - - - - - 0x018E75 06:8E65: FE 87 00  INC ram_таймер_кадра_анимации,X
C - - - - - 0x018E78 06:8E68: BD 87 00  LDA ram_таймер_кадра_анимации,X
C - - - - - 0x018E7B 06:8E6B: C9 04     CMP #$04
C - - - - - 0x018E7D 06:8E6D: B0 05     BCS bra_8E74
C - - - - - 0x018E7F 06:8E6F: A9 05     LDA #$05
C - - - - - 0x018E81 06:8E71: 9D 74 00  STA ram_номер_анимации,X
bra_8E74:
...
C - - - - - 0x018E9B 06:8E8B: 9D 74 00  STA ram_номер_анимации,X
bra_8E8E_RTS:
...
C - - - - - 0x019009 06:8FF9: BD 74 00  LDA ram_номер_анимации,X
C - - - - - 0x01900C 06:8FFC: 29 83     AND #$83
C - - - - - 0x01900E 06:8FFE: 9D 74 00  STA ram_номер_анимации,X
...
C - - - - - 0x01908E 06:907E: 9D 74 00  STA ram_номер_анимации,X
...
bra_9630:
loc_9630:
C D 0 - - - 0x019640 06:9630: BD 74 00  LDA ram_номер_анимации,X
...
C - - - - - 0x01964E 06:963E: 9D 74 00  STA ram_номер_анимации,X
bra_9641_RTS:
...
C - - - - - 0x01965C 06:964C: 9D 74 00  STA ram_номер_анимации,X
...
C - - - - - 0x0196B4 06:96A4: FE 87 00  INC ram_таймер_кадра_анимации,X
C - - - - - 0x0196B7 06:96A7: BD 87 00  LDA ram_таймер_кадра_анимации,X
C - - - - - 0x0196BA 06:96AA: D9 D5 96  CMP tbl_96D5,Y
C - - - - - 0x0196BD 06:96AD: 90 18     BCC bra_96C7
C - - - - - 0x0196BF 06:96AF: A9 00     LDA #$00
C - - - - - 0x0196C1 06:96B1: 9D 87 00  STA ram_таймер_кадра_анимации,X
...
C - - - - - 0x0196D4 06:96C4: 9D 74 00  STA ram_номер_анимации,X
bra_96C7:
loc_96C7:
C D 0 - - - 0x0196D7 06:96C7: BD 74 00  LDA ram_номер_анимации,X
C - - - - - 0x0196DA 06:96CA: 05 1D     ORA ram_001D
C - - - - - 0x0196DC 06:96CC: 9D 74 00  STA ram_номер_анимации,X
...
sub_977B:
C - - - - - 0x01978B 06:977B: BD D9 00  LDA ram_флаг_видимости,X
...
C - - - - - 0x01993E 06:992E: 9D 87 00  STA ram_таймер_кадра_анимации,X
...
- - - - - - 0x019952 06:9942: 9D 87 00  STA ram_таймер_кадра_анимации,X
...
bra_9D5E:
C - - - - - 0x019D6E 06:9D5E: 5D 74 00  EOR ram_номер_анимации,X
C - - - - - 0x019D71 06:9D61: 9D 74 00  STA ram_номер_анимации,X
...
C - - - - - 0x019E94 06:9E84: 99 87 00  STA ram_таймер_кадра_анимации,Y
...
C - - - - - 0x019F7C 06:9F6C: 9D 87 00  STA ram_таймер_кадра_анимации,X
bra_9F6F_RTS:
loc_9F6F_RTS:
...
C - - - - - 0x01B09D 06:B08D: 99 87 00  STA ram_таймер_кадра_анимации,Y
...
C - - - - - 0x01B3BE 06:B3AE: B9 D9 00  LDA ram_флаг_видимости,Y
...
bra_BD07:
C - - - - - 0x01BD17 06:BD07: AD ED 00  LDA ram_камера_X_hi
C - - - - - 0x01BD1A 06:BD0A: D0 0B     BNE bra_BD17
C - - - - - 0x01BD1C 06:BD0C: AD EC 00  LDA ram_камера_X_lo
...
C - - - - - 0x01BD2B 06:BD1B: AD EC 00  LDA ram_камера_X_lo
...
; bzk мусор
- - - - - - 0x01BEF8 06:BEE8: FF        .byte $FF   ; 
- - - - - - 0x01BEF9 06:BEE9: FF        .byte $FF   ; 
- - - - - - 0x01BEFA 06:BEEA: FF        .byte $FF   ; 
- - - - - - 0x01BEFB 06:BEEB: FF        .byte $FF   ; 
- - - - - - 0x01BEFC 06:BEEC: FF        .byte $FF   ; 
- - - - - - 0x01BEFD 06:BEED: FF        .byte $FF   ; 
- - - - - - 0x01BEFE 06:BEEE: FF        .byte $FF   ; 
- - - - - - 0x01BEFF 06:BEEF: FF        .byte $FF   ; 
- - - - - - 0x01BF00 06:BEF0: FF        .byte $FF   ; 
- - - - - - 0x01BF01 06:BEF1: FF        .byte $FF   ; 
- - - - - - 0x01BF02 06:BEF2: FF        .byte $FF   ; 
- - - - - - 0x01BF03 06:BEF3: FF        .byte $FF   ; 
- - - - - - 0x01BF04 06:BEF4: FF        .byte $FF   ; 
- - - - - - 0x01BF05 06:BEF5: FF        .byte $FF   ; 
- - - - - - 0x01BF06 06:BEF6: FF        .byte $FF   ; 
- - - - - - 0x01BF07 06:BEF7: FF        .byte $FF   ; 
- - - - - - 0x01BF08 06:BEF8: FF        .byte $FF   ; 
- - - - - - 0x01BF09 06:BEF9: FF        .byte $FF   ; 
- - - - - - 0x01BF0A 06:BEFA: FF        .byte $FF   ; 
- - - - - - 0x01BF0B 06:BEFB: FF        .byte $FF   ; 
- - - - - - 0x01BF0C 06:BEFC: FF        .byte $FF   ; 
- - - - - - 0x01BF0D 06:BEFD: FF        .byte $FF   ; 
- - - - - - 0x01BF0E 06:BEFE: FF        .byte $FF   ; 
- - - - - - 0x01BF0F 06:BEFF: FF        .byte $FF   ; 
- - - - - - 0x01BF10 06:BF00: FF        .byte $FF   ; 
- - - - - - 0x01BF11 06:BF01: FF        .byte $FF   ; 
- - - - - - 0x01BF12 06:BF02: FF        .byte $FF   ; 
- - - - - - 0x01BF13 06:BF03: FF        .byte $FF   ; 
- - - - - - 0x01BF14 06:BF04: FF        .byte $FF   ; 
- - - - - - 0x01BF15 06:BF05: FF        .byte $FF   ; 
- - - - - - 0x01BF16 06:BF06: FF        .byte $FF   ; 
- - - - - - 0x01BF17 06:BF07: FF        .byte $FF   ; 
- - - - - - 0x01BF18 06:BF08: FF        .byte $FF   ; 
- - - - - - 0x01BF19 06:BF09: FF        .byte $FF   ; 
- - - - - - 0x01BF1A 06:BF0A: FF        .byte $FF   ; 
- - - - - - 0x01BF1B 06:BF0B: FF        .byte $FF   ; 
- - - - - - 0x01BF1C 06:BF0C: FF        .byte $FF   ; 
- - - - - - 0x01BF1D 06:BF0D: FF        .byte $FF   ; 
- - - - - - 0x01BF1E 06:BF0E: FF        .byte $FF   ; 
- - - - - - 0x01BF1F 06:BF0F: FF        .byte $FF   ; 
- - - - - - 0x01BF20 06:BF10: FF        .byte $FF   ; 
- - - - - - 0x01BF21 06:BF11: FF        .byte $FF   ; 
- - - - - - 0x01BF22 06:BF12: FF        .byte $FF   ; 
- - - - - - 0x01BF23 06:BF13: FF        .byte $FF   ; 
- - - - - - 0x01BF24 06:BF14: FF        .byte $FF   ; 
- - - - - - 0x01BF25 06:BF15: FF        .byte $FF   ; 
- - - - - - 0x01BF26 06:BF16: FF        .byte $FF   ; 
- - - - - - 0x01BF27 06:BF17: FF        .byte $FF   ; 
- - - - - - 0x01BF28 06:BF18: FF        .byte $FF   ; 
- - - - - - 0x01BF29 06:BF19: FF        .byte $FF   ; 
- - - - - - 0x01BF2A 06:BF1A: FF        .byte $FF   ; 
- - - - - - 0x01BF2B 06:BF1B: FF        .byte $FF   ; 
- - - - - - 0x01BF2C 06:BF1C: FF        .byte $FF   ; 
- - - - - - 0x01BF2D 06:BF1D: FF        .byte $FF   ; 
- - - - - - 0x01BF2E 06:BF1E: FF        .byte $FF   ; 
- - - - - - 0x01BF2F 06:BF1F: FF        .byte $FF   ; 
- - - - - - 0x01BF30 06:BF20: FF        .byte $FF   ; 
- - - - - - 0x01BF31 06:BF21: FF        .byte $FF   ; 
- - - - - - 0x01BF32 06:BF22: FF        .byte $FF   ; 
- - - - - - 0x01BF33 06:BF23: FF        .byte $FF   ; 
- - - - - - 0x01BF34 06:BF24: FF        .byte $FF   ; 
- - - - - - 0x01BF35 06:BF25: FF        .byte $FF   ; 
- - - - - - 0x01BF36 06:BF26: FF        .byte $FF   ; 
- - - - - - 0x01BF37 06:BF27: FF        .byte $FF   ; 
- - - - - - 0x01BF38 06:BF28: FF        .byte $FF   ; 
- - - - - - 0x01BF39 06:BF29: FF        .byte $FF   ; 
- - - - - - 0x01BF3A 06:BF2A: FF        .byte $FF   ; 
- - - - - - 0x01BF3B 06:BF2B: FF        .byte $FF   ; 
- - - - - - 0x01BF3C 06:BF2C: FF        .byte $FF   ; 
- - - - - - 0x01BF3D 06:BF2D: FF        .byte $FF   ; 
- - - - - - 0x01BF3E 06:BF2E: FF        .byte $FF   ; 
- - - - - - 0x01BF3F 06:BF2F: FF        .byte $FF   ; 
- - - - - - 0x01BF40 06:BF30: FF        .byte $FF   ; 
- - - - - - 0x01BF41 06:BF31: FF        .byte $FF   ; 
- - - - - - 0x01BF42 06:BF32: FF        .byte $FF   ; 
- - - - - - 0x01BF43 06:BF33: FF        .byte $FF   ; 
- - - - - - 0x01BF44 06:BF34: FF        .byte $FF   ; 
- - - - - - 0x01BF45 06:BF35: FF        .byte $FF   ; 
- - - - - - 0x01BF46 06:BF36: FF        .byte $FF   ; 
- - - - - - 0x01BF47 06:BF37: FF        .byte $FF   ; 
- - - - - - 0x01BF48 06:BF38: FF        .byte $FF   ; 
- - - - - - 0x01BF49 06:BF39: FF        .byte $FF   ; 
- - - - - - 0x01BF4A 06:BF3A: FF        .byte $FF   ; 
- - - - - - 0x01BF4B 06:BF3B: FF        .byte $FF   ; 
- - - - - - 0x01BF4C 06:BF3C: FF        .byte $FF   ; 
- - - - - - 0x01BF4D 06:BF3D: FF        .byte $FF   ; 
- - - - - - 0x01BF4E 06:BF3E: FF        .byte $FF   ; 
- - - - - - 0x01BF4F 06:BF3F: FF        .byte $FF   ; 
- - - - - - 0x01BF50 06:BF40: FF        .byte $FF   ; 
- - - - - - 0x01BF51 06:BF41: FF        .byte $FF   ; 
- - - - - - 0x01BF52 06:BF42: FF        .byte $FF   ; 
- - - - - - 0x01BF53 06:BF43: FF        .byte $FF   ; 
- - - - - - 0x01BF54 06:BF44: FF        .byte $FF   ; 
- - - - - - 0x01BF55 06:BF45: FF        .byte $FF   ; 
- - - - - - 0x01BF56 06:BF46: FF        .byte $FF   ; 
- - - - - - 0x01BF57 06:BF47: FF        .byte $FF   ; 
- - - - - - 0x01BF58 06:BF48: FF        .byte $FF   ; 
- - - - - - 0x01BF59 06:BF49: FF        .byte $FF   ; 
- - - - - - 0x01BF5A 06:BF4A: FF        .byte $FF   ; 
- - - - - - 0x01BF5B 06:BF4B: FF        .byte $FF   ; 
- - - - - - 0x01BF5C 06:BF4C: FF        .byte $FF   ; 
- - - - - - 0x01BF5D 06:BF4D: FF        .byte $FF   ; 
- - - - - - 0x01BF5E 06:BF4E: FF        .byte $FF   ; 
- - - - - - 0x01BF5F 06:BF4F: FF        .byte $FF   ; 
- - - - - - 0x01BF60 06:BF50: FF        .byte $FF   ; 
- - - - - - 0x01BF61 06:BF51: FF        .byte $FF   ; 
- - - - - - 0x01BF62 06:BF52: FF        .byte $FF   ; 
- - - - - - 0x01BF63 06:BF53: FF        .byte $FF   ; 
- - - - - - 0x01BF64 06:BF54: FF        .byte $FF   ; 
- - - - - - 0x01BF65 06:BF55: FF        .byte $FF   ; 
- - - - - - 0x01BF66 06:BF56: FF        .byte $FF   ; 
- - - - - - 0x01BF67 06:BF57: FF        .byte $FF   ; 
- - - - - - 0x01BF68 06:BF58: FF        .byte $FF   ; 
- - - - - - 0x01BF69 06:BF59: FF        .byte $FF   ; 
- - - - - - 0x01BF6A 06:BF5A: FF        .byte $FF   ; 
- - - - - - 0x01BF6B 06:BF5B: FF        .byte $FF   ; 
- - - - - - 0x01BF6C 06:BF5C: FF        .byte $FF   ; 
- - - - - - 0x01BF6D 06:BF5D: FF        .byte $FF   ; 
- - - - - - 0x01BF6E 06:BF5E: FF        .byte $FF   ; 
- - - - - - 0x01BF6F 06:BF5F: FF        .byte $FF   ; 
- - - - - - 0x01BF70 06:BF60: FF        .byte $FF   ; 
- - - - - - 0x01BF71 06:BF61: FF        .byte $FF   ; 
- - - - - - 0x01BF72 06:BF62: FF        .byte $FF   ; 
- - - - - - 0x01BF73 06:BF63: FF        .byte $FF   ; 
- - - - - - 0x01BF74 06:BF64: FF        .byte $FF   ; 
- - - - - - 0x01BF75 06:BF65: FF        .byte $FF   ; 
- - - - - - 0x01BF76 06:BF66: FF        .byte $FF   ; 
- - - - - - 0x01BF77 06:BF67: FF        .byte $FF   ; 
- - - - - - 0x01BF78 06:BF68: FF        .byte $FF   ; 
- - - - - - 0x01BF79 06:BF69: FF        .byte $FF   ; 
- - - - - - 0x01BF7A 06:BF6A: FF        .byte $FF   ; 
- - - - - - 0x01BF7B 06:BF6B: FF        .byte $FF   ; 
- - - - - - 0x01BF7C 06:BF6C: FF        .byte $FF   ; 
- - - - - - 0x01BF7D 06:BF6D: FF        .byte $FF   ; 
- - - - - - 0x01BF7E 06:BF6E: FF        .byte $FF   ; 
- - - - - - 0x01BF7F 06:BF6F: FF        .byte $FF   ; 
- - - - - - 0x01BF80 06:BF70: FF        .byte $FF   ; 
- - - - - - 0x01BF81 06:BF71: FF        .byte $FF   ; 
- - - - - - 0x01BF82 06:BF72: FF        .byte $FF   ; 
- - - - - - 0x01BF83 06:BF73: FF        .byte $FF   ; 
- - - - - - 0x01BF84 06:BF74: FF        .byte $FF   ; 
- - - - - - 0x01BF85 06:BF75: FF        .byte $FF   ; 
- - - - - - 0x01BF86 06:BF76: FF        .byte $FF   ; 
- - - - - - 0x01BF87 06:BF77: FF        .byte $FF   ; 
- - - - - - 0x01BF88 06:BF78: FF        .byte $FF   ; 
- - - - - - 0x01BF89 06:BF79: FF        .byte $FF   ; 
- - - - - - 0x01BF8A 06:BF7A: FF        .byte $FF   ; 
- - - - - - 0x01BF8B 06:BF7B: FF        .byte $FF   ; 
- - - - - - 0x01BF8C 06:BF7C: FF        .byte $FF   ; 
- - - - - - 0x01BF8D 06:BF7D: FF        .byte $FF   ; 
- - - - - - 0x01BF8E 06:BF7E: FF        .byte $FF   ; 
- - - - - - 0x01BF8F 06:BF7F: FF        .byte $FF   ; 
- - - - - - 0x01BF90 06:BF80: FF        .byte $FF   ; 
- - - - - - 0x01BF91 06:BF81: FF        .byte $FF   ; 
- - - - - - 0x01BF92 06:BF82: FF        .byte $FF   ; 
- - - - - - 0x01BF93 06:BF83: FF        .byte $FF   ; 
- - - - - - 0x01BF94 06:BF84: FF        .byte $FF   ; 
- - - - - - 0x01BF95 06:BF85: FF        .byte $FF   ; 
- - - - - - 0x01BF96 06:BF86: FF        .byte $FF   ; 
- - - - - - 0x01BF97 06:BF87: FF        .byte $FF   ; 
- - - - - - 0x01BF98 06:BF88: FF        .byte $FF   ; 
- - - - - - 0x01BF99 06:BF89: FF        .byte $FF   ; 
- - - - - - 0x01BF9A 06:BF8A: FF        .byte $FF   ; 
- - - - - - 0x01BF9B 06:BF8B: FF        .byte $FF   ; 
- - - - - - 0x01BF9C 06:BF8C: FF        .byte $FF   ; 
- - - - - - 0x01BF9D 06:BF8D: FF        .byte $FF   ; 
- - - - - - 0x01BF9E 06:BF8E: FF        .byte $FF   ; 
- - - - - - 0x01BF9F 06:BF8F: FF        .byte $FF   ; 
- - - - - - 0x01BFA0 06:BF90: FF        .byte $FF   ; 
- - - - - - 0x01BFA1 06:BF91: FF        .byte $FF   ; 
- - - - - - 0x01BFA2 06:BF92: FF        .byte $FF   ; 
- - - - - - 0x01BFA3 06:BF93: FF        .byte $FF   ; 
- - - - - - 0x01BFA4 06:BF94: FF        .byte $FF   ; 
- - - - - - 0x01BFA5 06:BF95: FF        .byte $FF   ; 
- - - - - - 0x01BFA6 06:BF96: FF        .byte $FF   ; 
- - - - - - 0x01BFA7 06:BF97: FF        .byte $FF   ; 
- - - - - - 0x01BFA8 06:BF98: FF        .byte $FF   ; 
- - - - - - 0x01BFA9 06:BF99: FF        .byte $FF   ; 
- - - - - - 0x01BFAA 06:BF9A: FF        .byte $FF   ; 
- - - - - - 0x01BFAB 06:BF9B: FF        .byte $FF   ; 
- - - - - - 0x01BFAC 06:BF9C: FF        .byte $FF   ; 
- - - - - - 0x01BFAD 06:BF9D: FF        .byte $FF   ; 
- - - - - - 0x01BFAE 06:BF9E: FF        .byte $FF   ; 
- - - - - - 0x01BFAF 06:BF9F: FF        .byte $FF   ; 
- - - - - - 0x01BFB0 06:BFA0: FF        .byte $FF   ; 
- - - - - - 0x01BFB1 06:BFA1: FF        .byte $FF   ; 
- - - - - - 0x01BFB2 06:BFA2: FF        .byte $FF   ; 
- - - - - - 0x01BFB3 06:BFA3: FF        .byte $FF   ; 
- - - - - - 0x01BFB4 06:BFA4: FF        .byte $FF   ; 
- - - - - - 0x01BFB5 06:BFA5: FF        .byte $FF   ; 
- - - - - - 0x01BFB6 06:BFA6: FF        .byte $FF   ; 
- - - - - - 0x01BFB7 06:BFA7: FF        .byte $FF   ; 
- - - - - - 0x01BFB8 06:BFA8: FF        .byte $FF   ; 
- - - - - - 0x01BFB9 06:BFA9: FF        .byte $FF   ; 
- - - - - - 0x01BFBA 06:BFAA: FF        .byte $FF   ; 
- - - - - - 0x01BFBB 06:BFAB: FF        .byte $FF   ; 
- - - - - - 0x01BFBC 06:BFAC: FF        .byte $FF   ; 
- - - - - - 0x01BFBD 06:BFAD: FF        .byte $FF   ; 
- - - - - - 0x01BFBE 06:BFAE: FF        .byte $FF   ; 
- - - - - - 0x01BFBF 06:BFAF: FF        .byte $FF   ; 
- - - - - - 0x01BFC0 06:BFB0: FF        .byte $FF   ; 
- - - - - - 0x01BFC1 06:BFB1: FF        .byte $FF   ; 
- - - - - - 0x01BFC2 06:BFB2: FF        .byte $FF   ; 
- - - - - - 0x01BFC3 06:BFB3: FF        .byte $FF   ; 
- - - - - - 0x01BFC4 06:BFB4: FF        .byte $FF   ; 
- - - - - - 0x01BFC5 06:BFB5: FF        .byte $FF   ; 
- - - - - - 0x01BFC6 06:BFB6: FF        .byte $FF   ; 
- - - - - - 0x01BFC7 06:BFB7: FF        .byte $FF   ; 
- - - - - - 0x01BFC8 06:BFB8: FF        .byte $FF   ; 
- - - - - - 0x01BFC9 06:BFB9: FF        .byte $FF   ; 
- - - - - - 0x01BFCA 06:BFBA: FF        .byte $FF   ; 
- - - - - - 0x01BFCB 06:BFBB: FF        .byte $FF   ; 
- - - - - - 0x01BFCC 06:BFBC: FF        .byte $FF   ; 
- - - - - - 0x01BFCD 06:BFBD: FF        .byte $FF   ; 
- - - - - - 0x01BFCE 06:BFBE: FF        .byte $FF   ; 
- - - - - - 0x01BFCF 06:BFBF: FF        .byte $FF   ; 
- - - - - - 0x01BFD0 06:BFC0: FF        .byte $FF   ; 
- - - - - - 0x01BFD1 06:BFC1: FF        .byte $FF   ; 
- - - - - - 0x01BFD2 06:BFC2: FF        .byte $FF   ; 
- - - - - - 0x01BFD3 06:BFC3: FF        .byte $FF   ; 
- - - - - - 0x01BFD4 06:BFC4: FF        .byte $FF   ; 
- - - - - - 0x01BFD5 06:BFC5: FF        .byte $FF   ; 
- - - - - - 0x01BFD6 06:BFC6: FF        .byte $FF   ; 
- - - - - - 0x01BFD7 06:BFC7: FF        .byte $FF   ; 
- - - - - - 0x01BFD8 06:BFC8: FF        .byte $FF   ; 
- - - - - - 0x01BFD9 06:BFC9: FF        .byte $FF   ; 
- - - - - - 0x01BFDA 06:BFCA: FF        .byte $FF   ; 
- - - - - - 0x01BFDB 06:BFCB: FF        .byte $FF   ; 
- - - - - - 0x01BFDC 06:BFCC: FF        .byte $FF   ; 
- - - - - - 0x01BFDD 06:BFCD: FF        .byte $FF   ; 
- - - - - - 0x01BFDE 06:BFCE: FF        .byte $FF   ; 
- - - - - - 0x01BFDF 06:BFCF: FF        .byte $FF   ; 
- - - - - - 0x01BFE0 06:BFD0: FF        .byte $FF   ; 
- - - - - - 0x01BFE1 06:BFD1: FF        .byte $FF   ; 
- - - - - - 0x01BFE2 06:BFD2: FF        .byte $FF   ; 
- - - - - - 0x01BFE3 06:BFD3: FF        .byte $FF   ; 
- - - - - - 0x01BFE4 06:BFD4: FF        .byte $FF   ; 
- - - - - - 0x01BFE5 06:BFD5: FF        .byte $FF   ; 
- - - - - - 0x01BFE6 06:BFD6: FF        .byte $FF   ; 
- - - - - - 0x01BFE7 06:BFD7: FF        .byte $FF   ; 
- - - - - - 0x01BFE8 06:BFD8: FF        .byte $FF   ; 
- - - - - - 0x01BFE9 06:BFD9: FF        .byte $FF   ; 
- - - - - - 0x01BFEA 06:BFDA: FF        .byte $FF   ; 
- - - - - - 0x01BFEB 06:BFDB: FF        .byte $FF   ; 
- - - - - - 0x01BFEC 06:BFDC: FF        .byte $FF   ; 
- - - - - - 0x01BFED 06:BFDD: FF        .byte $FF   ; 
- - - - - - 0x01BFEE 06:BFDE: FF        .byte $FF   ; 
- - - - - - 0x01BFEF 06:BFDF: FF        .byte $FF   ; 
- - - - - - 0x01BFF0 06:BFE0: FF        .byte $FF   ; 
- - - - - - 0x01BFF1 06:BFE1: FF        .byte $FF   ; 
- - - - - - 0x01BFF2 06:BFE2: FF        .byte $FF   ; 
- - - - - - 0x01BFF3 06:BFE3: FF        .byte $FF   ; 
- - - - - - 0x01BFF4 06:BFE4: FF        .byte $FF   ; 
- - - - - - 0x01BFF5 06:BFE5: FF        .byte $FF   ; 
- - - - - - 0x01BFF6 06:BFE6: FF        .byte $FF   ; 
- - - - - - 0x01BFF7 06:BFE7: FF        .byte $FF   ; 
- - - - - - 0x01BFF8 06:BFE8: FF        .byte $FF   ; 
- - - - - - 0x01BFF9 06:BFE9: FF        .byte $FF   ; 
- - - - - - 0x01BFFA 06:BFEA: FF        .byte $FF   ; 
- - - - - - 0x01BFFB 06:BFEB: FF        .byte $FF   ; 
- - - - - - 0x01BFFC 06:BFEC: FF        .byte $FF   ; 
- - - - - - 0x01BFFD 06:BFED: FF        .byte $FF   ; 
- - - - - - 0x01BFFE 06:BFEE: FF        .byte $FF   ; 
- - - - - - 0x01BFFF 06:BFEF: FF        .byte $FF   ; 
- - - - - - 0x01C000 06:BFF0: FF        .byte $FF   ; 
- - - - - - 0x01C001 06:BFF1: FF        .byte $FF   ; 
- - - - - - 0x01C002 06:BFF2: FF        .byte $FF   ; 
- - - - - - 0x01C003 06:BFF3: FF        .byte $FF   ; 
- - - - - - 0x01C004 06:BFF4: FF        .byte $FF   ; 
- - - - - - 0x01C005 06:BFF5: FF        .byte $FF   ; 
- - - - - - 0x01C006 06:BFF6: FF        .byte $FF   ; 
- - - - - - 0x01C007 06:BFF7: FF        .byte $FF   ; 
- - - - - - 0x01C008 06:BFF8: FF        .byte $FF   ; 
- - - - - - 0x01C009 06:BFF9: FF        .byte $FF   ; 
- - - - - - 0x01C00A 06:BFFA: FF        .byte $FF   ; 
- - - - - - 0x01C00B 06:BFFB: FF        .byte $FF   ; 
- - - - - - 0x01C00C 06:BFFC: FF        .byte $FF   ; 
- - - - - - 0x01C00D 06:BFFD: FF        .byte $FF   ; 
- - - - - - 0x01C00E 06:BFFE: FF        .byte $FF   ; 
