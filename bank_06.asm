...
; удалена проверка что соперник в воздухе, для того чтобы можно было давать пиздюлей с земли,если соперник не слишком высоко и достает хитбокс
bra_B175_в_воздухе:
...
C - - - - - 0x01B1A4 06:B194: 90 D1     BCC bra_B175_в_воздухе
