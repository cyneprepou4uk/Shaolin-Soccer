...
C - - - - - 0x0183B8 06:83A8: 9D 6C 04  STA ram_категория_анимации_игрока,X
...
C - - - - - 0x0184C5 06:84B5: BC 6C 04  LDY ram_категория_анимации_игрока,X
...
bra_86C8:
C - - - - - 0x0186D8 06:86C8: BD 6C 04  LDA ram_категория_анимации_игрока,X
...
C - - - - - 0x018AB3 06:8AA3: BC 6C 04  LDY ram_категория_анимации_игрока,X
...
C - - - - - 0x018BA3 06:8B93: 9D 6C 04  STA ram_категория_анимации_игрока,X
...
C - - - - - 0x018CAD 06:8C9D: BD 59 04  LDA ram_действие_мяча - con_индекс_мяча,X
...
ofs_8E8F_04_пас:
C - - J - - 0x018E9F 06:8E8F: BD 59 04  LDA ram_действие_мяча - con_индекс_мяча,X
...
C - - - - - 0x018ED8 06:8EC8: BD 2E 04  LDA ram_spd_Z_hi_мяча - con_индекс_мяча,X
C - - - - - 0x018EDB 06:8ECB: 10 05     BPL bra_8ED2
C - - - - - 0x018EDD 06:8ECD: A9 06     LDA #con_action_06
C - - - - - 0x018EDF 06:8ECF: 9D 59 04  STA ram_действие_мяча - con_индекс_мяча,X
bra_8ED2:
...
C - - - - - 0x018EED 06:8EDD: 9D 20 04  STA ram_spd_Z_lo_мяча - con_индекс_мяча,X
C - - - - - 0x018EF0 06:8EE0: 9D 2E 04  STA ram_spd_Z_hi_мяча - con_индекс_мяча,X
C - - - - - 0x018EF3 06:8EE3: A9 07     LDA #con_action_07
C - - - - - 0x018EF5 06:8EE5: 9D 59 04  STA ram_действие_мяча - con_индекс_мяча,X
...
C - - - - - 0x019944 06:9934: 9D 6C 04  STA ram_категория_анимации_игрока,X
...
sub_9CF8:
C - - - - - 0x019D08 06:9CF8: BD 6C 04  LDA ram_категория_анимации_игрока,X
...
C - - - - - 0x019E97 06:9E87: 99 6C 04  STA ram_категория_анимации_игрока,Y
...
C - - - - - 0x01A139 06:A129: B9 90 06  LDA ram_флаг_кипера_в_штрафной + con_индекс_кипера,Y
...
C - - - - - 0x01A245 06:A235: C9 0F     CMP #con_индекс_мексики
...
bra_A248:
C - - - - - 0x01A258 06:A248: E0 0A     CPX #con_индекс_кипера
...
C - - - - - 0x01A2C2 06:A2B2: FE 6C 04  INC ram_категория_анимации_игрока,X
...
C - - - - - 0x01A2D7 06:A2C7: FE 6C 04  INC ram_категория_анимации_игрока,X
...
C - - - - - 0x01A2E3 06:A2D3: 9D 6C 04  STA ram_категория_анимации_игрока,X
bra_A2D6_RTS:
...
C - - - - - 0x01B0A3 06:B093: 99 6C 04  STA ram_категория_анимации_игрока,Y
bra_B096_RTS:
...
C - - - - - 0x01B364 06:B354: BC 6C 04  LDY ram_категория_анимации_игрока,X
