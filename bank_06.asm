...
sub_9D65:
.scope
tmp_кто_пиздит      = ram_001C
tmp_кого_пиздят     = ram_001D
...
C - - - - - 0x019D86 06:9D76: 90 17     BCC bra_9D8F_запись_итоговой_силы_в_temp    ; если это не кипер
...
C - - - - - 0x019D9B 06:9D8B: 90 02     BCC bra_9D8F_запись_итоговой_силы_в_temp    ; если not overflow
- - - - - - 0x019D9D 06:9D8D: A9 FF     LDA #$FF
bra_9D8F_запись_итоговой_силы_в_temp:
