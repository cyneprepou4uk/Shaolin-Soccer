...
C - - - - - 0x00AB4C 02:AB3C: 20 47 C0  JSR sub_0x01D046_ожидание_записи_палитры_в_буфер
bra_AB3F_RTS:
...
C - - - - - 0x00B045 02:B035: D6 87     DEC ram_таймер_анимации_игрока,X
...
bra_B049:
C - - - - - 0x00B059 02:B049: F6 94     INC ram_кадр_анимации_игрока,X
C - - - - - 0x00B05B 02:B04B: B5 94     LDA ram_кадр_анимации_игрока,X
...
C - - - - - 0x00B06B 02:B05B: B5 74     LDA ram_номер_анимации_игрока,X
C - - - - - 0x00B06D 02:B05D: 49 01     EOR #$01
bra_B05F:
C - - - - - 0x00B06F 02:B05F: 09 80     ORA #$80
C - - - - - 0x00B071 02:B061: 95 74     STA ram_номер_анимации_игрока,X
; bzk возможно баг, тот же байт для номера анимации и таймера
C - - - - - 0x00B073 02:B063: B9 70 B0  LDA tbl_B06F + 1,Y
C - - - - - 0x00B076 02:B066: 95 87     STA ram_таймер_анимации_игрока,X
bra_B068:
