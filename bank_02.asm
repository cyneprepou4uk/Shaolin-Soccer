...
C - - - - - 0x00B27E 02:B26E: 9D 6C 04  STA ram_подтип_анимации_игрока,X
...
C - - - - - 0x00B29F 02:B28F: 9D 6C 04  STA ram_подтип_анимации_игрока,X
...
C - - - - - 0x00B8BE 02:B8AE: 9D 6C 04  STA ram_подтип_анимации_игрока,X
