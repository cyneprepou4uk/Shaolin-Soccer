...
C - - - - - 0x014372 05:8362: 8D 62 00  STA ram_0061 + 1
...
C - - - - - 0x014386 05:8376: 8D 63 00  STA ram_0061 + 2
C - - - - - 0x014389 05:8379: A9 01     LDA #$01    ; con_action_стоит_на_месте
C - - - - - 0x01438B 05:837B: 8D 6D 00  STA ram_006D_мяч
...
bra_83C3_loop:
C - - - - - 0x0143D3 05:83C3: 9D 6E 04  STA ram_тип_анимации_игрока + 2,X
...
C - - - - - 0x014554 05:8544: B9 6E 04  LDA ram_тип_анимации_игрока + 2,Y
C - - - - - 0x014557 05:8547: 69 01     ADC #$01
loc_8549:
C D 0 - - - 0x014559 05:8549: 29 0F     AND #$0F
C - - - - - 0x01455B 05:854B: 99 6E 04  STA ram_тип_анимации_игрока + 2,Y
...
C - - - - - 0x01457C 05:856C: B9 6E 04  LDA ram_тип_анимации_игрока + 2,Y
...
C - - - - - 0x014A82 05:8A72: 99 6E 04  STA ram_тип_анимации_игрока + 2,Y
...
sub_8AA8:
bra_8AA8_loop:
C - - - - - 0x014AB8 05:8AA8: B9 6E 04  LDA ram_тип_анимации_игрока + 2,Y
...
C - - - - - 0x014AF4 05:8AE4: 8D 63 00  STA ram_0061 + 2
C - - - - - 0x014AF7 05:8AE7: 8D 64 00  STA ram_0061 + 3
C - - - - - 0x014AFA 05:8AEA: A9 01     LDA #$01
C - - - - - 0x014AFC 05:8AEC: 8D 6D 00  STA ram_006D_мяч
...
C - - - - - 0x015036 05:9026: 8D 62 00  STA ram_0061 + 1
C - - - - - 0x015039 05:9029: 8D 64 00  STA ram_0061 + 3
...
C - - - - - 0x0151C4 05:91B4: 20 BB 91  JSR sub_91BB_признать_действие_и_очистить_адреса_анимаций
bra_91B7:
...
sub_91BB_признать_действие_и_очистить_адреса_анимаций:  ; bzk опт, единственная ссылка сюда
...
C - - - - - 0x0151D8 05:91C8: 9D 6C 04  STA ram_тип_анимации_игрока,X
...
C - - - - - 0x0153BE 05:93AE: 8D 62 00  STA ram_0061 + 1
...
C - - - - - 0x01630E 05:A2FE: 9D 61 00  STA ram_0061
...
C - - - - - 0x0165AC 05:A59C: 8D 63 00  STA ram_0061 + 2
...
C - - - - - 0x016804 05:A7F4: 9D 62 00  STA ram_0061 + 1,X
...
- - - - - - 0x017307 05:B2F7: 8C 6D 00  STY ram_006D_мяч
...
- - - - - - 0x0174F0 05:B4E0: 8D 6D 00  STA ram_006D_мяч
...
bra_B915_loop:
C - - - - - 0x017925 05:B915: B9 6E 04  LDA ram_тип_анимации_игрока + 2,Y
