...
bra_83C3_loop:
C - - - - - 0x0143D3 05:83C3: 9D 6E 04  STA ram_подтип_анимации_игрока + 2,X
...
C - - - - - 0x014554 05:8544: B9 6E 04  LDA ram_подтип_анимации_игрока + 2,Y
C - - - - - 0x014557 05:8547: 69 01     ADC #$01
loc_8549:
C D 0 - - - 0x014559 05:8549: 29 0F     AND #$0F
C - - - - - 0x01455B 05:854B: 99 6E 04  STA ram_подтип_анимации_игрока + 2,Y
...
C - - - - - 0x01457C 05:856C: B9 6E 04  LDA ram_подтип_анимации_игрока + 2,Y
...
C - - - - - 0x014A82 05:8A72: 99 6E 04  STA ram_подтип_анимации_игрока + 2,Y
...
sub_8AA8:
bra_8AA8_loop:
C - - - - - 0x014AB8 05:8AA8: B9 6E 04  LDA ram_подтип_анимации_игрока + 2,Y
...
C - - - - - 0x0151D8 05:91C8: 9D 6C 04  STA ram_подтип_анимации_игрока,X
bra_91B7:
...
bra_B915_loop:
C - - - - - 0x017925 05:B915: B9 6E 04  LDA ram_подтип_анимации_игрока + 2,Y
