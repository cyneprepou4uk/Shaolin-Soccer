...
sub_A2F7:
C - - - - - 0x016307 05:A2F7: A2 00     LDX #$00    ; bzk опт
C - - - - - 0x016309 05:A2F9: A9 00     LDA #$00
C - - - - - 0x01630B 05:A2FB: 9D 74 00  STA ram_анимация_игрока,X
...
C - - - - - 0x016317 05:A307: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x01631A 05:A30A: B9 17 A3  LDA tbl_A317,Y
C - - - - - 0x01631D 05:A30D: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x016320 05:A310: A9 09     LDA #con_action_09
C - - - - - 0x016322 05:A312: 9D 59 04  STA ram_действие_игрока,X
