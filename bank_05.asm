...
C - - - - - 0x0143E2 05:83D2: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x0146BD 05:86AD: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x014775 05:8765: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x014898 05:8888: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x0148C4 05:88B4: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x0148D8 05:88C8: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x014B86 05:8B76: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x014D01 05:8CF1: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x014E48 05:8E38: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x015078 05:9068: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x01528A 05:927A: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x01541E 05:940E: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x0157D6 05:97C6: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x0158D0 05:98C0: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x015DA3 05:9D93: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x01614C 05:A13C: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x016172 05:A162: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x016303 05:A2F3: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x0165E8 05:A5D8: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x0166E9 05:A6D9: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x01686B 05:A85B: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
C - - - - - 0x016A95 05:AA85: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
C - - - - - 0x016CBA 05:ACAA: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
- - - - - - 0x017347 05:B337: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
- - - - - - 0x0173C5 05:B3B5: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
...
- - - - - - 0x0174B0 05:B4A0: 20 5C C0  JSR sub_0x01D083_обработка_яркости_без_задержки
...
- - - - - - 0x0174D4 05:B4C4: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_задержкой_кадра
