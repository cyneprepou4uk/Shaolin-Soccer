...
bra_811E_loop:
C - - - - - 0x01412E 05:811E: A9 00     LDA #$00    ; con_action_00   con_state_стоит_идет
...
C - - - - - 0x01436A 05:835A: A9 00     LDA #$00    ; con_id_японии  con_anim_type_полевой
...
C - - - - - 0x014389 05:8379: A9 01     LDA #$01    ; con_action_стоит_на_месте  con_act_ball_01  con_anim_type_мяч
...
bra_8B06:
C - - - - - 0x014B16 05:8B06: A9 00     LDA #$00    ; con_anim_type_00
...
sub_A2F7:
C - - - - - 0x016309 05:A2F9: A9 00     LDA #$00    ; con_anim_type_00
...
C - - - - - 0x0165A2 05:A592: A9 07     LDA #$07    ; con_action_07  con_anim_type_победная
...
- - - - - - 0x017305 05:B2F5: A0 04     LDY #con_anim_type_04
- - - - - - 0x017307 05:B2F7: 8C 6D 00  STY ram_тип_анимации_мяча
- - - - - - 0x01730A 05:B2FA: C8        INY ; con_anim_type_стрелочка_рожи
- - - - - - 0x01730B 05:B2FB: 8C 61 00  STY ram_тип_анимации_игрока
...
- - - - - - 0x01748E 05:B47E: 30 0E     BMI bra_B48E    ; bzk разве бывает +80?
