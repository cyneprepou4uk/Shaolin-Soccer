...
.export loc_0x014010_скрипт_меню
.export loc_0x014013_рожи
.export loc_0x014016_выбор_палитры_командам
.export loc_0x014019
.export loc_0x01401C
...
loc_0x014010_скрипт_меню:
C D 0 J - - 0x014010 05:8000: 4C 55 80  JMP loc_8055_скрипт_меню

loc_0x014013_рожи:
C - - J - - 0x014013 05:8003: 4C 38 BD  JMP loc_BD38_рожи

loc_0x014016_выбор_палитры_командам:
C - - J - - 0x014016 05:8006: 4C B0 BD  JMP loc_BDB0_выбор_палитры_командам
...
loc_8055_скрипт_меню:
C D 0 - - - 0x014065 05:8055: A5 59     LDA ram_subscript
C - - - - - 0x014067 05:8057: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
sub_80DF_подготовить_и_отрисовать_экран:
...
C - - - - - 0x014113 05:8103: 8D CE 05  STA ram_суб_смещение_стрелки_в_меню_по_X
C - - - - - 0x014116 05:8106: A9 F0     LDA #$F0
C - - - - - 0x014118 05:8108: 8D 56 00  STA ram_ограничитель_Y_спрайтов
...
C - - - - - 0x014129 05:8119: 20 59 C0  JSR sub_0x01D05F_включить_осветление_яркости
C - - - - - 0x01412C 05:811C: A2 0C     LDX #$0C
bra_811E_loop:
C - - - - - 0x01412E 05:811E: A9 00     LDA #con_action_00
C - - - - - 0x014130 05:8120: 9D 59 04  STA ram_действие_игрока,X
                                        LDA #con_state_стоит_идет
C - - - - - 0x014133 05:8123: 9D 86 04  STA ram_состояние_игрока,X
                                        LDA #con_направо
C - - - - - 0x014136 05:8126: 9D A3 04  STA ram_напр_движ_игрока,X
                                        LDA #$00
C - - - - - 0x014139 05:8129: 9D B0 04  STA ram_смена_угла_движения,X
C - - - - - 0x01413C 05:812C: 9D E8 03  STA ram_spd_X_lo_игрока,X
C - - - - - 0x01413F 05:812F: 9D F6 03  STA ram_spd_X_hi_игрока,X
C - - - - - 0x014142 05:8132: 9D 04 04  STA ram_spd_Y_lo_игрока,X
C - - - - - 0x014145 05:8135: 9D 12 04  STA ram_spd_Y_hi_игрока,X
C - - - - - 0x014148 05:8138: 9D 20 04  STA ram_spd_Z_lo_игрока,X
C - - - - - 0x01414B 05:813B: 9D 2E 04  STA ram_spd_Z_hi_игрока,X
C - - - - - 0x01414E 05:813E: 9D 01 03  STA ram_pos_X_sub_игрока,X
C - - - - - 0x014151 05:8141: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x014154 05:8144: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x014157 05:8147: 9D 3A 03  STA ram_pos_Y_sub_игрока,X
C - - - - - 0x01415A 05:814A: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x01415D 05:814D: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x014160 05:8150: 9D 73 03  STA ram_pos_Z_sub_игрока,X
C - - - - - 0x014163 05:8153: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x014166 05:8156: 9D 99 03  STA ram_pos_Z_hi_игрока,X
C - - - - - 0x014169 05:8159: 9D 4A 04  STA ram_gravity_hi_игрока,X
C - - - - - 0x01416C 05:815C: 9D 3C 04  STA ram_gravity_lo_игрока,X
C - - - - - 0x01416F 05:815F: A9 FF     LDA #$FF
C - - - - - 0x014171 05:8161: 9D 79 04  STA ram_next_действие_игрока,X
...
tbl_816E_экраны:
- - - - - - 0x01417E 05:816E: FF        .byte $FF   ; 00 
- D 0 - - - 0x01417F 05:816F: 02        .byte $02   ; 01 главное меню
- D 0 - - - 0x014180 05:8170: 03        .byte $03   ; 02 выбор из таблицы команды на матч в режиме прохождения
- D 0 - - - 0x014181 05:8171: 0B        .byte $0B   ; 03 экран VS
- D 0 - - - 0x014182 05:8172: 04        .byte $04   ; 04 экран раздевалки со всеми опциями
- D 0 - - - 0x014183 05:8173: 06        .byte $06   ; 05 экран с выбором команд
- D 0 - - - 0x014184 05:8174: 07        .byte $07   ; 06 экран с выбором погоды
- D 0 - - - 0x014185 05:8175: 05        .byte $05   ; 07 экран с расстановкой
- D 0 - - - 0x014186 05:8176: 08        .byte $08   ; 08 экран с информацией о погоде
- D 0 - - - 0x014187 05:8177: 0D        .byte $0D   ; 09 экран со статистикой против 12 команд, вход через раздевалку
- D 0 - - - 0x014188 05:8178: 0C        .byte $0C   ; 0A экран с хатарактеристиками выбранного японца
- D 0 - - - 0x014189 05:8179: 09        .byte $09   ; 0B экран с выбором музыки
- - - - - - 0x01418A 05:817A: 0F        .byte $0F   ; 0C хз, предположительно какой-то экран раздевалки
- D 0 - - - 0x01418B 05:817B: 0A        .byte $0A   ; 0D экран со всеми 12 игроками японии, можно с ними побазарить
- - - - - - 0x01418C 05:817C: 14        .byte $14   ; 0E 
- - - - - - 0x01418D 05:817D: 15        .byte $15   ; 0F турнирная сетка
...
C - - - - - 0x014192 05:8182: F0 0E     BEQ bra_8192_не_Start_или_Select
C - - - - - 0x014194 05:8184: 29 10     AND #con_btn_Start
C - - - - - 0x014196 05:8186: F0 05     BEQ bra_818D_это_Select
...
C - - - - - 0x0141C1 05:81B1: B0 15     BCS bra_81C8_нажато_Left
C - - - - - 0x0141C3 05:81B3: 4A        LSR
C - - - - - 0x0141C4 05:81B4: B0 0D     BCS bra_81C3_нажато_Down
C - - - - - 0x0141C6 05:81B6: 4A        LSR
C - - - - - 0x0141C7 05:81B7: B0 05     BCS bra_81BE_нажато_Up
...
sub_81DD_сдвинуть_курсор_на_нужную_позицию:
C - - - - - 0x0141ED 05:81DD: AD CD 05  LDA ram_btn_menu
C - - - - - 0x0141F0 05:81E0: C9 05     CMP #$05
C - - - - - 0x0141F2 05:81E2: 90 20     BCC bra_8204_RTS    ; если это не кнопка Dpad
...
sub_8205_прочитать_поинтеры_после_JSR:
...
C - - - - - 0x014245 05:8235: 9D 14 03  STA ram_pos_X_lo_игрока,X
...
bra_8241:
C - - - - - 0x014251 05:8241: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x014254 05:8244: A9 00     LDA #$00
C - - - - - 0x014256 05:8246: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x014259 05:8249: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x01425C 05:824C: A0 00     LDY #$00
bra_824E_loop:
C - - - - - 0x01425E 05:824E: 1E 14 03  ASL ram_pos_X_lo_игрока,X
C - - - - - 0x014261 05:8251: 3E 27 03  ROL ram_pos_X_hi_игрока,X
C - - - - - 0x014264 05:8254: 1E 4D 03  ASL ram_pos_Y_lo_игрока,X
C - - - - - 0x014267 05:8257: 3E 60 03  ROL ram_pos_Y_hi_игрока,X
C - - - - - 0x01426A 05:825A: C8        INY
C - - - - - 0x01426B 05:825B: C0 03     CPY #$03
C - - - - - 0x01426D 05:825D: 90 EF     BCC bra_824E_loop
C - - - - - 0x01426F 05:825F: AD CE 05  LDA ram_суб_смещение_стрелки_в_меню_по_X
C - - - - - 0x014272 05:8262: 29 0F     AND #$0F
C - - - - - 0x014274 05:8264: 18        CLC
C - - - - - 0x014275 05:8265: 7D 14 03  ADC ram_pos_X_lo_игрока,X
C - - - - - 0x014278 05:8268: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x01427B 05:826B: BD 27 03  LDA ram_pos_X_hi_игрока,X
C - - - - - 0x01427E 05:826E: 69 00     ADC #$00
C - - - - - 0x014280 05:8270: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x014283 05:8273: 18        CLC
C - - - - - 0x014284 05:8274: BD 4D 03  LDA ram_pos_Y_lo_игрока,X
C - - - - - 0x014287 05:8277: 69 07     ADC #$07
C - - - - - 0x014289 05:8279: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x01428C 05:827C: BD 60 03  LDA ram_pos_Y_hi_игрока,X
C - - - - - 0x01428F 05:827F: 69 00     ADC #$00
C - - - - - 0x014291 05:8281: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x014294 05:8284: A9 00     LDA #$00
C - - - - - 0x014296 05:8286: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x014299 05:8289: 9D 99 03  STA ram_pos_Z_hi_игрока,X
...
C - - - - - 0x0142B4 05:82A4: 9D 74 00  STA ram_номер_анимации_игрока,X
C - - - - - 0x0142B7 05:82A7: 4C AF 82  RTS
bra_82AA:
C - - - - - 0x0142BA 05:82AA: A9 7F     LDA #$7F
C - - - - - 0x0142BC 05:82AC: 9D 74 00  STA ram_номер_анимации_игрока,X
...
C - - - - - 0x01434A 05:833A: 30 06     BMI bra_8342_подготовка_уже_была
C - - - - - 0x01434C 05:833C: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x01434F 05:833F: 20 55 83  JSR sub_8355
bra_8342_подготовка_уже_была:
C - - - - - 0x014352 05:8342: 20 93 85  JSR sub_8593
C - - - - - 0x014355 05:8345: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x014358 05:8348: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x01436F 05:835F: 8D 61 00  STA ram_тип_анимации_игрока
C - - - - - 0x014372 05:8362: 8D 62 00  STA ram_тип_анимации_игрока + 1
                                        LDA #$00
...
C - - - - - 0x014384 05:8374: A9 05     LDA #con_anim_type_стрелочка_рожи
...
C - - - - - 0x014394 05:8384: 8D 59 04  STA ram_действие_игрока
                                        LDA #con_act_ball_01
C - - - - - 0x014397 05:8387: 8D 65 04  STA ram_действие_мяча
C - - - - - 0x01439A 05:838A: A9 80     LDA #$80
C - - - - - 0x01439C 05:838C: 8D 14 03  STA ram_pos_X_lo_игрока
C - - - - - 0x01439F 05:838F: A9 8C     LDA #$8C
C - - - - - 0x0143A1 05:8391: 8D 20 03  STA ram_pos_X_lo_мяча
C - - - - - 0x0143A4 05:8394: A9 A4     LDA #$A4
C - - - - - 0x0143A6 05:8396: 8D 4D 03  STA ram_pos_Y_lo_игрока
...
C - - - - - 0x0143B1 05:83A1: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x0143D1 05:83C1: A9 00     LDA #$00    ; полевой
bra_83C3_loop:
C - - - - - 0x0143D3 05:83C3: 9D 6E 04  STA ram_подтип_анимации + 2,X
...
C - - - - - 0x0143DD 05:83CD: 10 03     BPL bra_83D2_яркость_не_готова
C - - - - - 0x0143DF 05:83CF: EE C9 05  INC ram_счетчик_опций
bra_83D2_яркость_не_готова:
C - - - - - 0x0143E2 05:83D2: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
C - - - - - 0x0143E5 05:83D5: 20 41 80  JSR sub_0x01C297
C - - - - - 0x0143E8 05:83D8: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x014404 05:83F4: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014423 05:8413: A9 11     LDA #con_action_базарит    ; кунио базарит
C - - - - - 0x014425 05:8415: 8D 79 04  STA ram_next_действие_игрока
...
C - - - - - 0x01443B 05:842B: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x014452 05:8442: A9 11     LDA #con_action_базарит    ; кунио базарит
C - - - - - 0x014454 05:8444: 8D 79 04  STA ram_next_действие_игрока
...
C - - - - - 0x01445F 05:844F: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x014481 05:8471: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x01449B 05:848B: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0144BF 05:84AF: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x0144DE 05:84CE: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014504 05:84F4: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x01451C 05:850C: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014554 05:8544: B9 6E 04  LDA ram_подтип_анимации + 2,Y
C - - - - - 0x014557 05:8547: 69 01     ADC #$01
loc_8549:
C D 0 - - - 0x014559 05:8549: 29 0F     AND #$0F
C - - - - - 0x01455B 05:854B: 99 6E 04  STA ram_подтип_анимации + 2,Y
...
C - - - - - 0x01457C 05:856C: B9 6E 04  LDA ram_подтип_анимации + 2,Y
...
sub_8593:
C - - - - - 0x0145A3 05:8593: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
sub_860C:
C - - - - - 0x01461C 05:860C: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x014640 05:8630: 85 57     STA ram_опция_режим_и_сложность
...
sub_863A:
C - - - - - 0x01464A 05:863A: A5 5D     LDA ram_колво_игроков
C - - - - - 0x01464C 05:863C: D0 04     BNE bra_8642
- - - - - - 0x01464E 05:863E: A9 01     LDA #$01
- - - - - - 0x014650 05:8640: 85 5D     STA ram_колво_игроков
bra_8642:
C - - - - - 0x014652 05:8642: A0 00     LDY #$00
C - - - - - 0x014654 05:8644: A5 57     LDA ram_опция_режим_и_сложность
loc_8646_loop:
...
C - - - - - 0x014660 05:8650: 65 5D     ADC ram_колво_игроков
...
sub_866B:
C - - - - - 0x01467B 05:866B: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x014688 05:8678: A5 57     LDA ram_опция_режим_и_сложность
C - - - - - 0x01468A 05:867A: 29 0F     AND #$0F
C - - - - - 0x01468C 05:867C: 19 87 86  ORA tbl_8687,Y
C - - - - - 0x01468F 05:867F: 85 57     STA ram_опция_режим_и_сложность
C - - - - - 0x014691 05:8681: B9 88 86  LDA tbl_8687 + 1,Y
C - - - - - 0x014694 05:8684: 85 5D     STA ram_колво_игроков
...
C - - - - - 0x0146A5 05:8695: 85 5D     STA ram_колво_игроков
...
sub_86A0:
C - - - - - 0x0146B0 05:86A0: A5 57     LDA ram_опция_режим_и_сложность
C - - - - - 0x0146B2 05:86A2: 29 F8     AND #$F8
C - - - - - 0x0146B4 05:86A4: 0D CA 05  ORA ram_номер_опции
C - - - - - 0x0146B7 05:86A7: 85 57     STA ram_опция_режим_и_сложность
C - - - - - 0x0146B9 05:86A9: 60        RTS



sub_86AA:
C - - - - - 0x0146BA 05:86AA: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
C - - - - - 0x0146BD 05:86AD: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x0146DC 05:86CC: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x0146EB 05:86DB: 8D 4A 05  STA ram_раунд_плей_офф
C - - - - - 0x0146EE 05:86DE: A0 00     LDY #$00
C - - - - - 0x0146F0 05:86E0: A9 08     LDA #$08
bra_86E2_loop:
C - - - - - 0x0146F2 05:86E2: 99 D5 05  STA ram_суб_позиция_управления,Y
...
C - - - - - 0x0146FF 05:86EF: 8D D3 05  STA ram_опции_тактики
C - - - - - 0x014702 05:86F2: 8D D4 05  STA ram_опции_тактики + 1
C - - - - - 0x014705 05:86F5: A0 00     LDY #$00
C - - - - - 0x014707 05:86F7: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x01472C 05:871C: 30 06     BMI bra_8724_подготовка_уже_была
C - - - - - 0x01472E 05:871E: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x014731 05:8721: 20 31 87  JSR sub_8731
bra_8724_подготовка_уже_была:
C - - - - - 0x014734 05:8724: 20 DC 87  JSR sub_87DC
C - - - - - 0x014737 05:8727: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x01473A 05:872A: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014746 05:8736: A9 05     LDA #con_anim_type_стрелочка_рожи
...
C - - - - - 0x014758 05:8748: A2 26     LDA #con_chr_bank + $26
C - - - - - 0x01475A 05:874A: 8E B8 05  STA ram_банк_спрайтов
C - - - - - 0x01475D 05:874D: E8        LDA #con_chr_bank + $27
C - - - - - 0x01475E 05:874E: 8E B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x014761 05:8751: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
C - - - - - 0x014770 05:8760: 10 03     BPL bra_8765_яркость_не_готова
C - - - - - 0x014772 05:8762: EE C9 05  INC ram_счетчик_опций
bra_8765_яркость_не_готова:
C - - - - - 0x014775 05:8765: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x01478D 05:877D: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0147C7 05:87B7: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x0147D5 05:87C5: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x0147E8 05:87D8: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C D 0 - - - 0x0147EB 05:87DB: 60        RTS



sub_87DC:
C - - - - - 0x0147EC 05:87DC: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x014871 05:8861: B9 D1 A6  LDA tbl_A6D1_музыка_материка,Y
...
C - - - - - 0x014881 05:8871: B9 3E 05  LDA ram_флаги_результатов_матчей_в_прохе,Y
...
C - - - - - 0x014898 05:8888: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x0148A5 05:8895: 30 0B     BMI bra_88A2_подготовка_уже_была
C - - - - - 0x0148A7 05:8897: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
...
bra_88A2_подготовка_уже_была:
C - - - - - 0x0148B2 05:88A2: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x0148B5 05:88A5: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0148BF 05:88AF: 10 03     BPL bra_88B4_яркость_не_готова
C - - - - - 0x0148C1 05:88B1: EE C9 05  INC ram_счетчик_опций
bra_88B4_яркость_не_готова:
C - - - - - 0x0148C4 05:88B4: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x0148D8 05:88C8: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
sub_8947:
- - - - - - 0x014957 05:8947: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
sub_8953:
C - - - - - 0x014963 05:8953: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x014975 05:8965: B9 3E 05  LDA ram_флаги_результатов_матчей_в_прохе,Y
...
C - - - - - 0x014A82 05:8A72: 99 6E 04  STA ram_подтип_анимации + 2,Y
...
sub_8AA8:
bra_8AA8_loop:
C - - - - - 0x014AB8 05:8AA8: B9 6E 04  LDA ram_подтип_анимации + 2,Y
...
C - - - - - 0x014AD0 05:8AC0: 30 06     BMI bra_8AC8_подготовка_уже_была
C - - - - - 0x014AD2 05:8AC2: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x014AD5 05:8AC5: 20 D5 8A  JSR sub_8AD5
bra_8AC8_подготовка_уже_была:
C - - - - - 0x014AD8 05:8AC8: 20 73 8C  JSR sub_8C73
C - - - - - 0x014ADB 05:8ACB: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x014ADE 05:8ACE: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014AEA 05:8ADA: 8D 80 00  STA ram_номер_анимации_мяча
...
C - - - - - 0x014B18 05:8B08: 9D 61 00  STA ram_тип_анимации_игрока,X
                                        LDA #$00
C - - - - - 0x014B1B 05:8B0B: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x014B1E 05:8B0E: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x014B21 05:8B11: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x014B24 05:8B14: 9D 99 03  STA ram_pos_Z_hi_игрока,X
C - - - - - 0x014B27 05:8B17: 9D E8 03  STA ram_spd_X_lo_игрока,X
C - - - - - 0x014B2A 05:8B1A: 9D F6 03  STA ram_spd_X_hi_игрока,X
C - - - - - 0x014B2D 05:8B1D: 9D 04 04  STA ram_spd_Y_lo_игрока,X
C - - - - - 0x014B30 05:8B20: 9D 12 04  STA ram_spd_Y_hi_игрока,X
C - - - - - 0x014B33 05:8B23: 9D 20 04  STA ram_spd_Z_lo_игрока,X
C - - - - - 0x014B36 05:8B26: 9D 2E 04  STA ram_spd_Z_hi_игрока,X
C - - - - - 0x014B39 05:8B29: A9 FF     LDA #$FF
C - - - - - 0x014B3B 05:8B2B: 9D 79 04  STA ram_next_действие_игрока,X
C - - - - - 0x014B3E 05:8B2E: A9 01     LDA #con_action_стоит_на_месте
C - - - - - 0x014B40 05:8B30: 9D 59 04  STA ram_действие_игрока,X
...
C - - - - - 0x014B5F 05:8B4F: A9 80     LDA #con_налево
C - - - - - 0x014B61 05:8B51: 8D A4 04  STA ram_напр_движ_игрока + 1
                                        LDA #$80
C - - - - - 0x014B64 05:8B54: 8D 20 03  STA ram_pos_X_lo_мяча
C - - - - - 0x014B67 05:8B57: A9 D0     LDA #$D0
C - - - - - 0x014B69 05:8B59: 8D 59 03  STA ram_pos_Y_lo_мяча
C - - - - - 0x014B6C 05:8B5C: A9 00     LDA #$00
C - - - - - 0x014B6E 05:8B5E: 8D 33 03  STA ram_pos_X_hi_мяча
C - - - - - 0x014B71 05:8B61: 8D 6C 03  STA ram_pos_Y_hi_мяча
C - - - - - 0x014B74 05:8B64: 8D 92 03  STA ram_pos_Z_lo_мяча
C - - - - - 0x014B77 05:8B67: 8D A5 03  STA ram_pos_Z_hi_мяча
...
C - - - - - 0x014B81 05:8B71: 10 03     BPL bra_8B76_яркость_не_готова
C - - - - - 0x014B83 05:8B73: EE C9 05  INC ram_счетчик_опций
bra_8B76_яркость_не_готова:
C - - - - - 0x014B86 05:8B76: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
ofs_8B80_01:
C - - J - - 0x014B90 05:8B80: A5 57     LDA ram_опция_режим_и_сложность
C - - - - - 0x014B92 05:8B82: 29 20     AND #con_gm_пенальти
C - - - - - 0x014B94 05:8B84: F0 13     BEQ bra_8B99
C - - - - - 0x014B96 05:8B86: A5 5D     LDA ram_колво_игроков
...
C - - - - - 0x014BBB 05:8BAB: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014C23 05:8C13: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
bra_8C16:
loc_8C16:
ofs_8C16_00_nothing:
ofs_8C16_02_Select:
...
C - - - - - 0x014C43 05:8C33: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C - - - - - 0x014C46 05:8C36: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
; bzk какого хрена тип анимации используется для хранения банков спрайтов
C - - - - - 0x014C49 05:8C39: AD 66 00  LDA ram_тип_анимации_игрока + 5
C - - - - - 0x014C4C 05:8C3C: 8D B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x014C4F 05:8C3F: AD 67 00  LDA ram_тип_анимации_игрока + 6
C - - - - - 0x014C52 05:8C42: 8D BA 05  STA ram_банк_спрайтов + 2
C - - - - - 0x014C55 05:8C45: 20 38 BD  JSR sub_BD38_рожи
C - - - - - 0x014C58 05:8C48: AD 66 00  LDA ram_тип_анимации_игрока + 5
C - - - - - 0x014C5B 05:8C4B: 48        PHA
C - - - - - 0x014C5C 05:8C4C: AD 67 00  LDA ram_тип_анимации_игрока + 6
C - - - - - 0x014C5F 05:8C4F: 48        PHA
C - - - - - 0x014C60 05:8C50: AD B9 05  LDA ram_банк_спрайтов + 1
C - - - - - 0x014C63 05:8C53: 8D 66 00  STA ram_тип_анимации_игрока + 5
C - - - - - 0x014C66 05:8C56: AD BA 05  LDA ram_банк_спрайтов + 2
C - - - - - 0x014C69 05:8C59: 8D 67 00  STA ram_тип_анимации_игрока + 6
...
C - - - - - 0x014C77 05:8C67: 20 B0 BD  JSR sub_BDB0_выбор_палитры_командам
C - - - - - 0x014C82 05:8C72: 60        RTS



sub_8C73:
C - - - - - 0x014C83 05:8C73: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x014CDE 05:8CCE: B9 FE 8C  LDA tbl_8CFE_конвертер_номера_опции_в_номер_команды,Y
...
C - - - - - 0x014CE9 05:8CD9: A5 57     LDA ram_опция_режим_и_сложность
C - - - - - 0x014CEB 05:8CDB: 29 20     AND #con_gm_пенальти
C - - - - - 0x014CED 05:8CDD: F0 0E     BEQ bra_8CED_RTS    ; если было выбрано пенальти
C - - - - - 0x014CEF 05:8CDF: A5 5D     LDA ram_колво_игроков
C - - - - - 0x014CF1 05:8CE1: C9 01     CMP #$01
C - - - - - 0x014CF3 05:8CE3: D0 08     BNE bra_8CED_RTS    ; если в пк выбрано 2 игрока
; пометить команду справа как команду из ботов
...
sub_8CEE:
C - - - - - 0x014CFE 05:8CEE: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
C - - - - - 0x014D01 05:8CF1: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
tbl_8CFE_конвертер_номера_опции_в_номер_команды:
; 00 команда слева
- D 0 - - - 0x014D0E 05:8CFE: 00        .byte $00   ; 00 япония
- D 0 - - - 0x014D0F 05:8CFF: 0B        .byte $0B   ; 01 италия
- D 0 - - - 0x014D10 05:8D00: 09        .byte $09   ; 02 германия
- D 0 - - - 0x014D11 05:8D01: 0E        .byte $0E   ; 03 аргентина
- D 0 - - - 0x014D12 05:8D02: 0D        .byte $0D   ; 04 бразилия
- D 0 - - - 0x014D13 05:8D03: 07        .byte $07   ; 05 камерун
; 06 команла справа
- D 0 - - - 0x014D14 05:8D04: 00        .byte $00   ; 06 япония
- D 0 - - - 0x014D15 05:8D05: 0B        .byte $0B   ; 07 италия
- D 0 - - - 0x014D16 05:8D06: 09        .byte $09   ; 08 германия
- D 0 - - - 0x014D17 05:8D07: 0E        .byte $0E   ; 09 аргентина
- D 0 - - - 0x014D18 05:8D08: 0D        .byte $0D   ; 0A бразилия
- D 0 - - - 0x014D19 05:8D09: 07        .byte $07   ; 0B камерун



sub_8D0A:
C - - - - - 0x014D1A 05:8D0A: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
bra_8D22_minibattle:
C - - - - - 0x014D32 05:8D22: A5 5D     LDA ram_колво_игроков
...
C - - - - - 0x014D44 05:8D34: A5 5D     LDA ram_колво_игроков
...
C - - - - - 0x014DCE 05:8DBE: 30 06     BMI bra_8DC6_подготовка_уже_была
C - - - - - 0x014DD0 05:8DC0: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x014DD3 05:8DC3: 20 D0 8D  JSR sub_8DD0_экран_vs
bra_8DC6_подготовка_уже_была:
C - - - - - 0x014DD6 05:8DC6: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x014DD9 05:8DC9: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014DFE 05:8DEE: 8D D2 05  STA ram_длительность_экрана_VS
C - - - - - 0x014E01 05:8DF1: 20 3C 8E  JSR sub_8E3C_палитра_и_анимация_спрайтов
C - - - - - 0x014E04 05:8DF4: 20 79 8F  JSR sub_8F79_выбор_палитры_и_банка_фона
...
C - - - - - 0x014E10 05:8E00: 10 03     BPL bra_8E05_яркость_не_готова
C - - - - - 0x014E12 05:8E02: EE C9 05  INC ram_счетчик_опций
bra_8E05_яркость_не_готова:
...
bra_8E20:
C - - - - - 0x014E30 05:8E20: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
...
C - - - - - 0x014E3D 05:8E2D: CE D2 05  DEC ram_длительность_экрана_VS
C - - - - - 0x014E40 05:8E30: 30 EE     BMI bra_8E20
bra_8E32:
loc_8E32:
C D 0 - - - 0x014E42 05:8E32: 20 E5 8E  JSR sub_8EE5
C - - - - - 0x014E45 05:8E35: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C - - - - - 0x014E48 05:8E38: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
C D 0 - - - 0x014E4B 05:8E3B: 60        RTS



sub_8E3C_палитра_и_анимация_спрайтов:
...
C - - - - - 0x014E66 05:8E56: 99 74 00  STA ram_номер_анимации_игрока,Y
bra_8E59:
C - - - - - 0x014E69 05:8E59: BC FB 8E  LDY tbl_8EFB,X
C - - - - - 0x014E6C 05:8E5C: A9 06     LDA #con_anim_type_экран_vs
C - - - - - 0x014E6E 05:8E5E: 99 61 00  STA ram_тип_анимации_игрока,Y
...
C - - - - - 0x014E78 05:8E68: 99 14 03  STA ram_pos_X_lo_игрока,Y
C - - - - - 0x014E7B 05:8E6B: BD D6 8E  LDA tbl_8ED5 + 1,X
C - - - - - 0x014E7E 05:8E6E: 99 27 03  STA ram_pos_X_hi_игрока,Y
C - - - - - 0x014E81 05:8E71: BD D7 8E  LDA tbl_8ED5 + 2,X
C - - - - - 0x014E84 05:8E74: 99 4D 03  STA ram_pos_Y_lo_игрока,Y
C - - - - - 0x014E87 05:8E77: BD D8 8E  LDA tbl_8ED5 + 3,X
C - - - - - 0x014E8A 05:8E7A: 99 60 03  STA ram_pos_Y_hi_игрока,Y
...
C - - - - - 0x014E94 05:8E84: A9 01     LDA #con_action_стоит_на_месте
C - - - - - 0x014E96 05:8E86: 8D 5C 04  STA ram_действие_игрока + 3
...
C - - - - - 0x014EA4 05:8E94: 8D 5A 04  STA ram_действие_игрока + 1
...
tbl_8EB3:
- D 0 - - - 0x014EC3 05:8EB3: 8C        .byte $8C   ; 00 = япония
- D 0 - - - 0x014EC4 05:8EB4: 80        .byte $80   ; 01 = корея
- D 0 - - - 0x014EC5 05:8EB5: 81        .byte $81   ; 02 = монголия
- D 0 - - - 0x014EC6 05:8EB6: 82        .byte $82   ; 03 = таиланд
- - - - - - 0x014EC7 05:8EB7: 8C        .byte $8C   ; 04 = 
- D 0 - - - 0x014EC8 05:8EB8: 83        .byte $83   ; 05 = гвинея
- D 0 - - - 0x014EC9 05:8EB9: 84        .byte $84   ; 06 = сенегал
- D 0 - - - 0x014ECA 05:8EBA: 85        .byte $85   ; 07 = камерун
- - - - - - 0x014ECB 05:8EBB: 8C        .byte $8C   ; 08 = 
- D 0 - - - 0x014ECC 05:8EBC: 86        .byte $86   ; 09 = германия
- D 0 - - - 0x014ECD 05:8EBD: 87        .byte $87   ; 0A = англия
- D 0 - - - 0x014ECE 05:8EBE: 88        .byte $88   ; 0B = италия
- - - - - - 0x014ECF 05:8EBF: 8C        .byte $8C   ; 0C = 
- D 0 - - - 0x014ED0 05:8EC0: 89        .byte $89   ; 0D = бразилия
- D 0 - - - 0x014ED1 05:8EC1: 8A        .byte $8A   ; 0E = аргентина
- D 0 - - - 0x014ED2 05:8EC2: 8B        .byte $8B   ; 0F = мексика
...
tbl_8EFB:
- D 0 - - - 0x014F0B 05:8EFB: 0C        .byte con_id_мяча   ; 
...
sub_8EFF:
C - - - - - 0x014F0F 05:8EFF: BD 59 04  LDA ram_действие_игрока,X
C - - - - - 0x014F12 05:8F02: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x014F24 05:8F14: B9 14 03  LDA ram_pos_X_lo_игрока,Y
C - - - - - 0x014F27 05:8F17: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x014F2A 05:8F1A: B9 27 03  LDA ram_pos_X_hi_игрока,Y
C - - - - - 0x014F2D 05:8F1D: 9D 27 03  STA ram_pos_X_hi_игрока,X
C - - - - - 0x014F30 05:8F20: B9 4D 03  LDA ram_pos_Y_lo_игрока,Y
C - - - - - 0x014F33 05:8F23: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
C - - - - - 0x014F36 05:8F26: B9 60 03  LDA ram_pos_Y_hi_игрока,Y
C - - - - - 0x014F39 05:8F29: 9D 60 03  STA ram_pos_Y_hi_игрока,X
C - - - - - 0x014F3C 05:8F2C: B9 86 03  LDA ram_pos_Z_lo_игрока,Y
C - - - - - 0x014F3F 05:8F2F: 9D 86 03  STA ram_pos_Z_lo_игрока,X
C - - - - - 0x014F42 05:8F32: B9 99 03  LDA ram_pos_Z_hi_игрока,Y
C - - - - - 0x014F45 05:8F35: 9D 99 03  STA ram_pos_Z_hi_игрока,X
C - - - - - 0x014F48 05:8F38: B9 74 00  LDA ram_номер_анимации_игрока,Y
C - - - - - 0x014F4B 05:8F3B: 95 74     STA ram_номер_анимации_игрока,X
C - - - - - 0x014F4D 05:8F3D: F6 74     INC ram_номер_анимации_игрока,X
...
ofs_8F40_03:
ofs_8F40_04:
C - - J - - 0x014F50 05:8F40: BD 59 04  LDA ram_действие_игрока,X
C - - - - - 0x014F53 05:8F43: 30 0D     BMI bra_8F52
C - - - - - 0x014F55 05:8F45: 09 80     ORA #$80
C - - - - - 0x014F57 05:8F47: 9D 59 04  STA ram_действие_игрока,X
C - - - - - 0x014F5A 05:8F4A: A9 00     LDA #$00
C - - - - - 0x014F5C 05:8F4C: 9D 87 00  STA ram_таймер_анимации_игрока,X
C - - - - - 0x014F5F 05:8F4F: 9D 94 00  STA ram_кадр_анимации_игрока,X
bra_8F52:
C - - - - - 0x014F62 05:8F52: 20 CF 8F  JSR sub_8FCF
C - - - - - 0x014F65 05:8F55: BD 59 04  LDA ram_действие_игрока,X
...
C - - - - - 0x014F70 05:8F60: 9D E8 03  STA ram_spd_X_lo_игрока,X
C - - - - - 0x014F73 05:8F63: B9 6E 8F  LDA tbl_8F6D_spd_X + 1,Y
C - - - - - 0x014F76 05:8F66: 9D F6 03  STA ram_spd_X_hi_игрока,X
C - - - - - 0x014F79 05:8F69: 20 1E 80  JSR sub_0x01C25C_сдвинуть_объект
...
sub_8F79_выбор_палитры_и_банка_фона:
...
C - - - - - 0x014FE9 05:8FD9: BD 59 04  LDA ram_действие_игрока,X
...
C - - - - - 0x01500B 05:8FFB: 30 12     BMI bra_900F_подготовка_уже_была
C - - - - - 0x01500D 05:8FFD: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x015010 05:9000: 24 57     BIT ram_опция_режим_и_сложность
C - - - - - 0x015012 05:9002: 50 08     BVC bra_900C_не_минибатл
...
C - - - - - 0x015031 05:9021: A9 05     LDA #con_anim_type_стрелочка_рожи
C - - - - - 0x015033 05:9023: 8D 61 00  STA ram_тип_анимации_игрока
C - - - - - 0x015036 05:9026: 8D 62 00  STA ram_тип_анимации_игрока + 1
C - - - - - 0x015039 05:9029: 8D 64 00  STA ram_тип_анимации_игрока + 3
...
C - - - - - 0x015059 05:9049: A2 26     LDA #con_chr_bank + $26
C - - - - - 0x01505B 05:904B: 8E B8 05  STA ram_банк_спрайтов
C - - - - - 0x01505E 05:904E: E8        LDA #con_chr_bank + $27
C - - - - - 0x01505F 05:904F: 8E B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x015062 05:9052: A9 11     LDA #con_chr_bank + $11
C - - - - - 0x015064 05:9054: 8D BB 05  STA ram_банк_спрайтов + 3
C - - - - - 0x015067 05:9057: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
C - - - - - 0x015073 05:9063: 10 03     BPL bra_9068_яркость_не_готова
C - - - - - 0x015075 05:9065: EE C9 05  INC ram_счетчик_опций
bra_9068_яркость_не_готова:
C - - - - - 0x015078 05:9068: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x01508B 05:907B: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0150B6 05:90A6: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
loc_90A9:
ofs_90A9_00_nothing:
ofs_90A9_02_Select:
...
C - - - - - 0x0150D1 05:90C1: 90 F4     BCC bra_90B7_loop
C - - - - - 0x0150D3 05:90C3: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C - - - - - 0x0150D6 05:90C6: 60        RTS



sub_90C7:
C - - - - - 0x0150D7 05:90C7: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x01511A 05:910A: F0 02     BEQ bra_910E_это_япония
...
C - - - - - 0x01516F 05:915F: 9D 5A 04  STA ram_действие_игрока + 1,X
C - - - - - 0x015172 05:9162: BD 90 91  LDA tbl_9190,X
C - - - - - 0x015175 05:9165: 9D 15 03  STA ram_pos_X_lo_игрока + 1,X
C - - - - - 0x015178 05:9168: BD 91 91  LDA tbl_9191,X
C - - - - - 0x01517B 05:916B: 9D 4E 03  STA ram_pos_Y_lo_игрока + 1,X
C - - - - - 0x01517E 05:916E: A9 00     LDA #$00
C - - - - - 0x015180 05:9170: 9D 28 03  STA ram_pos_X_hi_игрока + 1,X
C - - - - - 0x015183 05:9173: 9D 61 03  STA ram_pos_Y_hi_игрока + 1,X
C - - - - - 0x015186 05:9176: 9D 87 03  STA ram_pos_Z_lo_игрока + 1,X
C - - - - - 0x015189 05:9179: 9D 9A 03  STA ram_pos_Z_hi_игрока + 1,X
...
tbl_9184:
- D 0 - - - 0x015194 05:9184: 01        .byte con_action_стоит_на_месте   ; 
- D 0 - - - 0x015195 05:9185: 04        .byte con_action_лежит_на_спине   ; 
- D 0 - - - 0x015196 05:9186: 01        .byte con_action_стоит_на_месте   ; 
- D 0 - - - 0x015197 05:9187: 04        .byte con_action_лежит_на_спине   ; 
- D 0 - - - 0x015198 05:9188: 03        .byte con_action_03   ; 
- D 0 - - - 0x015199 05:9189: 06        .byte con_action_06   ; 
- D 0 - - - 0x01519A 05:918A: 02        .byte con_action_02   ; 
- D 0 - - - 0x01519B 05:918B: 05        .byte con_action_лежит_на_животе   ; 
- D 0 - - - 0x01519C 05:918C: 02        .byte con_action_02   ; 
- D 0 - - - 0x01519D 05:918D: 05        .byte con_action_лежит_на_животе   ; 
- D 0 - - - 0x01519E 05:918E: 03        .byte con_action_03   ; 
- D 0 - - - 0x01519F 05:918F: 06        .byte con_action_06   ; 
...
sub_9194:
C - - - - - 0x0151A4 05:9194: BD 59 04  LDA ram_действие_игрока,X
C - - - - - 0x0151A7 05:9197: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
ofs_91AF_08:
ofs_91AF_09:
C - - J - - 0x0151BF 05:91AF: BD 59 04  LDA ram_действие_игрока,X
C - - - - - 0x0151C2 05:91B2: 30 03     BMI bra_91B7
C - - - - - 0x0151CB 05:91BB: 09 80     ORA #$80
C - - - - - 0x0151CD 05:91BD: 9D 59 04  STA ram_действие_игрока,X
C - - - - - 0x0151D0 05:91C0: A9 00     LDA #$00
C - - - - - 0x0151D2 05:91C2: 9D 87 00  STA ram_таймер_анимации_игрока,X
C - - - - - 0x0151D5 05:91C5: 9D 94 00  STA ram_кадр_анимации_игрока,X
C - - - - - 0x0151D8 05:91C8: 9D 6C 04  STA ram_подтип_анимации,X
bra_91B7:
...
ofs_91CC:   ; bzk стремная подпрограмма, зачем очищать этот флаг?
- - - - - - 0x0151DC 05:91CC: BD 59 04  LDA ram_действие_игрока,X
- - - - - - 0x0151DF 05:91CF: 29 7F     AND #$7F
- - - - - - 0x0151E1 05:91D1: 9D 59 04  STA ram_действие_игрока,X
...
C - - - - - 0x015263 05:9253: 8D D1 05  STA ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x015266 05:9256: AD CA 05  LDA ram_номер_опции
C - - - - - 0x015269 05:9259: 0A        ASL
C - - - - - 0x01526A 05:925A: A8        TAY
C - - - - - 0x01526B 05:925B: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x015287 05:9277: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
C - - - - - 0x01528A 05:927A: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
- - - - - - 0x01529F 05:928F: A9 0F     LDA #con_subscr_menu_турнирная_сетка
...
- - - - - - 0x015325 05:9315: 39 93     .word off_9339_01_корея
- - - - - - 0x015327 05:9317: 39 93     .word off_9339_02_монголия
- - - - - - 0x015329 05:9319: 39 93     .word off_9339_03_таиланд
- - - - - - 0x01532B 05:931B: 39 93     .word off_9339_04
- - - - - - 0x01532D 05:931D: 39 93     .word off_9339_05_гвинея
- - - - - - 0x01532F 05:931F: 39 93     .word off_9339_06_сенегал
- D 0 - - - 0x015331 05:9321: 39 93     .word off_9339_07_камерун
- - - - - - 0x015333 05:9323: 3F 93     .word off_933F_08
- D 0 - - - 0x015335 05:9325: 3F 93     .word off_933F_09_германия
- - - - - - 0x015337 05:9327: 45 93     .word off_9345_0A_англия
- D 0 - - - 0x015339 05:9329: 45 93     .word off_9345_0B_италия
- - - - - - 0x01533B 05:932B: 4B 93     .word off_934B_0C
- D 0 - - - 0x01533D 05:932D: 4B 93     .word off_934B_0D_бразилия
- D 0 - - - 0x01533F 05:932F: 51 93     .word off_9351_0E_аргентина
- - - - - - 0x015341 05:9331: 57 93     .word off_9357_0F_мексика
...
C - - - - - 0x015369 05:9359: 30 06     BMI bra_9361_подготовка_уже_была
C - - - - - 0x01536B 05:935B: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x01536E 05:935E: 20 96 93  JSR sub_9396
bra_9361_подготовка_уже_была:
...
C - - - - - 0x0153AD 05:939D: 8D 74 00  STA ram_номер_анимации_игрока
C - - - - - 0x0153B0 05:93A0: 8D 75 00  STA ram_номер_анимации_игрока + 1
C - - - - - 0x0153B3 05:93A3: 8D 76 00  STA ram_номер_анимации_игрока + 2
C - - - - - 0x0153B6 05:93A6: 8D 77 00  STA ram_номер_анимации_игрока + 3
...
C - - - - - 0x0153CF 05:93BF: A2 26     LDA #con_chr_bank + $26
C - - - - - 0x0153D1 05:93C1: 8E B8 05  STA ram_банк_спрайтов
C - - - - - 0x0153D4 05:93C4: E8        LDA #con_chr_bank + $27
C - - - - - 0x0153D5 05:93C5: 8E B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x0153D8 05:93C8: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
C - - - - - 0x0153DB 05:93CB: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x0153DE 05:93CE: 48        PHA
C - - - - - 0x0153DF 05:93CF: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x015416 05:9406: 10 06     BPL bra_940E_яркость_не_готова
C - - - - - 0x015418 05:9408: EE C9 05  INC ram_счетчик_опций
C - - - - - 0x01541B 05:940B: EE C9 05  INC ram_счетчик_опций
bra_940E_яркость_не_готова:
C - - - - - 0x01541E 05:940E: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x015433 05:9423: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x015473 05:9463: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x0154BA 05:94AA: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
sub_94C2:
C - - - - - 0x0154D2 05:94C2: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x015570 05:9560: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
ofs_95A5_05_дождь:
C - - J - - 0x0155B5 05:95A5: AD 94 04  LDA ram_опция_дождя_и_ветра
...
ofs_95B0_06_ветер:
C - - J - - 0x0155C0 05:95B0: AD 94 04  LDA ram_опция_дождя_и_ветра
...
C - - - - - 0x0155F9 05:95E9: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
ofs_9632_05:
C - - J - - 0x015642 05:9632: AD 94 04  LDA ram_опция_дождя_и_ветра
C - - - - - 0x015645 05:9635: 29 F0     AND #$F0
C - - - - - 0x015647 05:9637: 8D 94 04  STA ram_опция_дождя_и_ветра
C - - - - - 0x01564A 05:963A: AD CA 05  LDA ram_номер_опции
C - - - - - 0x01564D 05:963D: 29 0F     AND #$0F
C - - - - - 0x01564F 05:963F: 0D 94 04  ORA ram_опция_дождя_и_ветра
C - - - - - 0x015652 05:9642: 8D 94 04  STA ram_опция_дождя_и_ветра
C - - - - - 0x015655 05:9645: 4C 00 96  RTS



ofs_9648_06:
C - - J - - 0x015658 05:9648: AD 94 04  LDA ram_опция_дождя_и_ветра
C - - - - - 0x01565B 05:964B: 29 0F     AND #$0F
C - - - - - 0x01565D 05:964D: 8D 94 04  STA ram_опция_дождя_и_ветра
...
C - - - - - 0x015669 05:9659: 0D 94 04  ORA ram_опция_дождя_и_ветра
C - - - - - 0x01566C 05:965C: 8D 94 04  STA ram_опция_дождя_и_ветра
...
sub_97C3:
C - - - - - 0x0157D3 05:97C3: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
C - - - - - 0x0157D6 05:97C6: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
C - - - - - 0x0157D9 05:97C9: AD F2 05  LDA ram_номер_банка_фона_поля   ; bzk мусор предположительно, нах это надо
C - - - - - 0x0157DC 05:97CC: 29 0F     AND #$0F
C - - - - - 0x0157DE 05:97CE: 8D F2 05  STA ram_номер_банка_фона_поля
...
C - - - - - 0x0157ED 05:97DD: B9 D1 A6  LDA tbl_A6D1_музыка_материка,Y
...
C - - - - - 0x015807 05:97F7: 30 06     BMI bra_97FF_подготовка_уже_была
C - - - - - 0x015809 05:97F9: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x01580C 05:97FC: 20 2C 98  JSR sub_982C
bra_97FF_подготовка_уже_была:
...
sub_982C:
C - - - - - 0x01583C 05:982C: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x01585E 05:984E: A9 05     LDA #con_anim_type_стрелочка_рожи
bra_9850_loop:
C - - - - - 0x015860 05:9850: 9D 61 00  STA ram_тип_анимации_игрока,X
C - - - - - 0x015863 05:9853: E8        INX
C - - - - - 0x015864 05:9854: E0 0D     CPX #$0D
C - - - - - 0x015866 05:9856: 90 F8     BCC bra_9850_loop
...
C - - - - - 0x015880 05:9870: 90 F3     BCC bra_9865_loop
...
C - - - - - 0x0158A1 05:9891: A2 26     LDA #con_chr_bank + $26
C - - - - - 0x0158A3 05:9893: 8E B8 05  STA ram_банк_спрайтов
C - - - - - 0x0158A6 05:9896: E8        LDA #con_chr_bank + $27
C - - - - - 0x0158A7 05:9897: 8E B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x0158AA 05:989A: A9 09     LDA #con_chr_bank + $09
C - - - - - 0x0158AC 05:989C: 8D BB 05  STA ram_банк_спрайтов + 3
C - - - - - 0x0158AF 05:989F: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
C - - - - - 0x0158CB 05:98BB: 10 03     BPL bra_98C0_яркость_не_готова
C - - - - - 0x0158CD 05:98BD: EE C9 05  INC ram_счетчик_опций
bra_98C0_яркость_не_готова:
C - - - - - 0x0158D0 05:98C0: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x0158EE 05:98DE: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x015957 05:9947: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x01599A 05:998A: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x0159BC 05:99AC: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x015A15 05:9A05: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x015A95 05:9A85: 24 57     BIT ram_опция_режим_и_сложность
...
C - - - - - 0x015AA6 05:9A96: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
loc_9A99:
...
C - - - - - 0x015ACF 05:9ABF: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x015B00 05:9AF0: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
ofs_9B03_05_Up:
ofs_9B03_06_Down:
C - - J - - 0x015B13 05:9B03: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
ofs_9B14_07_Left:
ofs_9B14_08_Right:
C - - J - - 0x015B24 05:9B14: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
sub_9B1D:
C - - - - - 0x015B2D 05:9B1D: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x015BF7 05:9BE7: A2 0C     LDX #con_id_мяча
...
C - - - - - 0x015C11 05:9C01: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x015CC6 05:9CB6: B9 D3 05  LDA ram_опции_тактики,Y
...
C - - - - - 0x015CD9 05:9CC9: 4C C2 9C  JMP loc_9CC2_loop
bra_9CCC:
...
C - - - - - 0x015D0C 05:9CFC: B9 D3 05  LDA ram_опции_тактики,Y
C - - - - - 0x015D0F 05:9CFF: 25 1C     AND ram_001C
C - - - - - 0x015D11 05:9D01: 05 1D     ORA ram_001D
C - - - - - 0x015D13 05:9D03: 99 D3 05  STA ram_опции_тактики,Y
...
C - - - - - 0x015DA3 05:9D93: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x015DEF 05:9DDF: 9D 14 03  STA ram_pos_X_lo_игрока,X
C - - - - - 0x015DF2 05:9DE2: B9 1B 9F  LDA tbl_9F1B,Y
C - - - - - 0x015DF5 05:9DE5: 9D 4D 03  STA ram_pos_Y_lo_игрока,X
...
C - - - - - 0x015E02 05:9DF2: 9D 74 00  STA ram_номер_анимации_игрока,X
...
C - - - - - 0x015E12 05:9E02: 9D 74 00  STA ram_номер_анимации_игрока,X
bra_9E05:
...
C - - - - - 0x015E2C 05:9E1C: 9D 74 00  STA ram_номер_анимации_игрока,X
C - - - - - 0x015E2F 05:9E1F: 4C 5F 9E  RTS
bra_9E22:
C - - - - - 0x015E32 05:9E22: A9 00     LDA #$00
C - - - - - 0x015E34 05:9E24: 85 1D     STA ram_001D
C - - - - - 0x015E36 05:9E26: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x015E57 05:9E47: 9D 74 00  STA ram_номер_анимации_игрока,X
...
C - - - - - 0x015E6C 05:9E5C: 9D 74 00  STA ram_номер_анимации_игрока,X
bra_9E5F_RTS:
...
C - - - - - 0x015EBE 05:9EAE: F0 09     BEQ bra_9EB9_это_япония
...
C - - - - - 0x015FFF 05:9FEF: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
sub_A0A0:
C - - - - - 0x0160B0 05:A0A0: A5 5D     LDA ram_колво_игроков
...
C - - - - - 0x0160BF 05:A0AF: 24 57     BIT ram_опция_режим_и_сложность
...
C - - - - - 0x0160F2 05:A0E2: 30 06     BMI bra_A0EA_подготовка_уже_была
C - - - - - 0x0160F4 05:A0E4: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x0160F7 05:A0E7: 20 F4 A0  JSR sub_A0F4
bra_A0EA_подготовка_уже_была:
C - - - - - 0x0160FA 05:A0EA: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x0160FD 05:A0ED: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
sub_A0F4:
C - - - - - 0x016104 05:A0F4: A9 05     LDA #con_anim_type_стрелочка_рожи
...
C - - - - - 0x016116 05:A106: A2 26     LDA #con_chr_bank + $26
C - - - - - 0x016118 05:A108: 8E B8 05  STA ram_банк_спрайтов
C - - - - - 0x01611B 05:A10B: E8        LDA #con_chr_bank + $27
C - - - - - 0x01611C 05:A10C: 8E B9 05  STA ram_банк_спрайтов + 1
C - - - - - 0x01611F 05:A10F: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
C - - - - - 0x016122 05:A112: A9 28     LDA #$28
C - - - - - 0x016124 05:A114: 8D 14 03  STA ram_pos_X_lo_игрока
C - - - - - 0x016127 05:A117: A9 B8     LDA #$B8
C - - - - - 0x016129 05:A119: 8D 4D 03  STA ram_pos_Y_lo_игрока
C - - - - - 0x01612C 05:A11C: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x016147 05:A137: 10 03     BPL bra_A13C_яркость_не_готова
C - - - - - 0x016149 05:A139: EE C9 05  INC ram_счетчик_опций
bra_A13C_яркость_не_готова:
C - - - - - 0x01614C 05:A13C: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x01616B 05:A15B: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x016172 05:A162: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x016180 05:A170: AD 03 06  LDA ram_шанс_на_дождь_при_ветер_плюс_дождь
...
C - - - - - 0x0161C8 05:A1B8: AD 94 04  LDA ram_опция_дождя_и_ветра
...
C - - - - - 0x016293 05:A283: 30 06     BMI bra_A28B_подготовка_уже_была
C - - - - - 0x016295 05:A285: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x016298 05:A288: 20 95 A2  JSR sub_A295
bra_A28B_подготовка_уже_была:
C - - - - - 0x01629B 05:A28B: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x01629E 05:A28E: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
sub_A295:
C - - - - - 0x0162A5 05:A295: A9 00     LDA #con_id_японии
C - - - - - 0x0162A7 05:A297: 8D 2C 05  STA ram_номер_команды
C - - - - - 0x0162AA 05:A29A: 20 38 BD  JSR sub_BD38_рожи
C - - - - - 0x0162AD 05:A29D: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
C - - - - - 0x0162B0 05:A2A0: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x0162C2 05:A2B2: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x0162D8 05:A2C8: 10 03     BPL bra_A2CD_яркость_не_готова
C - - - - - 0x0162DA 05:A2CA: EE C9 05  INC ram_счетчик_опций
bra_A2CD_яркость_не_готова:
...
C - - - - - 0x0162E3 05:A2D3: 10 13     BPL bra_A2E8    ; если яркость не готова
C - - - - - 0x0162E5 05:A2D5: 50 06     BVC bra_A2DD    ; если не затемнение
C - - - - - 0x0162E7 05:A2D7: 20 18 A3  JSR sub_A318_запись_следующего_заготовленного_subscript
...
C - - - - - 0x0162F5 05:A2E5: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
bra_A2E8:
loc_A2E8:
C D 1 - - - 0x0162F8 05:A2E8: A2 00     LDX #$00
C - - - - - 0x0162FA 05:A2EA: 20 94 91  JSR sub_9194
C - - - - - 0x0162FD 05:A2ED: 20 65 C0  JSR sub_0x01EB9C
C - - - - - 0x016300 05:A2F0: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C - - - - - 0x016303 05:A2F3: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x01630B 05:A2FB: 9D 74 00  STA ram_номер_анимации_игрока
                                        LDA #con_anim_type_полевой
C - - - - - 0x01630E 05:A2FE: 9D 61 00  STA ram_тип_анимации_игрока
C - - - - - 0x016314 05:A304: B9 16 A3  LDA #$3C
C - - - - - 0x016317 05:A307: 9D 14 03  STA ram_pos_X_lo_игрока
C - - - - - 0x01631A 05:A30A: B9 17 A3  LDA #$60
C - - - - - 0x01631D 05:A30D: 9D 4D 03  STA ram_pos_Y_lo_игрока
C - - - - - 0x016320 05:A310: A9 09     LDA #con_action_09
C - - - - - 0x016322 05:A312: 9D 59 04  STA ram_действие_игрока
C - - - - - 0x016325 05:A315: 60        RTS



sub_A318_запись_следующего_заготовленного_subscript:    ; bzk опт, единственная ссылка сюда
...
sub_A31F:
C - - - - - 0x01632F 05:A31F: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x016338 05:A328: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x01633B 05:A32B: 0A        ASL
C - - - - - 0x01633C 05:A32C: 0A        ASL
C - - - - - 0x01633D 05:A32D: 0A        ASL
C - - - - - 0x01633E 05:A32E: 38        SEC
C - - - - - 0x01633F 05:A32F: ED D1 05  SBC ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x0163C2 05:A3B2: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x016588 05:A578: 30 06     BMI bra_A580_подготовка_уже_была
C - - - - - 0x01658A 05:A57A: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x01658D 05:A57D: 20 8D A5  JSR sub_A58D
bra_A580_подготовка_уже_была:
C - - - - - 0x016590 05:A580: 20 70 A6  JSR sub_A670
C - - - - - 0x016593 05:A583: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x016596 05:A586: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0165A2 05:A592: A9 07     LDA #con_anim_type_победная
C - - - - - 0x0165A4 05:A594: 8D 61 00  STA ram_тип_анимации_игрока
                                        LDA #con_action_07
C - - - - - 0x0165A7 05:A597: 8D 59 04  STA ram_действие_игрока
C - - - - - 0x0165AA 05:A59A: A9 05     LDA #con_anim_type_стрелочка_рожи
...
C - - - - - 0x0165D7 05:A5C7: 8D 4D 03  STA ram_pos_Y_lo_игрока
...
C - - - - - 0x0165E3 05:A5D3: 10 03     BPL bra_A5D8_яркость_не_готова
C - - - - - 0x0165E5 05:A5D5: EE C9 05  INC ram_счетчик_опций
bra_A5D8_яркость_не_готова:
C - - - - - 0x0165E8 05:A5D8: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x016630 05:A620: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
ofs_A64B_05_Up:
ofs_A64B_06_Down:
C - - J - - 0x01665B 05:A64B: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x01667C 05:A66C: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
C D 1 - - - 0x01667F 05:A66F: 60        RTS



sub_A670:
C - - - - - 0x016680 05:A670: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x0166D2 05:A6C2: B9 D1 A6  LDA tbl_A6D1_музыка_материка,Y
bra_A6C5:
...
C - - - - - 0x0166E9 05:A6D9: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x01678A 05:A77A: 30 09     BMI bra_A785_подготовка_уже_была
C - - - - - 0x01678C 05:A77C: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
C - - - - - 0x01678F 05:A77F: 20 A4 A7  JSR sub_A7A4
C - - - - - 0x016792 05:A782: 20 87 AC  JSR sub_AC87
bra_A785_подготовка_уже_была:
C - - - - - 0x016795 05:A785: 20 EE AB  JSR sub_ABEE
C - - - - - 0x016798 05:A788: AD C9 05  LDA ram_счетчик_опций
C - - - - - 0x01679B 05:A78B: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
sub_A7A4:
C - - - - - 0x0167B4 05:A7A4: AD 58 05  LDA ram_общее_колво_побед_в_прохе
...
C - - - - - 0x0167F9 05:A7E9: 9D 15 03  STA ram_pos_X_lo_игрока + 1,X
C - - - - - 0x0167FC 05:A7EC: B9 4B A8  LDA tbl_A84B,Y
C - - - - - 0x0167FF 05:A7EF: 9D 4E 03  STA ram_pos_Y_lo_игрока + 1,X
C - - - - - 0x016802 05:A7F2: A9 05     LDA #con_anim_type_стрелочка_рожи
C - - - - - 0x016804 05:A7F4: 9D 62 00  STA ram_тип_анимации_игрока + 1,X
C - - - - - 0x016807 05:A7F7: E8        INX
C - - - - - 0x016808 05:A7F8: E0 02     CPX #$02
C - - - - - 0x01680A 05:A7FA: 90 E7     BCC bra_A7E3_loop
C - - - - - 0x01680C 05:A7FC: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x01680F 05:A7FF: 48        PHA
C - - - - - 0x016810 05:A800: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
C - - - - - 0x016851 05:A841: 8D D1 05  STA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x016861 05:A851: 10 08     BPL bra_A85B_яркость_не_готова
...
bra_A85B_яркость_не_готова:
C - - - - - 0x01686B 05:A85B: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
...
C - - - - - 0x016881 05:A871: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0168D2 05:A8C2: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
loc_A8C5:
ofs_A8C5_00_nothing:
ofs_A8C5_02_Select:
C D 1 - - - 0x0168D5 05:A8C5: A9 16     LDA #$16
C - - - - - 0x0168D7 05:A8C7: 8D 75 00  STA ram_номер_анимации_игрока + 1
C - - - - - 0x0168DA 05:A8CA: A9 7F     LDA #$7F
C - - - - - 0x0168DC 05:A8CC: 8D 76 00  STA ram_номер_анимации_игрока + 2
...
C - - - - - 0x0168F9 05:A8E9: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
C - - - - - 0x016910 05:A900: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
ofs_A90F_03_A:
C - - J - - 0x01691F 05:A90F: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x016986 05:A976: 20 DD 81  JSR sub_81DD_сдвинуть_курсор_на_нужную_позицию
...
C - - - - - 0x016991 05:A981: 8D 75 00  STA ram_номер_анимации_игрока + 1
C - - - - - 0x016994 05:A984: A9 96     LDA #$96
C - - - - - 0x016996 05:A986: 8D 76 00  STA ram_номер_анимации_игрока + 2
C - - - - - 0x016999 05:A989: A9 04     LDA #$04
C - - - - - 0x01699B 05:A98B: 8D CE 05  STA ram_суб_смещение_стрелки_в_меню_по_X
...
C - - - - - 0x0169BE 05:A9AE: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x0169E8 05:A9D8: 8D D2 05  STA ram_длительность_экрана_VS
...
C - - - - - 0x0169F9 05:A9E9: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
bra_A9F8:
C - - - - - 0x016A08 05:A9F8: AD D2 05  LDA ram_длительность_экрана_VS
...
C - - - - - 0x016A1B 05:AA0B: 8D D2 05  STA ram_длительность_экрана_VS
C - - - - - 0x016A1E 05:AA0E: EE CA 05  INC ram_номер_опции
bra_AA11:
C - - - - - 0x016A21 05:AA11: CE D2 05  DEC ram_длительность_экрана_VS
...
C - - - - - 0x016A4B 05:AA3B: 8D D0 05  STA ram_номер_опции_в_меню_звонков
...
C - - - - - 0x016A59 05:AA49: AD D0 05  LDA ram_номер_опции_в_меню_звонков
...
C - - - - - 0x016A7E 05:AA6E: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x016A95 05:AA85: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x016AB6 05:AAA6: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x016AD8 05:AAC8: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x016B61 05:AB51: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x016B64 05:AB54: 20 33 B2  JSR sub_B233
C - - - - - 0x016B67 05:AB57: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x016B6A 05:AB5A: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
C - - - - - 0x016B79 05:AB69: 6D D1 05  ADC ram_номер_игрока_в_меню_инфы_японии
...
bra_ABD7:
C - - - - - 0x016BE7 05:ABD7: AD D0 05  LDA ram_номер_опции_в_меню_звонков
...
sub_ABEE:
C - - - - - 0x016BFE 05:ABEE: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
C - - - - - 0x016C99 05:AC89: 8D CE 05  STA ram_суб_смещение_стрелки_в_меню_по_X
...
C - - - - - 0x016CBA 05:ACAA: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
C - - - - - 0x016D2F 05:AD1F: 8D D1 05  STA ram_номер_игрока_в_меню_инфы_японии
...
sub_AE22:
C - - - - - 0x016E32 05:AE22: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
sub_AE29:
C - - - - - 0x016E39 05:AE29: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
sub_AF5F:
C - - - - - 0x016F6F 05:AF5F: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x016F8C 05:AF7C: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
bra_AF89:   ; bzk опт
C - - - - - 0x016F99 05:AF89: 99 D5 05  STA ram_суб_позиция_управления,Y
bra_AF8C_RTS:
...
ofs_AF8D_00:
- - - - - - 0x016F9D 05:AF8D: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
- - - - - - 0x016FA0 05:AF90: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
ofs_AF97_03:
- - - - - - 0x016FA7 05:AF97: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
- - - - - - 0x016FAA 05:AF9A: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
bra_AFA5:
C - - - - - 0x016FB5 05:AFA5: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x016FB8 05:AFA8: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
sub_AFBD:
C - - - - - 0x016FCD 05:AFBD: AD D0 05  LDA ram_номер_опции_в_меню_звонков
C - - - - - 0x016FD0 05:AFC0: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
C - - - - - 0x016FEC 05:AFDC: ED 58 05  SBC ram_общее_колво_побед_в_прохе
...
C - - - - - 0x016FF9 05:AFE9: ED 55 05  SBC ram_общее_колво_очков_в_прохе
...
C - - - - - 0x017063 05:B053: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
C - - - - - 0x017078 05:B068: B9 D5 05  LDA ram_суб_позиция_управления,Y
C - - - - - 0x01707B 05:B06B: 29 F0     AND #$F0
C - - - - - 0x01707D 05:B06D: 05 1E     ORA ram_001E
C - - - - - 0x01707F 05:B06F: 99 D5 05  STA ram_суб_позиция_управления,Y
bra_B072:
...
sub_B0A8:
C - - - - - 0x0170B8 05:B0A8: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x0170CA 05:B0BA: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x0170CD 05:B0BD: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
C - - - - - 0x0170DF 05:B0CF: AC D1 05  LDY ram_номер_игрока_в_меню_инфы_японии
C - - - - - 0x0170E2 05:B0D2: B9 D5 05  LDA ram_суб_позиция_управления,Y
...
C - - - - - 0x01712C 05:B11C: AD D1 05  LDA ram_номер_игрока_в_меню_инфы_японии
...
C - - - - - 0x017137 05:B127: B9 E8 B1  LDA tbl_B1E7 + 1,Y
...
C - - - - - 0x017146 05:B136: B9 E8 B1  LDA tbl_B1E7 + 1,Y
...
C - - - - - 0x017157 05:B147: B9 E8 B1  LDA tbl_B1E7 + 1,Y
...
tbl_B1E7:
- D 1 - - - 0x0171F7 05:B1E7: E4 20     .word $20E4 ; 00
- D 1 - - - 0x0171F9 05:B1E9: E8 20     .word $20E8 ; 01
- D 1 - - - 0x0171FB 05:B1EB: EC 20     .word $20EC ; 02
- D 1 - - - 0x0171FD 05:B1ED: F0 20     .word $20F0 ; 03
- D 1 - - - 0x0171FF 05:B1EF: F4 20     .word $20F4 ; 04
- D 1 - - - 0x017201 05:B1F1: F8 20     .word $20F8 ; 05
- D 1 - - - 0x017203 05:B1F3: 84 21     .word $2184 ; 06
- D 1 - - - 0x017205 05:B1F5: 88 21     .word $2188 ; 07
- D 1 - - - 0x017207 05:B1F7: 8C 21     .word $218C ; 08
- D 1 - - - 0x017209 05:B1F9: 90 21     .word $2190 ; 09
- D 1 - - - 0x01720B 05:B1FB: 94 21     .word $2194 ; 0A
- D 1 - - - 0x01720D 05:B1FD: 98 21     .word $2198 ; 0B
...
C - - - - - 0x01724A 05:B23A: 99 11 06  STA ram_буфер_имени_игрока,Y
C - - - - - 0x01724D 05:B23D: C9 FF     CMP #$FF
C - - - - - 0x01724F 05:B23F: F0 05     BEQ bra_B246_закрыть_буфер
C - - - - - 0x017251 05:B241: C8        INY
C - - - - - 0x017252 05:B242: C0 05     CPY #$05
C - - - - - 0x017254 05:B244: 90 F2     BCC bra_B238_loop
bra_B246_закрыть_буфер:
C - - - - - 0x017256 05:B246: A9 F8     LDA #$F8
C - - - - - 0x017258 05:B248: 99 11 06  STA ram_буфер_имени_игрока,Y
...
C - - - - - 0x01725F 05:B24F: A0 01     LDY #$00
bra_B251_loop:
C - - - - - 0x017261 05:B251: B1 30     LDA (ram_0030),Y
C - - - - - 0x017263 05:B253: 99 16 06  STA ram_0617_буфер,Y
C - - - - - 0x017266 05:B256: C9 FF     CMP #$FF
C - - - - - 0x017268 05:B258: F0 05     BEQ bra_B25F_закрыть_буфер
C - - - - - 0x01726A 05:B25A: C8        INY
C - - - - - 0x01726B 05:B25B: C0 08     CPY #$07
C - - - - - 0x01726D 05:B25D: 90 F2     BCC bra_B251_loop
bra_B25F_закрыть_буфер:
C - - - - - 0x01726F 05:B25F: A9 F8     LDA #$F8
C - - - - - 0x017271 05:B261: 99 16 06  STA ram_0617_буфер,Y
...
C - - - - - 0x0172C4 05:B2B4: 30 2D     BMI bra_B2E3_подготовка_уже_была
C - - - - - 0x0172C6 05:B2B6: AD 4A 05  LDA ram_раунд_плей_офф
...
C - - - - - 0x0172D3 05:B2C3: AD 55 05  LDA ram_общее_колво_очков_в_прохе
C - - - - - 0x0172D6 05:B2C6: C9 46     CMP #$46
C - - - - - 0x0172D8 05:B2C8: 90 0E     BCC bra_B2D8
- - - - - - 0x0172DA 05:B2CA: AD 58 05  LDA ram_общее_колво_побед_в_прохе
...
bra_B2DD:
- - - - - - 0x0172ED 05:B2DD: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
- - - - - - 0x0172F0 05:B2E0: 20 F0 B2  JSR sub_B2F0
bra_B2E3_подготовка_уже_была:
- - - - - - 0x0172F3 05:B2E3: 20 A3 B3  JSR sub_B3A3
- - - - - - 0x0172F6 05:B2E6: AD C9 05  LDA ram_счетчик_опций
- - - - - - 0x0172F9 05:B2E9: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
- - - - - - 0x017305 05:B2F5: A0 04     LDA #con_anim_type_04
- - - - - - 0x017307 05:B2F7: 8C 6D 00  STA ram_тип_анимации_мяча
- - - - - - 0x01730A 05:B2FA: C8        LDA #con_anim_type_стрелочка_рожи
...
- - - - - - 0x017315 05:B305: 8D AE 05  STA ram_номер_анимации_мяча
                                        LDA #con_spr_pal + $07
- - - - - - 0x017318 05:B308: 8D 80 00  STA ram_номер_палитры_спрайтов
- - - - - - 0x01731B 05:B30B: A2 26     LDA #con_chr_bank + $26
- - - - - - 0x01731D 05:B30D: 8E B8 05  STA ram_банк_спрайтов
- - - - - - 0x017320 05:B310: E8        LDA #con_chr_bank + $27
- - - - - - 0x017321 05:B311: 8E B9 05  STA ram_банк_спрайтов + 1
- - - - - - 0x017324 05:B314: A9 2F     LDA #con_chr_bank + $2F
- - - - - - 0x017326 05:B316: 8D BB 05  STA ram_банк_спрайтов + 3
- - - - - - 0x017329 05:B319: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
- - - - - - 0x01732C 05:B31C: A9 C8     LDA #$C8
- - - - - - 0x01732E 05:B31E: 8D 20 03  STA ram_pos_X_lo_мяча
- - - - - - 0x017331 05:B321: A9 A0     LDA #$A0
- - - - - - 0x017333 05:B323: 8D 59 03  STA ram_pos_Y_lo_мяча
...
- - - - - - 0x017342 05:B332: 10 03     BPL bra_B337_яркость_не_готова
- - - - - - 0x017344 05:B334: EE C9 05  INC ram_счетчик_опций
bra_B337_яркость_не_готова:
- - - - - - 0x017347 05:B337: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
- - - - - - 0x01734A 05:B33A: A2 0C     LDX #con_id_мяча
- - - - - - 0x01734C 05:B33C: 20 65 C0  JSR sub_0x01EB9C
- - - - - - 0x01734F 05:B33F: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
- - - - - - 0x017369 05:B359: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
- - - - - - 0x0173AA 05:B39A: A2 0C     LDX #con_id_мяча
- - - - - - 0x0173AC 05:B39C: 20 65 C0  JSR sub_0x01EB9C
- - - - - - 0x0173AF 05:B39F: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
- - - - - - 0x0173B2 05:B3A2: 60        RTS



sub_B3A3:
- - - - - - 0x0173B3 05:B3A3: 20 05 82  JSR sub_8205_прочитать_поинтеры_после_JSR
...
sub_B3B2:
- - - - - - 0x0173C2 05:B3B2: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
- - - - - - 0x0173C5 05:B3B5: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
- - - - - - 0x0173DF 05:B3CF: 05 57     ORA ram_опция_режим_и_сложность
- - - - - - 0x0173E1 05:B3D1: 85 57     STA ram_опция_режим_и_сложность
loc_B3D3:
bra_B3D3:
...
tbl_B3DC:
- - - - - - 0x0173EC 05:B3DC: 0F        .byte con_subscr_menu_турнирная_сетка   ; 
...
C - - - - - 0x01740B 05:B3FB: B9 3E 05  LDA ram_флаги_результатов_матчей_в_прохе,Y
C - - - - - 0x01740E 05:B3FE: 69 01     ADC #$01
C - - - - - 0x017410 05:B400: 99 3E 05  STA ram_флаги_результатов_матчей_в_прохе,Y
C - - - - - 0x017413 05:B403: EE 56 05  INC ram_общее_колво_сыгр_матчей_в_прохе
...
- - - - - - 0x017421 05:B411: AD 57 05  LDA ram_общее_колво_поражений_в_прохе
- - - - - - 0x017424 05:B414: 69 01     ADC #$01
- - - - - - 0x017426 05:B416: B0 4C     BCS bra_B464_RTS
- - - - - - 0x017428 05:B418: 8D 57 05  STA ram_общее_колво_поражений_в_прохе
- - - - - - 0x01742B 05:B41B: 4C 64 B4  RTS
bra_B41E:
C - - - - - 0x01742E 05:B41E: B9 3E 05  LDA ram_флаги_результатов_матчей_в_прохе,Y
C - - - - - 0x017431 05:B421: 29 03     AND #$03
C - - - - - 0x017433 05:B423: AA        TAX
C - - - - - 0x017434 05:B424: BD 65 B4  LDA tbl_B465,X
C - - - - - 0x017437 05:B427: 19 3E 05  ORA ram_флаги_результатов_матчей_в_прохе,Y
C - - - - - 0x01743A 05:B42A: 99 3E 05  STA ram_флаги_результатов_матчей_в_прохе,Y
C - - - - - 0x01743D 05:B42D: EE 58 05  INC ram_общее_колво_побед_в_прохе
...
C - - - - - 0x01744B 05:B43B: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x01746A 05:B45A: 6D 55 05  ADC ram_общее_колво_очков_в_прохе
C - - - - - 0x01746D 05:B45D: 90 02     BCC bra_B461_not_overflow
- - - - - - 0x01746F 05:B45F: A9 FF     LDA #$FF
bra_B461_not_overflow:
C - - - - - 0x017471 05:B461: 8D 55 05  STA ram_общее_колво_очков_в_прохе
bra_B464_RTS:
...
tbl_B46C:
- - - - - - 0x01747C 05:B46C: 00        .byte $00   ; 00 = япония
- D 1 - - - 0x01747D 05:B46D: 00        .byte $00   ; 01 = корея
- - - - - - 0x01747E 05:B46E: 00        .byte $00   ; 02 = монголия
- - - - - - 0x01747F 05:B46F: 00        .byte $00   ; 03 = таиланд
- - - - - - 0x017480 05:B470: 00        .byte $00   ; 04 = 
- - - - - - 0x017481 05:B471: 00        .byte $00   ; 05 = гвинея
- - - - - - 0x017482 05:B472: 15        .byte $15   ; 06 = сенегал
- - - - - - 0x017483 05:B473: 29        .byte $29   ; 07 = камерун
- - - - - - 0x017484 05:B474: 00        .byte $00   ; 08 = 
- - - - - - 0x017485 05:B475: 3A        .byte $3A   ; 09 = германия
- - - - - - 0x017486 05:B476: 39        .byte $39   ; 0A = англия
- - - - - - 0x017487 05:B477: 4E        .byte $4E   ; 0B = италия
- - - - - - 0x017488 05:B478: 00        .byte $00   ; 0C = 
- - - - - - 0x017489 05:B479: 4E        .byte $4E   ; 0D = бразилия
- - - - - - 0x01748A 05:B47A: 29        .byte $29   ; 0E = аргентина
- - - - - - 0x01748B 05:B47B: 15        .byte $15   ; 0F = мексика



ofs_80D9_0F_турнирная_сетка:
- - - - - - 0x01748C 05:B47C: A5 59     LDA ram_subscript
- - - - - - 0x01748E 05:B47E: 30 0E     BMI bra_B48E_подготовка_уже_была
- - - - - - 0x017490 05:B480: 20 DF 80  JSR sub_80DF_подготовить_и_отрисовать_экран
...
bra_B48E_подготовка_уже_была:
- - - - - - 0x01749E 05:B48E: AD C9 05  LDA ram_счетчик_опций
- - - - - - 0x0174A1 05:B491: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
...
- - - - - - 0x0174AB 05:B49B: 10 03     BPL bra_B4A0_яркость_не_готова
- - - - - - 0x0174AD 05:B49D: EE C9 05  INC ram_счетчик_опций
bra_B4A0_яркость_не_готова:
- - - - - - 0x0174B0 05:B4A0: 20 5C C0  JSR sub_0x01D083_обработка_текущей_яркости
- - - - - - 0x0174B3 05:B4A3: A2 0C     LDX #con_id_мяча
- - - - - - 0x0174B5 05:B4A5: 20 65 C0  JSR sub_0x01EB9C
- - - - - - 0x0174B8 05:B4A8: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
- - - - - - 0x0174BB 05:B4AB: 4C D5 B4  RTS



ofs_B4AE_01:
- - - - - - 0x0174BE 05:B4AE: A2 0C     LDX #con_id_мяча
- - - - - - 0x0174C0 05:B4B0: 20 65 C0  JSR sub_0x01EB9C
- - - - - - 0x0174C3 05:B4B3: 20 14 80  JSR sub_0x01C2AE_флаг_видимости_и_приоритет_анимаций
...
- - - - - - 0x0174D1 05:B4C1: 20 44 C0  JSR sub_0x01D057_включить_затемнение_яркости
- - - - - - 0x0174D4 05:B4C4: 20 4A C0  JSR sub_0x01D072_обработка_яркости_с_ожиданием_завершения_обработки
...
sub_B4D6:
- - - - - - 0x0174E6 05:B4D6: A9 2F     LDA #con_chr_bank + $2F
...
- - - - - - 0x017507 05:B4F7: C9 04     CMP #con_subscr_menu_раздевалка
- - - - - - 0x017509 05:B4F9: F0 0E     BEQ bra_B509_RTS
- - - - - - 0x01750B 05:B4FB: AD 4A 05  LDA ram_раунд_плей_офф
- - - - - - 0x01750E 05:B4FE: 20 53 C0  JSR sub_0x01EC9F_прыжок_на_поинтеры_после_JSR
- - - - - - 0x017511 05:B501: 0A B5     .word ofs_B50A_00_начало_плей_офф
- - - - - - 0x017513 05:B503: 35 B5     .word ofs_B535_01_четверть_финал_плей_офф
- - - - - - 0x017515 05:B505: 54 B5     .word ofs_B554_02_полу_финал_плей_офф
- - - - - - 0x017517 05:B507: 74 B5     .word ofs_B574_03_финал_плей_офф
bra_B509_RTS:
- - - - - - 0x017519 05:B509: 60        RTS



ofs_B50A_00_начало_плей_офф:
- - - - - - 0x01751A 05:B50A: A2 00     LDX #$00
- - - - - - 0x01751C 05:B50C: A0 00     LDY #$00
- - - - - - 0x01751E 05:B50E: AD 55 05  LDA ram_общее_колво_очков_в_прохе
- - - - - - 0x017521 05:B511: C9 5A     CMP #$5A
- - - - - - 0x017523 05:B513: 90 08     BCC bra_B51D_запись_команд_на_начало_плей_офф
- - - - - - 0x017525 05:B515: A0 06     LDY #$06
- - - - - - 0x017527 05:B517: C9 78     CMP #$78
- - - - - - 0x017529 05:B519: 90 02     BCC bra_B51D_запись_команд_на_начало_плей_офф
- - - - - - 0x01752B 05:B51B: A0 0C     LDY #$0C
bra_B51D_запись_команд_на_начало_плей_офф:
bra_B51D_loop_запись_команд_на_начало_плей_офф:
- - - - - - 0x01752D 05:B51D: B9 D4 B5  LDA tbl_B5D4_команды_на_плей_офф,Y
- - - - - - 0x017530 05:B520: 9D 4B 05  STA ram_команды_на_плей_офф,X
- - - - - - 0x017533 05:B523: E8        INX
- - - - - - 0x017534 05:B524: C8        INY
- - - - - - 0x017535 05:B525: E0 06     CPX #$06
- - - - - - 0x017537 05:B527: 90 F4     BCC bra_B51D_loop_запись_команд_на_начало_плей_офф
; поиск японии и определение что это именно 1/8 плей-офф
- - - - - - 0x017539 05:B529: A2 04     LDX #$04
- - - - - - 0x01753B 05:B52B: A0 05     LDY #$05
- - - - - - 0x01753D 05:B52D: 20 88 B5  JSR sub_B588_определение_раунда_плей_офф_поиск_японии
- - - - - - 0x017540 05:B530: F0 D7     BEQ bra_B509_RTS    ; японию нашли - это 1/8 плеф-офф
- - - - - - 0x017542 05:B532: EE 4A 05  INC ram_раунд_плей_офф  ; японию не нашли, значит это не 1/8 и увеличиванем раунд плей-офф на +1
ofs_B535_01_четверть_финал_плей_офф:
- - - - - - 0x017545 05:B535: A2 04     LDX #$04
- - - - - - 0x017547 05:B537: A0 05     LDY #$05
- - - - - - 0x017549 05:B539: 20 A6 B5  JSR sub_B5A6
- - - - - - 0x01754C 05:B53C: 8D 51 05  STA ram_команды_на_плей_офф + 6
- - - - - - 0x01754F 05:B53F: A2 01     LDX #$01
- - - - - - 0x017551 05:B541: A0 02     LDY #$02
- - - - - - 0x017553 05:B543: 20 88 B5  JSR sub_B588_определение_раунда_плей_офф_поиск_японии
- - - - - - 0x017556 05:B546: F0 C1     BEQ bra_B509_RTS
- - - - - - 0x017558 05:B548: A2 03     LDX #$03
- - - - - - 0x01755A 05:B54A: A0 06     LDY #$06
- - - - - - 0x01755C 05:B54C: 20 88 B5  JSR sub_B588_определение_раунда_плей_офф_поиск_японии
- - - - - - 0x01755F 05:B54F: F0 B8     BEQ bra_B509_RTS
- - - - - - 0x017561 05:B551: EE 4A 05  INC ram_раунд_плей_офф
ofs_B554_02_полу_финал_плей_офф:
- - - - - - 0x017564 05:B554: A2 01     LDX #$01
- - - - - - 0x017566 05:B556: A0 02     LDY #$02
- - - - - - 0x017568 05:B558: 20 A6 B5  JSR sub_B5A6
- - - - - - 0x01756B 05:B55B: 8D 53 05  STA ram_команды_на_плей_офф + 8
- - - - - - 0x01756E 05:B55E: A2 03     LDX #$03
- - - - - - 0x017570 05:B560: A0 06     LDY #$06
- - - - - - 0x017572 05:B562: 20 A6 B5  JSR sub_B5A6
- - - - - - 0x017575 05:B565: 8D 52 05  STA ram_команды_на_плей_офф + 7
- - - - - - 0x017578 05:B568: A2 07     LDX #$07
- - - - - - 0x01757A 05:B56A: A0 08     LDY #$08
- - - - - - 0x01757C 05:B56C: 20 88 B5  JSR sub_B588_определение_раунда_плей_офф_поиск_японии
- - - - - - 0x01757F 05:B56F: F0 98     BEQ bra_B509_RTS
- - - - - - 0x017581 05:B571: EE 4A 05  INC ram_раунд_плей_офф
ofs_B574_03_финал_плей_офф:
- - - - - - 0x017584 05:B574: A2 08     LDX #$08
- - - - - - 0x017586 05:B576: A0 07     LDY #$07
- - - - - - 0x017588 05:B578: 20 A6 B5  JSR sub_B5A6
- - - - - - 0x01758B 05:B57B: 8D 54 05  STA ram_команды_на_плей_офф + 9
; определение соперников на финал
- - - - - - 0x01758E 05:B57E: A2 00     LDX #$00
- - - - - - 0x017590 05:B580: A0 09     LDY #$09
- - - - - - 0x017592 05:B582: 20 88 B5  JSR sub_B588_определение_раунда_плей_офф_поиск_японии
- - - - - - 0x017595 05:B585: 4C 09 B5  RTS



sub_B588_определение_раунда_плей_офф_поиск_японии:
- - - - - - 0x017598 05:B588: BD 4B 05  LDA ram_команды_на_плей_офф,X
- - - - - - 0x01759B 05:B58B: D0 06     BNE bra_B593
- - - - - - 0x01759D 05:B58D: B9 4B 05  LDA ram_команды_на_плей_офф,Y
- - - - - - 0x0175A0 05:B590: 4C 9B B5  JMP loc_B59B
bra_B593:
- - - - - - 0x0175A3 05:B593: B9 4B 05  LDA ram_команды_на_плей_офф,Y
- - - - - - 0x0175A6 05:B596: D0 0D     BNE bra_B5A5_RTS
- - - - - - 0x0175A8 05:B598: BD 4B 05  LDA ram_команды_на_плей_офф,X
loc_B59B:
...
sub_B5A6:
- - - - - - 0x0175B6 05:B5A6: BD 4B 05  LDA ram_команды_на_плей_офф,X
- - - - - - 0x0175B9 05:B5A9: D0 07     BNE bra_B5B2
- - - - - - 0x0175BB 05:B5AB: 09 80     ORA #$80
- - - - - - 0x0175BD 05:B5AD: 9D 4B 05  STA ram_команды_на_плей_офф,X
- - - - - - 0x0175C0 05:B5B0: D0 0A     BNE bra_B5BC
bra_B5B2:
- - - - - - 0x0175C2 05:B5B2: B9 4B 05  LDA ram_команды_на_плей_офф,Y
- - - - - - 0x0175C5 05:B5B5: D0 09     BNE bra_B5C0
- - - - - - 0x0175C7 05:B5B7: 09 80     ORA #$80
- - - - - - 0x0175C9 05:B5B9: 99 4B 05  STA ram_команды_на_плей_офф,Y
bra_B5BC:
...
bra_B5C9:
- - - - - - 0x0175D9 05:B5C9: BD 4B 05  LDA ram_команды_на_плей_офф,X
- - - - - - 0x0175DC 05:B5CC: 09 80     ORA #$80
- - - - - - 0x0175DE 05:B5CE: 9D 4B 05  STA ram_команды_на_плей_офф,X
...
tbl_B5D4_команды_на_плей_офф:
;-----------------------------------------------------------------------------------
; 1/8 плей-офф до 5A очков очков за чемпионат, набор команд на плей-офф. y00
- - - - - - 0x0175E4 05:B5D4: 0B        .byte $0B   ; италия
- - - - - - 0x0175E5 05:B5D5: 09        .byte $09   ; германия
- - - - - - 0x0175E6 05:B5D6: 0D        .byte $0D   ; бразилия
- - - - - - 0x0175E7 05:B5D7: 0E        .byte $0E   ; аргентина
- - - - - - 0x0175E8 05:B5D8: 07        .byte $07   ; камерун
- - - - - - 0x0175E9 05:B5D9: 00        .byte $00   ; япония
;-----------------------------------------------------------------------------------
; 1/4 плей-офф 5A-77 очков за чемпионат, набор команд на плей-офф. y06
- - - - - - 0x0175EA 05:B5DA: 0B        .byte $0B   ; италия
- - - - - - 0x0175EB 05:B5DB: 09        .byte $09   ; германия
- - - - - - 0x0175EC 05:B5DC: 0D        .byte $0D   ; бразилия
- - - - - - 0x0175ED 05:B5DD: 00        .byte $00   ; япония
- - - - - - 0x0175EE 05:B5DE: 0E        .byte $0E   ; аргентина
- - - - - - 0x0175EF 05:B5DF: 07        .byte $07   ; камерун
;-----------------------------------------------------------------------------------
; 1/4 плей-офф 78+ очков за чемпионат, набор команд на плей-офф. y0C
- - - - - - 0x0175F0 05:B5E0: 0B        .byte $0B   ; италия
- - - - - - 0x0175F1 05:B5E1: 09        .byte $09   ; германия
- - - - - - 0x0175F2 05:B5E2: 00        .byte $00   ; япония
- - - - - - 0x0175F3 05:B5E3: 0D        .byte $0D   ; бразилия
- - - - - - 0x0175F4 05:B5E4: 0E        .byte $0E   ; аргентина
- - - - - - 0x0175F5 05:B5E5: 07        .byte $07   ; камерун



sub_B5E6:
- - - - - - 0x0175F6 05:B5E6: 20 11 C0  JSR sub_0x01ECB9_выключить_NMI_при_следующем_вызове
...
- - - - - - 0x01761D 05:B60D: BD 4B 05  LDA ram_команды_на_плей_офф,X
...
- - - - - - 0x017665 05:B655: BD 4B 05  LDA ram_команды_на_плей_офф,X
...
- - - - - - 0x017678 05:B668: 10 F4     BPL bra_B65E_loop
...
- - - - - - 0x0176AA 05:B69A: 90 E6     BCC bra_B682_loop
- - - - - - 0x0176AC 05:B69C: 18        CLC
- - - - - - 0x0176AD 05:B69D: AD 4A 05  LDA ram_раунд_плей_офф
...
- - - - - - 0x0176FC 05:B6EC: 10 EE     BPL bra_B6DC_loop
...
C - - - - - 0x0178BC 05:B8AC: 10 FB     BPL bra_B8A9_loop
C - - - - - 0x0178BE 05:B8AE: A2 00     LDX #$00
bra_B8B0_loop:
C - - - - - 0x0178C0 05:B8B0: A0 00     LDY #$00
C - - - - - 0x0178C2 05:B8B2: BD 3E 05  LDA ram_флаги_результатов_матчей_в_прохе,X
...
C - - - - - 0x0178CB 05:B8BB: D0 FA     BNE bra_B8B7_loop
...
C - - - - - 0x0178E3 05:B8D3: 90 DB     BCC bra_B8B0_loop
C - - - - - 0x0178E5 05:B8D5: AD 55 05  LDA ram_общее_колво_очков_в_прохе
...
C - - - - - 0x0178F0 05:B8E0: AD 55 05  LDA ram_общее_колво_очков_в_прохе
...
C - - - - - 0x01791B 05:B90B: 10 FA     BPL bra_B907_loop
...
bra_B915_loop:
C - - - - - 0x017925 05:B915: B9 6E 04  LDA ram_подтип_анимации + 2,Y
C - - - - - 0x017928 05:B918: 99 2C 00  STA ram_002C,Y
C - - - - - 0x01792B 05:B91B: 88        DEY
C - - - - - 0x01792C 05:B91C: 10 F7     BPL bra_B915_loop
C - - - - - 0x01792E 05:B91E: A9 00     LDA #$00
C - - - - - 0x017930 05:B920: 8D 55 05  STA ram_общее_колво_очков_в_прохе
C - - - - - 0x017933 05:B923: 8D 56 05  STA ram_общее_колво_сыгр_матчей_в_прохе
C - - - - - 0x017936 05:B926: 8D 58 05  STA ram_общее_колво_побед_в_прохе
C - - - - - 0x017939 05:B929: 8D 57 05  STA ram_общее_колво_поражений_в_прохе
...
C - - - - - 0x017949 05:B939: 10 FA     BPL bra_B935_loop
...
- - - - - - 0x017970 05:B960: 8D 55 05  STA ram_общее_колво_очков_в_прохе
- - - - - - 0x017973 05:B963: A2 00     LDX #$00
- - - - - - 0x017975 05:B965: 8E 58 05  STX ram_общее_колво_побед_в_прохе
bra_B968_loop:
...
- - - - - - 0x017988 05:B978: 9D 3E 05  STA ram_флаги_результатов_матчей_в_прохе,X
- - - - - - 0x01798B 05:B97B: 18        CLC
- - - - - - 0x01798C 05:B97C: 98        TYA
- - - - - - 0x01798D 05:B97D: 6D 58 05  ADC ram_общее_колво_побед_в_прохе
- - - - - - 0x017990 05:B980: 8D 58 05  STA ram_общее_колво_побед_в_прохе
- - - - - - 0x017993 05:B983: E8        INX
- - - - - - 0x017994 05:B984: E0 0C     CPX #$0C
- - - - - - 0x017996 05:B986: 90 E0     BCC bra_B968_loop
bra_B988_RTS:
...
C D 1 - - - 0x0179DB 05:B9CB: A8        TAY ; bzk опт, сразу писать A в материк
...
C D 1 - - - 0x0179E9 05:B9D9: AD 4A 05  LDA ram_раунд_плей_офф
C D 1 - - - 0x0179EC 05:B9DC: 30 04     BMI bra_B9E2
C D 1 - - - 0x0179EE 05:B9DE: A9 0B     LDA #con_id_италии
...
C - - - - - 0x017A0E 05:B9FE: 8D 94 04  STA ram_опция_дождя_и_ветра
...
C - - - - - 0x017A1F 05:BA0F: 0D 94 04  ORA ram_опция_дождя_и_ветра
C - - - - - 0x017A22 05:BA12: 8D 94 04  STA ram_опция_дождя_и_ветра
C - - - - - 0x017A25 05:BA15: E8        INX
C - - - - - 0x017A26 05:BA16: E0 02     CPX #$02
C - - - - - 0x017A28 05:BA18: 90 EC     BCC bra_BA06_loop
bra_BA1A_loop:
...
C - - - - - 0x017A3C 05:BA2C: 90 EC     BCC bra_BA1A_loop
...
C - - - - - 0x017A45 05:BA35: AD 94 04  LDA ram_опция_дождя_и_ветра
C - - - - - 0x017A48 05:BA38: 29 F0     AND #$F0
C - - - - - 0x017A4A 05:BA3A: 8D 94 04  STA ram_опция_дождя_и_ветра
C - - - - - 0x017A4D 05:BA3D: 4C 5C BA  RTS
bra_BA40:
C - - - - - 0x017A50 05:BA40: AD 94 04  LDA ram_опция_дождя_и_ветра
...
sub_BA60:
; было стремное чтение 4C из последнего банка
; переделано под фиксированное чтение 4C
; bzk опт удалить лишние проверки 001C
...
tbl_BA92:
- D 1 - - - 0x017AA2 05:BA92: 00        .byte $00   ; 00
- D 1 - - - 0x017AA3 05:BA93: 04        .byte $04   ; 01
- D 1 - - - 0x017AA4 05:BA94: 04        .byte $04   ; 02
- D 1 - - - 0x017AA5 05:BA95: 08        .byte $08   ; 03
- - - - - - 0x017AA6 05:BA96: 00        .byte $00   ; 04
- D 1 - - - 0x017AA7 05:BA97: 0C        .byte $0C   ; 05
- D 1 - - - 0x017AA8 05:BA98: 04        .byte $04   ; 06
- D 1 - - - 0x017AA9 05:BA99: 04        .byte $04   ; 07
- - - - - - 0x017AAA 05:BA9A: 00        .byte $00   ; 08
- D 1 - - - 0x017AAB 05:BA9B: 00        .byte $00   ; 09
- D 1 - - - 0x017AAC 05:BA9C: 00        .byte $00   ; 0A
- D 1 - - - 0x017AAD 05:BA9D: 00        .byte $00   ; 0B
- - - - - - 0x017AAE 05:BA9E: 00        .byte $00   ; 0C
- D 1 - - - 0x017AAF 05:BA9F: 04        .byte $04   ; 0D
- D 1 - - - 0x017AB0 05:BAA0: 00        .byte $00   ; 0E
- D 1 - - - 0x017AB1 05:BAA1: 08        .byte $08   ; 0F



tbl_BAA2:
- D 1 - - - 0x017AB2 05:BAA2: 00        .byte $00   ; 00
- D 1 - - - 0x017AB3 05:BAA3: 00        .byte $00   ; 01
- D 1 - - - 0x017AB4 05:BAA4: 00        .byte $00   ; 02
- D 1 - - - 0x017AB5 05:BAA5: 00        .byte $00   ; 03
- D 1 - - - 0x017AB6 05:BAA6: 00        .byte $00   ; 04
- D 1 - - - 0x017AB7 05:BAA7: 00        .byte $00   ; 05
- D 1 - - - 0x017AB8 05:BAA8: 00        .byte $00   ; 06
- D 1 - - - 0x017AB9 05:BAA9: 01        .byte $01   ; 07
- D 1 - - - 0x017ABA 05:BAAA: 01        .byte $01   ; 08
- D 1 - - - 0x017ABB 05:BAAB: 01        .byte $01   ; 09
- D 1 - - - 0x017ABC 05:BAAC: 01        .byte $01   ; 0A
- D 1 - - - 0x017ABD 05:BAAD: 00        .byte $00   ; 0B
- D 1 - - - 0x017ABE 05:BAAE: 02        .byte $02   ; 0C
- - - - - - 0x017ABF 05:BAAF: 02        .byte $02   ; 0D
- - - - - - 0x017AC0 05:BAB0: 02        .byte $02   ; 0E
- - - - - - 0x017AC1 05:BAB1: 01        .byte $01   ; 0F
...
C - - - - - 0x017B6B 05:BB5B: A5 57     LDA ram_опция_режим_и_сложность
C - - - - - 0x017B6D 05:BB5D: 29 F0     AND #$F0
C - - - - - 0x017B6F 05:BB5F: F0 02     BEQ bra_BB63_демо
C - - - - - 0x017B71 05:BB61: 10 03     BPL bra_BB66_не_прохождение
bra_BB63_демо:
C - - - - - 0x017B73 05:BB63: 20 C4 B9  JSR sub_B9C4
bra_BB66_не_прохождение:
C - - - - - 0x017B76 05:BB66: AD 94 04  LDA ram_опция_дождя_и_ветра
...
C - - - - - 0x017B86 05:BB76: 8D 03 06  STA ram_шанс_на_дождь_при_ветер_плюс_дождь
...
C - - - - - 0x017BA5 05:BB95: AD 94 04  LDA ram_опция_дождя_и_ветра
...
C - - - - - 0x017C08 05:BBF8: 8D F2 05  STA ram_номер_банка_фона_поля
C - - - - - 0x017C0B 05:BBFB: C8        INY
C - - - - - 0x017C0C 05:BBFC: B1 2C     LDA (ram_002C),Y
C - - - - - 0x017C0E 05:BBFE: 8D F3 05  STA ram_номер_prg_банка ; bzk wtf
...
C - - - - - 0x017C2D 05:BC1D: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x017C59 05:BC49: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x017C7D 05:BC6D: 90 F0     BCC bra_BC5F_loop
bra_BC6F_demo:
...
C - - - - - 0x017C9A 05:BC8A: B9 18 BD  LDA tbl_BD18_план_на_игру,Y
C - - - - - 0x017C9D 05:BC8D: 9D D3 05  STA ram_опции_тактики,X
C - - - - - 0x017CA0 05:BC90: B9 19 BD  LDA tbl_BD18_план_на_игру + 1,Y
...
tbl_BCC8:
- D 1 - - - 0x017CD8 05:BCC8: CE BC     .word off_BCCE_00_трава
- - - - - - 0x017CDA 05:BCCA: E6 BC     .word off_BCE6_01_земля
- D 1 - - - 0x017CDC 05:BCCC: FE BC     .word off_BCFE_02_песок
...
tbl_BD18_план_на_игру:
; 00
- D 1 - - - 0x017D28 05:BD18: 55        .byte $55   ; средне/иногда/средне/иногда
- D 1 - - - 0x017D29 05:BD19: 00        .byte $00   ; 2-1-2
; 01
- D 1 - - - 0x017D2A 05:BD1A: 56        .byte $56   ; вестись/иногда/средне/иногда
- D 1 - - - 0x017D2B 05:BD1B: 00        .byte $00   ; 2-1-2
; 02
- - - - - - 0x017D2C 05:BD1C: 55        .byte $55   ; средне/иногда/средне/иногда
- - - - - - 0x017D2D 05:BD1D: 00        .byte $00   ; 2-1-2
; 03
- D 1 - - - 0x017D2E 05:BD1E: 52        .byte $52   ; вестись/всегда/средне/иногда
- D 1 - - - 0x017D2F 05:BD1F: 01        .byte $01   ; 1-2-2
; 04
- - - - - - 0x017D30 05:BD20: 55        .byte $55   ; средне/иногда/средне/иногда
- - - - - - 0x017D31 05:BD21: 00        .byte $00   ; 2-1-2
; 05
- D 1 - - - 0x017D32 05:BD22: 55        .byte $55   ; средне/иногда/средне/иногда
- D 1 - - - 0x017D33 05:BD23: 00        .byte $00   ; 2-1-2
; 06
- - - - - - 0x017D34 05:BD24: 80        .byte $80   ; пасовать/всегда/агресс/никогда
- - - - - - 0x017D35 05:BD25: 02        .byte $02   ; 2-2-1
; 07
- D 1 - - - 0x017D36 05:BD26: 91        .byte $91   ; средне/всегда/средне/никогда
- D 1 - - - 0x017D37 05:BD27: 00        .byte $00   ; 2-1-2
; 08
- - - - - - 0x017D38 05:BD28: 55        .byte $55   ; средне/иногда/средне/иногда
- - - - - - 0x017D39 05:BD29: 00        .byte $00   ; 2-1-2
; 09
- D 1 - - - 0x017D3A 05:BD2A: 80        .byte $80   ; пасовать/всегда/агресс/никогда
- D 1 - - - 0x017D3B 05:BD2B: 01        .byte $01   ; 1-2-2
; 0A
- - - - - - 0x017D3C 05:BD2C: 80        .byte $80   ; пасовать/всегда/агресс/никогда
- - - - - - 0x017D3D 05:BD2D: 02        .byte $02   ; 2-2-1
; 0B
- D 1 - - - 0x017D3E 05:BD2E: 90        .byte $90   ; пасовать/всегда/средне/никогда
- D 1 - - - 0x017D3F 05:BD2F: 01        .byte $01   ; 1-2-2
; 0C
- - - - - - 0x017D40 05:BD30: 55        .byte $55   ; средне/иногда/средне/иногда
- - - - - - 0x017D41 05:BD31: 00        .byte $00   ; 2-1-2
; 0D
- D 1 - - - 0x017D42 05:BD32: 80        .byte $80   ; пасовать/всегда/агресс/никогда
- D 1 - - - 0x017D43 05:BD33: 01        .byte $01   ; 1-2-2
; 0E
- D 1 - - - 0x017D44 05:BD34: 41        .byte $41   ; средне/всегда/агресс/иногда
- D 1 - - - 0x017D45 05:BD35: 00        .byte $00   ; 2-1-2
; 0F
- D 1 - - - 0x017D46 05:BD36: 82        .byte $82   ; вестись/всегда/агресс/никогда
- D 1 - - - 0x017D47 05:BD37: 02        .byte $02   ; 2-2-1
...
C - - - - - 0x017D54 05:BD44: D0 05     BNE bra_BD4B_это_япония
...
C - - - - - 0x017D82 05:BD72: D0 02     BNE bra_BD76_это_япония
...
C - - - - - 0x017D99 05:BD89: D0 02     BNE bra_BD8D_это_япония
...
tbl_BDF6:
- D 1 - - - 0x017E06 05:BDF6: 20        .byte con_chr_bank + $20   ; 
tbl_BDF7:
- D 1 - - - 0x017E07 05:BDF7: 14        .byte con_chr_bank + $14   ; 
- - - - - - 0x017E08 05:BDF8: 20        .byte con_chr_bank + $20   ; 
- D 1 - - - 0x017E09 05:BDF9: 14        .byte con_chr_bank + $14   ; 
- - - - - - 0x017E0A 05:BDFA: 20        .byte con_chr_bank + $20   ; 
- D 1 - - - 0x017E0B 05:BDFB: 15        .byte con_chr_bank + $15   ; 
- - - - - - 0x017E0C 05:BDFC: 20        .byte con_chr_bank + $20   ; 
- D 1 - - - 0x017E0D 05:BDFD: 16        .byte con_chr_bank + $16   ; 
- - - - - - 0x017E0E 05:BDFE: 20        .byte con_chr_bank + $20   ; 
- - - - - - 0x017E0F 05:BDFF: 17        .byte con_chr_bank + $17   ; 
- - - - - - 0x017E10 05:BE00: 20        .byte con_chr_bank + $20   ; 
- D 1 - - - 0x017E11 05:BE01: 17        .byte con_chr_bank + $17   ; 
- - - - - - 0x017E12 05:BE02: 20        .byte con_chr_bank + $20   ; 
- - - - - - 0x017E13 05:BE03: 18        .byte con_chr_bank + $18   ; 
- D 1 - - - 0x017E14 05:BE04: 21        .byte con_chr_bank + $21   ; 
- D 1 - - - 0x017E15 05:BE05: 19        .byte con_chr_bank + $19   ; 
- - - - - - 0x017E16 05:BE06: 20        .byte con_chr_bank + $20   ; 
- - - - - - 0x017E17 05:BE07: 1A        .byte con_chr_bank + $1A   ; 
- D 1 - - - 0x017E18 05:BE08: 22        .byte con_chr_bank + $22   ; 
- D 1 - - - 0x017E19 05:BE09: 1A        .byte con_chr_bank + $1A   ; 
- - - - - - 0x017E1A 05:BE0A: 20        .byte con_chr_bank + $20   ; 
- - - - - - 0x017E1B 05:BE0B: 1B        .byte con_chr_bank + $1B   ; 
- D 1 - - - 0x017E1C 05:BE0C: 23        .byte con_chr_bank + $23   ; 
- D 1 - - - 0x017E1D 05:BE0D: 1C        .byte con_chr_bank + $1C   ; 
- - - - - - 0x017E1E 05:BE0E: 20        .byte con_chr_bank + $20   ; 
- - - - - - 0x017E1F 05:BE0F: 1D        .byte con_chr_bank + $1D   ; 
- D 1 - - - 0x017E20 05:BE10: 24        .byte con_chr_bank + $24   ; 
- D 1 - - - 0x017E21 05:BE11: 1D        .byte con_chr_bank + $1D   ; 
- D 1 - - - 0x017E22 05:BE12: 25        .byte con_chr_bank + $25   ; 
- D 1 - - - 0x017E23 05:BE13: 1E        .byte con_chr_bank + $1E   ; 
- - - - - - 0x017E24 05:BE14: 20        .byte con_chr_bank + $20   ; 
- D 1 - - - 0x017E25 05:BE15: 1F        .byte con_chr_bank + $1F   ; 
...
C - - - - - 0x017EE0 05:BED0: 10 D1     BPL bra_BEA3_loop
C - - - - - 0x017EE2 05:BED2: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
C - - - - - 0x017F2C 05:BF1C: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
sub_BF2A:
C - - - - - 0x017F3A 05:BF2A: AD 03 06  LDA ram_шанс_на_дождь_при_ветер_плюс_дождь
...
C - - - - - 0x017F61 05:BF51: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
...
sub_BF65:
C - - - - - 0x017F75 05:BF65: A5 57     LDA ram_опция_режим_и_сложность
...
C - - - - - 0x017F82 05:BF72: AD 4A 05  LDA ram_раунд_плей_офф
...
C - - - - - 0x017FAE 05:BF9E: 20 0B C0  JSR sub_0x01EEAA_запись_банков_спрайтов
