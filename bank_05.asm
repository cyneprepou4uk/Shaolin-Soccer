...
C - - - - - 0x0142B4 05:82A4: 9D 74 00  STA ram_анимация_игрока,X
C - - - - - 0x0142B7 05:82A7: 4C AF 82  RTS
bra_82AA:
C - - - - - 0x0142BA 05:82AA: A9 7F     LDA #$7F
C - - - - - 0x0142BC 05:82AC: 9D 74 00  STA ram_анимация_игрока,X
...
C - - - - - 0x01436A 05:835A: A9 00     LDA #$00    ; con_индекс_японии
...
C - - - - - 0x014389 05:8379: A9 01     LDA #$01    ; con_action_стоит_на_месте
...
bra_83C3_loop:
C - - - - - 0x0143D3 05:83C3: 9D 6E 04  STA ram_категория_анимации_игрока + 2,X
...
C - - - - - 0x014554 05:8544: B9 6E 04  LDA ram_категория_анимации_игрока + 2,Y
C - - - - - 0x014557 05:8547: 69 01     ADC #$01
loc_8549:
C D 0 - - - 0x014559 05:8549: 29 0F     AND #$0F
C - - - - - 0x01455B 05:854B: 99 6E 04  STA ram_категория_анимации_игрока + 2,Y
...
C - - - - - 0x01457C 05:856C: B9 6E 04  LDA ram_категория_анимации_игрока + 2,Y
...
C - - - - - 0x01474B 05:873B: A9 00     LDA #con_индекс_японии
...
C - - - - - 0x014A82 05:8A72: 99 6E 04  STA ram_категория_анимации_игрока + 2,Y
...
sub_8AA8:
bra_8AA8_loop:
C - - - - - 0x014AB8 05:8AA8: B9 6E 04  LDA ram_категория_анимации_игрока + 2,Y
...
C - - - - - 0x014AEA 05:8ADA: 8D 80 00  STA ram_анимация_мяча
...
C - - - - - 0x014E66 05:8E56: 99 74 00  STA ram_анимация_игрока,Y
bra_8E59:
...
tbl_8EFB:
- D 0 - - - 0x014F0B 05:8EFB: 0C        .byte con_индекс_мяча   ; 
...
C - - - - - 0x014F48 05:8F38: B9 74 00  LDA ram_анимация_игрока,Y
C - - - - - 0x014F4B 05:8F3B: 95 74     STA ram_анимация_игрока,X
C - - - - - 0x014F4D 05:8F3D: F6 74     INC ram_анимация_игрока,X
...
C - - - - - 0x0151D8 05:91C8: 9D 6C 04  STA ram_категория_анимации_игрока,X
bra_91B7:
...
C - - - - - 0x0153AD 05:939D: 8D 74 00  STA ram_анимация_игрока
C - - - - - 0x0153B0 05:93A0: 8D 75 00  STA ram_анимация_игрока + 1
C - - - - - 0x0153B3 05:93A3: 8D 76 00  STA ram_анимация_игрока + 2
C - - - - - 0x0153B6 05:93A6: 8D 77 00  STA ram_анимация_игрока + 3
...
C - - - - - 0x015BF7 05:9BE7: A2 0C     LDX #con_индекс_мяча
...
C - - - - - 0x015E02 05:9DF2: 9D 74 00  STA ram_анимация_игрока,X
...
C - - - - - 0x015E12 05:9E02: 9D 74 00  STA ram_анимация_игрока,X
bra_9E05:
...
C - - - - - 0x015E2C 05:9E1C: 9D 74 00  STA ram_анимация_игрока,X
...
C - - - - - 0x015E57 05:9E47: 9D 74 00  STA ram_анимация_игрока,X
...
C - - - - - 0x015E6C 05:9E5C: 9D 74 00  STA ram_анимация_игрока,X
bra_9E5F_RTS:
...
sub_A295:
C - - - - - 0x0162A5 05:A295: A9 00     LDA #con_индекс_японии
...
C - - - - - 0x01630B 05:A2FB: 9D 74 00  STA ram_анимация_игрока
...
C - - - - - 0x0165A2 05:A592: A9 07     LDA #$07    ; con_action_07
...
C - - - - - 0x0168D7 05:A8C7: 8D 75 00  STA ram_анимация_игрока + 1
C - - - - - 0x0168DA 05:A8CA: A9 7F     LDA #$7F
C - - - - - 0x0168DC 05:A8CC: 8D 76 00  STA ram_анимация_игрока + 2
...
C - - - - - 0x016991 05:A981: 8D 75 00  STA ram_анимация_игрока + 1
C - - - - - 0x016994 05:A984: A9 96     LDA #$96
C - - - - - 0x016996 05:A986: 8D 76 00  STA ram_анимация_игрока + 2
...
- - - - - - 0x01730E 05:B2FE: A9 00     LDA #con_индекс_японии
...
- - - - - - 0x017318 05:B308: 8D 80 00  STA ram_анимация_мяча
...
- - - - - - 0x01734A 05:B33A: A2 0C     LDX #con_индекс_мяча
...
- - - - - - 0x0173AA 05:B39A: A2 0C     LDX #con_индекс_мяча
...
- - - - - - 0x0174B3 05:B4A3: A2 0C     LDX #con_индекс_мяча
...
ofs_B4AE_01:
- - - - - - 0x0174BE 05:B4AE: A2 0C     LDX #con_индекс_мяча
...
- - - - - - 0x0174F5 05:B4E5: 8D 80 00  STA ram_анимация_мяча
...
bra_B915_loop:
C - - - - - 0x017925 05:B915: B9 6E 04  LDA ram_категория_анимации_игрока + 2,Y
...
C D 1 - - - 0x0179EE 05:B9DE: A9 0B     LDA #con_индекс_италии
