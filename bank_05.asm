...
C - - - - - 0x014130 05:8120: 9D 59 04  STA ram_подтип_действия,X
...
C - - - - - 0x014171 05:8161: 9D 79 04  STA ram_тип_действия,X
...
C - - - - - 0x014394 05:8384: 8D 59 04  STA ram_подтип_действия
C - - - - - 0x014397 05:8387: 8D 65 04  STA ram_подтип_удара
...
C - - - - - 0x014425 05:8415: 8D 79 04  STA ram_тип_действия
...
C - - - - - 0x014454 05:8444: 8D 79 04  STA ram_тип_действия
...
C - - - - - 0x014702 05:86F2: 8D D4 05  STA ram_05D3 + 1
...
C - - - - - 0x014B3B 05:8B2B: 9D 79 04  STA ram_тип_действия,X
C - - - - - 0x014B3E 05:8B2E: A9 01     LDA #$01
C - - - - - 0x014B40 05:8B30: 9D 59 04  STA ram_подтип_действия,X
...
C - - - - - 0x014E96 05:8E86: 8D 5C 04  STA ram_подтип_действия + 3
...
C - - - - - 0x014EA4 05:8E94: 8D 5A 04  STA ram_подтип_действия + 1
...
sub_8EFF:
C - - - - - 0x014F0F 05:8EFF: BD 59 04  LDA ram_подтип_действия,X
...
ofs_8F40_03:
ofs_8F40_04:
C - - J - - 0x014F50 05:8F40: BD 59 04  LDA ram_подтип_действия,X
C - - - - - 0x014F53 05:8F43: 30 0D     BMI bra_8F52
C - - - - - 0x014F55 05:8F45: 09 80     ORA #$80
C - - - - - 0x014F57 05:8F47: 9D 59 04  STA ram_подтип_действия,X
...
C - - - - - 0x014F65 05:8F55: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x014FE9 05:8FD9: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x01516F 05:915F: 9D 5A 04  STA ram_подтип_действия + 1,X
...
sub_9194:
C - - - - - 0x0151A4 05:9194: BD 59 04  LDA ram_подтип_действия,X
...
ofs_91AF_08:
ofs_91AF_09:
C - - J - - 0x0151BF 05:91AF: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x0151CD 05:91BD: 9D 59 04  STA ram_подтип_действия,X
...
ofs_91CC:
- - - - - - 0x0151DC 05:91CC: BD 59 04  LDA ram_подтип_действия,X
- - - - - - 0x0151DF 05:91CF: 29 7F     AND #$7F
- - - - - - 0x0151E1 05:91D1: 9D 59 04  STA ram_подтип_действия,X
...
C - - - - - 0x0151F9 05:91E9: BD 59 04  LDA ram_подтип_действия,X
...
C - - - - - 0x01610B 05:A0FB: 8D 59 04  STA ram_подтип_действия
...
C - - - - - 0x016322 05:A312: 9D 59 04  STA ram_подтип_действия,X
...
C - - - - - 0x0165A7 05:A597: 8D 59 04  STA ram_подтип_действия
...
C - - - - - 0x017CA0 05:BC90: B9 19 BD  LDA tbl_BD18 + 1,Y
...
- D 1 - - - 0x017D29 05:BD19: 00        .byte $00   ; расстановка
; 01
