...
C - - - - - 0x014389 05:8379: A9 01     LDA #$01    ; con_action_стоит_на_месте  con_anim_type_мяч
...
sub_A7A4:
C - - - - - 0x0167B4 05:A7A4: AD 58 05  LDA ram_общее_количество_побед_в_прохе
...
C - - - - - 0x016FEC 05:AFDC: ED 58 05  SBC ram_общее_количество_побед_в_прохе
...
C - - - - - 0x016FF9 05:AFE9: ED 55 05  SBC ram_общее_количество_очков_в_прохе
...
C - - - - - 0x0172D3 05:B2C3: AD 55 05  LDA ram_общее_количество_очков_в_прохе
C - - - - - 0x0172D6 05:B2C6: C9 46     CMP #$46
C - - - - - 0x0172D8 05:B2C8: 90 0E     BCC bra_B2D8
- - - - - - 0x0172DA 05:B2CA: AD 58 05  LDA ram_общее_количество_побед_в_прохе
...
C - - - - - 0x017413 05:B403: EE 56 05  INC ram_общее_количество_сыгранных_матчей_в_прохе
...
- - - - - - 0x017421 05:B411: AD 57 05  LDA ram_общее_количество_поражений_в_прохе
- - - - - - 0x017424 05:B414: 69 01     ADC #$01
- - - - - - 0x017426 05:B416: B0 4C     BCS bra_B464_RTS
- - - - - - 0x017428 05:B418: 8D 57 05  STA ram_общее_количество_поражений_в_прохе
...
C - - - - - 0x01743D 05:B42D: EE 58 05  INC ram_общее_количество_побед_в_прохе
...
C - - - - - 0x01746A 05:B45A: 6D 55 05  ADC ram_общее_количество_очков_в_прохе
C - - - - - 0x01746D 05:B45D: 90 02     BCC bra_B461_not_overflow
- - - - - - 0x01746F 05:B45F: A9 FF     LDA #$FF
bra_B461_not_overflow:
C - - - - - 0x017471 05:B461: 8D 55 05  STA ram_общее_количество_очков_в_прохе
bra_B464_RTS:
...
- - - - - - 0x01751E 05:B50E: AD 55 05  LDA ram_общее_количество_очков_в_прохе
...
C - - - - - 0x0178E5 05:B8D5: AD 55 05  LDA ram_общее_количество_очков_в_прохе
...
C - - - - - 0x0178F0 05:B8E0: AD 55 05  LDA ram_общее_количество_очков_в_прохе
...
C - - - - - 0x017930 05:B920: 8D 55 05  STA ram_общее_количество_очков_в_прохе
C - - - - - 0x017933 05:B923: 8D 56 05  STA ram_общее_количество_сыгранных_матчей_в_прохе
C - - - - - 0x017936 05:B926: 8D 58 05  STA ram_общее_количество_побед_в_прохе
C - - - - - 0x017939 05:B929: 8D 57 05  STA ram_общее_количество_поражений_в_прохе
...
- - - - - - 0x017970 05:B960: 8D 55 05  STA ram_общее_количество_очков_в_прохе
- - - - - - 0x017973 05:B963: A2 00     LDX #$00
- - - - - - 0x017975 05:B965: 8E 58 05  STX ram_общее_количество_побед_в_прохе
bra_B968_loop:
...
- - - - - - 0x01798D 05:B97D: 6D 58 05  ADC ram_общее_количество_побед_в_прохе
- - - - - - 0x017990 05:B980: 8D 58 05  STA ram_общее_количество_побед_в_прохе
